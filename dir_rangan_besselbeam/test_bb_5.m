...
% Simple axicon-lens --> bessel-beam. ;
%%%%%%%%;
...
lightpipe.a          = 10.0  * unit.mm ; % slit width ;
%%%%%%%%;
% circular aperture. ;
...
%%%%%%%%;
fname_fig_pre = sprintf('%s/test_bb_5_FIGA',dir_fig);
...
%%%%%%%%;
fname_fig_pre = sprintf('%s/test_bb_5_FIGB',dir_fig);
fname_fig_jpg = sprintf('%s.jpg',fname_fig_pre);
if flag_replot | ~exist(fname_fig_jpg,'file');
disp(sprintf(' %% Writing %s',fname_fig_pre));
sgtitle(fname_fig_pre,'Interpreter','none');
