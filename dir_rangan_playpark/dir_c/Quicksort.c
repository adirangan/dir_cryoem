...
void iQuickSort(unsigned int recursion_level,int *i_,int stride,int l,int r)
{
  /* modified from http://www.comp.dit.ie/rlawlor/Alg_DS/sorting/quickSort.c */
  /* test with: */
  /*
    int i_[] = { 7 , 8 , 6 , 3 , 2 , 9 , 10 , 11 , 6 , 7 , 6 };
    array_printf(i_,"int",1,11," %% i_: ");
  ...
  */
  ...
  if( l < r ) { 
    if (recursion_level<GLOBAL_recursion_limit){ 
      ...
      iQuickSort(recursion_level+1,i_,stride,l,j-1); 
      iQuickSort(recursion_level+1,i_,stride,j+1,r);
      /* if (recursion_level<GLOBAL_recursion_limit){ } */}
    else /* if (recursion_level>=GLOBAL_recursion_limit) */{ 
...
void dQuickSort(unsigned int recursion_level,double *d_,int stride,int l,int r)
{
  /* modified from http://www.comp.dit.ie/rlawlor/Alg_DS/sorting/quickSort.c */
  /* test with: */
  /*
    double d_[] = { 7.0 , 8.0 , 6.0 , 3.0 , 2.0 , 9.0 , 10.0 , 11.0 , 6.0 , 7.0 , 6.0 };
    array_printf(d_,"double",1,11," %% d_: ");
  ...
  */
  ...
  if( l < r ) { 
    if (recursion_level<GLOBAL_recursion_limit){ 
      ...
      dQuickSort(recursion_level+1,d_,stride,l,j-1); 
      dQuickSort(recursion_level+1,d_,stride,j+1,r);
      /* if (recursion_level<GLOBAL_recursion_limit){ } */}
    else /* if (recursion_level>=GLOBAL_recursion_limit) */{ 
...
void irandperm(unsigned int recursion_level,int *i_)
{
  int verbose=0;
  double d_[recursion_level];
  int nj=0;
  for (nj=0;nj<recursion_level;nj++){ d_[nj] = rand01;}
  if (verbose){ printf(" %% [entering irandperm] recursion_level %d\n",recursion_level);}
  dQuickSort_xij(0,d_,1,i_,NULL,NULL,NULL,NULL,NULL,0,recursion_level-1);
  if (verbose){ array_printf(i_,"int",1,recursion_level," %% i_: ");}
  if (verbose){ printf(" %% [finished irandperm] recursion_level %d\n",recursion_level);}
}
...
unsigned int ulliQuickSort_index(unsigned int recursion_level,unsigned long long int *ulli_,int stride,int *index_,int l,int r)
{
  /* modified from http://www.comp.dit.ie/rlawlor/Alg_DS/sorting/quickSort.c */
  ...
  if( l < r ) { 
    ...
    if (recursion_level<GLOBAL_recursion_limit){ 
      n1 = ulliQuickSort_index(recursion_level+1,ulli_,stride,index_,l,j-1); 
      n2 = ulliQuickSort_index(recursion_level+1,ulli_,stride,index_,j+1,r); 
      /* if (recursion_level<GLOBAL_recursion_limit){ } */}
...
void ulliQuickSort_index_driver(int n_ulli,unsigned long long int *ulli_,int stride,unsigned long long int *ulli_workspace_,int *index_)
{
  ...
  array_printf(ulli_workspace_,"unsigned long long int",1,n_ulli," %% ulli_workspace_: ");
  array_printf(index_,"int",1,n_ulli," %% index_: ");
  */
  int nulli=0;
...
unsigned int lQuickSort_index(unsigned int recursion_level,int *l_,int stride,int *index_,int l,int r)
{
  /* modified from http://www.comp.dit.ie/rlawlor/Alg_DS/sorting/quickSort.c */
  int j=0; unsigned int n1=recursion_level,n2=recursion_level;
  if( l < r ) { 
    ...
    if (recursion_level<GLOBAL_recursion_limit){ 
      n1 = lQuickSort_index(recursion_level+1,l_,stride,index_,l,j-1); 
      n2 = lQuickSort_index(recursion_level+1,l_,stride,index_,j+1,r); 
      /* if (recursion_level<GLOBAL_recursion_limit){ } */}
    else /* (recursion_level>=GLOBAL_recursion_limit) */{ 
...
void lQuickSort_index_driver(int n_l,int *l_,int stride,int *l_workspace_,int *index_)
{
  ...
  array_printf(l_workspace_,"int",1,n_l," %% l_workspace_: ");
  array_printf(index_,"int",1,n_l," %% index_: ");
  */
  int nl=0;
...
unsigned int charpQuickSort_index(unsigned int recursion_level,char **charp_,int stride,int *index_,int l,int r)
{
  /* modified from http://www.comp.dit.ie/rlawlor/Alg_DS/sorting/quickSort.c */
  int verbose=0;
  int j=0; unsigned int n1=recursion_level,n2=recursion_level;
  if (verbose){ printf(" %% [entering charpQuickSort_index] recursion_level %d stride %d l %d r %d\n",recursion_level,stride,l,r);}
  if( l < r ) {
    ...
    if (recursion_level<GLOBAL_recursion_limit){ 
      ...
      n1 = charpQuickSort_index(recursion_level+1,charp_,stride,index_,l,j-1); 
      n2 = charpQuickSort_index(recursion_level+1,charp_,stride,index_,j+1,r); 
      /* if (recursion_level<GLOBAL_recursion_limit){ } */}
    else /* (recursion_level>=GLOBAL_recursion_limit) */{ 
...
void charpQuickSort_index_test()
{
  ...
  array_printf(index_,"int",1,n_charp," %% index_: ");
}
...
void charpQuickSort_index_index_test()
{
  ...
  for (ncharp=0;ncharp<2*n_charp;ncharp++){ printf(" %% ncharp %d: %s\n",ncharp,charp_[ncharp]);}
  array_printf(index_orig_from_sort_,"int",1,n_charp," %% index_orig_from_sort_: ");
  array_printf(index_sort_from_orig_,"int",1,n_charp," %% index_sort_from_orig_: ");
}
...
void charpIntersect_index_index_test()
{
  ...
  array_printf(index_0_orig_from_intersect_,"int",1,n_intersect," %% index_0_orig_from_intersect_: ");
  array_printf(index_0_intersect_from_orig_,"int",1,n_charp_0," %% index_0_intersect_from_orig_: ");
  array_printf(index_1_orig_from_intersect_,"int",1,n_intersect," %% index_1_orig_from_intersect_: ");
  array_printf(index_1_intersect_from_orig_,"int",1,n_charp_1," %% index_1_intersect_from_orig_: ");
  exit(0);
}
...
void charpIntersectall_index_index_test()
{
  ...
  for (nlist=0;nlist<n_list;nlist++){
    ...
    array_printf(index_orig_from_intersect__[nlist],"int",1,n_intersect," %% index_orig_from_intersect__: ");
    array_printf(index_intersect_from_orig__[nlist],"int",1,n_charp_[nlist]," %% index_intersect_from_orig__: ");
    /* for (nlist=0;nlist<n_list;nlist++){ } */}
  for (nintersect=0;nintersect<n_intersect;nintersect++){ printf(" %% nintersect %d: %s\n",nintersect,charp_workspace_[nintersect]);}
  exit(0);
}
