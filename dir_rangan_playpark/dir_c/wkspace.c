...
void * malloc1(size_t size){ void *vp=NULL; vp = malloc(size); memset(vp,0,size); GLOBAL_n_malloc1++; return vp;}
void free1(void **vp){ if ( (vp!=NULL) && ((*vp)!=NULL) ){ GLOBAL_n_malloc1--; free(*vp); *vp=NULL; }}
