...
void dtranspose_test()
{
  ...
  for (block_size=1;block_size<=128;block_size*=2){
    ...
    /* for (block_size=1;block_size<128;block_size*=2){ } */}
  /* %%%%%%%% */
  free1(d_0in_); d_0in_ = NULL;
  free1(d_tru_); d_tru_ = NULL;
  free1(d_out_); d_out_ = NULL;
  free1(d_0in_sub_); d_0in_sub_ = NULL;
  free1(d_tru_sub_); d_tru_sub_ = NULL;
  free1(d_out_sub_); d_out_sub_ = NULL;
  //wkspace_printf();
}
...
void cntranspose_test()
{
  ...
  for (block_size=1;block_size<=128;block_size*=2){
    ...
    /* for (block_size=1;block_size<128;block_size*=2){ } */}
  /* %%%%%%%% */
  free1(c_0in_); c_0in_ = NULL;
  free1(c_tru_); c_tru_ = NULL;
  free1(c_out_); c_out_ = NULL;
  free1(c_0in_sub_); c_0in_sub_ = NULL;
  free1(c_tru_sub_); c_tru_sub_ = NULL;
  free1(c_out_sub_); c_out_sub_ = NULL;
  //wkspace_printf();
}
