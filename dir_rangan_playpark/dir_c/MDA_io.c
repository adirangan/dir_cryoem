...
void MDA_io_test()
{
  ...
  array_printf(i4_0_,"int",d_0_[0],d_0_[1]," %% i4_0_: ");
  MDA_write_i4(n_d_0,d_0_,i4_0_,fname);
  MDA_read_i4(&n_d_1,&d_1_,&i4_1_,fname);
  array_printf(i4_1_,"int",d_1_[0],d_1_[1]," %% i4_1_: ");
  double r8_0_[n_i];
  ...
  int *r8_2_=NULL;
  int *d_2_=NULL;
  array_printf(r8_0_,"double",d_0_[0],d_0_[1]," %% r8_0_: ");
  MDA_write_r8(n_d_0,d_0_,r8_0_,fname);
  MDA_read_r8(&n_d_2,&d_2_,&r8_2_,fname);
  array_printf(r8_2_,"double",d_2_[0],d_2_[1]," %% r8_2_: ");
  ...
  int *ulli_3_=NULL;
  int *d_3_=NULL;
  array_printf(ulli_0_,"unsigned long long int",d_0_[0],d_0_[1]," %% ulli_0_: ");
  MDA_write_ulli(n_d_0,d_0_,ulli_0_,fname);
  MDA_read_ulli(&n_d_3,&d_3_,&ulli_3_,fname);
  array_printf(ulli_3_,"unsigned long long int",d_3_[0],d_3_[1]," %% ulli_3_: ");
  wkspace_printf();
}
