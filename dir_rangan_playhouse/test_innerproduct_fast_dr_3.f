c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
      program test_innerproduct_fast_dr_3
c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
c$$$      list: verbose ncur eps_svd N_pixels_in n_delta_x n_delta_y n_gamma_z svd_calculation_type n_omp_sub
      ...
      if (verbose.gt.0) then
          write(6,'(A)')
     $        '[entering test_innerproduct_fast_dr_3]: '
       end if
       if (verbose.gt.0) then
...
c$$$      write(6,'(A)') ' test_innerproduct_fast_dr_3: '
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
     ...
     $     *n_S,') innerproducts'
      timing_tic = omp_get_wtime()
      call test_innerproduct_fast_wrapper_2(verbose,rseed,n_omp_sub,n_r
     ...
     $     ,n_SM_use)
      timing_toc = omp_get_wtime()
      if (verbose.gt.0) then
         write(6,'(A,A,F8.3)') 'test_innerproduct_fast_wrapper_2:'
     $        ,' total_time ',timing_toc-timing_tic
      end if
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
 ...
 10    continue
      ...
      if (verbose.gt.1) then
         write(6,'(A)') '[finished test_innerproduct_fast_dr_3]'
      end if
