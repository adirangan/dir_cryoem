c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
     ...
     $     ,svd_calculation_type,n_r,grid_p_,n_w_,half_diameter_x_c,n_S
     $     ,ld_S,S_p_ ,tesselation_distance_req,S_alpha_polar_a_
     ...
     $     ,CTF_p_,polar_a_est_ ,azimu_b_est_ ,gamma_z_est_
...
c$$$      parameters for timing
      ...
      integer *4 n_M_sub,nM_sub,n_r_tmp,n_A_tmp,n_tmp,i_tmp
...
c$OMP PARALLEL PRIVATE(n_tmp,i_tmp,n_r_tmp,n_A_tmp)
c$OMP DO 
      do nM_sub=0,n_M_sub-1
     ...
     $        ,svd_calculation_type,n_r,grid_p_,n_w_,half_diameter_x_c
     $        ,n_S,ld_S ,S_p_,tesselation_distance_req,S_alpha_polar_a_
     $        ,S_alpha_azimu_b_,L_ ,nl_max,nm_sum ,ll_sum,T_nl_,T_vm_
     $        ,T_tr_,T_ll_ ,T_lf_ ,T_c0_,T_c1_,T_c2_ ,T_c3_,T_ls_,T_LT_
     $        ,n_T_root_base ,T_root_base_,n_tmp,ld_M ,M_p_(ld_M*i_tmp)
     $        ,n_CTF,ld_CTF ,CTF_p_ ,polar_a_est_(i_tmp)
     $        ,azimu_b_est_(i_tmp) ,gamma_z_est_(i_tmp)
     $        ,delta_x_est_(i_tmp) ,delta_y_est_(i_tmp)
     $        ,l2_norm_est_(i_tmp) ,ctf_ind_est_(i_tmp),eps_target
     $        ,n_pixels_in ,displacement_max,n_delta_x,n_delta_y
     $        ,n_gamma_z ,delta_x_optimal_(n_S*i_tmp)
     $        ,delta_y_optimal_(n_S *i_tmp) ,gamma_z_optimal_(n_S*i_tmp)
     $        ,C_M_(i_tmp),C_S_optimal_(n_S *i_tmp) ,C_Z_optimal_(n_S
     $        *i_tmp),fftw_plan_frwd__(n_r_tmp)
...
c$OMP END DO
c$OMP END PARALLEL
      n_SM_use = sum_i4_f(n_M_sub,SM_use_sub_)
