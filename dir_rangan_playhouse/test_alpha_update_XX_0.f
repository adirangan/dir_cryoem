      subroutine test_alpha_update_SM_0(verbose,half_diameter_x_c_tmp
     ...
     $     ,alpha1d_est_,alpha_update_f,Y_est_,n_azimu_b_polar_a_sum_
     $     ,ld_S ,n_S_sample_max,n_SM,n_MS,n_delta_x,n_delta_y,n_gamma_z
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
     ...
     $     *n_S_sample,') innerproducts'
      ...
      call test_innerproduct_batch_SM_wrapper_0a(0,n_k_cur,n_polar_a_
     $     ,grid_k_p_,half_diameter_x_c_tmp,n_S_sample,ld_S,S_sample_
     $     ,tesselation_distance_req_use ,S_alpha_polar_a_sample_
     $     ,S_alpha_azimu_b_sample_ ,n_M_sample ,ld_M,M_sample_ ,n_ctf
     $     ,ld_CTF ,CTF_k_p_,n_alpha ,alpha1d_est_,alpha_update_f ,0.1d0
     $     ,n_pixels_in ,displacement_max ,n_delta_x ,n_delta_y
     $     ,n_gamma_z, svd_calculation_type ,C_M_ ,n_SM_use)
