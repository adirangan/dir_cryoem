      subroutine test_innerproduct_fast_STxTRM_0(verbose,n_delta_x
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_fast_STxTRM_0]'
...
c$$$         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)')
     $        '[finished test_innerproduct_fast_STxTRM_0]'
      end if !if (verbose.gt.0) then
      end
