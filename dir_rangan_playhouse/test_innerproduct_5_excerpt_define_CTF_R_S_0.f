...
c     $OMP DO 
     ...
     $           ,' test_innerproduct_5_CTF_R_S_2'
     $           ,' with thread: ',omp_get_thread_num()
         end if
         call test_innerproduct_5_CTF_R_S_2(verbose-1,n_gamma_z
...
c     $OMP END PARALLEL
     ...
     $        ,Z_q_omp__(n_A_tmp))
      ...
      gnump_tot = (n_A*1.0d0)*(nS_0_per*1.0d0)*(n_CTF*1.0d0)
