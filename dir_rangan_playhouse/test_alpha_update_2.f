      subroutine test_alpha_update_2(verbose,n_omp_sub ,fpm_howmany_max
     ...
     $     ,svd_calculation_type ,eps_svd ,n_pixels_in ,displacement_max
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
     ...
     $     -1) + n_w_(n_k_cur-1)
      ...
      call test_innerproduct_fast_wrapper_1(0,n_omp_sub,n_k_cur
