     ...
     $     ,ld_CTF,CTF_k_p_,k_p,fftw_plan_frwd,fftw_plan_back,n_w_sum
     $     ,n_w,fftw_in1_ ,fftw_out_,alpha2d__ ,M_k_c_
     $     ,polar_a_,azimu_b_ ,weight_CTF_k_c_,n_w_M)
      implicit none
      integer verbose
      data verbose / 0 /
      integer n_M,I_M_sample_(0:n_M-1),ld_M,n_CTF,ld_CTF,n_w_sum,n_w
     $     ,n_w_M
...
c
         ...
         do nw = 0,n_w-1
            M_k_p_1_(nw) = M_k_p__(n_w_sum-1+nw + I_M_sample_(nM)*ld_M)
     $           /l2_norm
