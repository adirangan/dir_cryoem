c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
      program test_innerproduct_fast_dr_4
c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
c$$$      This program is a driver which tests the subroutine
c$$$      test_innerproduct_fast_wrapper_2.f ,
...
c$$$         various images.
c$$$      D. Then we call test_innerproduct_fast_wrapper_2 to calculate
...
c$$$      D. The routine test_innerproduct_fast_wrapper_2 is used
...
c$$$      List of parameters: ;
      ...
      if (verbose.gt.0) then
          write(6,'(A)')
     $        '[entering test_innerproduct_fast_dr_4]: '
       end if
       if (verbose.gt.0) then
...
c$$$      write(6,'(A)') ' test_innerproduct_fast_dr_4: '
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
     ...
     $     *n_S,') innerproducts'
      timing_tic = omp_get_wtime()
      call test_innerproduct_fast_wrapper_3(verbose,rseed,n_omp_sub,n_r
     $     ,n_polar_a_,grid_k_p_,max_x_c,n_S,I_S_sample_,n_A ,S_k_p_
     $     ,tesselation_distance_req ,alpha_polar_a_,alpha_azimu_b_ ,n_M
     $     ,I_M_sample_,n_A,M_k_p_ ,n_CTF,n_A ,CTF_k_p_,n_alpha
     $     ,alpha_est_ ,alpha_update_f,flag_MS_vs_SM,N_pixels_in
     $     ,displacement_max ,n_delta_x ,n_delta_y,n_gamma_z,
     $     svd_calculation_type ,eps_svd ,fpm_howmany_max,C_M_
     $     ,n_SM_use)
      timing_toc = omp_get_wtime()
      if (verbose.gt.0) then
         write(6,'(A,A,F8.3)') 'test_innerproduct_fast_wrapper_3:'
     $        ,' total_time ',timing_toc-timing_tic
      end if
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
 ...
 10    continue
      ...
      if (verbose.gt.1) then
         write(6,'(A)') '[finished test_innerproduct_fast_dr_4]'
      end if
