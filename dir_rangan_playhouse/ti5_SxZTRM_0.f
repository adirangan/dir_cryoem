...
c$$$      %%%%%%%%%%%%%%%%
     ...
     $           ' calling test_innerproduct_5_SxZTRM_2 to test. '
         ...
         call  test_innerproduct_5_SxZTRM_3(verbose-1,n_svd_d,svd_d_
     $        ,n_svd_r,svd_r_,n_svd_l,svd_l_,svd_U_d_,svd_s_,svd_V_r_
     $        ,Z_M_svdd_,n_delta_v ,delta_x_,delta_y_ ,n_gamma_z
     $        ,gamma_z_,delta_x_est_(nM_1_sum) ,delta_y_est_(nM_1_sum)
     ...
     $        ,grid_k_p_,n_w_,n_A,S_p_,S_q_,nS_1_per
