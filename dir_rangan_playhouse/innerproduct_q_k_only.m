function C_q_ = innerproduct_q_k_only(n_r,grid_p_,n_w_,n_A,T_q_,M_q_);
...
verbose=0;
if (verbose>0);
disp(sprintf(' %% [entering innerproduct_q_k_only]'));
end;%if;
...
if (verbose>0);
disp(sprintf(' %% [finished innerproduct_q_k_only]'));
end;%if;
