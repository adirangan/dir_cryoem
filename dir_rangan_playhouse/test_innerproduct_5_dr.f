c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
      program test_innerproduct_dr_5
c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
c$$$      This program is a driver which tests the subroutine
c$$$      test_innerproduct_5.f ,
...
c$$$         various images.
c$$$      D. Then we call test_innerproduct_5 to calculate
...
c$$$      D. The routine test_innerproduct_5 is used
...
c$$$      tesselation_distance_req = 0.2d0
      ...
      if (verbose.gt.0) then
          write(6,'(A)')
     $        '[entering test_innerproduct_dr_5]: '
       end if
       if (verbose.gt.0) then
...
c$$$      svd_calculation_type == 2 --> account for displacements via brute-force. ;
     ...
     $     )
      ...
      if ((verbose.gt.0) .and. (flag_memory_estimate.eqv..false.)) then
         write(6,'(A,A,F8.3)') 'test_innerproduct_5:'
     $        ,' total_time ',timing_toc-timing_tic
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
 ...
 10    continue
      ...
      if (verbose.gt.1) then
         write(6,'(A)') '[finished test_innerproduct_dr_5]'
      end if
