      subroutine Fig_gen_ctf_ver2(ncur,nlats_,grid_k_p_,n_M,ld_M,N_k_p_
     $    ,M_k_p_,ld_CTF,CTF_k_p_,n_alpha,alpha_est_,n_M_sample,prefix)
...
c$$$      Printing figure file for image
     ...
     $     ,trim(fname_fig),trim(fname_jpg)
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished Fig_gen_ctf_ver2]'
      end if
