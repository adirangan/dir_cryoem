     ...
     $        gnump_total_CTF_R_S/max(1.0d0,timing_total_CTF_R_S*1.0d9)
         ...
         write(6,'(A,F8.4)') ' timing_total_O_S_q: ' ,
     $        timing_total_O_S_q
         write(6,'(A,F8.4)') ' gnump_total_O_S_q: ' , gnump_total_O_S_q
     $        /max(1.0d0,timing_total_O_S_q*1.0d9)
     ...
     $        /max(1.0d0,timing_total_Z_S_q*1.0d9)
         ...
         write(6,'(A,F8.4)') ' timing_total_O_T_R_CTF_M_q: ' ,
     $        timing_total_O_T_R_CTF_M_q
         write(6,'(A,F8.4)') ' gnump_total_O_T_R_CTF_M_q: ' ,
     $        gnump_total_O_T_R_CTF_M_q/max(1.0d0
     $        ,timing_total_O_T_R_CTF_M_q *1.0d9)
