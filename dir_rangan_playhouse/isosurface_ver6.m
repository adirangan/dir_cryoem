function isosurface_ver6(n_,dirname,infix) ;
% for use with test_ver10.f, which has model_A and model_B, as well as Y_tru_ and Y_est_ ;
figure;
...
print('-djpeg',sprintf('%s/f_x_c_%s___%d_%d_%d.jpg',dirname,infix,n_(2),round(mean(diff(n_(2:end)))),n_(end)));
