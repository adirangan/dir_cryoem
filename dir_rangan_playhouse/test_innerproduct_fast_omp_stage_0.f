c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
      subroutine test_innerproduct_fast_omp_stage_0(verbose,n_omp_sub
...
c$$$      pi
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_fast_omp_stage_0]'
      end if      
...
c$$$         call dfftw_destroy_plan_(fpm_frwd_(nomp_sub))
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_fast_omp_stage_0]'
      end if
