      subroutine test_innerproduct_5_SxZTRM_3(verbose,n_svd_d,svd_d_
     $     ,n_svd_r,svd_r_,n_svd_l,svd_l_,svd_U_d_,svd_s_,svd_V_r_
     $     ,Z_M_svdd_,n_delta_v,delta_x_ ,delta_y_ ,n_gamma_z ,gamma_z_
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_5_SxZTRM_3]'
      ...
      call innerproduct_q_k_svdd_2(.true.,n_svd_d,svd_d_,n_svd_l,svd_l_
     $     ,svd_U_d_,n_delta_v,delta_x_,delta_y_,Z_S_svdd_)
...
c$$$         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
         ...
         do ndv=0,n_delta_v-1
            ...
            call write_sub_c16(n_w_max,C_S_q_(n_w_max*ndv),9,
     $ ' C_S_q_: ')
            call write_sub_c16(n_w_max,C_M_q_(n_w_max*ndv),9,
     $ ' C_M_q_: ')
         enddo !do ndv=0,n_delta_v-1
...
c$$$  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)')
     $        '[finished test_innerproduct_5_SxZTRM_3]'
      end if !if (verbose.gt.0) then
      end
