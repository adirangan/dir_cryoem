      ...
      if (flag_RTRT_vs_RTTR.eqv..true.) then
         call cl1_c16(n_svd_l*n_delta_x*n_delta_y,Z_S_svdd_)
         call innerproduct_q_k_svdd_1(flag_RTRT_vs_RTTR,n_svd_d,svd_d_
...
c$$$      %%%%%%%%%%%%%%%%
      ...
      if (flag_RTRT_vs_RTTR.eqv..false.) then
         call cl1_c16(n_svd_l*n_delta_x*n_delta_y,Z_M_svdd_)
         call innerproduct_q_k_svdd_1(flag_RTRT_vs_RTTR,n_svd_d,svd_d_
     $        ,n_svd_l,svd_l_,svd_U_d_,n_delta_x,delta_x_,n_delta_y
     $        ,delta_y_,Z_M_svdd_)
c$$$      %%%%%%%%%%%%%%%%
