function test_fft_sampling_7(k_r,n_polar_a,model_type);
%{

  model_type = 'helix'; n_polar_a = 32; for k_r = 4:4:48; test_fft_sampling_7(k_r,n_polar_a,model_type); end;
  model_type = 'lissajous'; n_polar_a = 32; for k_r = 4:4:48; test_fft_sampling_7(k_r,n_polar_a,model_type); end;
  %%%%%%%%;
  model_type = 'random'; n_polar_a = 32; for k_r = 4:4:48; test_fft_sampling_7(k_r,n_polar_a,model_type); end;
  model_type = 'lissajous'; n_polar_a = 32; for k_r = 4:4:48; test_fft_sampling_7(k_r,n_polar_a,model_type); end;
  model_type = 'helix'; n_polar_a = 32; for k_r = 4:4:48; test_fft_sampling_7(k_r,n_polar_a,model_type); end;
...
fname_tmp = sprintf('%s/test_fft_sampling_7_%s',pwd,model_type);
...
figbig;
fname_tmp = sprintf('%s/test_fft_sampling_7_%s_X_k%da%d',pwd,model_type,round(k_r),n_polar_a);
disp(sprintf(' %% writing %s.jpg',fname_tmp));
print('-djpeg',sprintf('%s.jpg',fname_tmp));
end;%if flag_plot;
...
figbig;
fname_tmp = sprintf('%s/test_fft_sampling_7_%s_mesh_k%da%d',pwd,model_type,round(k_r),n_polar_a);
disp(sprintf(' %% writing %s.jpg',fname_tmp));
print('-djpeg',sprintf('%s.jpg',fname_tmp));
end;%if flag_plot;
