function isosurface_ver7(n_,dirname,infix) ;
% for use with test_ver11.f, which has model_A,B,C, as well as Y_tru_ and Y_est_ ;
% to see model__A,model__B,model__C and blend, try: ;
%{
  isosurface_ver7([-1,-2,-3,0],'./dir_mda11','');
  %}
figure;
