      if (verbose.gt.0) then
         ...
         include 'test_innerproduct_5_excerpt_timing_display_0.f'
         ...
         timing_tot = timing_total_S_q
         gnump_tot = gnump_total_S_q
     ...
     $        (flag_RTRT_vs_RTTR.eqv..true.)) then
         ...
         timing_tot = timing_total_T_R_CTF_M_q
         gnump_tot = gnump_total_T_R_CTF_M_q
         write(timing_string,'(A)') 'T_R_CTF_M_q'
         include 'test_innerproduct_5_excerpt_timing_display_0.f'
