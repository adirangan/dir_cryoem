...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_fast_T_S_q_0]'
     ...
     $              ,n_A,fftw_in1_,fftw_out_,S_p_,S_q_)
               ...
               ld_X = n_r*n_delta_x*n_delta_y*n_S
     ...
     $                 ,Z_tmp)
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_fast_T_S_q_0]'
      end if !if (verbose.gt.0) then
      end
