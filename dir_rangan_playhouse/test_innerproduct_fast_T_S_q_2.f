      subroutine test_innerproduct_fast_T_S_q_2(verbose,n_delta_x
     $     ,delta_x_,n_delta_y,delta_y_,fftw_plan_frwd_,fftw_in1_
     $     ,fftw_out_ ,n_r,grid_p_,n_w_,n_A,S_p_,S_q_,n_S_sub
     $     ,I_S_sample_,IS_per,ld_S,S_p__ ,n_S_tot ,T_S_q__)
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
     ...
     $     ,n_S_tot,ld_S
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_fast_T_S_q_2]'
     ...
     $                 ,Z_tmp)
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_fast_T_S_q_2]'
      end if !if (verbose.gt.0) then
      end
