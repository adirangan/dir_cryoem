      subroutine test_alpha_update_5(
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
      ...
      include 'omp_lib.h'
c$$$  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
c$$$  Variables used for test_innerproduct_7. ;
c$$$  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
...
c$$$  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
      integer n_w_sum_(0:n_k_cur-1) ! cumulative sum of n_w_. also called icstart(nk). ;
      ...
      integer n_Y_lm_sum_(0:n_k_cur-1) ! cumulative sum of n_Y_lm_. also called isph_start(nk). ;
...
c$$$  svd_calculation_type == 2 --> account for displacements via brute-force. ;
         ...
         call print_sub_i4(n_k_cur,n_w_sum_,' n_w_sum_: ') ! cumulative sum of n_w_. also called icstart(nk). ;
     ...
     $        quadrature_type_azimu_b ! quadrature type in the azimuthal direction. sometimes named itypep. ;
         ...
         write(6,'(A,I0)') ' n_Y_lm_sum_max ' , n_Y_lm_sum_max ! total number of points used in spherical harmonic expansion (in k-space polar coordinates). sometimes called nsphstore. ;
         call print_sub_i4(n_k_cur,n_Y_lm_sum_,' n_Y_lm_sum_: ') ! cumulative sum of n_Y_lm_. also called isph_start(nk). ;
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
     ...
     $     ,ld_CTF,CTF_k_p__,alpha_est__ ,n_w_sum_ ,n_polar_a_
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
     ...
     $     ,n_k_cur,n_w_,ld_S,n_w_sum_, n_polar_a_
...
c$$$  calling checkset. ;
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
      include 'test_alpha_update_5_checkset.f'
