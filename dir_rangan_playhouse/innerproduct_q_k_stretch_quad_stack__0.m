...
%    M_q__(:,1+nM) contains the fourier-bessel coefficients for m-index nM. ;
...
%    Note that, for the output, we assume that interpretation of the nw requires only knowledge of n_w_max (which is independent of nr). ;
