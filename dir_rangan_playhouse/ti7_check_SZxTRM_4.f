      subroutine ti7_check_SZxTRM_4(verbose,svd_r_max,n_svd_r,svd_r_
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering ti7_check_SZxTRM_4]'
...
c$$$         Combine S_q and M_q into Z_svdr_
         call innerproduct_q_k_svdr_3(.true.,svd_r_max,n_svd_r,svd_r_
