...
% That is, Lx(1+k,j) = L_{k}(lx(j)), where L_{k}(x) is the orthonormal polynomial of degree k. ;
% The fourth output Lv is the array of polynomial coefficients. ;
% That is, Lv(1+k,:) are the polynomial coefficients for L_{k}(x) (in matlab order). ;
