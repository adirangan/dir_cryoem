function [c_] = colorpcube_8points_gamma(polar_a_,azimu_b_,gamma);
...
%p_c_(:,1+na,:) = repmat(colorpcube_8points(polar_a_k_cur,azimu_b_k_cur),4,1);
...
p_c_ = repmat(reshape(colorpcube_8points_gamma(polar_a_k_cur_,azimu_b_k_cur_,0.0),[1,n_A,3]),4,1,1);
