      subroutine test_innerproduct_fast_T_S_q_1(verbose,n_delta_x
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_fast_T_S_q_1]'
     ...
     $                 ,Z_tmp)
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_fast_T_S_q_1]'
      end if !if (verbose.gt.0) then
      end
