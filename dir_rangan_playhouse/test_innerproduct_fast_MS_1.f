      subroutine test_innerproduct_fast_MS_1(verbose,flag_RTRT_vs_RTTR
     $     ,n_delta_x,delta_x_,n_delta_y,delta_y_,n_gamma_z,gamma_z_,n_r
     $     ,grid_p_,n_w_,n_A,n_S,S_alpha_polar_a_,S_alpha_azimu_b_
     $     ,n_M_sub,polar_a_est_,azimu_b_est_,gamma_z_est_ ,delta_x_est_
     ...
     $     ,l2_norm_est_(0:n_M_sub-1)
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_fast_MS_1]'
...
c$$$            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_fast_MS_1]'
      end if !if (verbose.gt.0) then
