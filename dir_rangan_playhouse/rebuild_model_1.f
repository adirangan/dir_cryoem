C***********************************************************************
      subroutine rebuild_model_1(n_M,I_M_sample_,ld_M,M_k_p__,n_CTF
...
C***********************************************************************
      ...
      if (verbose.gt.0) then
         write(6,*) '[entering rebuild_model_1]'
      end if
...
c
     ...
     $        ,' .neq. n_A: ',n_A,' in rebuild_model_1'
      end if
c
      do nk = n_k_low-1,n_k_cur-1
         ...
         call get_lsqdata_1(n_M,I_M_sample_,ld_M,M_k_p__,n_CTF,ld_CTF
     $        ,CTF_k_p_,grid_k_p_(nk),n_w_sum_(nk),n_w_(nk)
     $        ,alpha2d__,M_k_c_,polar_a_,azimu_b_
