      subroutine test_innerproduct_5_SZxTRM_3(verbose,n_svd_r,svd_r_
     $     ,n_svd_l,svd_l_,svd_s_,svd_V_r_,Z_S_svdd_,n_delta_v ,delta_x_
     $     ,delta_y_,n_gamma_z,gamma_z_,delta_x_est_ ,delta_y_est_
     $     ,gamma_z_est_,ctf_ind_est_,fftw_plan_frwd_,fftw_plan_back_
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_5_SZxTRM_3]'
...
c$$$         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
         do ndv=0,n_delta_v-1
c$$$  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            call cp1_c16(n_w_max,C_q2_(0+n_w_max*ndv),Z_tmp_)
...
c$$$  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%               
      ...
      if (verbose.gt.0) then
         write(6,'(A)')
     $        '[finished test_innerproduct_5_SZxTRM_3]'
      end if !if (verbose.gt.0) then
      end
