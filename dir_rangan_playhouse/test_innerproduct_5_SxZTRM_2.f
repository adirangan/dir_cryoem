      subroutine test_innerproduct_5_SxZTRM_2(verbose,n_svd_d,svd_d_
     $     ,n_svd_r,svd_r_,n_svd_l,svd_l_,svd_U_d_,svd_s_,svd_V_r_
     $     ,Z_M_svdd_,n_delta_x,delta_x_ ,n_delta_y,delta_y_ ,n_gamma_z
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_5_SxZTRM_2]'
...
c$$$               %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%               
      ...
      if (verbose.gt.0) then
         write(6,'(A)')
     $        '[finished test_innerproduct_5_SxZTRM_2]'
      end if !if (verbose.gt.0) then
      end
