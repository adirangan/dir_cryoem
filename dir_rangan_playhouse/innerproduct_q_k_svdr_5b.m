function [C_q_,V_r__] = innerproduct_q_k_svdr_5b(flag_S_vs_M,svd_r_max,n_svd_r,svd_r_,n_svd_l,svd_l_,svd_s_,svd_V_r_,n_r,grid_p_,n_w_,n_A,T_q_,M_q_,C_q_);
;
...
if (verbose>0);
disp(sprintf(' %% [entering innerproduct_q_k_svdr_5b] n_r %d',n_r));
end;%if;
...
if (verbose>0);
disp(sprintf(' %% [finished innerproduct_q_k_svdr_5b]'));
end;%if;
