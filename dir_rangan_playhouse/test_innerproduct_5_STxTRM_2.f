      subroutine test_innerproduct_5_STxTRM_2(verbose,n_delta_x
     ...
     $     ,M_p__,CTF_p_ ,n_CTF ,ld_CTF ,CTF_p__,CTF_R_S_
     $     ,S_T_T_R_CTF_M_q__)
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_5_STxTRM_2]'
...
c$$$         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)')
     $        '[finished test_innerproduct_5_STxTRM_2]'
      end if !if (verbose.gt.0) then
      end
