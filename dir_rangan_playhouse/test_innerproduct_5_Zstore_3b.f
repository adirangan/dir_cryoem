      subroutine test_innerproduct_5_Zstore_3b(
     $     verbose
     $     ,rseed
     $     ,flag_RTRT_vs_RTTR
     $     ,n_delta_v
...
c$$$      MS storage
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_5_Zstore_3b]'
...
c$$$c$$$            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
c$$$            call test_innerproduct_5_ZZ_scan_4(flag_RTRT_vs_RTTR
...
c$$$            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_5_Zstore_3b]'
      end if !if (verbose.gt.0) then
