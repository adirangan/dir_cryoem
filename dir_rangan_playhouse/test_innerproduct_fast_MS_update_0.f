      subroutine test_innerproduct_fast_MS_update_0(verbose,n_S,n_M,C_M_
...
c$$$      parameters for timing
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_fast_MS_update_0]'
      end if
      if (verbose.gt.0) then
...
c$$$               %%%%%%%%%%%%%%%%
     ...
     $        ,ns_tmp,'; ns ',ns,'; finished'
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_fast_MS_update_0]'
      end if
      end
