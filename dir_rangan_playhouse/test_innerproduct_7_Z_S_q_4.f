      subroutine test_innerproduct_7_Z_S_q_4(verbose,svd_r_max,n_svd_r
...
c$$$      real *8, allocatable :: V_r_(:)
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_7_Z_S_q_4]'
...
c$$$      deallocate(V_r_);
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_7_Z_S_q_4]'
      end if !if (verbose.gt.0) then
      end
