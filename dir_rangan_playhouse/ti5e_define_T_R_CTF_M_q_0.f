      ...
      call cl1_c16(n_r*nM_0_per*n_w_max,T_R_CTF_M_q__)
     ...
     $        ' Calculate bessel coefficients of T(R(CTF.*M)).'
         ...
         write(6,'(A)') ' '
         write(6,'(A,A)') ' T_R_CTF_M_q__(nr + n_r*(nm + nM_0_per*nw)) '
...
c$OMP DO 
      do nM_9_sub=0,n_M_9_sub_use-1
         ...
         call test_innerproduct_5_T_R_CTF_M_q_3(verbose-1
...
c$OMP END PARALLEL
     ...
     $        ,T_R_CTF_M_q__(n_r*nM_9_sum))
      ...
      timing_total_T_R_CTF_M_q = timing_total_T_R_CTF_M_q + timing_tot
      gnump_total_T_R_CTF_M_q = gnump_total_T_R_CTF_M_q + gnump_tot
     ...
     $        timing_tmp
         ...
         if (flag_MDA.eqv..true.) then
            ...
            MDA_d_(1) = nM_0_per
            MDA_d_(2) = n_w_max
            write(MDA_string,'(A,2(A,I0),A)') './dir_mda/T_R_CTF_M_q__'
     $           , 'nS0_' , nS_0_sub , '_nM0_' , nM_0_sub ,'.mda'
            call MDA_write_c16(MDA_n_d,MDA_d_,T_R_CTF_M_q__,MDA_string)
