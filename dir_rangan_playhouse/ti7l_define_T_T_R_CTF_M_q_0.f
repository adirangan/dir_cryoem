     ...
     $           ,p_T_T_R_CTF_M_q_local
         ...
         call ti7_build_T_T_R_CTF_M_q_2(verbose-1 ,n_delta_v
     ...
     $        ,1 ,T_T_R_CTF_M_q_local_omp__(p_T_T_R_CTF_M_q_local))
         ...
         call print_sub_c16(n_A,Z_p_omp__(n_A_tmp),' Z_p_omp__:')
         call print_sub_c16(n_A,M_p_omp__(n_A_tmp),' M_p_omp__:')
         call print_sub_c16(n_r*n_transf*n_w_max
     $        ,T_T_R_CTF_M_q_local_omp__(p_T_T_R_CTF_M_q_local)
