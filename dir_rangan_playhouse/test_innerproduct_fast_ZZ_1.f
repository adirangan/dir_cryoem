      subroutine test_innerproduct_fast_ZZ_1(verbose,n_delta_x,delta_x_
     ...
     $     ,l2_norm_upd_(0:n_M_sub-1)
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_fast_ZZ_1]'
...
c$$$            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_fast_ZZ_1]'
      end if !if (verbose.gt.0) then
