      subroutine test_innerproduct_fast_SZxTRM_1(verbose,n_svd_r,svd_r_
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_fast_SZxTRM_1]'
...
c$$$              nC1 = nw + ndx*n_w_max + ndy*n_w_max*n_delta_x
                  ...
                  nC3 = nw*n_svd_l
                  do nsvd_l=0,n_svd_l-1
                     C_q_(nC1) = C_q_(nC1) + Z_S_svdd_(nC2)
     $                    *Z_svdr_(nC3)
                     nC2 = nC2 + 1
                     nC3 = nC3 + 1
                  enddo !do nsvd_l=0,n_svd_l-1
...
c$$$               %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%               
      ...
      if (verbose.gt.0) then
         write(6,'(A)')
     $        '[finished test_innerproduct_fast_SZxTRM_1]'
      end if !if (verbose.gt.0) then
      end
