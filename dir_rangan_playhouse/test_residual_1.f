C***********************************************************************
      subroutine test_residual_1(n_M,ld_M,M_k_p__,n_CTF,ld_CTF ,CTF_k_p_
     $     ,n_alpha,alpha2d__,n_w_sum_,n_polar_a_
...
c$$$      complex *16, allocatable :: H_(:) !temporary: stores single Et*R (in terms of spherical harmonic coefficients). ;
      ...
      if (verbose.gt.0) then
         write(6,*) '[entering test_residual_1]'
      end if
