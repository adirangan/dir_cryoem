      subroutine test_alpha_update_SM_0(verbose,n_M_sub
     $     ,half_diameter_x_c_tmp,n_k_p_max,n_M_sample,ld_M,M_sample_
     $     ,n_w_sum_,n_polar_a_,quadrature_type_azimu_b,grid_k_p_,n_w_
     $     ,n_k_low,n_k_cur,n_Y_lm_sum_max,n_Y_lm_sum_,n_Y_l_
     $     ,lsq_oversample,lsq_interpolation_order,eps_default,n_ctf
     $     ,ld_CTF ,CTF_k_p_,n_alpha,alpha1d_est_,alpha_update_f,Y_est_
...
c$$$  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
      ...
      real *8 tesselation_distance_req_use !temporary: actual value of tesselation_distance_req passed to test_innerproduct_batch_SM_wrapper_0a. ;
     ...
     $     '[entering test_alpha_update_SM_0]'
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
     ...
     $     -1) + n_w_(n_k_cur-1)
      ...
      call test_innerproduct_batch_SM_wrapper_0a(0,n_M_sub,n_k_cur
     ...
     $     ,n_SM_use)
      ...
      if (verbose.gt.0) then
         write(6,'(A,A,A,F8.4)') 'test_alpha_update_SM_0: ',
     $        'test_innerproduct_batch_SM_wrapper_0a:',
     $        ' tesselation_distance_req_use ' ,
     $        tesselation_distance_req_use
         write(6,'(A,A,A,I0,A,I0,A,I0,A)') 'test_alpha_update_SM_0: ',
     $        'test_innerproduct_batch_SM_wrapper_0a:',
     $        ' calculated '
     $        , n_SM_use , ' / ' , n_M_sample *n_S_sample , ' = ' ,
     $        floor((n_SM_use*100.0d0) /(1.0d0*n_M_sample
     $        *n_S_sample)) , '% '
         write(6,'(A,A,A,F16.9)') 'test_alpha_update_SM_0: ',
     $        'test_innerproduct_batch_SM_wrapper_0a:',
     $        ' total_time                    ' ,timing_toc-timing_tic  
         write(6,'(A,A,A,F16.9)') 'test_alpha_update_SM_0: ',
     $        'test_innerproduct_batch_SM_wrapper_0a:',
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
     ...
     $        ,tmp_fname)
      ...
      if (verbose.gt.0) write(6,'(A)')
     $     '[finished test_alpha_update_SM_0]'
