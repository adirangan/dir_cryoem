function M_q_ = transf_qcrop_svd_q_to_q_0(svd_r_max,n_svd_r,svd_r_,svd_d_max,n_svd_d,svd_d_,n_svd_l,svd_l_,svd_U_d_,svd_s_,svd_V_r_,n_r,grid_p_,n_w_,n_A,S_q_,delta_x,delta_y);
