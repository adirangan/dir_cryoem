...
c$$$      include './dir_gen_Jsvd_1/Jsvd_var_allocation__on_0.f'
      include './dir_gen_Jsvd_1/Jsvd_var_allocation_off_0.f'
      integer *4 n_svd_max
...
c$$$      indices
      ...
      integer *4 n_w_sum_(0:0) !array (length at least n_k_cur) to store cumulative sum of n_w_. ;
