...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
tic;
n_x = 128; max_x_c = 1; max_k_c = n_x/max_x_c; max_k_p = max_k_c/2;
...
tmp_gamma = -1*pi/12; G_x_c_ = rotate_c_to_c(n_x,max_x_c,n_x,max_x_c,G_x_c_,tmp_gamma);
...
if flag_disp;
figure(n_figure); clf; n_figure = n_figure + 1;
colormap(colormap_beach());exp(-tmp_R_x_c_.^2/2/tmp_s.^2);
...
fname_fig = sprintf('%s/blob_FIGC_1',dir_fig);
if flag_plot; print('-djpeg',sprintf('%s.jpg',fname_fig)); end;
if flag_plot; print('-depsc',sprintf('%s.eps',fname_fig)); end;
%disp('return');return;
end;%if flag_disp;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
tic;
N_pixels = 16.0; N_pixels_in = N_pixels; K_max = max_k_p; eps_target = 0.01; l_max = 18;
