     ...
     $              ,Z_S_q_local_omp__(nx2 + p_Z_S_q_local))
         ...
         if ((nS_1_sum.eq.nS_1_per_max) .or. (nLT.eq.n_LT-1)) then
            ...
            include 'ti7l_STxTRM_0.f'
            include 'ti7l_SxTTRM_0.f'
            include 'ti7l_SZxTRM_0.f'
            include 'ti7l_SxZTRM_0.f'
            include 'ti7l_Zstore_1.f'
     ...
     $        ' not implemented in test_innerproduct_7_local_0.f'
