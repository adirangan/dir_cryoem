...
%%%%%%%%;
[tmp_Z_S_svdr_0b_,V_r__] = innerproduct_q_k_svdr_5b(1,svd_r_max,n_svd_r,svd_r_,n_svd_l,svd_l_,svd_s_,svd_V_r_,n_r,grid_p_,n_w_,n_A,S_q_,M_q_);
disp(sprintf(' %% Z_S_svdr_0b_ error: %0.16f/%0.16f = %0.16f',norm(tmp_Z_S_svdr_0b_-Z_S_svdr_0_),norm(Z_S_svdr_0_),norm(tmp_Z_S_svdr_0b_-Z_S_svdr_0_)/norm(Z_S_svdr_0_)));
tmp_Z_S_svdr_b_ = zeros(size(tmp_Z_S_svdr_0b_));
for nsvd_l=0:n_svd_l-1;
tmp_ij_ = nsvd_l + [0:n_w_max-1]*n_svd_l;
tmp_Z_S_svdr_b_(1+tmp_ij_) = ifft(tmp_Z_S_svdr_0b_(1+tmp_ij_))*n_w_max;
end;%for nsvd_l=0:n_svd_l-1;
disp(sprintf(' %% Z_S_svdr_b_ error: %0.16f/%0.16f = %0.16f',norm(tmp_Z_S_svdr_b_-Z_S_svdr_),norm(Z_S_svdr_),norm(tmp_Z_S_svdr_b_-Z_S_svdr_)/norm(Z_S_svdr_)));
%%%%%%%%;
[tmp_Z_M_svdr_0b_,V_r__] = innerproduct_q_k_svdr_5b(0,svd_r_max,n_svd_r,svd_r_,n_svd_l,svd_l_,svd_s_,svd_V_r_,n_r,grid_p_,n_w_,n_A,S_q_,M_q_);
disp(sprintf(' %% Z_M_svdr_0b_ error: %0.16f/%0.16f = %0.16f',norm(tmp_Z_M_svdr_0b_-Z_M_svdr_0_),norm(Z_M_svdr_0_),norm(tmp_Z_M_svdr_0b_-Z_M_svdr_0_)/norm(Z_M_svdr_0_)));
tmp_Z_M_svdr_b_ = zeros(size(tmp_Z_M_svdr_0b_));
for nsvd_l=0:n_svd_l-1;
tmp_ij_ = nsvd_l + [0:n_w_max-1]*n_svd_l;
tmp_Z_M_svdr_b_(1+tmp_ij_) = ifft(tmp_Z_M_svdr_0b_(1+tmp_ij_))*n_w_max;
end;%for nsvd_l=0:n_svd_l-1;
disp(sprintf(' %% Z_M_svdr_b_ error: %0.16f/%0.16f = %0.16f',norm(tmp_Z_M_svdr_b_-Z_M_svdr_),norm(Z_M_svdr_),norm(tmp_Z_M_svdr_b_-Z_M_svdr_)/norm(Z_M_svdr_)));
...
tmp_C_S_q_b_ = zeros(n_w_max*n_delta_v,1);
tmp_C_M_q_b_ = zeros(n_w_max*n_delta_v,1);
nC1 = 0 ;
for ndv=0:n_delta_v-1;
for nw=0:n_w_max-1;
%  nC1 = nw + ndv*n_w_max ;
tmp_C_S_q_(1+nC1) = 0;
tmp_C_M_q_(1+nC1) = 0;
tmp_C_S_q_b_(1+nC1) = 0;
tmp_C_M_q_b_(1+nC1) = 0;
nC2 = ndv*n_svd_l;
nC3 = nw*n_svd_l;
for nsvd_l=0:n_svd_l-1;
...
tmp_C_S_q_b_(1+nC1) = tmp_C_S_q_b_(1+nC1) + Z_S_svdd_(1+nC2)*tmp_Z_S_svdr_b_(1+nC3);
tmp_C_M_q_b_(1+nC1) = tmp_C_M_q_b_(1+nC1) + Z_M_svdd_(1+nC2)*tmp_Z_M_svdr_b_(1+nC3);
nC2 = nC2 + 1;
nC3 = nC3 + 1;
end;%for nsvd_l=0:n_svd_l-1;
nC1 = nC1 + 1;
...
disp(sprintf(' %% C_S_q_ error: %0.16f/%0.16f = %0.16f',norm(tmp_C_S_q_-C_S_q_),norm(C_S_q_),norm(tmp_C_S_q_-C_S_q_)/norm(C_S_q_)));
disp(sprintf(' %% C_M_q_ error: %0.16f/%0.16f = %0.16f',norm(tmp_C_M_q_-C_M_q_),norm(C_M_q_),norm(tmp_C_M_q_-C_M_q_)/norm(C_M_q_)));
disp(sprintf(' %% C_S_q_b_ error: %0.16f/%0.16f = %0.16f',norm(tmp_C_S_q_b_-C_S_q_),norm(C_S_q_),norm(tmp_C_S_q_b_-C_S_q_)/norm(C_S_q_)));
disp(sprintf(' %% C_M_q_b_ error: %0.16f/%0.16f = %0.16f',norm(tmp_C_M_q_b_-C_M_q_),norm(C_M_q_),norm(tmp_C_M_q_b_-C_M_q_)/norm(C_M_q_)));
Z_X_tmp = 0;
for ndv=0:n_delta_v-1;
delta_x = delta_x_(1+ndv);
delta_y = delta_y_(1+ndv);
...
tmp_S_R_T_x_T_R_CTF_M_q_0__ = zeros(n_w_max,1); tmp_S_T_R_x_T_R_CTF_M_q_0__ = zeros(n_w_max,1);
tmp_S_R_T_x_T_R_CTF_M_q_1__ = zeros(n_w_max,1); tmp_S_T_R_x_T_R_CTF_M_q_1__ = zeros(n_w_max,1);
%%%%%%%%;
...
%%%%%%%%;
T_q_ = S_q_;
T_q_ = transf_besselj_q_to_q_0(2*l_max,n_r,grid_p_,n_w_,n_A,T_q_,delta_x,delta_y);
T_q_ = rotate_q_to_q_0(n_r,n_w_,n_A,T_q_,gamma_z);
tmp_S_T_R_x_T_R_CTF_M_q_0__(1+nw) = innerproduct_p(n_r,grid_p_,n_w_,n_A,T_q_,M_q_);
%%%%%%%%;
T_q_ = S_q_;
T_q_ = rotate_q_to_q_0(n_r,n_w_,n_A,T_q_,gamma_z);
T_q_ = transf_besselj_q_to_q_0(2*l_max,n_r,grid_p_,n_w_,n_A,T_q_,delta_x,delta_y);
tmp_S_R_T_x_T_R_CTF_M_q_0__(1+nw) = innerproduct_p(n_r,grid_p_,n_w_,n_A,T_q_,M_q_);
%%%%%%%%;
%%;
%%%%%%%%;
T_p_ = S_p_;
T_p_ = transf_p_to_p(n_r,grid_p_,n_w_,n_A,T_p_,delta_x,delta_y);
T_p_ = rotate_p2p_fx(n_r,n_w_,n_A,T_p_,gamma_z);
T_q_ = interp_p_to_q(n_r,n_w_,n_A,T_p_);
tmp_S_T_R_x_T_R_CTF_M_q_1__(1+nw) = innerproduct_p(n_r,grid_p_,n_w_,n_A,T_q_,M_q_);
%%%%%%%%;
T_p_ = S_p_;
T_p_ = rotate_p2p_fx(n_r,n_w_,n_A,T_p_,gamma_z);
T_p_ = transf_p_to_p(n_r,grid_p_,n_w_,n_A,T_p_,delta_x,delta_y);
T_q_ = interp_p_to_q(n_r,n_w_,n_A,T_p_);
tmp_S_R_T_x_T_R_CTF_M_q_1__(1+nw) = innerproduct_p(n_r,grid_p_,n_w_,n_A,T_q_,M_q_);
%%%%%%%%;
%%;
...
disp(sprintf(' %% tmp_C_S_q_b_(1+ndv*n_w_max + nw)  = %0.16f + i*%0.16f',real(tmp_C_S_q_b_(1+ndv*n_w_max + nw)),imag(tmp_C_S_q_b_(1+ndv*n_w_max + nw))));
...
disp(sprintf(' %% tmp_S_T_R_x_T_R_CTF_M_q_0__(1+nw) = %0.16f + i*%0.16f',real(tmp_S_T_R_x_T_R_CTF_M_q_0__(1+nw)),imag(tmp_S_T_R_x_T_R_CTF_M_q_0__(1+nw))));
disp(sprintf(' %% tmp_S_T_R_x_T_R_CTF_M_q_1__(1+nw) = %0.16f + i*%0.16f',real(tmp_S_T_R_x_T_R_CTF_M_q_1__(1+nw)),imag(tmp_S_T_R_x_T_R_CTF_M_q_1__(1+nw))));
disp(sprintf(' %% C_M_q_(1+ndv*n_w_max + nw)        = %0.16f + i*%0.16f',real(C_M_q_(1+ndv*n_w_max + nw)),imag(C_M_q_(1+ndv*n_w_max + nw))));
disp(sprintf(' %% tmp_C_M_q_b_(1+ndv*n_w_max + nw)  = %0.16f + i*%0.16f',real(tmp_C_M_q_b_(1+ndv*n_w_max + nw)),imag(tmp_C_M_q_b_(1+ndv*n_w_max + nw))));
...
disp(sprintf(' %% tmp_S_R_T_x_T_R_CTF_M_q_0__(1+nw) = %0.16f + i*%0.16f',real(tmp_S_R_T_x_T_R_CTF_M_q_0__(1+nw)),imag(tmp_S_R_T_x_T_R_CTF_M_q_0__(1+nw))));
disp(sprintf(' %% tmp_S_R_T_x_T_R_CTF_M_q_1__(1+nw) = %0.16f + i*%0.16f',real(tmp_S_R_T_x_T_R_CTF_M_q_1__(1+nw)),imag(tmp_S_R_T_x_T_R_CTF_M_q_1__(1+nw))));
end;%for nw=0:n_w_max-1;
%%%%%%%%;
...
tm2_C_S_q_b_ = tmp_C_S_q_b_(1+ndv*n_w_max + (0:n_w_max-1));
disp(sprintf(' %% C_S_q_b_ vs S_T_R_x_T_R_CTF_M_q__ %0.16f/%0.16f = %0.16f',norm(tm2_C_S_q_b_ - S_T_R_x_T_R_CTF_M_q__),norm(tm2_C_S_q_b_),norm(tm2_C_S_q_b_ - S_T_R_x_T_R_CTF_M_q__)/norm(tm2_C_S_q_b_)));
tm2_C_M_q_b_ = tmp_C_M_q_b_(1+ndv*n_w_max + (0:n_w_max-1));
disp(sprintf(' %% C_M_q_b_ vs S_R_T_x_T_R_CTF_M_q__ %0.16f/%0.16f = %0.16f',norm(tm2_C_M_q_b_ - S_R_T_x_T_R_CTF_M_q__),norm(tm2_C_M_q_b_),norm(tm2_C_M_q_b_ - S_R_T_x_T_R_CTF_M_q__)/norm(tm2_C_M_q_b_)));

tm2_C_S_q_b_ = tmp_C_S_q_b_(1+ndv*n_w_max + (0:n_w_max-1));
disp(sprintf(' %% C_S_q_b_ vs tmp_S_T_R_x_T_R_CTF_M_q_0__ %0.16f/%0.16f = %0.16f',norm(tm2_C_S_q_b_ - tmp_S_T_R_x_T_R_CTF_M_q_0__),norm(tm2_C_S_q_b_),norm(tm2_C_S_q_b_ - tmp_S_T_R_x_T_R_CTF_M_q_0__)/norm(tm2_C_S_q_b_)));
tm2_C_M_q_b_ = tmp_C_M_q_b_(1+ndv*n_w_max + (0:n_w_max-1));
disp(sprintf(' %% C_M_q_b_ vs tmp_S_R_T_x_T_R_CTF_M_q_0__ %0.16f/%0.16f = %0.16f',norm(tm2_C_M_q_b_ - tmp_S_R_T_x_T_R_CTF_M_q_0__),norm(tm2_C_M_q_b_),norm(tm2_C_M_q_b_ - tmp_S_R_T_x_T_R_CTF_M_q_0__)/norm(tm2_C_M_q_b_)));

disp(sprintf(' %% tmp_S_T_R_x_T_R_CTF_M_q__ vs tmp_S_T_R_x_T_R_CTF_M_q_0__ %0.16f/%0.16f = %0.16f',norm(tmp_S_T_R_x_T_R_CTF_M_q__ - tmp_S_T_R_x_T_R_CTF_M_q_0__),norm(tmp_S_T_R_x_T_R_CTF_M_q__),norm(tmp_S_T_R_x_T_R_CTF_M_q__ - tmp_S_T_R_x_T_R_CTF_M_q_0__)/norm(tmp_S_T_R_x_T_R_CTF_M_q__)));
disp(sprintf(' %% tmp_S_R_T_x_T_R_CTF_M_q__ vs tmp_S_R_T_x_T_R_CTF_M_q_0__ %0.16f/%0.16f = %0.16f',norm(tmp_S_R_T_x_T_R_CTF_M_q__ - tmp_S_R_T_x_T_R_CTF_M_q_0__),norm(tmp_S_R_T_x_T_R_CTF_M_q__),norm(tmp_S_R_T_x_T_R_CTF_M_q__ - tmp_S_R_T_x_T_R_CTF_M_q_0__)/norm(tmp_S_R_T_x_T_R_CTF_M_q__)));

tm2_C_S_q_b_ = tmp_C_S_q_b_(1+ndv*n_w_max + (0:n_w_max-1));
disp(sprintf(' %% C_S_q_b_ vs tmp_S_T_R_x_T_R_CTF_M_q_1__ %0.16f/%0.16f = %0.16f',norm(tm2_C_S_q_b_ - tmp_S_T_R_x_T_R_CTF_M_q_1__),norm(tm2_C_S_q_b_),norm(tm2_C_S_q_b_ - tmp_S_T_R_x_T_R_CTF_M_q_1__)/norm(tm2_C_S_q_b_)));
tm2_C_M_q_b_ = tmp_C_M_q_b_(1+ndv*n_w_max + (0:n_w_max-1));
disp(sprintf(' %% C_M_q_b_ vs tmp_S_R_T_x_T_R_CTF_M_q_1__ %0.16f/%0.16f = %0.16f',norm(tm2_C_M_q_b_ - tmp_S_R_T_x_T_R_CTF_M_q_1__),norm(tm2_C_M_q_b_),norm(tm2_C_M_q_b_ - tmp_S_R_T_x_T_R_CTF_M_q_1__)/norm(tm2_C_M_q_b_)));
