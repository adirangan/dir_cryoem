      subroutine ti7_build_O_T_R_CTF_M_q_3(verbose
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
     ...
     $     ,n_M_tot,ld_M,n_CTF,ld_CTF
      ...
      if (verbose.gt.0) then
         write(6,'(A)')
     $        '[entering ti7_build_O_T_R_CTF_M_q_3]'
      ...
      if (verbose.gt.1) then
         ...
         call write_sub_c16(n_A,M_p__(I_M_sample_(0)*ld_M),8
     $        ,' M_p__(0): ')
         call write_sub_c16(n_A,M_p__(I_M_sample_(n_M_sub-1)*ld_M),8
     $        ,' M_p__(end): ')
     ...
     $           ,Z_tmp)
      ...
      if (verbose.gt.0) then
         write(6,'(A)')
     $        '[finished ti7_build_O_T_R_CTF_M_q_3]'
      end if !if (verbose.gt.0) then
      end
