...
c$$$      command line input variables
      ...
      r_heterogeneity_A = cmd_A
      r_heterogeneity_B = cmd_B
      r_heterogeneity_C = cmd_C
      r_heterogeneity_D = cmd_D
      snr = cmd_snr
      rseed = cmd_rseed
...
c$$$  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
         ...
         call test_alpha_update_3(verbose,rseed,n_omp_sub
