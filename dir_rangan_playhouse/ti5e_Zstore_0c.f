      if (verbose.gt.1) then
         write(6,'(A)')
     $        ' calling test_innerproduct_5_Zstore_1c. '
         write(6,'(A)') ' '
...
c$OMP DO
      do nM_9_sub=0,n_M_9_sub_use-1
         ...
         n_A_tmp = nM_9_sub*n_delta_x*n_delta_y*n_gamma_z
         nm0 = nM_9_sum
         nm1 = nM_1_sum + nm0
         nm2 = nM_0_sum + nm1
         nm3 = n_alpha*n_SM_max*nm2
         nm4 = n_delta_x*n_delta_y*nS_1_per*nm0
         ns0 = 0
         ns1 = nS_1_sum + ns0
         ns2 = nS_0_sum + ns1
         ns3 = n_alpha*n_MS_max*ns2
         ns4 = n_gamma_z*n_CTF*ns1
         call test_innerproduct_5_Zstore_1c(
     $        verbose-1
     $        ,rseed
     $        ,flag_RTRT_vs_RTTR
     $        ,n_delta_x
