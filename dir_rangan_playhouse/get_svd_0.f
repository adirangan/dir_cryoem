      subroutine get_svd_0(eps_target,n_svd_r_out,n_svd_d_out
     $     ,n_svd_l_out,svd_r_out_,svd_d_out_,svd_l_out_,svd_U_d_out_
     $     ,svd_s_out_,svd_V_r_out_,svd_unitnumber_out,svd_fname_out
     $     ,grid_p_,n_r,n_delta_x,delta_x_
     $     ,n_delta_y,delta_y_ ,flag_warning,R_max ,K_max,delta_max
     $     ,n_pixels)
      implicit none
      integer verbose
      data verbose / 1 /
