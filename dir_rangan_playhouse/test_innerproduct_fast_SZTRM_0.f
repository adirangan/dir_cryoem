      subroutine test_innerproduct_fast_SZTRM_0(verbose,n_svd_r,svd_r_
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_fast_SZTRM_0]'
...
c$$$               %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%               
      ...
      if (verbose.gt.0) then
         write(6,'(A)')
     $        '[finished test_innerproduct_fast_SZTRM_0]'
      end if !if (verbose.gt.0) then
      end
