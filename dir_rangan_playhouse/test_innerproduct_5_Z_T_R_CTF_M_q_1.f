     ...
     $     ,fftw_plan_back_ ,fftw_in1_,fftw_out_,n_r,grid_p_,n_w_,n_A
     $     ,M_p_ ,M_q_,n_M_sub ,I_M_sample_,ld_M ,M_p__,CTF_p_ ,n_CTF
     $     ,ld_CTF,CTF_p__ ,C_M_ ,n_M_tot,Z_T_R_CTF_M_q__)
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
