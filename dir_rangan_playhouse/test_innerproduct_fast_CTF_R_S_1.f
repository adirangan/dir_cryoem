      subroutine test_innerproduct_fast_CTF_R_S_1(verbose,n_gamma_z
...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
     ...
     $     ,ld_CTF
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_fast_CTF_R_S_1]'
     ...
     $              *n_gamma_z*n_S),6,'CTF_R_S_: ')
      ...
      deallocate(Z_tmp_)
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_fast_CTF_R_S_1]'
      end if !if (verbose.gt.0) then
      end
