...
if n_c<0;
gamma1_ = linspace(0,2,1+16);
gamma2_ = linspace(0,2,1+16);
n_c = 64;
p_ = 0:n_c-1;
x_ = [0+p_;1+p_;1+p_;0+p_;0+p_];
y_ = repmat([0;0;1;1;0],[1,n_c]);
for ng1=0:16; for ng2=0:16;
gamma1 = gamma1_(1+ng1);
gamma2 = gamma2_(1+ng2);
subplot(17,17,1+ng1+ng2*17);
c_ = reshape(colormap_80s(n_c,gamma1,gamma2),[1,n_c,3]);
p_ = patch(x_,y_,c_); set(p_,'EdgeColor','none');
title(sprintf('%0.2f %0.2f',gamma1,gamma2));
axisnotick;
end;end;%for ng1=0:16; for ng2=0:16;
