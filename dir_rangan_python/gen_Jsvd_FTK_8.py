...
def gen_Jsvd_FTK_8(
    ...
    FTK['n_svd_r'] = r8_a_jt_.numel(); FTK['r8_svd_r_'] = r8_a_jt_;
    ...
    FTK['n_svd_d'] = r8_b_jt_.numel(); FTK['r8_svd_d_'] = r8_b_jt_;
    ...
    for nl in range(FTK['n_svd_l']):
        ...
        for nd_degree in range(FTK['n_d_degree']):
            ...
            tmp_index_ = torch.arange(int(np.minimum(FTK['n_d_degree'],tmp_r8_j_chebcoef_.numel()))).to(dtype=torch.int32);
        ...
        for nr_degree in range(FTK['n_r_degree']):
            ...
            tmp_index_ = torch.arange(int(np.minimum(FTK['n_r_degree'],tmp_r8_j_chebcoef_.numel()))).to(dtype=torch.int32);
            tmp_r8_p_j_chebcoef_[tmp_index_] = tmp_r8_p_j_chebcoef_.ravel()[tmp_index_] + tmp_r8_j_chebcoef_.ravel()[tmp_index_];
