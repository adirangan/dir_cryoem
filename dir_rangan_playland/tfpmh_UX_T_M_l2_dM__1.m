function UX_T_M_l2_dM__ = tfpmh_UX_T_M_l2_dM__1(FTK,n_w_,n_M,pm_n_UX_rank,svd_V_UX_M_lwnM____);
...
UX_T_M_k_q_dwnM____ = reshape(pagemtimes(FTK.svd_U_d_expiw_s__,svd_V_UX_M_lwnM____),[FTK.n_delta_v,n_w_max,pm_n_UX_rank,n_M]);
