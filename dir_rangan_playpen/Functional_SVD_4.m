function Functional_SVD_4(K_max,N_pixel,eps_target,l_max,k_polycoef_,d_polycoef_);
% Tests functional SVD. ;
% This time the test involves the non-separable bessel function. ;
% We go out to N_pixel. ;

% K_max = 128; N_pixel = 3.0; eps_target = 0.1; l_max = 16; n_r_degree = 18; n_d_degree = 19; k_polycoef_ = [1,1]; d_polycoef_ = [1,1]; %default ;
ni=1;
...
if (nargin<ni); k_polycoef_ = [1 1]; end; ni = ni+1; % polynomial weight for k. ;
if (nargin<ni); d_polycoef_ = [1 1]; ni = ni+1; % polynomial weight for d. ;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
% sample each bessel-function independently on a quadrature grid. ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
% sample each bessel-function independently on uniform grid. ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ;
