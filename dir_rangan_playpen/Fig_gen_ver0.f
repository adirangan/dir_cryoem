...
c$$$      printing templates and images
     ...
     $        ,y_side)
         write(fig_title,'(A,I2,A)') 'R(M_k_p(',nm,'))'
         text_length = 12
         color_index = 0
         font_type = 0
         font_size = 72
     ...
     $        ,M_k_p_(nm*ld_M),F_min,F_max,x_offset,y_offset,x_side
     $        ,y_side)
         write(fig_title,'(A,I2,A)') 'I(M_k_p(',nm,'))'
         text_length = 12
         color_index = 0
         font_type = 0
         font_size = 72
...
c$$$cd /data/rangan/dir_cryoem/dir_rangan_playpen/      
c$$$scp -p get_template_size.f stdlim_c16.f pearson_c16.f cp1_c16.f cps_c16.f af1_c16.f afs_c16.f linspace.f periodize_r8.f periodize_i.f hsv2rgb.f colorscale.f Fig_header.f Fig_text.f recenter_c16.f Fig_c16_carte.f Fig_c16_cart2.f Fig_c16_polar.f Fig_c16_bessl.f Fig_c16_bess2.f ../dir_greengard_work/
