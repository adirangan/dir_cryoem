c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
     ...
     $     ,n_M,ld_M,M_p_,delta_x_est_,delta_y_est_,gamma_z_est_
...
c$$$      parameters for timing
     ...
     $        ,' too small in test_innerproduct_svdread_batch'
      ...
      if (svd_calculation_type.lt.0) then
         if (.false.) then
      ...
      else if (svd_calculation_type.ge.0) then
         svd_calculation_type = max(0,min(2,svd_calculation_type))
         if (verbose.gt.0) then
