function [max_k_c,max_k_p,grid_x_c_,d_x_c,X_x_c_,Y_x_c_,R_x_c_,W_x_c_,grid_k_c_,d_k_c,X_k_c_,Y_k_c_,R_k_c_,W_k_c_,grid_x_r_,grid_x_w_,R_x_p_,W_x_p_,grid_k_r_,d_k_r,grid_k_w_,d_k_w,R_k_p_,W_k_p_,X_k_p_,Y_k_p_] = test_F_grid_1(n_point,max_x_c);
...
grid_x_r_ = linspace(0,max_x_c/2,n_point+1); grid_x_r_ = grid_x_r_(1:end-1); grid_x_w_ = linspace(0,2*pi,round(2*pi*n_point)+1); grid_x_w_ = grid_x_w_(1:end-1); 
...
grid_k_w_ = linspace(0,2*pi,round(2*pi*n_point)+1); grid_k_w_ = grid_k_w_(1:end-1); d_k_w = mean(diff(grid_k_w_));
