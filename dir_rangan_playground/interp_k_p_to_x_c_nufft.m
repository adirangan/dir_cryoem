function S_x_c_ = interp_k_p_to_x_c_nufft(n_x1,diameter_x1_c,n_x2,diameter_x2_c,n_r,grid_k_p_,n_w_,S_k_p_);
verbose=0;
...
S_x_c_ = nufft2d1(n_w_sum,k1_,k2_,S_k_p_,+1,1e-12,n_x1,n_x2)/sqrt(n_x1*n_x2);
