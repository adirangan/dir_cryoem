...
c     $OMP DO 
     ...
     $              ,svd_polyval_V_r_,delta_x_est_(nM_9_sum)
     ...
     $              ,ctf_ind_est_(nM_9_sum) ,fftw_plan_frwd__(n_r_tmp)
     $              ,fftw_plan_back__(n_r_tmp) ,fftw_0in__(n_A_tmp)
     $              ,fftw_out__(n_A_tmp) ,n_r ,grid_k_p_,weight_k_p_r_
     $              ,n_w_,n_A ,M_p_omp__(n_A_tmp) ,M_q_omp__(n_A_tmp)
     $              ,nM_9_per,I_M_sample_(nM_0_sum +nM_9_sum),ld_M
     $              ,M_k_p__,CTF_p_omp__(n_A_tmp) ,n_CTF ,ld_CTF
     $              ,CTF_k_p__,C_M_(nM_0_sum + nM_9_sum) ,nM_0_per
     $              ,Z_T_R_CTF_M_q__(n_r*n_transf*nM_9_sum))
