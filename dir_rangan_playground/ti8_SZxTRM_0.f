...
c$OMP DO 
     ...
     $        ,n_svd_l ,1.0d0*dcmplx(1.0d0,0.0d0),Z_S_svdd_,n_svd_l
...
c$$$      %%%%%%%%%%%%%%%%
     ...
     $        ,fftw_0in_ ,fftw_out_ ,fftw_plan_back_last ,fftw_0in_last_
     $        ,fftw_out_last_ ,n_r ,grid_k_p_,weight_k_p_r_,n_w_,n_A
