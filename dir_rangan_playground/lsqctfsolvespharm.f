...
c$$$%%%%%%%%
      subroutine lsqctfsolve_marina(phiout,thetas,phis,nout,localp
     $     ,nterms,nquad,nquadm,k,xnodes,wts,ctfw,multaha,eps,niter)
      implicit real *8 (a-h,o-z)
      integer nterms,nquad,nquadm,nitermax,niter
      integer, allocatable :: icols(:,:)
      real *8 xnodes(nquad),wts(nquad)
      real *8 thetas(nout)
      real *8 phis(nout)
