...
c$OMP DO 
     ...
     $              ,' with thread: ',omp_get_thread_num()
            ...
            call ti8_build_Z_S_q_5(verbose-1,svd_r_max,n_svd_r ,svd_r_
     $           ,n_svd_l,svd_l_,svd_s_,svd_V_r_,svd_polyval_V_r_
     $           ,fftw_plan_frwd__(n_r_tmp) ,fftw_0in__(n_A_tmp)
     $           ,fftw_out__(n_A_tmp),n_r ,grid_k_p_,weight_k_p_r_,n_w_
     $           ,n_A ,S_p_omp__(n_A_tmp),S_q_omp__(n_A_tmp) ,nS_9_per
