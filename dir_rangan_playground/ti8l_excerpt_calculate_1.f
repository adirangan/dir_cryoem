...
!> Calculates innerproducts for local search. ;\n
     ...
     $        I_S_sample_(ns_local)
         ...
         nx3 = n_gamma_z*n_CTF*nS_1_per_max*n_omp_sub_0in
     ...
     $        ,CTF_R_S_local_omp__(nx2 + p_CTF_R_S_local))
         do nw=0,n_w_max-1
            if (flag_RTRT_vs_RTTR.eqv..false.) then
               ...
               nx3 = n_r*nS_1_per_max*n_w_max *n_omp_sub_0in
     ...
     $                 *nS_1_per_max*n_w_max *n_omp_sub_0in
               end if           !if (verbose.gt.1) then
     ...
     $           (flag_RTRT_vs_RTTR.eqv..true.)) then
               ...
               nx3 = n_r*n_transf*nS_1_per_max *n_w_max*n_omp_sub_0in
     ...
     $                 *n_transf*nS_1_per_max *n_w_max*n_omp_sub_0in
               end if           !if (verbose.gt.1) then
     ...
     $              ,Z_S_q_local_omp__(nx2 + p_Z_S_q_local))
         ...
         if ((nS_1_sum.eq.nS_1_per_max) .or. (nLT.eq.n_LT-1)) then
            ...
            include 'ti8l_excerpt_define_STxTRM_0.f'
            include 'ti8l_excerpt_define_SxTTRM_0.f'
            include 'ti8l_excerpt_define_SZxTRM_0.f'
            include 'ti8l_excerpt_define_SxZTRM_0.f'
            include 'ti8l_excerpt_define_Zstore_full_0.f'
     ...
     $        ' not implemented in ti8l_excerpt_calculate_1.f'
