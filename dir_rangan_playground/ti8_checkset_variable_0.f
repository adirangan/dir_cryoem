...
c$$$         do nothing
     ...
     $        ,'svd_polyval_V_r_',flag_memory_checkset)
      ...
      call cxs_c16(n_A*n_omp_sub_0in,S_p_omp__,'S_p_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_A*n_omp_sub_0in,S_q_omp__,'S_q_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_A,M_p_,'M_p_',flag_memory_checkset)
      call cxs_c16(n_A,M_q_,'M_q_',flag_memory_checkset)
      call cxs_c16(n_A*n_omp_sub_0in,M_p_omp__,'M_p_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_A*n_omp_sub_0in,M_q_omp__,'M_q_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_A,CTF_p_,'CTF_p_',flag_memory_checkset)
      call cxs_c16(n_A,CTF_q_,'CTF_q_',flag_memory_checkset)
      call cxs_c16(n_A*n_omp_sub_0in,CTF_p_omp__,'CTF_p_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_A*n_omp_sub_0in,CTF_q_omp__,'CTF_q_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_A,Z_p_,'Z_p_',flag_memory_checkset)
      call cxs_c16(n_A,Z_q_,'Z_q_',flag_memory_checkset)
      call cxs_c16(n_A*n_omp_sub_0in,Z_p_omp__,'Z_p_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_A*n_omp_sub_0in,Z_q_omp__,'Z_q_omp__'
     $     ,flag_memory_checkset)
