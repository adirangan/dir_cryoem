...
!> Prints out several parameters at the beginning of test_innerproduct_8. ;\n
     ...
     $        ,flag_memory_estimate
         ...
         call print_all_i4(n_k_p_r_cur,n_polar_a_,' n_polar_a_: ')
         call print_all_r8(n_k_p_r_cur,grid_k_p_r_,' grid_k_p_r_: ')
         call print_all_r8(n_k_p_r_cur,weight_k_p_r_,' weight_k_p_r_: ')
...
c$$$         call print_sub_c16(n_S*ld_S,S_k_p__,' S_k_p___: ')
     ...
     $        ,tesselation_distance_req
         write(6,'(A,I0)') ' n_LT_add: '
     $        ,n_LT_add
         write(6,'(A,I0)') ' n_LT_ref: '
     $        ,n_LT_ref
