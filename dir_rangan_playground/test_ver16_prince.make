...
FSRCS = test_ver16.f \
	...
	rotate_p2p_fx.f \
	rotate_p2p_fx_single.f \
	rotate_q_to_q.f \
	innerproduct_c.f \
	innerproduct_p.f \
	innerproduct_q_stretch_0.f \
	innerproduct_q_k_stretch_0.f \
	innerproduct_q_k_svdr_5.f \
	innerproduct_q_k_svdr_6.f \
	innerproduct_q_k_svdd_3.f \
	innerproduct_q_k_svdd_4.f \
	...
	ti8_check_SxTTRM_3.f \
	ti8_check_SxZTRM_4.f \
	ti8_Zstore_3a.f \
	ti8_Zstore_3b.f \
	ti8_Zstore_3c.f \
	ti8_Zstore_3d.f \
...
$(PROJECT):   $(MODS)   $(OBJS)
	rm -f $(PROJECT)
	$(FLINK) $(OBJS) $(LFLAGS) -L/home/avr209/finufft-master/lib/ -lfinufft -lfftw3 -lfftw3_threads -fopenmp -lopenblas -lstdc++
#	./$(PROJECT)
#
clean: 
	rm -f $(OBJS)
