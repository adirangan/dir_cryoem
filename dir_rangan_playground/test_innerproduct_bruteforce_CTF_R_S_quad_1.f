...
!> and appealing to the fft. ;\n
      subroutine test_innerproduct_bruteforce_CTF_R_S_quad_1(verbose
     ...
     $     ,S_p__,CTF_p_ ,CTF_q_ ,n_CTF ,ld_CTF ,CTF_p__,CTF_R_S_)
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
c$$$      Calculates : 
     ...
     $        '[entering test_innerproduct_bruteforce_CTF_R_S_1]'
      ...
      do ns=0,n_S-1
         ...
         if (verbose.gt.2) then
            call innerproduct_p_quad(n_r,grid_p_,weight_p_,n_w_,n_A
