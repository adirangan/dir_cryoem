...
!> generates indices used for blocking arrays. ;\n
      subroutine block_1(verbose,n_A_sub_0in,n_A,n_A_per_,n_A_sum_
     $     ,n_A_sub_use,nA_per_min,nA_per_max)
      implicit none
      integer *4 verbose !verbosity level. ;
      integer *4 n_A_sub_0in !requested (maximum) number of blocks to split n_A into. ;
      ...
      n_A_sub_use = min(n_A_sub_0in,n_A)
      if (verbose.gt.0) then
         write (6,'(3(A,I0))') ' n_A_sub_0in ' , n_A_sub_0in , ' n_A ' ,
