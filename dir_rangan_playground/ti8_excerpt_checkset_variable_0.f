...
c$$$         do nothing
     ...
     $        ,flag_memory_checkset)
      ...
      call cxs_i4(n_k_p_r_cur,n_w_,'n_w_',flag_memory_checkset)
      call cxs_i4(n_k_p_r_cur,n_w_csum_,'n_w_csum_'
     $     ,flag_memory_checkset)
      call cxs_r8(n_gamma_z,gamma_z_,'gamma_z_',flag_memory_checkset)
      call cxs_r8(nufft1df77_lw,nufft1df77_fw_,'nufft1df77_fw_'
     $     ,flag_memory_checkset)      
      call cxs_i4(n_omp_sub_0in,nufft1df77_lused_,'nufft1df77_lused_'
     $     ,flag_memory_checkset)
      call cxs_i4(n_omp_sub_0in,nufft1df77_lw_,'nufft1df77_lw_'
     $     ,flag_memory_checkset)
      call cxs_r8(n_omp_sub_0in*nufft1df77_lw,nufft1df77_fw__
     $     ,'nufft1df77_fw__',flag_memory_checkset)      
     ...
     $        ,'svd_polyval_V_r_',flag_memory_checkset)
      ...
      call cxs_c16(n_w_sum,S_p_,'S_p_',flag_memory_checkset)
      call cxs_c16(n_w_sum,S_q_,'S_q_',flag_memory_checkset)
      call cxs_c16(n_w_sum*n_omp_sub_0in,S_p_omp__,'S_p_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_w_sum*n_omp_sub_0in,S_q_omp__,'S_q_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_w_sum,M_p_,'M_p_',flag_memory_checkset)
      call cxs_c16(n_w_sum,M_q_,'M_q_',flag_memory_checkset)
      call cxs_c16(n_w_sum*n_omp_sub_0in,M_p_omp__,'M_p_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_w_sum*n_omp_sub_0in,M_q_omp__,'M_q_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_w_sum,CTF_p_,'CTF_p_',flag_memory_checkset)
      call cxs_c16(n_w_sum,CTF_q_,'CTF_q_',flag_memory_checkset)
      call cxs_c16(n_w_sum*n_omp_sub_0in,CTF_p_omp__,'CTF_p_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_w_sum*n_omp_sub_0in,CTF_q_omp__,'CTF_q_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_Z_x,Z_p_,'Z_p_',flag_memory_checkset)
      call cxs_c16(n_Z_x,Z_q_,'Z_q_',flag_memory_checkset)
      call cxs_c16(n_Z_x*n_omp_sub_0in,Z_p_omp__,'Z_p_omp__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_Z_x*n_omp_sub_0in,Z_q_omp__,'Z_q_omp__'
     $     ,flag_memory_checkset)

      call cxs_c16(n_delta_v*n_gamma_z,ZZ__,'ZZ__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_delta_v*n_gamma_z*n_omp_sub_0in,ZZ_omp__
     $     ,'ZZ_omp__',flag_memory_checkset)
      call cxs_c16(n_w_max,ZZ_sub_,'ZZ_sub_',flag_memory_checkset)
      call cxs_c16(n_w_max*n_omp_sub_0in,ZZ_sub_omp__
     $     ,'ZZ_sub_omp__',flag_memory_checkset)
      call cxs_c16(n_gamma_z,ZZ_pos_,'ZZ_pos_',flag_memory_checkset)
      call cxs_c16(n_gamma_z*n_omp_sub_0in,ZZ_pos_omp__
     $     ,'ZZ_pos_omp__',flag_memory_checkset)
      call cxs_c16(n_gamma_z,CTF_R_S_sub__,'CTF_R_S_sub__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_gamma_z*n_omp_sub_0in,CTF_R_S_sub_omp__
     ...
     $        ,flag_memory_checkset)
      ...
      if (flag_tesselation.eqv..true.) then
         call cxs_r8(3*n_omp_sub_0in,vp_input_omp__
     $        ,'vp_input_omp__',flag_memory_checkset)
         call cxs_l2(nS_0_per_max*n_omp_sub_0in,flag_S_use_omp__
     $        ,'flag_S_use_omp__',flag_memory_checkset)
         call cxs_i4(2*nS_0_per_max*n_omp_sub_0in,LT_omp__
     ...
     $        ,flag_memory_checkset)
      ...
      call cxs_r8(n_alpha,alpha_0in_,'alpha_0in_'
     $     ,flag_memory_checkset)
      call cxs_r8(n_alpha*n_omp_sub_0in,alpha_0in_omp__
     $     ,'alpha_0in_omp__',flag_memory_checkset)
      if (flag_MS_vs_SM.eqv..true.) then
      call cxs_i4(n_S*n_omp_sub_0in,n_MS_omp__
     $     ,'n_MS_omp__',flag_memory_checkset)
      call cxs_r8(n_alpha*n_MS_max*n_S*n_omp_sub_0in,alpha_MS_omp__
     $     ,'alpha_MS_omp__',flag_memory_checkset)
     ...
     $           ,'S_T_T_R_CTF_M_q_local_omp__',flag_memory_checkset)
      ...
      call cxs_i4(n_omp_sub_0in,n_S_9_per_,'n_S_9_per_'
     $     ,flag_memory_checkset)
      call cxs_i4(n_omp_sub_0in,n_S_9_sum_,'n_S_9_sum_'
     $     ,flag_memory_checkset)
      call cxs_i4(n_omp_sub_0in,n_M_9_per_,'n_M_9_per_'
     $     ,flag_memory_checkset)
      call cxs_i4(n_omp_sub_0in,n_M_9_sum_,'n_M_9_sum_'
     $     ,flag_memory_checkset)

      call cxs_i4(n_omp_sub_0in,n_S_use_sum_,'n_S_use_sum_'
     $     ,flag_memory_checkset)
