...
!> checks memory allocation for test_ver18.f ;\n
      if (verbose.gt.1) then
         write(6,'(A)') '[entering test_ver18_excerpt_checkset]'
      end if !if (verbose.gt.1) then
      
      flag_memory_checkset = .true.

      call cxs_i4(n_k_p_r_max,nlats,'nlats',flag_memory_checkset)
      call cxs_i4(n_k_p_r_max,n_polar_a_,'n_polar_a_'
     $     ,flag_memory_checkset)
      call cxs_i4(n_polar_a_upperbound*n_k_p_r_max,n_azimu_b__
     $     ,'n_azimu_b__',flag_memory_checkset)
      call cxs_i4(n_k_p_r_max,n_azimu_b__sum_,'n_azimu_b__sum_'
     $     ,flag_memory_checkset)
      call cxs_i4(n_k_p_r_max,numonsphere,'numonsphere'
     $     ,flag_memory_checkset)
      call cxs_i4(n_k_p_r_max,nterms_sph,'nterms_sph'
     $     ,flag_memory_checkset)
      call cxs_i4(n_k_p_r_max,n_Y_l_,'n_Y_l_',flag_memory_checkset)
      call cxs_i4(n_k_p_r_max,n_Y_lm_,'n_Y_lm_'
     $     ,flag_memory_checkset)
      call cxs_i4(n_k_p_r_max,isph_start,'isph_start'
     $     ,flag_memory_checkset)
      call cxs_i4(n_k_p_r_max,n_Y_lm_csum_,'n_Y_lm_csum_'
     $     ,flag_memory_checkset)
      call cxs_i4(n_polar_a_upperbound,ngridc,'ngridc'
     $     ,flag_memory_checkset)
      call cxs_i4(n_polar_a_upperbound,n_w_,'n_w_',flag_memory_checkset)
      call cxs_i4(n_polar_a_upperbound,n_w_tmp_,'n_w_tmp_'
     $     ,flag_memory_checkset)
      call cxs_i4(n_k_p_r_max,icstart,'icstart',flag_memory_checkset)
      call cxs_i4(n_k_p_r_max,n_w_csum_,'n_w_csum_'
     $     ,flag_memory_checkset)
      call cxs_i4(n_polar_a_upperbound,ngridps,'ngridps'
     $     ,flag_memory_checkset)
      call cxs_i4(n_polar_a_upperbound,n_azimu_b_,'n_azimu_b_'
     $     ,flag_memory_checkset)
      call cxs_r8(n_k_p_r_max,grid_k_p_r_,'grid_k_p_r_'
     $     ,flag_memory_checkset)
      call cxs_r8(n_k_p_r_max,weight_k_p_r_,'weight_k_p_r_'
     $     ,flag_memory_checkset)
      call cxs_r8(n_polar_a_upperbound,xnodesth,'xnodesth'
     $     ,flag_memory_checkset)
      call cxs_r8(n_polar_a_upperbound,grid_cos_polar_a_
     $     ,'grid_cos_polar_a_',flag_memory_checkset)
      call cxs_r8(n_polar_a_upperbound,sthetas,'sthetas'
     $     ,flag_memory_checkset)
      call cxs_r8(n_polar_a_upperbound,grid_sin_polar_a_
     $     ,'grid_sin_polar_a_',flag_memory_checkset)
      call cxs_r8(n_polar_a_upperbound,weight_cos_polar_a_
     $     ,'weight_cos_polar_a_',flag_memory_checkset)
      call cxs_r8(n_polar_a_upperbound,azimu_b_step_,'azimu_b_step_'
     $     ,flag_memory_checkset)
      n = 3*n_source_max
      call cxs_r8(n,source_x0_c_x1_c_x2_c_A__
     $     ,'source_x0_c_x1_c_x2_c_A__',flag_memory_checkset)
      if (flag_heterogeneity) then
         n = 3*n_source_max
         call cxs_r8(n,source_x0_c_x1_c_x2_c_B__
     $        ,'source_x0_c_x1_c_x2_c_B__',flag_memory_checkset)
         n = 3*n_source_max
         call cxs_r8(n,source_x0_c_x1_c_x2_c_C__
     $        ,'source_x0_c_x1_c_x2_c_C__',flag_memory_checkset)
      end if !      if (flag_heterogeneity) then
      n = n_x_c_max*n_x_c_max*n_x_c_max
      call cxs_r8(n,grid_x0_c___,'grid_x0_c___',flag_memory_checkset)
      n = n_x_c_max*n_x_c_max*n_x_c_max
     ...
     $     ,flag_memory_checkset)
      ...
      call cxs_r8(n,grid_k0_c_,'grid_k0_c_',flag_memory_checkset)
      n = n_azimu_b__sum_sum
...
c$$$  store timing. ;
     ...
     $     ,flag_memory_checkset)
      ...
      if (verbose.gt.1) then
         write(6,'(A)') '[finished test_ver18_excerpt_checkset]'
      end if !if (verbose.gt.1) then
