...
!> Performs polynomial evaluation internally. ;\n
      subroutine transf_svd_q_to_q_polyval_0on_0(svd_r_max,n_svd_r
     $     ,svd_r_,svd_d_max,n_svd_d,svd_d_,n_svd_l,svd_l_,svd_U_d_
     $     ,svd_s_,svd_V_r_,n_r,grid_p_,n_w_,n_A,S_q_,delta_x,delta_y
     $     ,M_q_)
...
c$$$      Upgraded to ignore frequencies of magnitude n_w_(nr)/2 or larger. ;
     ...
     $        ' in transf_svd_q_to_q_polyval_0on_0.f'
