...
!> Calculates S_T_T_R_CTF_M_q_local_omp__. ;\n
     ...
     $        ,S_Z_T_R_CTF_M_q_local_omp__(p_S_Z_T_R_CTF_M_q_local))
      ...
      do nw=0,n_w_max-1
         ...
         nx4 = n_r*nS_1_per_max*n_w_max*n_omp_sub_0in
     ...
     $           *n_transf -1 , ' max: ' , nx4-1
         ...
         nx4 = n_r*n_transf*n_w_max*n_omp_sub_0in
     ...
     $           nx4-1
         ...
         nx4 = nS_1_per_max*n_transf*n_w_max*n_omp_sub_0in
     ...
     $        *dcmplx(1.0d0,0.0d0),O_S_q_local_omp__(nx1+p_O_S_q_local)
...
c$$$      %%%%%%%%%%%%%%%%
     ...
     $        *dcmplx(1.0d0,0.0d0),Z_M_svdd_,n_svd_l
...
c$$$      %%%%%%%%%%%%%%%%
     ...
     $           ' calling ti8_check_SxZTRM_4 to test. '
         ...
         call ti8_check_SxZTRM_4(verbose-1
     $,svd_d_max
     $,n_svd_d
     $,svd_d_
     $,svd_r_max
