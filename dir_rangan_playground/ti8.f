...
!> end 0-level S-block. ;\n
     ...
     $     )
      include 'ti8_excerpt_define_var_allocation_0on_0.f'
      include 'ti8_excerpt_entering_0.f'
      include 'ti8_excerpt_allocate_variable_0.f'
      include 'ti8_excerpt_define_svdd_3.f'
      include 'ti8_excerpt_define_fftw_local_0.f'
      include 'ti8_excerpt_define_fftw_omp_0.f'
      include 'ti8_excerpt_define_fftw_fpm_0.f'
     ...
     $        ,n_S_9_sum_,n_S_9_sub_use,nS_9_per_min,nS_9_per_max)
         include 'ti8_excerpt_checkset_variable_0.f'
         include 'ti8_excerpt_define_CTF_R_S_0.f'
         include 'ti8_excerpt_checkset_variable_0.f'
         include 'ti8_excerpt_define_O_S_q_0.f'
         include 'ti8_excerpt_checkset_variable_0.f'
         include 'ti8_excerpt_define_T_S_q_0.f'
         include 'ti8_excerpt_checkset_variable_0.f'
         include 'ti8_excerpt_define_Z_S_q_0.f'
         include 'ti8_excerpt_checkset_variable_0.f'
     ...
     $           )
            ...
            include 'ti8_excerpt_define_tesselation_0.f'
            call ti8_local_0(
            include 'ti8_excerpt_list_var_external_0.f'
            include 'ti8_excerpt_list_var_internal_0.f'
     $           )
      ...
      include 'ti8_excerpt_checkset_variable_0.f'
      include 'ti8_excerpt_deallocate_0.f'
      include 'ti8_excerpt_finished_1.f'
