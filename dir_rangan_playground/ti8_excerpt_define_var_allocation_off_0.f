...
c$$$      include './dir_gen_Jsvd_6/Jsvd_excerpt_var_allocation_0on_0.f'
      include './dir_gen_Jsvd_6/Jsvd_excerpt_var_allocation_off_0.f'
      integer *4 n_svd_max
c$$$      parameter (n_svd_max=512)
      ...
      real *8 svd_polyval_V_r_(0:0) ! array storing polynomial evaluations of svd_V_r_ at the various grid_k_p_r_(nr) values. ;
...
c$$$      pointer (p_CTF_p__,CTF_p__) !another name for CTF_k_p__. ;
      ...
      complex *16 ZZ_pos_(0:0) !temporary storage for a single array. ;
      complex *16 ZZ_pos_omp__(0:0) !temporary storage for a few arrays across multiple threads. ;
...
c$$$      indices
      ...
      integer *4 n_w_(0:0) !array (length at least n_k_p_r_cur) to store number of angles (omega) for each nk. ;
      integer *4 n_w_csum_(0:0) !array (length at least n_k_p_r_cur) to store cumulative sum of n_w_. ;
...
c$$$      nufft workspace for omp
      integer *4 nufft1df77_lw_(0:0)
      integer *4 nufft1df77_lused_(0:0)
      real *8 nufft1df77_fw__(0:0)
