...
c$OMP DO 
     ...
     $        *dcmplx(1.0d0,0.0d0),O_S_q__(nx1),n_r,T_T_R_CTF_M_q__(nx2)
...
c$$$      %%%%%%%%%%%%%%%%
     ...
     $           ' calling ti8_check_SxTTRM_3 to test. '
         ...
         call ti8_check_SxTTRM_3(verbose-1,n_delta_v ,delta_x_ ,delta_y_
     ...
     $        *(nS_0_sum + nS_1_sum)),S_T_T_R_CTF_M_q__)
