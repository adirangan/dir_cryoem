...
!> This program calculates innerproducts via brute force. ;\n
      subroutine test_innerproduct_bruteforce_quad_1(verbose ,n_r
     $     ,grid_p_,weight_p_,n_w_ ,half_diameter_x_c ,S_p_0in_
     $     ,M_p_0in_ ,CTF_p_0in_,delta_x_est ,delta_y_est ,gamma_z_est
...
c$$$      parameters for timing
     ...
     $        ,' total_time ',timing_toc-timing_tic
      ...
      timing_tic = omp_get_wtime()
      call test_innerproduct_bruteforce_CTF_R_S_quad_1(verbose-1
     $     ,n_gamma_z,gamma_z_,fftw_plan_frwd_,fftw_0in_,fftw_out_
     $     ,fftw_plan_back_last,fftw_0in_last_,fftw_out_last_,n_r
     $     ,grid_p_,weight_p_,n_w_,n_A,S_p_,S_q_,n_S,I_S_sample_,ld_S
     $     ,S_p_0in_ ,CTF_p_ ,CTF_q_ ,n_CTF,ld_CTF ,CTF_p_0in_
     $     ,CTF_R_S_xx_)
      timing_toc = omp_get_wtime()
     ...
     $        ,n_w_,n_A,fftw_0in_,fftw_out_,S_p_0in_,+gamma_z,S_p_)
         ...
         call innerproduct_p_quad(n_r,grid_p_,weight_p_,n_w_,n_A,S_p_
     $        ,S_p_,C_p)
...
c$$$     $     -delta_y,M_p_)
     ...
     $        ,fftw_0in_,fftw_out_,S_p_,S_q_)
         call innerproduct_q_k_stretch_quad_0(n_r,grid_p_,weight_p_,n_w_
