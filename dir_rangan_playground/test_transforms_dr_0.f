...
c$$$      Then calculates the innerproduct <R_{\gamma}*S,M>. ;
      ...
      data verbose / 1 /
      integer n_r ! integer: number of nodes in the radial direction. ;
      integer n_A ! integer: number of points in k_p. ;
      integer n_w_max ! integer: number of points at grid_k_p_r_(n_r-1). ;
      integer n_x_c_0 ! integer: number of nodes in the 1-direction in x_c coordinates. ;
      integer n_x_c_1 ! integer: number of nodes in the 2-direction in x_c coordinates. ;
      real *8 diameter_x_c_0 ! real *8: 1-diameter of image in x_c coordinates. ;
      real *8 diameter_x_c_1 ! real *8: 2-diameter of image in x_c coordinates. ;
      real *8 half_diameter_x_c_0 ! real *8: 1-half_diameter of image in x_c coordinates. ;
      real *8 half_diameter_x_c_1 ! real *8: 2-half_diameter of image in x_c coordinates. ;
      real *8 dx_c_0 !real *8: 1-stepsize in x_c. ;
      real *8 dx_c_1 !real *8: 2-stepsize in x_c. ;
      real *8 x_c_0_max !real *8: 1-max in x_c. ;
      real *8 x_c_1_max !real *8: 2-max in x_c. ;
      ...
      real *8, allocatable :: grid_x_c_0_(:) !real *8 array, size n_x_c_0. ;
      real *8, allocatable :: grid_x_c_1_(:) !real *8 array, size n_x_c_1. ;
      real *8, allocatable :: grid_x_p_r_(:) !real *8 array, size n_x_c_0*n_x_c_1. ;
      real *8, allocatable :: grid_x_p_w_(:) !real *8 array, size n_x_c_0*n_x_c_1. ;
      real *8, allocatable :: grid_k_c_0_(:) !real *8 array, size n_x_c_0. ;
      real *8, allocatable :: grid_k_c_1_(:) !real *8 array, size n_x_c_1. ;
      integer *4, allocatable :: n_polar_a_(:) !integer *4 array, size n_r. ;
      integer *4, allocatable :: n_w_(:) !integer *4 array, size n_r. ;
      real *8, allocatable :: grid_k_p_r_(:) !real *8 array, size n_r. ;
      real *8, allocatable :: grid_k_p_1_(:) !real *8 array, size n_A. ;
      real *8, allocatable :: grid_k_p_2_(:) !real *8 array, size n_A. ;
      real *8, allocatable :: weight_k_p_(:) !real *8 array, size n_A. ;
      complex *16, allocatable :: S_x_c_(:) !complex *16 array, size n_x_c_0*n_x_c_1. ;
      complex *16, allocatable :: M_x_c_(:) !complex *16 array, size n_x_c_0*n_x_c_1. ;
      complex *16, allocatable :: S_k_c_(:) !complex *16 array, size n_x_c_0*n_x_c_1. ;
      complex *16, allocatable :: M_k_c_(:) !complex *16 array, size n_x_c_0*n_x_c_1. ;
      complex *16, allocatable :: S_k_p_(:) !complex *16 array, size n_A. ;
      complex *16, allocatable :: M_k_p_(:) !complex *16 array, size n_A. ;
      complex *16, allocatable :: S_k_q_(:) !complex *16 array, size n_A. ;
      complex *16, allocatable :: M_k_q_(:) !complex *16 array, size n_A. ;
      integer *8, allocatable :: fftw_plan_frwd_(:) !integer *8 array, size n_r. ;
      integer *8, allocatable :: fftw_plan_back_(:) !integer *8 array, size n_r. ;
      complex *16, allocatable :: fftw_0in_(:) !complex *16 array, size n_A. ;
      complex *16, allocatable :: fftw_out_(:) !complex *16 array, size n_A. ;
      complex *16, allocatable :: T_k_p_(:) !complex *16 array, size n_A. ;
      complex *16, allocatable :: X0_(:) !complex *16 array, size n_w_max. ;
      complex *16, allocatable :: X1_(:) !complex *16 array, size n_w_max. ;
      ...
      real *8, allocatable :: quad_grid_k_p_2_(:) !real *8 array, size quad_n_A. ;
      ...
      real *8 fix_I !real *8, integral of plane-wave. ;
      real *8 tmp_e !temporary: real *8, exponent. ;
      ...
      complex *16, allocatable :: P_k_p_(:) !complex *16 array, size quad_n_A. plane-wave with displacement fix_delta_x_c_ ;
      ...
      real *8, allocatable :: tmp_delta_M_x_c_(:) !real *8 array, size 2. plane-wave displacement. ;
      real *8, allocatable :: tmp_delta_S_x_c_(:) !real *8 array, size 2. plane-wave displacement. ;
      real *8, allocatable :: tmp_delta_Y_x_c_(:) !real *8 array, size 2. plane-wave displacement. ;
      ...
      real *8 fix_I_SM !real *8, <P_S,P_M>. ;
      real *8 fix_I_SCM !real *8, <P_S,conj(P_C)*P_M>. ;
      ...
      complex *16, allocatable :: fix_X0_(:) !complex *16 array, size quad_n_w_max. ;
      complex *16, allocatable :: fix_SX0_(:) !complex *16 array, size quad_n_w_max. ;
      complex *16, allocatable :: fix_MX0_(:) !complex *16 array, size quad_n_w_max. ;
...
c$$$      declaration of svd-expansion and associated variables
      include './dir_gen_Jsvd_6/Jsvd_var_allocation_0on_0.f'
      integer *4 n_svd_max
      ...
      complex *16, allocatable :: tmp_Z_(:) !complex *16 array, size max(n_gamma_z_upd,n_gamma_z_nuf). ;
      complex *16, allocatable :: quad_CTF_R_S_0__(:) !complex *16 array, size n_gamma_z_upd. ;
      complex *16, allocatable :: quad_CTF_R_S_1__(:) !complex *16 array, size n_gamma_z_upd. ;
      complex *16, allocatable :: quad_Y_CTF_R_S_0__(:) !complex *16 array, size n_gamma_z_upd. ;
      complex *16, allocatable :: quad_Y_CTF_R_S_1__(:) !complex *16 array, size n_gamma_z_upd. ;
      complex *16, allocatable :: quad_Y_CTF_R_S_2__(:) !complex *16 array, size n_gamma_z_nuf. ;
      complex *16, allocatable :: quad_Y_CTF_R_S_3__(:) !complex *16 array, size n_gamma_z_nuf. ;
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering innerproduct_k_q_stretch_0_dr]'
      ...
      dx_c_0 = diameter_x_c_0/n_x_c_0
      dx_c_1 = diameter_x_c_1/n_x_c_1
      x_c_0_max = dx_c_0*floor(n_x_c_0/2.0d0)
      x_c_1_max = dx_c_1*floor(n_x_c_1/2.0d0)
c$$$      %%%%%%%%
      allocate(grid_x_c_0_(0:1+n_x_c_0-1))
      call cs1_r8(n_x_c_0,grid_x_c_0_)
      allocate(grid_x_c_1_(0:1+n_x_c_1-1))
      call cs1_r8(n_x_c_1,grid_x_c_1_)
      do nx_c_0=0,n_x_c_0-1
         grid_x_c_0_(nx_c_0) = -x_c_0_max + dx_c_0*nx_c_0
      enddo !do nx_c_0=0,n_x_c_0-1
      do nx_c_1=0,n_x_c_1-1
         grid_x_c_1_(nx_c_1) = -x_c_1_max + dx_c_1*nx_c_1
      enddo !do nx_c_1=0,n_x_c_1-1
      if (verbose.gt.1) then
      call print_sub_r8(n_x_c_0,grid_x_c_0_,' grid_x_c_0_: ')
      call print_sub_r8(n_x_c_1,grid_x_c_1_,' grid_x_c_1_: ')
      end if !if (verbose.gt.1) then
c$$$      %%%%%%%%
      allocate(grid_x_p_r_(0:1+n_x_c_0*n_x_c_1-1))
      call cs1_r8(n_x_c_0*n_x_c_1,grid_x_p_r_)
      allocate(grid_x_p_w_(0:1+n_x_c_0*n_x_c_1-1))
      call cs1_r8(n_x_c_0*n_x_c_1,grid_x_p_w_)
      na=0
      do nx_c_1=0,n_x_c_1-1
      do nx_c_0=0,n_x_c_0-1
         grid_x_p_r_(na) = dsqrt(grid_x_c_0_(nx_c_0)**2 +
     $        grid_x_c_1_(nx_c_1)**2)
         grid_x_p_w_(na) = datan2(grid_x_c_1_(nx_c_1)
     $        ,grid_x_c_0_(nx_c_0))
         na=na+1
      enddo !do nx_c_0=0,n_x_c_0-1
      enddo !do nx_c_1=0,n_x_c_1-1
      if (verbose.gt.1) then
      call print_sub_r8(n_x_c_0*n_x_c_1,grid_x_p_r_,' grid_x_p_r_: ')
      call print_sub_r8(n_x_c_0*n_x_c_1,grid_x_p_w_,' grid_x_p_w_: ')
      end if !if (verbose.gt.1) then
c$$$      %%%%%%%%
      allocate(S_x_c_(0:1+n_x_c_0*n_x_c_1-1))
      call cs1_c16(n_x_c_0*n_x_c_1,S_x_c_)
      na=0
      do nx_c_1=0,n_x_c_1-1
      do nx_c_0=0,n_x_c_0-1
         S_x_c_(na) = S_x_c_(na) - 0.50d0*dexp(-grid_x_p_r_(na)**2 /
     $        (2.0d0*(1.0d0/16.0d0 * (2.0d0+dcos(5.0d0*(grid_x_p_w_(na)
     $        -pi/1.0d0))))**2))
         S_x_c_(na) = S_x_c_(na) + 0.75d0*dexp(-grid_x_p_r_(na)**2 /
     $        (2.0d0*(1.0d0/16.0d0 * (2.0d0+dcos(6.0d0*(grid_x_p_w_(na)
     $        -pi/2.5d0))))**2))
         S_x_c_(na) = S_x_c_(na) + 0.75d0*dexp(-grid_x_p_r_(na)**2 /
     $        (2.0d0*(1.0d0/16.0d0 * (2.0d0+dcos(7.0d0*(grid_x_p_w_(na)
     $        -pi/5.0d0))))**2))
         if ((grid_x_c_0_(nx_c_0).eq.0.0d0) .and.
     $        (grid_x_c_1_(nx_c_1).eq.0.0d0)) then
            S_x_c_(na) = dcmplx(-0.5d0,0.0d0)
         end if !if ((grid_x_c_0_(nx_c_0).eq.0.0d0) .and. (grid_x_c_1_(nx_c_1).eq.0.0d0)) then
         na=na+1
      enddo !do nx_c_0=0,n_x_c_0-1
      enddo !do nx_c_1=0,n_x_c_1-1
      if (verbose.gt.1) then
      call print_sub_c16(n_x_c_0*n_x_c_1,S_x_c_,' S_x_c_: ')
      end if !if (verbose.gt.1) then
c$$$      %%%%%%%%
      allocate(M_x_c_(0:1+n_x_c_0*n_x_c_1-1))
      call cs1_c16(n_x_c_0*n_x_c_1,M_x_c_)
      na=0
      do nx_c_1=0,n_x_c_1-1
      do nx_c_0=0,n_x_c_0-1
         M_x_c_(na) = M_x_c_(na) - 0.20d0*dexp(-grid_x_p_r_(na)**2 /
     $        (2.0d0*(1.0d0/16.0d0 * (2.0d0+dcos(2.0d0*(grid_x_p_w_(na)
     $        -pi/3.0d0))))**2))
         M_x_c_(na) = M_x_c_(na) + 0.15d0*dexp(-grid_x_p_r_(na)**2 /
     $        (2.0d0*(1.0d0/16.0d0 * (2.0d0+dcos(3.0d0*(grid_x_p_w_(na)
     $        -pi/5.5d0))))**2))
         M_x_c_(na) = M_x_c_(na) + 0.45d0*dexp(-grid_x_p_r_(na)**2 /
     $        (2.0d0*(1.0d0/16.0d0 * (2.0d0+dcos(5.0d0*(grid_x_p_w_(na)
     $        -pi/7.0d0))))**2))
         if ((grid_x_c_0_(nx_c_0).eq.0.0d0) .and.
     $        (grid_x_c_1_(nx_c_1).eq.0.0d0)) then
            M_x_c_(na) = dcmplx(-0.5d0,0.0d0)
         end if !if ((grid_x_c_0_(nx_c_0).eq.0.0d0) .and. (grid_x_c_1_(nx_c_1).eq.0.0d0)) then
         na=na+1
      enddo !do nx_c_0=0,n_x_c_0-1
      enddo !do nx_c_1=0,n_x_c_1-1
      if (verbose.gt.1) then
      call print_sub_c16(n_x_c_0*n_x_c_1,M_x_c_,' M_x_c_: ')
      end if !if (verbose.gt.1) then
c$$$      %%%%%%%%
      diameter_k_c = 2.0*n_r/diameter_x_c_0
      allocate(grid_k_c_0_(0:1+n_x_c_0-1))
      call cs1_r8(n_x_c_0,grid_k_c_0_)
      allocate(grid_k_c_1_(0:1+n_x_c_1-1))
      call cs1_r8(n_x_c_1,grid_k_c_1_)
      do nx_c_0=0,n_x_c_0-1
         grid_k_c_0_(nx_c_0) = 0.5*(nx_c_0 - floor(n_x_c_0/2.0d0))
      enddo !do nx_c_0=0,n_x_c_0-1
      do nx_c_1=0,n_x_c_1-1
         grid_k_c_1_(nx_c_1) = 0.5*(nx_c_1 - floor(n_x_c_1/2.0d0))
      enddo !do nx_c_1=0,n_x_c_1-1
      if (verbose.gt.1) then
      call print_sub_r8(n_x_c_0,grid_k_c_0_,' grid_k_c_0_: ')
      call print_sub_r8(n_x_c_1,grid_k_c_1_,' grid_k_c_1_: ')
      end if !if (verbose.gt.1) then
      ...
      n_w_max = n_w_(n_r-1)
      allocate(grid_k_p_1_(0:1+n_A-1))
      call cs1_r8(n_A,grid_k_p_1_)
      allocate(grid_k_p_2_(0:1+n_A-1))
      call cs1_r8(n_A,grid_k_p_2_)
      allocate(weight_k_p_(0:1+n_A-1))
      call cs1_r8(n_A,weight_k_p_)
      na=0
      do nr=0,n_r-1
         tmp_k = grid_k_p_r_(nr)
         do nw=0,n_w_(nr)-1
            tmp_w = 2.0d0*pi*nw/n_w_(nr)
            grid_k_p_1_(na) = pi*tmp_k/half_diameter_k_c*dcos(tmp_w)
            grid_k_p_2_(na) = pi*tmp_k/half_diameter_k_c*dsin(tmp_w)
            weight_k_p_(na) = 2.0d0*pi*grid_k_p_r_(nr)*dr / n_w_(nr)
            na = na+1
         enddo !do nw=0,n_w_(nr)-1
      enddo !do nr=0,n_r-1
      if (verbose.gt.1) then
      call print_sub_r8(n_A,grid_k_p_1_,' grid_k_p_1_: ')
      call print_sub_r8(n_A,grid_k_p_2_,' grid_k_p_2_: ')
      call print_sub_r8(n_A,weight_k_p_,' weight_k_p_: ')
      end if !if (verbose.gt.1) then
c$$$      %%%%%%%%
      ...
      allocate(fftw_0in_(0:1+n_A-1))
      call cs1_c16(n_A,fftw_0in_)
      allocate(fftw_out_(0:1+n_A-1))
      call cs1_c16(n_A,fftw_out_)
      na=0
      do nr=0,n_r-1
     ...
     $        ,fftw_out_(na),fftw_0in_(na),FFTW_BACKWARD,FFTW_MEASURE)
      ...
      enddo !do nr=0,n_r-1
c$$$      %%%%%%%%
      allocate(S_k_p_(0:1+n_A-1))
      call cs1_c16(n_A,S_k_p_)
      allocate(S_k_q_(0:1+n_A-1))
      call cs1_c16(n_A,S_k_q_)
      finufft_iflag = -1
      finufft_eps = 1.0d-12
      call finufft2d2_f(n_A,grid_k_p_1_,grid_k_p_2_,S_k_p_,finufft_iflag
     $     ,finufft_eps,n_x_c_0,n_x_c_1,S_x_c_,finufft_ier)
      c16_alpha = dcmplx(1.0d0/dsqrt(1.0d0*n_x_c_0*1.0d0*n_x_c_1),0.0d0)
      if (verbose.gt.1) then
     ...
     $     , ' , ' , aimag(c16_alpha)
      ...
      if (verbose.gt.1) then
      call print_sub_c16(n_A,S_k_p_,' S_k_p_: ')
      end if !if (verbose.gt.1) then
      call interp_p_to_q_fftw(n_r,fftw_plan_frwd_,n_w_,n_A,fftw_0in_
     $     ,fftw_out_,S_k_p_,S_k_q_)
      if (verbose.gt.1) then
      call print_sub_c16(n_A,S_k_q_,' S_k_q_: ')
      end if !if (verbose.gt.1) then
c$$$      %%%%%%%%
      allocate(M_k_p_(0:1+n_A-1))
      call cs1_c16(n_A,M_k_p_)
      allocate(M_k_q_(0:1+n_A-1))
      call cs1_c16(n_A,M_k_q_)
      finufft_iflag = -1
      finufft_eps = 1.0d-12
      call finufft2d2_f(n_A,grid_k_p_1_,grid_k_p_2_,M_k_p_,finufft_iflag
     $     ,finufft_eps,n_x_c_0,n_x_c_1,M_x_c_,finufft_ier)
      c16_alpha = dcmplx(1.0d0/dsqrt(1.0d0*n_x_c_0*n_x_c_1),0.0d0); 
      c16_beta = dcmplx(0.0d0,0.0d0); 
      call af1_c16(n_A,c16_alpha,c16_beta,M_k_p_,M_k_p_)
      if (verbose.gt.1) then
      call print_sub_c16(n_A,M_k_p_,' M_k_p_: ')
      end if !if (verbose.gt.1) then
      call interp_p_to_q_fftw(n_r,fftw_plan_frwd_,n_w_,n_A,fftw_0in_
     $     ,fftw_out_,M_k_p_,M_k_q_)
      if (verbose.gt.1) then
      call print_sub_c16(n_A,M_k_q_,' M_k_q_: ')
      end if !if (verbose.gt.1) then
c$$$      %%%%%%%%
      allocate(T_k_p_(0:1+n_A-1))
      call cs1_c16(n_A,T_k_p_)
      allocate(X0_(0:1+n_w_max-1))
      call cs1_c16(n_w_max,X0_)
      do nw=0,n_w_max-1
         tmp_gamma_z = (2.0d0*pi*nw)/n_w_max
         call rotate_p2p_fx(n_r,fftw_plan_frwd_,fftw_plan_back_,n_w_,n_A
     $        ,fftw_0in_,fftw_out_,S_k_p_,tmp_gamma_z,T_k_p_)
         call innerproduct_p(n_r,grid_k_p_r_,n_w_,n_A,T_k_p_,M_k_p_
     $        ,X0_(nw))
      enddo !do nw=0,n_w_max-1
      if (verbose.gt.1) then
      call print_sub_c16(n_w_max,X0_,' X0_: ')
      end if !if (verbose.gt.1) then
      allocate(X1_(0:1+n_w_max-1))
      call cs1_c16(n_w_max,X1_)
      call innerproduct_q_k_stretch_0(n_r,grid_k_p_r_,n_w_,n_A,S_k_q_
     $     ,M_k_q_,X1_)
      if (verbose.gt.1) then
      call print_sub_c16(n_w_max,X1_,' X1_: ')
      end if !if (verbose.gt.1) then
      call cp1_c16(n_w_max,X1_,fftw_out_(n_A-n_w_max))
      call dfftw_execute_(fftw_plan_back_(n_r-1))
      c16_alpha = dcmplx(1.0d0,0.0d0); 
      c16_beta = dcmplx(0.0d0,0.0d0); 
      call af1_c16(n_w_max,c16_alpha,c16_beta,fftw_0in_(n_A-n_w_max)
     $     ,X1_)
      if (verbose.gt.1) then
      call print_sub_c16(n_w_max,X1_,' X1_: ')
      end if !if (verbose.gt.1) then
      write(6,'(A,F21.16)') ' X1 vs X0_: ',fnod_c16_f(n_w_max,X1_
     $     ,X0_)/al2_c16_f(n_w_max,X0_)
c$$$      %%%%%%%%
      quad_n_r = 48
...
c$$$      %%%%%%%%
      ...
      allocate(quad_grid_k_p_2_(0:1+quad_n_A-1))
      call cs1_r8(quad_n_A,quad_grid_k_p_2_)
     ...
     $           *dcos(tmp_w)
            quad_grid_k_p_2_(na) = pi*tmp_k/half_diameter_k_c
     $           *dsin(tmp_w)
     ...
     $           quad_n_w_(nr)
      ...
      call print_sub_r8(quad_n_A,quad_grid_k_p_2_,' quad_grid_k_p_2_: ')
...
c$$$      %%%%%%%%
     ...
     $     **2)
      ...
      call jbess(0.0d0,1,2.0d0*pi*half_diameter_k_c*fix_delta_x_p_r
     $     ,tmp_j0)
      call jbess(2.0d0,1,2.0d0*pi*half_diameter_k_c*fix_delta_x_p_r
     $     ,tmp_j2)
      fix_I = tmp_j0 + tmp_j2
      if (verbose.gt.1) then
      write(6,'(A,F21.16)') ' fix_I: ' , fix_I
      end if !if (verbose.gt.1) then
c$$$      %%%%%%%%
     ...
     $           -fix_delta_x_p_w)
      ...
      quad_I = quad_I / (pi*half_diameter_k_c**2)
      write(6,'(A,F21.16,A,F21.16,A)') ' quad_I error: ( ',real((quad_I
     $     -fix_I)/fix_I),' , ' , aimag((quad_I-fix_I)/fix_I) , ' )'
c$$$      %%%%%%%%
      allocate(P_k_p_(0:1+n_A-1))
      call cs1_c16(n_A,P_k_p_)
      na=0
      do nr=0,n_r-1
         tmp_k = grid_k_p_r_(nr)
         do nw=0,n_w_(nr)-1
            ...
            tmp_e = 2.0d0*pi*tmp_k*fix_delta_x_p_r*dcos(tmp_w
     $           -fix_delta_x_p_w)
            P_k_p_(na) = dcmplx(+dcos(tmp_e),+dsin(tmp_e))
            na = na+1
         enddo !do nw=0,n_w_(nr)-1
      enddo !do nr=0,n_r-1
      if (verbose.gt.1) then
      call print_sub_c16(n_A,P_k_p_,' P_k_p_: ')
      end if !if (verbose.gt.1) then
      equi_I = dcmplx(0.0d0,0.0d0)
      do na=0,n_A-1
         equi_I = equi_I + P_k_p_(na)*weight_k_p_(na)
      enddo !do na=0,n_A-1
      equi_I = equi_I / (pi*half_diameter_k_c**2)
      write(6,'(A,F21.16,A,F21.16,A)') ' equi_I error: ( ',real((equi_I
     $     -fix_I)/fix_I),' , ' , aimag((equi_I-fix_I)/fix_I) , ' )'
c$$$      %%%%%%%%
     ...
     $     ,tmp_j0)
      call jbess(2.0d0,1,2.0d0*pi*half_diameter_k_c*fix_delta_x_p_r
     $     ,tmp_j2)
      fix_I_SM = tmp_j0 + tmp_j2
      if (verbose.gt.1) then
      write(6,'(A,F21.16)') ' fix_I_SM: ' , fix_I_SM
      end if !if (verbose.gt.1) then
c$$$      %%%%%%%%
...
c$$$      %%%%%%%%
     ...
     $     ,quad_weight_k_p_) / (pi*half_diameter_k_c**2)
      write(6,'(A,F21.16,A,F21.16,A)') ' quad_I_SM error: ( '
     $     ,real((quad_I_SM-fix_I_SM)/fix_I_SM),' , ' , aimag((quad_I_SM
     $     -fix_I_SM)/fix_I_SM) , ' )'
c$$$      %%%%%%%%
...
c$$$      fix_delta_C_x_c_(0) = +0.0d0
c$$$      fix_delta_C_x_c_(1) = -0.0d0
     ...
     $     ,tmp_j0)
      call jbess(2.0d0,1,2.0d0*pi*half_diameter_k_c*fix_delta_x_p_r
     $     ,tmp_j2)
      fix_I_SCM = tmp_j0 + tmp_j2
      if (verbose.gt.1) then
      write(6,'(A,F21.16)') ' fix_I_SCM: ' , fix_I_SCM
      end if !if (verbose.gt.1) then
...
c$$$      %%%%%%%%
     ...
     $     ,quad_weight_k_p_) / (pi*half_diameter_k_c**2)
c$$$      write(6,'(A,F21.16,A,F21.16,A)') ' quad_I_SCM: ( ',
c$$$     $     real(quad_I_SCM) , ' , ' , aimag(quad_I_SCM) , ' )'
c$$$      write(6,'(A,F21.16)') ' fix_I_SCM: ', fix_I_SCM
      write(6,'(A,F21.16,A,F21.16,A)') ' quad_I_SCM error: ( '
     $     ,real((quad_I_SCM-fix_I_SCM)/fix_I_SCM),' , ' ,
     $     aimag((quad_I_SCM -fix_I_SCM)/fix_I_SCM) , ' )'
c$$$      %%%%%%%%
...
c$$$  %%%%%%%%;
c$$$      delta_est_x_c_0 = 0.0d0
c$$$      delta_est_x_c_1 = 0.0d0
c$$$      gamma_z_est = 0.0d0
c$$$      delta_upd_x_c_0 = 0.0d0
c$$$      delta_upd_x_c_1 = 0.0d0
c$$$      %%%%%%%%
     ...
     $     ,quad_P_R_k_q_)
      ...
      call rotate_p2p_fx(quad_n_r,quad_fftw_plan_frwd_
     ...
     $     ,quad_P_N_k_q_,quad_X1_)
      c16_alpha = dcmplx(1.0d0/(2.0d0*pi*half_diameter_k_c**2),0.0d0); 
      c16_beta = dcmplx(0.0d0,0.0d0); 
      call af1_c16(quad_n_w_max,c16_alpha,c16_beta
     $     ,quad_X1_,quad_X1_)
c$$$      call innerproduct_q_k_stretch_0(quad_n_r,quad_grid_k_p_r_
c$$$     $     ,quad_n_w_,quad_n_A,quad_P_R_k_q_,quad_P_N_k_q_,quad_X1_)
      if (verbose.gt.1) then
...
c$$$      %%%%%%%%
     ...
     $        ,quad_P_N_k_p_,quad_weight_k_p_) / (pi*half_diameter_k_c
     $        **2)
c$$$         call innerproduct_p(quad_n_r,quad_grid_k_p_r_,quad_n_w_
c$$$     $        ,quad_n_A,quad_P_R_k_p_,quad_P_N_k_p_,quad_X0_(nw))
...
c$$$      %%%%%%%%
      ...
      allocate(fix_X0_(0:1+quad_n_w_max-1))
      call cs1_c16(quad_n_w_max,fix_X0_)
      allocate(fix_SX0_(0:1+quad_n_w_max-1))
      call cs1_c16(quad_n_w_max,fix_SX0_)
      allocate(fix_MX0_(0:1+quad_n_w_max-1))
      call cs1_c16(quad_n_w_max,fix_MX0_)
      do nw=0,quad_n_w_max-1
         gamma_z_upd = (2.0d0*pi*nw)/(1.0d0*quad_n_w_max)
     ...
     $        ,tmp_delta_S_x_c_)
         tmp_delta_M_x_c_(0) = fix_delta_M_x_c_(0) - fix_delta_C_x_c_(0)
         tmp_delta_M_x_c_(1) = fix_delta_M_x_c_(1) - fix_delta_C_x_c_(1)
         call rotate_delta(-gamma_z_est,tmp_delta_M_x_c_
     $        ,tmp_delta_M_x_c_)
         tmp_delta_Y_x_c_(0) = delta_est_x_c_0 + tmp_delta_M_x_c_(0) -
     $        tmp_delta_S_x_c_(0)
         tmp_delta_Y_x_c_(1) = delta_est_x_c_1 + tmp_delta_M_x_c_(1) -
     $        tmp_delta_S_x_c_(1)
         fix_delta_x_p_r = dsqrt(tmp_delta_Y_x_c_(0)**2 +
     $        tmp_delta_Y_x_c_(1)**2)
         call jbess(0.0d0,1,2.0d0*pi*half_diameter_k_c*fix_delta_x_p_r
     $        ,tmp_j0)
         call jbess(2.0d0,1,2.0d0*pi*half_diameter_k_c*fix_delta_x_p_r
     $        ,tmp_j2)
         fix_X0_(nw) = tmp_j0 + tmp_j2
         fix_SX0_(nw) = tmp_j0 + tmp_j2
     ...
     $        ,tmp_j0)
         call jbess(2.0d0,1,2.0d0*pi*half_diameter_k_c*fix_delta_x_p_r
     $        ,tmp_j2)
         fix_MX0_(nw) = tmp_j0 + tmp_j2
      enddo !do nw=0,quad_n_w_max-1
      if (verbose.gt.1) then
      call print_sub_c16(quad_n_w_max,fix_X0_,' fix_X0_: ')
      call print_sub_c16(quad_n_w_max,fix_SX0_,' fix_SX0_: ')
      call print_sub_c16(quad_n_w_max,fix_MX0_,' fix_MX0_: ')
      end if !if (verbose.gt.1) then
      write(6,'(A,F21.16)') ' fix_X0 vs quad_X0_: '
     $     ,fnod_c16_f(quad_n_w_max,fix_X0_,quad_X0_)
     $     /al2_c16_f(quad_n_w_max,fix_X0_)
c$$$      %%%%%%%%
      eps_svd = 1.0d-6
...
c$$$      %%%%%%%%
     ...
     $     '; fix_X0 vs quad_X2_: ',fnod_c16_f(quad_n_w_max,fix_X0_
     $     ,quad_X2_)/al2_c16_f(quad_n_w_max,fix_X0_)
c$$$      %%%%%%%%
     ...
     $     ,1)
      ...
      write(6,'(A,F8.6,A,F21.16)') ' eps_svd: ' , eps_svd ,
     $     '; fix_X0 vs quad_X3_: ',fnod_c16_f(quad_n_w_max,fix_X0_
     $     ,quad_X3_)/al2_c16_f(quad_n_w_max,fix_X0_)
      write(6,'(A,F8.6,A,F21.16)') ' eps_svd: ' , eps_svd ,
...
c$$$      %%%%%%%%
     ...
     $     '; n_svd_l: ' , n_svd_l , '; fix_X0 vs quad_X2_: '
     $     ,fnod_c16_f(quad_n_w_max,fix_X0_,quad_X2_)
     $     /al2_c16_f(quad_n_w_max,fix_X0_)         
      enddo !do neps_svd=0,n_eps_svd-1
c$$$      %%%%%%%%
      write(6,'(A)') ' Second: testing SxZTRM: '
      eps_svd = 1.0d-6
      call cl1_r8(n_svd_max,svd_r_)
      call cl1_r8(n_svd_max,svd_d_)
      call cl1_i4(n_svd_max,svd_l_)
...
c$$$      %%%%%%%%
     ...
     $        ,quad_P_N_k_q_,quad_weight_k_p_) / (pi*half_diameter_k_c
     $        **2)
     ...
     $     ,quad_MX1_)
      write(6,'(A,F21.16)') ' fix_SX0 vs quad_SX2_: '
     $     ,fnod_c16_f(quad_n_w_max,fix_SX0_,quad_SX2_)
     $     /al2_c16_f(quad_n_w_max,fix_SX0_)
      write(6,'(A,F21.16)') ' fix_MX0 vs quad_MX2_: '
     $     ,fnod_c16_f(quad_n_w_max,fix_MX0_,quad_MX2_)
     $     /al2_c16_f(quad_n_w_max,fix_MX0_)
c$$$      %%%%%%%%
     ...
     $        *n_gamma_z_nuf))**2
      ...
      allocate(tmp_Z_(0:1+max(n_gamma_z_upd,n_gamma_z_nuf)-1))
      call cs1_c16(max(n_gamma_z_upd,n_gamma_z_nuf),tmp_Z_)
      allocate(quad_CTF_R_S_0__(0:1+n_gamma_z_upd-1))
      call cs1_c16(n_gamma_z_upd,quad_CTF_R_S_0__)
      allocate(quad_CTF_R_S_1__(0:1+n_gamma_z_upd-1))
      call cs1_c16(n_gamma_z_upd,quad_CTF_R_S_1__)
      allocate(quad_Y_CTF_R_S_0__(0:1+n_gamma_z_upd-1))
      call cs1_c16(n_gamma_z_upd,quad_Y_CTF_R_S_0__)
      allocate(quad_Y_CTF_R_S_1__(0:1+n_gamma_z_upd-1))
      call cs1_c16(n_gamma_z_upd,quad_Y_CTF_R_S_1__)
      allocate(quad_Y_CTF_R_S_2__(0:1+n_gamma_z_nuf-1))
      call cs1_c16(n_gamma_z_nuf,quad_Y_CTF_R_S_2__)
      allocate(quad_Y_CTF_R_S_3__(0:1+n_gamma_z_nuf-1))
      call cs1_c16(n_gamma_z_nuf,quad_Y_CTF_R_S_3__)
c$$$      %%%%%%%%
      call ti8_build_CTF_R_S_quad_3(0,n_gamma_z_upd,gamma_z_upd_
     $     ,quad_fftw_plan_frwd_,quad_fftw_plan_back_,quad_fftw_0in_
     $     ,quad_fftw_out_,quad_n_r,quad_grid_k_p_r_,quad_weight_k_p_r_
     $     ,quad_n_w_,quad_n_A,quad_P_R_k_p_
     $     ,quad_P_R_k_q_,1,0,quad_n_A ,quad_P_S_k_p_,quad_P_T_k_p_
     $     ,quad_P_T_k_q_,1,quad_n_A ,quad_P_C_k_p_,quad_CTF_R_S_1__
     $     ,tmp_Z_)
      c16_alpha = dcmplx(1.0d0/dsqrt(2.0d0*pi*half_diameter_k_c**2)
     $     ,0.0d0)
      c16_beta = dcmplx(0.0d0,0.0d0); 
      call af1_c16(n_gamma_z_upd,c16_alpha,c16_beta
     $     ,quad_CTF_R_S_1__,quad_CTF_R_S_1__)
      do ngz=0,n_gamma_z_upd-1
         quad_CTF_R_S_0__(ngz) = dcmplx(1.0d0,0.0d0)
      enddo !do ngz=0,n_gamma_z_upd-1
      if (verbose.gt.1) then
         call print_sub_c16(n_gamma_z_upd,quad_CTF_R_S_1__,
     $        ' quad_CTF_R_S_1__: ')
         call print_sub_c16(n_gamma_z_upd,quad_CTF_R_S_0__,
     $        ' quad_CTF_R_S_0__: ')
      end if !if (verbose.gt.1) then
      write(6,'(A,F21.16)') ' quad_CTF_R_S_1__ vs quad_CTF_R_S_0__: '
     $     ,fnod_c16_f(n_gamma_z_upd,quad_CTF_R_S_1__,quad_CTF_R_S_0__)
     $     /al2_c16_f(n_gamma_z_upd,quad_CTF_R_S_0__)
c$$$      %%%%%%%%
      na=0
      do nr=0,quad_n_r-1
         tmp_k = quad_grid_k_p_r_(nr)
...
c$$$      %%%%%%%%
     ...
     $     ,quad_fftw_out_,quad_n_r,quad_grid_k_p_r_,quad_weight_k_p_r_
     $     ,quad_n_w_,quad_n_A,quad_P_R_k_p_
     $     ,quad_P_R_k_q_,1,0,quad_n_A ,quad_Y_S_k_p_,quad_P_T_k_p_
     $     ,quad_P_T_k_q_,1,quad_n_A ,quad_Y_C_k_p_,quad_Y_CTF_R_S_0__
     $     ,tmp_Z_)
      c16_alpha = dcmplx(1.0d0/dsqrt(2.0d0*pi*half_diameter_k_c**2)
     $     ,0.0d0)
      c16_beta = dcmplx(0.0d0,0.0d0); 
      call af1_c16(n_gamma_z_upd,c16_alpha,c16_beta
     $     ,quad_Y_CTF_R_S_0__,quad_Y_CTF_R_S_0__)
      if (verbose.gt.1) then
         call print_sub_c16(n_gamma_z_upd,quad_Y_CTF_R_S_0__,
     $        ' quad_Y_CTF_R_S_0__: ')
      end if !if (verbose.gt.1) then
      do ngz=0,n_gamma_z_upd-1
     ...
     $        ,quad_Y_R_k_p_)
         quad_Y_CTF_R_S_1__(ngz) = zsqrt(dotw_c16_f(quad_n_A
     $        ,quad_Y_R_k_p_,quad_Y_R_k_p_,quad_weight_k_p_) / (pi
     $        *half_diameter_k_c**2))
      enddo !do ngz=0,n_gamma_z_upd-1
      if (verbose.gt.1) then
         call print_sub_c16(n_gamma_z_upd,quad_Y_CTF_R_S_1__,
     $        ' quad_Y_CTF_R_S_1__: ')
      end if !if (verbose.gt.1) then
      write(6,'(A,F21.16)')
     $     ' fftw: quad_Y_CTF_R_S_1__ vs quad_Y_CTF_R_S_0__: '
     $     ,fnod_c16_f(n_gamma_z_upd,quad_Y_CTF_R_S_1__
     $     ,quad_Y_CTF_R_S_0__) /al2_c16_f(n_gamma_z_upd
     $     ,quad_Y_CTF_R_S_0__)
c$$$      %%%%%%%%
      call ti8_build_CTF_R_S_quad_3(0,n_gamma_z_nuf,gamma_z_nuf_
     $     ,quad_fftw_plan_frwd_,quad_fftw_plan_back_,quad_fftw_0in_
     $     ,quad_fftw_out_,quad_n_r,quad_grid_k_p_r_,quad_weight_k_p_r_
     $     ,quad_n_w_,quad_n_A,quad_P_R_k_p_
     $     ,quad_P_R_k_q_,1,0,quad_n_A ,quad_Y_S_k_p_,quad_P_T_k_p_
     $     ,quad_P_T_k_q_,1,quad_n_A ,quad_Y_C_k_p_,quad_Y_CTF_R_S_2__
     $     ,tmp_Z_)
      c16_alpha = dcmplx(1.0d0/dsqrt(2.0d0*pi*half_diameter_k_c**2)
     $     ,0.0d0)
      c16_beta = dcmplx(0.0d0,0.0d0); 
      call af1_c16(n_gamma_z_nuf,c16_alpha,c16_beta
     $     ,quad_Y_CTF_R_S_2__,quad_Y_CTF_R_S_2__)
      if (verbose.gt.1) then
         call print_sub_c16(n_gamma_z_nuf,quad_Y_CTF_R_S_2__,
     $        ' quad_Y_CTF_R_S_2__: ')
      end if !if (verbose.gt.1) then
      do ngz=0,n_gamma_z_nuf-1
     ...
     $        ,quad_fftw_out_,quad_Y_S_k_p_,+gamma_z_upd,quad_Y_T_k_p_)
         call xc1_c16(quad_n_A,quad_Y_T_k_p_,quad_Y_C_k_p_
     $        ,quad_Y_R_k_p_)
         quad_Y_CTF_R_S_3__(ngz) = zsqrt(dotw_c16_f(quad_n_A
     $        ,quad_Y_R_k_p_,quad_Y_R_k_p_,quad_weight_k_p_) / (pi
     $        *half_diameter_k_c**2))
      enddo !do ngz=0,n_gamma_z_nuf-1
      if (verbose.gt.1) then
         call print_sub_c16(n_gamma_z_nuf,quad_Y_CTF_R_S_3__,
     $        ' quad_Y_CTF_R_S_3__: ')
      end if !if (verbose.gt.1) then
      write(6,'(A,F21.16)')
     $     ' finufft: quad_Y_CTF_R_S_3__ vs quad_Y_CTF_R_S_2__: '
     $     ,fnod_c16_f(n_gamma_z_nuf,quad_Y_CTF_R_S_3__
     $     ,quad_Y_CTF_R_S_2__) /al2_c16_f(n_gamma_z_nuf
     $     ,quad_Y_CTF_R_S_2__)
c$$$      %%%%%%%%

c$$$      %%%%%%%%
      flag_memory_checkset = .true.
      call cxs_r8(n_x_c_0,grid_x_c_0_,',grid_x_c_0_'
     $     ,flag_memory_checkset)
      call cxs_r8(n_x_c_1,grid_x_c_1_,',grid_x_c_1_'
     $     ,flag_memory_checkset)
      call cxs_r8(n_x_c_0*n_x_c_1,grid_x_p_r_,',grid_x_p_r_'
     $     ,flag_memory_checkset)
      call cxs_r8(n_x_c_0*n_x_c_1,grid_x_p_w_,',grid_x_p_w_'
     $     ,flag_memory_checkset)
      call cxs_c16(n_x_c_0*n_x_c_1,S_x_c_,',S_x_c_'
     $     ,flag_memory_checkset)
      call cxs_c16(n_x_c_0*n_x_c_1,M_x_c_,',M_x_c_'
     $     ,flag_memory_checkset)
      call cxs_r8(n_x_c_0,grid_k_c_0_,',grid_k_c_0_'
     $     ,flag_memory_checkset)
      call cxs_r8(n_x_c_1,grid_k_c_1_,',grid_k_c_1_'
     $     ,flag_memory_checkset)
      ...
      call cxs_r8(n_A,grid_k_p_1_,',grid_k_p_1_',flag_memory_checkset)
      call cxs_r8(n_A,grid_k_p_2_,',grid_k_p_2_',flag_memory_checkset)
      call cxs_r8(n_A,weight_k_p_,',weight_k_p_',flag_memory_checkset)
      call cxs_i8(n_r,fftw_plan_frwd_,',fftw_plan_frwd_'
     $     ,flag_memory_checkset)
      call cxs_i8(n_r,fftw_plan_back_,',fftw_plan_back_'
     $     ,flag_memory_checkset)
      call cxs_c16(n_A,fftw_0in_,',fftw_0in_',flag_memory_checkset)
      call cxs_c16(n_A,fftw_out_,',fftw_out_',flag_memory_checkset)
      call cxs_c16(n_A,S_k_p_,',S_k_p_',flag_memory_checkset)
      call cxs_c16(n_A,S_k_q_,',S_k_q_',flag_memory_checkset)
      call cxs_c16(n_A,M_k_p_,',M_k_p_',flag_memory_checkset)
      call cxs_c16(n_A,M_k_q_,',M_k_q_',flag_memory_checkset)
      call cxs_c16(n_A,T_k_p_,',T_k_p_',flag_memory_checkset)
      call cxs_c16(n_w_max,X0_,',X0_',flag_memory_checkset)
      call cxs_c16(n_w_max,X1_,',X1_',flag_memory_checkset)
     ...
     $     ,flag_memory_checkset)
      call cxs_r8(quad_n_A,quad_grid_k_p_2_,'quad_grid_k_p_2_'
     $     ,flag_memory_checkset)
     ...
     $     ,flag_memory_checkset)
      call cxs_c16(n_A,P_k_p_,'P_k_p_'
     $     ,flag_memory_checkset)
     ...
     $     ,flag_memory_checkset)
      call cxs_c16(quad_n_w_max,fix_X0_,',fix_X0_'
     $     ,flag_memory_checkset)
      call cxs_c16(quad_n_w_max,fix_SX0_,',fix_SX0_'
     $     ,flag_memory_checkset)
      call cxs_c16(quad_n_w_max,fix_MX0_,',fix_MX0_'
     $     ,flag_memory_checkset)
     ...
     $     ,flag_memory_checkset)
      call cxs_c16(max(n_gamma_z_upd,n_gamma_z_nuf),tmp_Z_,'tmp_Z_'
     $     ,flag_memory_checkset)
      call cxs_c16(n_gamma_z_upd,quad_CTF_R_S_0__,'quad_CTF_R_S_0__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_gamma_z_upd,quad_CTF_R_S_1__,'quad_CTF_R_S_1__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_gamma_z_upd,quad_Y_CTF_R_S_0__,'quad_Y_CTF_R_S_0__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_gamma_z_upd,quad_Y_CTF_R_S_1__,'quad_Y_CTF_R_S_1__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_gamma_z_nuf,quad_Y_CTF_R_S_2__,'quad_Y_CTF_R_S_2__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_gamma_z_nuf,quad_Y_CTF_R_S_3__,'quad_Y_CTF_R_S_3__'
     $     ,flag_memory_checkset)
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished innerproduct_k_q_stretch_0_dr]'
      end if !if (verbose.gt.0) then
      stop
      end !driver. ;
