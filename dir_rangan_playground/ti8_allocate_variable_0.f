...
c$$$      indices
     ...
     $           ' = n_svd_l = ' , n_svd_l
      ...
      allocate(S_p_omp__(0:1+n_A*n_omp_sub_0in-1))
      call cs1_c16(n_A*n_omp_sub_0in,S_p_omp__)
      allocate(S_q_omp__(0:1+n_A*n_omp_sub_0in-1))
      call cs1_c16(n_A*n_omp_sub_0in,S_q_omp__)
      allocate(M_p_(0:1+n_A-1))
      call cs1_c16(n_A,M_p_)
      allocate(M_q_(0:1+n_A-1))
      call cs1_c16(n_A,M_q_)
      allocate(M_p_omp__(0:1+n_A*n_omp_sub_0in-1))
      call cs1_c16(n_A*n_omp_sub_0in,M_p_omp__)
      allocate(M_q_omp__(0:1+n_A*n_omp_sub_0in-1))
      call cs1_c16(n_A*n_omp_sub_0in,M_q_omp__)
      allocate(CTF_p_(0:1+n_A-1))
      call cs1_c16(n_A,CTF_p_)
      allocate(CTF_q_(0:1+n_A-1))
      call cs1_c16(n_A,CTF_q_)
      allocate(CTF_p_omp__(0:1+n_A*n_omp_sub_0in-1))
      call cs1_c16(n_A*n_omp_sub_0in,CTF_p_omp__)
      allocate(CTF_q_omp__(0:1+n_A*n_omp_sub_0in-1))
      call cs1_c16(n_A*n_omp_sub_0in,CTF_q_omp__)
      allocate(Z_p_(0:1+n_A-1))
      call cs1_c16(n_A,Z_p_)
      allocate(Z_q_(0:1+n_A-1))
      call cs1_c16(n_A,Z_q_)
      allocate(Z_p_omp__(0:1+n_A*n_omp_sub_0in-1))
      call cs1_c16(n_A*n_omp_sub_0in,Z_p_omp__)
      allocate(Z_q_omp__(0:1+n_A*n_omp_sub_0in-1))
      call cs1_c16(n_A*n_omp_sub_0in,Z_q_omp__)
