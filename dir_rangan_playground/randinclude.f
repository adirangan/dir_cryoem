!> Doxygen comment: ;\n
!> Randomly choose n_add elements which have not yet been flgged within S_used_, ;\n
!> and add those elements to the list LT_. ;\n
      subroutine randinclude(n_LT,LT_,n_S,S_used_,S_used_total,n_add)
      implicit none
