...
!> Defines variables assuming preallocation (i.e., without allocating). ;\n
      ...
      real *8 weight_k_p_r_(0:0) !real *8 array (length at least n_k_cur): weights for radial quadrature. ;
      real *8 weight_k_p_(0:0) !real *8 array (length at least n_A_cur): all weights (unrolled) for quadrature, for use with k_p coordinates. ;
...
c$$$      include './dir_gen_Jsvd_6/Jsvd_var_allocation_0on_0.f'
      include './dir_gen_Jsvd_6/Jsvd_var_allocation_off_0.f'
      integer *4 n_svd_max
