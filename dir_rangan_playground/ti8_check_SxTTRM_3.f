...
c$$$      %%%%%%%%%%%%%%%%%%%%%%%
      ...
      if (verbose.gt.-1) then
         ...
         call print_sub_c16(n_w_sum,S_p__(ld_S*ns),' S_p_0in_: ')
         call print_sub_c16(n_w_sum,M_p__(ld_M*nm),' M_p_0in_: ')
         call print_sub_c16(n_w_sum,
     $        CTF_p__(ld_CTF*nctf),' CTF_p_0in_: ')
      end if                    !if (verbose.gt.1) then
      call test_innerproduct_bruteforce_quad_1(2,n_r ,grid_p_ ,weight_p_
     $     ,n_w_,0.5d0 ,S_p__(ld_S*ns),M_p__(ld_M*nm) ,CTF_p__(ld_CTF
     $     *nctf) ,delta_x_est_(nm) ,delta_y_est_(nm) ,gamma_z_est_(nm)
     $     ,n_delta_v ,delta_x_ ,delta_y_,n_gamma_z ,gamma_z_)
...
c$$$         call print_sub_c16(n_w_sum,S_p_,' S_p_: ')
...
c$$$         call print_sub_c16(n_w_sum,M_p_,' M_p_: ')
c$$$         call print_sub_c16(n_w_sum,CTF_p__(nctf*ld_CTF),' CTF_p_: ')
