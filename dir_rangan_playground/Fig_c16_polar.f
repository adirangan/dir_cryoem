...
!> Uses fig2dev to convert to jpeg. ;\n
     ...
     $              *pi)
            ...
            if (nt.lt.n_t_(nr)-1) then
               ...
               tval_pos = 0.5*(tvals_(na-n_t_(nr)+1) + 2.0d0*pi +
     $              tvals_(na))
            end if
