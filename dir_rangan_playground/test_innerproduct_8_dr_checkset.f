      if (verbose.gt.1) then
         write(6,'(A)') '[entering test_innerproduct_8_dr_checkset]'
      ...
      call cxs_c16(n_A,T0_k_p_,'T0_k_p_',flag_memory_checkset)
      call cxs_c16(n_A,T1_k_p_,'T1_k_p_',flag_memory_checkset)
      call cxs_c16(n_A,T2_k_p_,'T2_k_p_',flag_memory_checkset)
      call cxs_c16(n_A,T3_k_p_,'T3_k_p_',flag_memory_checkset)
     ...
     $     ,flag_memory_checkset)
      call cxs_c16(n_A*n_S_max,S_x_p__,'S_x_p__',flag_memory_checkset)
      call cxs_c16(2*n_r*2*n_r*n_S_max,S_k_c__,'S_k_c__'
     $     ,flag_memory_checkset)
      call cxs_c16(n_A*n_S_max,S_k_p__,'S_k_p__',flag_memory_checkset)
      call cxs_c16(n_A*n_S_max,S_k_q__,'S_k_q__',flag_memory_checkset)
     ...
     $     ,flag_memory_checkset)
      call cxs_c16(n_A*n_M_max,N_k_p__,'N_k_p__',flag_memory_checkset)
      call cxs_c16(n_A*n_M_max,N_k_q__,'N_k_q__',flag_memory_checkset)
      ...
      call cxs_c16(n_ctf*n_A,CTF_k_p__,'CTF_k_p__',flag_memory_checkset)
     ...
     $     ,flag_memory_checkset)
      call cxs_c16(n_A*n_M_max,M_k_p__,'M_k_p__',flag_memory_checkset)
