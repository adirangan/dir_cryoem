...
corr_a_k_Y_true = tmp_.corr_a_k_Y_(end);
...
plot(real(tmp_M_.corr_a_k_Y_),real(tmp_N_.corr_a_k_Y_),'o-',[0,1],[0,1],'k-'); 
xlim([0,1]);ylim([0,1]);
axis square; xlabel('M corr'); ylabel('N corr'); title('corr_a_k_Y_','Interpreter','none');
subplot(1,2,1+ns);ns=ns+1;
