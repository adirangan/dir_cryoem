...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_8_a_k_p_quad_.mat',dir_trunk);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_a_k_p_quad_',dir_trunk);
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_8_b_x_u_reco__.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_b_x_u_reco__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_8_a_k_Y_quad_.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
l_max_upb = 36;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_a_k_Y_quad_A',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_a_k_Y_quad_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_8_S_k_p__.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_S_k_p__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_S_k_p__A',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
nk_p_r = 12;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_8_CTF_k_p__.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_CTF_k_p__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_CTF_k_p_r_xxxx__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_8_X_%s.mat',dir_trunk,str_cost);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
...
[X_,X_weight_r_] = principled_marching_cost_matrix_3(n_k_p_r,tmp_weight_k_p_r_,l_max_max,a_k_Y_quad__,tmp_CTF__); 
%%%%%%%%;
...
a_UX_Y_quad__(1:tmp_n_lm,1+nUX_rank) = a_UX_Y_quad__(1:tmp_n_lm,1+nUX_rank) + UX_(1+nk_p_r,1+nUX_rank)*X_weight_r_(1+nk_p_r)*a_k_Y_quad_(1+tmp_ij_)*CTF_avg_k_p_r_(1+nk_p_r); %<-- use average CTF here, under the assumption that a_UX_Y_quad_ will be used alone. ;
end;%for nk_p_r=0:n_k_p_r-1;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_X_%s_A',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_X_%s_B',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
%%%%%%%%;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_8_UX_%s_S_CTF_k_p___.mat',dir_trunk,str_cost);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_UX_%s_S_CTF_k_p___',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_UX_%s_S_CTF_k_q___',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_UX_%s_S_CTF_k_q___spectrum',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
n_plot=6;
for nplot=0:n_plot-1;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_UX_%s_S_CTF_k_p___A',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_8_M_x_c___.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_euler_angle_marina_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_delta_read_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_M_x_c___center_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
N_x_c___ = M_x_c___;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_M_x_c___sample',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_8_UX_%s_M_k_p___.mat',dir_trunk,str_combine);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
tmp_UX_M_k_p_ = tmp_UX_M_k_p_ + UX_(1+nk_p_r,1+nUX_rank)*X_weight_r_(1+nk_p_r)*CTF_factor*tmp_M_k_p__(:,1+nk_p_r);
end;%for nk_p_r=0:n_k_p_r-1;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_UX_%s_M_k_p___',dir_trunk,str_combine);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_UX_%s_M_k_q___',dir_trunk,str_combine);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_UX_%s_M_k_q___spectrum',dir_trunk,str_combine);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_8_c_k_Y_.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
tmp_t = tic;
c_k_Y_reco_ = cg_lsq_3(tmp_n_order,n_k_p_r,l_max_,n_w_,tmp_n_M,M_k_p__,CTF_idx_,CTF_k_p__,tmp_euler_polar_a_,tmp_euler_azimu_b_,tmp_euler_gamma_z_);
tmp_t = toc(tmp_t); disp(sprintf(' %% M_k_p__ --> c_k_Y_reco_ time %0.2fs',tmp_t));
[tmp_X_best_orig,~,~,~,~,~,~] = register_spharm_to_spharm_wigner_0(n_k_p_r,k_p_r_,k_p_r_max,weight_k_p_r_,0,l_max_,a_k_Y_quad_,c_k_Y_reco_);
[tmp_X_best_flip,~,~,~,~,~,~] = register_spharm_to_spharm_wigner_0(n_k_p_r,k_p_r_,k_p_r_max,weight_k_p_r_,0,l_max_,a_k_Y_quad_,flipY(n_k_p_r,l_max_,c_k_Y_reco_));
X_best_reco = max(tmp_X_best_orig,tmp_X_best_flip);
disp(sprintf(' %% X_best_reco %0.3f',X_best_reco));
%%%%%%%%;
tmp_t = tic;
[c_k_p_reco_] = convert_spharm_to_k_p_1(verbose,n_k_all,n_k_all_csum_,k_p_r_all_,k_p_azimu_b_all_,k_p_polar_a_all_,weight_k_all_,weight_shell_k_,n_k_p_r,k_p_r_,weight_k_p_r_,l_max_,c_k_Y_reco_);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_8_c_x_u_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
[tmp_X_best_orig,~,~,~,~,~,~] = register_spharm_to_spharm_wigner_0(n_k_p_r,k_p_r_,k_p_r_max,weight_k_p_r_,0,l_max_,a_k_Y_quad_,tmp_d_k_Y_reco_);
[tmp_X_best_flip,~,~,~,~,~,~] = register_spharm_to_spharm_wigner_0(n_k_p_r,k_p_r_,k_p_r_max,weight_k_p_r_,0,l_max_,a_k_Y_quad_,flipY(n_k_p_r,l_max_,tmp_d_k_Y_reco_));
X_best_MS = max(tmp_X_best_orig,tmp_X_best_flip);
%%%%%%%%;
flag_MS_vs_SM = 0; f_rand = 0.05;
[dat_X_best_allshell_SM_,~,euler_polar_a_SM__,euler_azimu_b_SM__,euler_gamma_z_SM__] = am_2(tmp_rseed,tmp_n_iteration,tmp_n_iteration_register,tmp_viewing_k_eq_d,tmp_n_order,tmp_n_k_p_r,tmp_k_p_r_,tmp_k_p_r_max,tmp_weight_k_p_r_,tmp_weight_2d_k_p_r_,tmp_n_w_,dat_n_M,tmp_M_k_p__,tmp_M_k_q__,1,ones(tmp_n_w_sum,1),tmp_l_max_,tmp_a_k_Y_quad_,euler_polar_a_MS__(:,end),euler_azimu_b_MS__(:,end),euler_gamma_z_MS__(:,end),flag_MS_vs_SM,f_rand);
%%%%%%%%;
tmp_n_order = 5; tmp_n_M = n_image_sub;
...
%%%%%%%%;
tmp_R_k_q_ = transf_svd_q_to_q_FTK_5(FTK,n_k_p_r,2*pi*k_p_r_,n_w_,n_w_sum,tmp_S_k_q_,tmp_delta_(1+0),tmp_delta_(1+1));
...
tmp_T_k_q_ = transf_svd_q_to_q_FTK_5(FTK,n_k_p_r,2*pi*k_p_r_,n_w_,n_w_sum,tmp_M_k_q_,tmp_delta__(1+0,1+ndelta_v),tmp_delta__(1+1,1+ndelta_v));
...
tpmham_experimental_4(dat_infix,dat_rseed,dat_n_M,UX_M_k_p___,UX_M_k_q___,dat_n_UX_rank,dat_n_iteration,dat_n_order,dir_trunk,n_k_p_r,n_w_,l_max_,a_UX_Y_quad__);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/tpmham_experimental_4_UX_%s_Y_n%.3d_dat_X_best_singlepc____',dir_trunk,dat_infix,dat_n_M);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
% Collect output. ;
%%%%%%%%;
dat_X_best_allshell___ = zeros(dat_n_iteration,dat_n_UX_rank,n_dat_rseed);
flag_dat_X_best_allshell___ = zeros(dat_n_iteration,dat_n_UX_rank,n_dat_rseed);
for ndat_rseed=0:n_dat_rseed-1;
dat_rseed = dat_rseed_(1+ndat_rseed);
for nUX_rank=0:dat_n_UX_rank-1;
...
if ( exist(fname_mat,'file'));
tmp_ = load(fname_mat);
dat_X_best_allshell___(:,1+nUX_rank,1+ndat_rseed) = tmp_.dat_X_best_allshell_(:);
flag_dat_X_best_allshell___(:,1+nUX_rank,1+ndat_rseed) = 1;
clear tmp_;
end;%if ( exist(fname_mat,'file'));
end;%for nUX_rank=0:dat_n_UX_rank-1;
end;%for ndat_rseed=0:n_dat_rseed-1;
%%%%%%%%;
dat_X_best_allshell_SM___ = zeros(dat_n_iteration,dat_n_UX_rank,n_dat_rseed);
flag_dat_X_best_allshell_SM___ = zeros(dat_n_iteration,dat_n_UX_rank,n_dat_rseed);
for ndat_rseed=0:n_dat_rseed-1;
dat_rseed = dat_rseed_(1+ndat_rseed);
for nUX_rank=0:dat_n_UX_rank-1;
fname_pre = sprintf('%s_mat/tpmham_experimental_4_UX_%s_Y_n%.3d_allshell_SM_rng%.3dnUX%.3d',dir_trunk,dat_infix,dat_n_M,dat_rseed,nUX_rank);
fname_mat = sprintf('%s.mat',fname_pre);
if ( exist(fname_mat,'file'));
tmp_SM_ = load(fname_mat);
dat_X_best_allshell_SM___(:,1+nUX_rank,1+ndat_rseed) = tmp_SM_.dat_X_best_allshell_SM_(:);
flag_dat_X_best_allshell_SM___(:,1+nUX_rank,1+ndat_rseed) = 1;
clear tmp_SM_;
end;%if ( exist(fname_mat,'file'));
end;%for nUX_rank=0:dat_n_UX_rank-1;
end;%for ndat_rseed=0:n_dat_rseed-1;
%%%%%%%%;
fname_fig = sprintf('%s_jpg/tpmham_experimental_4_UX_%s_Y_n%.3d_dat_X_best_allshell_SM___',dir_trunk,dat_infix,dat_n_M);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%%%%%;
clf;
...
for nUX_rank=0:dat_n_UX_rank-1;
nc = max(0,min(n_c-1,floor(n_c*nUX_rank/dat_n_UX_rank)));
tmp_X_ = squeeze(dat_X_best_allshell___(:,1+nUX_rank,:));
tmp_F_ = squeeze(flag_dat_X_best_allshell___(:,1+nUX_rank,:));
tmp_ij_ = find(sum(tmp_F_,1));
if (numel(tmp_ij_)>0);
plot(0:dat_n_iteration-1,tmp_X_(:,tmp_ij_),'o-','Color',c_(1+nc,:),'LineWidth',2,'MarkerFaceColor',c_(1+nc,:),'MarkerEdgeColor','k');
end;%if (numel(tmp_ij_)>0);
tmp_X_SM_ = squeeze(dat_X_best_allshell_SM___(:,1+nUX_rank,:));
tmp_F_SM_ = squeeze(flag_dat_X_best_allshell_SM___(:,1+nUX_rank,:));
tmp_ij_SM_ = find(sum(tmp_F_SM_,1));
if (numel(tmp_ij_SM_)>0);
plot(dat_n_iteration + (0:dat_n_iteration-1),tmp_X_SM_(:,tmp_ij_SM_),'o-','Color',c_(1+nc,:),'LineWidth',2,'MarkerFaceColor',c_(1+nc,:),'MarkerEdgeColor','k');
end;%if (numel(tmp_ij_SM_)>0);
end;%for nUX_rank=0:dat_n_UX_rank-1;
plot(0:2*dat_n_iteration-1,X_best_reco*ones(1,2*dat_n_iteration),'k-');
plot((dat_n_iteration-0.5)*[1,1],[-1,1],'k-');
%legend(num2str(0:dat_n_UX_rank-1),'Location','NorthWest');
xlim([0,2*dat_n_iteration-1]); ylim([-0.125,1.000]);
xlabel('Phase-1 iteration <--> Phase-2 iteration');
ylabel(sprintf('correlation with a_UX_Y_quad__(:,:)'),'Interpreter','none');
grid on;
figbig;
disp(sprintf(' %% writing %s',fname_fig));
...
clf;
subplot(1,1,1);
tmp_X___ = -ones(n_dat_rseed+1,dat_n_UX_rank,2*dat_n_iteration);
tmp_X___(1:n_dat_rseed,:,0*dat_n_iteration + (1:dat_n_iteration)) = permute(dat_X_best_allshell___,[3,2,1]);
tmp_X___(1:n_dat_rseed,:,1*dat_n_iteration + (1:dat_n_iteration)) = permute(dat_X_best_allshell_SM___,[3,2,1]);
tmp_X__ = reshape(tmp_X___,[(n_dat_rseed+1)*dat_n_UX_rank,2*dat_n_iteration]);
tmp_str_niteration_=cell(2*dat_n_iteration,1);
na=0;
for niteration=0:dat_n_iteration-1;
tmp_str_niteration_{1+na} = sprintf('%s: %d','Phase 1',niteration);
na=na+1;
end;%for niteration=0:dat_n_iteration-1;
for niteration=0:dat_n_iteration-1;
tmp_str_niteration_{1+na} = sprintf('%s: %d','Phase 2',niteration);
na=na+1;
end;%for niteration=0:dat_n_iteration-1;
tmp_str_trial_ = cell(n_dat_rseed*dat_n_UX_rank,1);
na=0;
for nUX_rank=0:dat_n_UX_rank-1;
for ndat_rseed=0:n_dat_rseed-0;
if (ndat_rseed< n_dat_rseed); tmp_str_trial_{1+na} = sprintf('r%.2d: s%.2d',nUX_rank,ndat_rseed); end;
if (ndat_rseed==n_dat_rseed); tmp_str_trial_{1+na} = sprintf(' '); end;
na=na+1;
end;%for ndat_rseed=0:n_dat_rseed-0;
end;%for nUX_rank=0:dat_n_UX_rank-1;
c_ = colormap_beach(); n_c = size(c_,1); c_(1,:) = [1,1,1]; colormap(c_);
imagesc(transpose(tmp_X__),[0,1]);
set(gca,'XTick',1:(n_dat_rseed+1)*dat_n_UX_rank,'XTickLabel',tmp_str_trial_); xtickangle(90);
set(gca,'YTick',0:2*dat_n_iteration-1,'YTickLabel',tmp_str_niteration_);
set(gca,'TickLength',[0,0]);
xlabel('experimental trial (rank:seed)');
ylabel('Phase-2 iteration <-- Phase-1 iteration');
title(sprintf('correlation with a_k_Y_quad_'),'Interpreter','none');
set(gca,'FontSize',7);
figbig;
disp(sprintf(' %% writing %s_A',fname_fig));
print('-djpeg',sprintf('%s_A.jpg',fname_fig));
print('-depsc',sprintf('%s_A.eps',fname_fig));
%%%%%%%%;
end;%if (~exist(sprintf('%s.jpg',fname_fig),'file'));
if ( exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s found, not creating',fname_fig));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/tpmham_synthetic_4_UX_%s_Y_n%.3dsxxxrxxx_syn_X_best_singlepc____',dir_trunk,syn_infix,syn_n_M);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
c_ = colormap_beach(); n_c = size(c_,1); %c_ = diag(0.85 + 0.15*transpose(linspace(-1,+1,n_c)).^2) * c_;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/tpmham_synthetic_4_UX_%s_Y_n%.3dsxxxrxxx_syn_X_best_allshell____',dir_trunk,syn_infix,syn_n_M);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
c_ = colormap_beach(); n_c = size(c_,1); %c_ = diag(0.85 + 0.15*transpose(linspace(-1,+1,n_c)).^2) * c_;
...
%{
%%%%%%%%;
% Now determine the d_k_Y_reco_ reconstruction using the principle-marching values. ;
%%%%%%%%;
fname_mat = sprintf('%s_mat/tpmham_experimental_4_UX_%s_Y_n%.3d_allshell_rngxxxnUXxxx.mat',dir_trunk,dat_infix,dat_n_M);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
fname_m = sprintf('%s_mat/tpmham_experimental_4_UX_%s_Y_n%.3d_allshell_rngxxxnUXxxx.m',dir_trunk,dat_infix,dat_n_M);
tmp_str = sprintf('dat_X_reco_allshell___ = zeros(1,%d,%d);',n_dat_rseed,dat_n_UX_rank);
fp = fopen(fname_m,'a'); fprintf(fp,'%s\n',tmp_str); fclose(fp);
disp(tmp_str);
%dat_X_reco_allshell___ = zeros(dat_n_iteration,dat_n_UX_rank,n_dat_rseed);
%flag_dat_X_reco_allshell___ = zeros(dat_n_iteration,dat_n_UX_rank,n_dat_rseed);
dat_X_reco_allshell___ = zeros(1,dat_n_UX_rank,n_dat_rseed);
flag_dat_X_reco_allshell___ = zeros(1,dat_n_UX_rank,n_dat_rseed);
for ndat_rseed=0:n_dat_rseed-1;
dat_rseed = dat_rseed_(1+ndat_rseed);
for nUX_rank=0:dat_n_UX_rank-1;
fname_pre = sprintf('%s_mat/tpmham_experimental_4_UX_%s_Y_n%.3d_allshell_rng%.3dnUX%.3d',dir_trunk,dat_infix,dat_n_M,dat_rseed,nUX_rank);
tmp_fname_mat = sprintf('%s.mat',fname_pre);
if ( exist(tmp_fname_mat,'file'));
tmp_ = load(tmp_fname_mat);
%%%%%%%%;
tmp_n_order = 5; tmp_n_M = n_image_sub;
tmp_euler_polar_a_ = +tmp_.euler_polar_a__(:,end); tmp_euler_azimu_b_ = +tmp_.euler_azimu_b__(:,end); tmp_euler_gamma_z_ = +tmp_.euler_gamma_z__(:,end);
%%%%%%%%;
tmp_t = tic;
d_k_Y_reco_ = cg_lsq_3(tmp_n_order,n_k_p_r,l_max_,n_w_,tmp_n_M,M_k_p__,CTF_idx_,CTF_k_p__,tmp_euler_polar_a_,tmp_euler_azimu_b_,tmp_euler_gamma_z_);
tmp_t = toc(tmp_t); disp(sprintf(' %% M_k_p__ --> d_k_Y_reco_ time %0.2fs',tmp_t));
%{
%%%%%%%%;
tmp_t = tic;
[d_k_p_reco_] = convert_spharm_to_k_p_1(verbose,n_k_all,n_k_all_csum_,k_p_r_all_,k_p_azimu_b_all_,k_p_polar_a_all_,weight_k_all_,weight_shell_k_,n_k_p_r,k_p_r_,weight_k_p_r_,l_max_,d_k_Y_reco_);
tmp_t = toc(tmp_t); disp(sprintf(' %% d_k_Y_reco_ --> d_k_p_reco_ time %0.2fs',tmp_t));
%%%%%%%%;
tmp_t = tic;
eta = pi/k_p_r_max; 
d_x_u_reco_ = nufft3d3(n_k_all,2*pi*k_c_0_all_*eta,2*pi*k_c_1_all_*eta,2*pi*k_c_2_all_*eta,d_k_p_reco_.*(2*pi)^3.*weight_k_all_,+1,1e-12,n_X_u,X_u_0_(:)/eta,X_u_1_(:)/eta,X_u_2_(:)/eta)/sqrt(2*pi)/sqrt(2*pi)/sqrt(2*pi);
tmp_t = toc(tmp_t); disp(sprintf(' %% nufft3d3: d_x_u_reco_ time %0.2fs',tmp_t));
%%%%%%%%;
 %}
[tmp_X_best_orig,~,~,~,~,~,~] = register_spharm_to_spharm_wigner_0(n_k_p_r,k_p_r_,k_p_r_max,weight_k_p_r_,0,l_max_,a_k_Y_quad_,d_k_Y_reco_);
[tmp_X_best_flip,~,~,~,~,~,~] = register_spharm_to_spharm_wigner_0(n_k_p_r,k_p_r_,k_p_r_max,weight_k_p_r_,0,l_max_,a_k_Y_quad_,flipY(n_k_p_r,l_max_,d_k_Y_reco_));
tmp_X_best = max(tmp_X_best_orig,tmp_X_best_flip);
tmp_str = sprintf('dat_X_reco_allshell___(1,1+%d,1+%d) = %0.16f;',ndat_rseed,nUX_rank,tmp_X_best);
fp = fopen(fname_m,'a'); fprintf(fp,'%s\n',tmp_str); fclose(fp);
disp(tmp_str);
dat_X_reco_allshell___(1,1+nUX_rank,1+ndat_rseed) = tmp_X_best;
flag_dat_X_reco_allshell___(1,1+nUX_rank,1+ndat_rseed) = 1;
end;%if ( exist(tmp_fname_mat,'file'));
end;%for nUX_rank=0:dat_n_UX_rank-1;
end;%for ndat_rseed=0:n_dat_rseed-1;
%%%%%%%%;
save(fname_mat ...
     ,'dat_X_reco_allshell___' ...
     ,'flag_dat_X_reco_allshell___' ...
     );
end;%if (~exist(fname_mat,'file'));
if ( exist(fname_mat,'file'));
disp(sprintf(' %% %s found, not creating',fname_mat));
