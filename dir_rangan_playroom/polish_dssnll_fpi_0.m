...
if (flag_verbose>0); disp(sprintf( '%% niteration %d/%d: ssnll_q2d %0.2f G_fnorm_iter %0.2f [%0.2f,%0.2f,%0.2f,%0.2f] flag_continue %d',niteration,n_iteration,ssnll_q2d,G_fnorm_iter,tmp_G_fnorm_dvol,tmp_G_fnorm_a,tmp_G_fnorm_b,tmp_G_fnorm_c,flag_continue)); end;
