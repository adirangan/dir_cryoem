...
euler_sub_ = [-viewing_gamma_z_sub,viewing_polar_a_sub,viewing_azimu_b_sub];
R_sub__ = euler_to_R_0(euler_sub_);
R_rot__ = transpose(R_use__)*R_sub__;
euler_rot_ = R_to_euler_0(R_rot__);
viewing_gamma_z_rot = euler_rot_(1+0); viewing_polar_a_rot = euler_rot_(1+1); viewing_azimu_b_rot = euler_rot_(1+2);
viewing_R_polar_a_S_(1+nS) = +viewing_polar_a_rot;
viewing_R_azimu_b_S_(1+nS) = +viewing_azimu_b_rot;
viewing_R_gamma_z_S_(1+nS) = -viewing_gamma_z_rot;
end;%for nS=0:n_S-1;
