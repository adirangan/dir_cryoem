...
tmp_cg_ = (shadow_offset + (1-shadow_offset)*0).^shadow_gamma*[1,1,1];
...
%%%%;
template_viewing_pole_3_ = k_p_r_max_use*Rz(+template_viewing_azimu_b)*Ry(+template_viewing_polar_a)*[0;0;1];
plot3([0;template_viewing_pole_3_(1+0)],[0;template_viewing_pole_3_(1+1)],[0;template_viewing_pole_3_(1+2)],'k-','LineWidth',3);
plot3( +1*k_p_r_max_use + [0;0*template_viewing_pole_3_(1+0)],[0;template_viewing_pole_3_(1+1)],[0;template_viewing_pole_3_(1+2)],'-','LineWidth',2,'Color',tmp_cg_);
plot3( [0;template_viewing_pole_3_(1+0)],+1*k_p_r_max_use + [0;0*template_viewing_pole_3_(1+1)],[0;template_viewing_pole_3_(1+2)],'-','LineWidth',2,'Color',tmp_cg_);
plot3( [0;template_viewing_pole_3_(1+0)],[0;template_viewing_pole_3_(1+1)],-1*k_p_r_max_use + [0;0*template_viewing_pole_3_(1+2)],'-','LineWidth',2,'Color',tmp_cg_);
