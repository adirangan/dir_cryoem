...
str_thisfunction = 'sphere_post__0';
...
inplane_z_dilation = @(point_pole_predilated_polar_a,point_pole_predilated_azimu_b) inplane_z_dilated_amplitude*sin(1*point_pole_predilated_azimu_b)*cos(point_pole_predilated_polar_a);
...
[tmp_x_,tmp_y_,tmp_z_] = sphere(64); 
surf(tmp_x_,tmp_y_,tmp_z_,0*tmp_z_,'LineStyle','none');
colormap('gray');
hold off;
xlabel('x0');
ylabel('x1');
