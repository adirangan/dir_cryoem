...
FTK = gen_Jsvd_FTK_7(k_p_r_max,pm_N_pixel,svd_eps,l_max,a_K,b_K);
%%%%;
...
FTK.svd_polyval_U_d_ = reshape(get_svd_polyval_U_d_0(FTK.svd_d_max,FTK.n_svd_d,FTK.svd_d_,FTK.n_svd_l,FTK.svd_l_,FTK.svd_U_d_,FTK.n_delta_v,FTK.delta_x_,FTK.delta_y_),[FTK.n_svd_l*FTK.n_delta_v,1]);
FTK.svd_r_max = 2*pi*k_p_r_max;
FTK.svd_polyval_V_r_ = reshape(get_svd_polyval_V_r_0(FTK.svd_r_max,FTK.n_svd_r,FTK.svd_r_,FTK.n_svd_l,FTK.svd_l_,FTK.svd_V_r_,n_k_p_r,2*pi*k_p_r_),[FTK.n_svd_l*n_k_p_r,1]);
