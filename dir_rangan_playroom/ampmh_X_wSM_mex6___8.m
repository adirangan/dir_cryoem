...
% runs mex_mkl_ampmh_X_wSM___16.m. ;
%%%%%%%%;
function ...
[ ...
 parameter ...
...
tmp_t = toc(tmp_t); if (verbose>1); disp(sprintf(' %% ampmh_X_wSM_mex6___8: %0.3fs',tmp_t)); end;
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex6___8',tmp_t);
...
verbose = 1;
if (verbose>0); disp(sprintf(' %% [entering ampmh_X_wSM_mex6___8]')); end;
...
elrt_sum_mex_mkl_ampmh_X_wSM___16=0;
...
elrt_sum_X_wSM___=0;
elrt_sum_ori_ampmh_X_wSM___16=0;
...
tmp_t_0 = toc(tmp_t_0); if (verbose>1); disp(sprintf(' %% mex_mkl_ampmh_X_wSM___16: %0.6f',tmp_t_0)); end; elrt_sum_mex_mkl_ampmh_X_wSM___16 = elrt_sum_mex_mkl_ampmh_X_wSM___16 + tmp_t_0;
%%%%%%%%%%%%%%%%;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex6___8: svd_VUXM_nMwl____',tmp_t,1,nop);
%%%%%%%%;
if (flag_compress_S==0);
tmp_t = tic(); nop=0;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex6___8: svd_SVUXM_SMwl____',tmp_t,1,nop);
%%%%;
tmp_t = tic(); nop=0;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex6___8: svd_SVUXM_lwSM____',tmp_t,1,nop);
end;%if (flag_compress_S==0);
%%%%%%%%;
flag_disp=0;
if flag_disp;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex6___8: svd_USVUXM_SMwl____',tmp_t,1,nop);
tmp_t = tic(); nop=0;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex6___8: svd_USVUXM_SMwl____ (permute)',tmp_t,1,nop);
end;%if (flag_compress_S==1);
%%%%%%%%;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex6___8: svd_USESVUXM_dwSM____',tmp_t,1,nop);
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex6___8: X_sub_dwSM____',tmp_t,1,nop);
%%%%%%%%;
flag_check=0;
if flag_check;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex6___8: X_wSM___',tmp_t,1,nop);
end;%if (flag_optimize_over_gamma_z == 0);
%%%%%%%%;
if (flag_optimize_over_gamma_z == 1);
tmp_t = tic(); nop=0;
...
%%%%%%%%%%%%%%%%;
tmp_t_1 = toc(tmp_t_1);
if (verbose>1); disp(sprintf(' %% ori_ampmh_X_wSM___16: %0.6f',tmp_t_1)); end;
elrt_sum_ori_ampmh_X_wSM___16 = elrt_sum_ori_ampmh_X_wSM___16 + tmp_t_1;
parameter = parameter_timing_update(parameter,'ampmh_X_wSM___8: matlab',tmp_t_1,1,nop);
%%%%%%%%%%%%%%%%;

if (verbose>0);
disp(sprintf(' %% elrt_sum_mex_mkl_ampmh_X_wSM___16: %0.6f',elrt_sum_mex_mkl_ampmh_X_wSM___16));
...
disp(sprintf(' %% elrt_sum_ori_ampmh_X_wSM___16: %0.6f',elrt_sum_ori_ampmh_X_wSM___16));
end;%if (verbose>0);
...
if (verbose>0); disp(sprintf(' %% [finished ampmh_X_wSM_mex6___8]')); end;
