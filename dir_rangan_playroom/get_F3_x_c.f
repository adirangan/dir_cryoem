      subroutine get_F3_x_c(max_x_c,X_x_c,Y_x_c,F_x_c,param_1,param_2
     $     ,param_3)
      real *8 max_x_c,X_x_c,Y_x_c,param_1,param_2,param_3
      complex *16 F_x_c
     ...
     $     *mx)**2/2/(max_x_c*sx)**2)*exp(-(Y_x_c - max_x_c*my)**2
     $     /2 /(max_x_c*sy)**2)
      tmp_crop = 0.5*(1+erf(-16.0*(R_x_c-0.25*param_3*(1 + 0.5
     $     *cos(param_2*W_x_c)))))
