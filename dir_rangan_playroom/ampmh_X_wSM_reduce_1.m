...
verbose = 0;
if (verbose); disp(sprintf(' %% [entering ampmh_X_wSM_reduce_1]')); end;
...
if (n_delta_v_use>0);
if (verbose); disp(sprintf(' %% changing n_delta_v %d --> %d',n_delta_v,n_delta_v_use)); end;
...
if (verbose); disp(sprintf(' %% [finished ampmh_X_wSM_reduce_1]')); end;
