...
str_thisfunction = 'ssnll_from_plane_wave_expansion_0';
...
if (nargin<1+na); index_nS_from_nM_=[]; end; na=na+1;
...
%%%%;
% the nS template U_k_p_wk_ is associated with the nM image V_k_p_wk_ below. ;
...
%%%%;
% the nM image V_k_p_wk_ is assumed to come from volume b projected along nS viewing_angle_. ;
% (i.e., V_k_p_wk_ will not change if the nM euler_angle_ changes). ;
%%%%;
tmp_polar_a = viewing_polar_a_S_(1+nS);
tmp_azimu_b = viewing_azimu_b_S_(1+nS);
tmp_gamma_z = viewing_gamma_z_S_(1+nS);
