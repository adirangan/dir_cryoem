...
str_thisfunction = 'test_Hemaglu_0';
...
fname_noroot_star='particles_smallset.star';
...
for nvolume=0:n_volume-1;
a_k_Y_quad_ = a_k_Y_quad_vy__{1+nvolume};
fname_mat = sprintf('%s/a_k_Y_reco_%d_from_%s__.mat',dir_pm_mat,nvolume,tmp_str);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
parameter = struct('type','parameter');
...
parameter.fname_align_a_k_Y_pre = sprintf('%s/a_k_Y_reco_%d_from_%s__',dir_pm_mat,nvolume,tmp_str);
[ ...
 parameter ...
,a_k_Y_reco_yki__ ...
,corr_a_k_Y_i_ ...
