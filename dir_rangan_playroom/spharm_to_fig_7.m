function [ FA_x_c_ , X_1_ , X_2_ , X_3_ ]  = spharm_to_fig_7(n_k,k_,n_l_,a_,res,alpha_,delta_);
% plots the spherical harmonic representation passed in by modsph ;
% calculates real-space function via nufft3d3 ;
% tests out functions such as convert_spharm_to_k_p_0.m and convert_k_p_to_spharm_0.m ;
% ;
...
if nargin<6; alpha_ = 0*[1*pi/4,1*pi/4,1*pi/6]; end;
...
a_ = rotate_spharm_to_spharm_0(verbose,n_k,k_,n_l_,a_,alpha_);
