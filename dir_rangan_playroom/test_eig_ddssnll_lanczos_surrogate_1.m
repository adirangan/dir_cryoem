...
for n3=0:n_3-1;
if (flag_verbose>0); disp(sprintf(' %% n3 %d: uu tilde = %0.6f',n3,local_weightless_f_bar_dot_g_(n_k_p_r,weight_3d_riesz_k_p_r_,l_max_,n_M,U_tilde_SmallRotation_Delta_ykabc3__(:,1+n3),U_tilde_SmallRotation_Delta_ykabc3__(:,1+n3)))); end;
U_tilde_SmallRotation_Delta_ykabc3__(:,1+n3) = local_weightless_normalize_f_(n_k_p_r,weight_3d_riesz_k_p_r_,l_max_,n_M,U_tilde_SmallRotation_Delta_ykabc3__(:,1+n3));
end;%for n3=0:n_3-1;
end;%if flag_U==1;
%%%%;
if flag_U==0;
...
[tmp_vv,tmp_vv_dvol,tmp_vv_a,tmp_vv_b,tmp_vv_c] = local_weightless_f_bar_dot_g_(n_k_p_r,weight_3d_riesz_k_p_r_,l_max_,n_M,v_tilde_eig_ykabc_,v_tilde_eig_ykabc_);
