...
str_thisfunction = 'kappa_qpro_apply_3';
...
%{
%%%%%%%%;
% test 1d reconstruction. ;
% Note that the bandlimited delta-function decays algebraically (i.e., very slowly). ;
% Verdict: the shell-based strategy of kappa_qpro_apply might be reasonable. ;
%%%%%%%%;
nf=0;
n_x_u_sub = 64;
dx_sub = 1.0/max(1,n_x_u_sub);
x_shift = 48.5*dx_sub;
n_x_u_pad = 1024*2;
x_u_sub_ = transpose(linspace(0,1,n_x_u_sub+1))-0.5; x_u_sub_ = x_u_sub_(1:n_x_u_sub);
x_u_pad_ = transpose(linspace(0,1,n_x_u_pad+1))-0.5; x_u_pad_ = x_u_pad_(1:n_x_u_pad);
figure(1+nf);nf=nf+1;clf;figmed;
hold on;
plot(x_u_sub_,zeros(n_x_u_sub,1),'ko','MarkerFaceColor','r');
plot(x_u_pad_,sinc(n_x_u_sub*(x_u_pad_-x_shift)),'r-');
deltafunc_sub_ = sum(exp(+i*2*pi*(x_u_sub_-x_shift)*[-n_x_u_sub/2+1:+n_x_u_sub/2-1]),2)/max(1,n_x_u_sub) + 0.5*sum(exp(+i*2*pi*(x_u_sub_-x_shift)*[-n_x_u_sub/2,+n_x_u_sub/2]),2)/max(1,n_x_u_sub);
deltafunc_pad_ = sum(exp(+i*2*pi*(x_u_pad_-x_shift)*[-n_x_u_sub/2+1:+n_x_u_sub/2-1]),2)/max(1,n_x_u_sub) + 0.5*sum(exp(+i*2*pi*(x_u_pad_-x_shift)*[-n_x_u_sub/2,+n_x_u_sub/2]),2)/max(1,n_x_u_sub);
dx_deltafunc_pad_ = sum(bsxfun(@times,[+i*2*pi*[-n_x_u_sub/2+1:+n_x_u_sub/2-1]],exp(+i*2*pi*(x_u_pad_-x_shift)*[-n_x_u_sub/2+1:+n_x_u_sub/2-1])/max(1,n_x_u_sub)),2) + 0.5*sum(bsxfun(@times,[+i*2*pi*[-n_x_u_sub/2,+n_x_u_sub/2]],exp(+i*2*pi*(x_u_pad_-x_shift)*[-n_x_u_sub/2,+n_x_u_sub/2])/max(1,n_x_u_sub)),2);
dx_deltafunc_pad_ = dx_deltafunc_pad_/max(1e-12,max(abs(dx_deltafunc_pad_)));
dx_dx_deltafunc_pad_ = sum(bsxfun(@times,[+i*2*pi*[-n_x_u_sub/2+1:+n_x_u_sub/2-1]].^2,exp(+i*2*pi*(x_u_pad_-x_shift)*[-n_x_u_sub/2+1:+n_x_u_sub/2-1])/max(1,n_x_u_sub)),2) + 0.5*sum(bsxfun(@times,[+i*2*pi*[-n_x_u_sub/2,+n_x_u_sub/2]].^2,exp(+i*2*pi*(x_u_pad_-x_shift)*[-n_x_u_sub/2,+n_x_u_sub/2])/max(1,n_x_u_sub)),2);
dx_dx_deltafunc_pad_ = dx_dx_deltafunc_pad_/max(1e-12,max(abs(dx_dx_deltafunc_pad_)));
plot(x_u_pad_,deltafunc_pad_,'g.-');
plot(x_u_pad_,dx_deltafunc_pad_,'r-');
plot(x_u_pad_,dx_dx_deltafunc_pad_,'b-');
hold off;
xlim([-0.5,+0.5]); xlabel('x');
figure(1+nf);nf=nf+1;clf;figmed;fig81s;
subplot(1,3,1);imagesc(log(abs(deltafunc_pad_*transpose(deltafunc_pad_))),[-6,0]); axis square; axis image; axisnotick;
subplot(1,3,2);imagesc(log(abs(dx_deltafunc_pad_*transpose(dx_deltafunc_pad_))),[-6,0]); axis square; axis image; axisnotick;
subplot(1,3,3);imagesc(log(abs(dx_dx_deltafunc_pad_*transpose(dx_dx_deltafunc_pad_))),[-6,0]); axis square; axis image; axisnotick;
%}
disp(sprintf(' %% also see kappa_qpro_recon_3'));
nf=0;
%%%%%%%%;
...
parameter.kernel_qpro_l_max_use = 24;
parameter.kernel_qpro_l_max_ext = ceil(1.25*parameter.kernel_qpro_l_max_use);
...
parameter.kernel_qpro_polar_a_pole_north=3.5*pi/24;
parameter.kernel_qpro_polar_a_pole_south=2.5*pi/24;
parameter.kernel_qpro_qref_k_eq_d_double = 0.50;
[parameter,KAPPA] = kappa_qpro_apply_3(parameter);
%%%%%%%%;
n_w_max = 98;
n_M = 13;
weight_imagecount_M_ = [];
...
[ ...
 parameter ...
,KAPPA ...
,a_restore_C2M0_mid_k_Y_yk__ ...
,a_restore_C1M1_mid_k_Y_yk__ ...
,a_restore_C0M2_mid_k_Y_yk__ ...
,dtau_a_restore_C2M0_mid_k_Y_yk__ ...
,dtau_a_restore_C1M1_mid_k_Y_yk__ ...
,dtau_a_restore_C0M2_mid_k_Y_yk__ ...
,dtau_dtau_a_restore_C2M0_mid_k_Y_yk__ ...
,dtau_dtau_a_restore_C1M1_mid_k_Y_yk__ ...
,dtau_dtau_a_restore_C0M2_mid_k_Y_yk__ ...
] = ...
kappa_qpro_apply_3( ...
 parameter ...
,KAPPA ...
...
[ ...
 parameter ...
,KAPPA ...
,a_restore_C2M0_pos_k_Y_yk__ ...
,a_restore_C1M1_pos_k_Y_yk__ ...
,a_restore_C0M2_pos_k_Y_yk__ ...
] = ...
kappa_qpro_apply_3( ...
 parameter ...
,KAPPA ...
...
[ ...
 parameter ...
,KAPPA ...
,a_restore_C2M0_neg_k_Y_yk__ ...
,a_restore_C1M1_neg_k_Y_yk__ ...
,a_restore_C0M2_neg_k_Y_yk__ ...
] = ...
kappa_qpro_apply_3( ...
 parameter ...
,KAPPA ...
...
%%%%%%%%;
dtau_a_restore_C2M0_dif_k_Y_yk__ = (a_restore_C2M0_pos_k_Y_yk__ - a_restore_C2M0_neg_k_Y_yk__)/max(1e-12,2*dtau);
disp(sprintf(' %% dtau_a_restore_C2M0_dif_k_Y_yk__ vs dtau_a_restore_C2M0_mid_k_Y_yk__: %0.16f',fnorm(dtau_a_restore_C2M0_dif_k_Y_yk__ - dtau_a_restore_C2M0_mid_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_C2M0_dif_k_Y_yk__))));
dtau_a_restore_C1M1_dif_k_Y_yk__ = (a_restore_C1M1_pos_k_Y_yk__ - a_restore_C1M1_neg_k_Y_yk__)/max(1e-12,2*dtau);
disp(sprintf(' %% dtau_a_restore_C1M1_dif_k_Y_yk__ vs dtau_a_restore_C1M1_mid_k_Y_yk__: %0.16f',fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__ - dtau_a_restore_C1M1_mid_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__))));
dtau_a_restore_C0M2_dif_k_Y_yk__ = (a_restore_C0M2_pos_k_Y_yk__ - a_restore_C0M2_neg_k_Y_yk__)/max(1e-12,2*dtau);
disp(sprintf(' %% dtau_a_restore_C0M2_dif_k_Y_yk__ vs dtau_a_restore_C0M2_mid_k_Y_yk__: %0.16f',fnorm(dtau_a_restore_C0M2_dif_k_Y_yk__ - dtau_a_restore_C0M2_mid_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_C0M2_dif_k_Y_yk__))));
%%%%%%%%;
dtau_dtau_a_restore_C2M0_dif_k_Y_yk__ = (a_restore_C2M0_pos_k_Y_yk__ - 2*a_restore_C2M0_mid_k_Y_yk__ + a_restore_C2M0_neg_k_Y_yk__)/max(1e-12,dtau*dtau);
disp(sprintf(' %% dtau_dtau_a_restore_C2M0_dif_k_Y_yk__ vs dtau_dtau_a_restore_C2M0_mid_k_Y_yk__: %0.16f',fnorm(dtau_dtau_a_restore_C2M0_dif_k_Y_yk__ - dtau_dtau_a_restore_C2M0_mid_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_C2M0_dif_k_Y_yk__))));
dtau_dtau_a_restore_C1M1_dif_k_Y_yk__ = (a_restore_C1M1_pos_k_Y_yk__ - 2*a_restore_C1M1_mid_k_Y_yk__ + a_restore_C1M1_neg_k_Y_yk__)/max(1e-12,dtau*dtau);
disp(sprintf(' %% dtau_dtau_a_restore_C1M1_dif_k_Y_yk__ vs dtau_dtau_a_restore_C1M1_mid_k_Y_yk__: %0.16f',fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__ - dtau_dtau_a_restore_C1M1_mid_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__))));
dtau_dtau_a_restore_C0M2_dif_k_Y_yk__ = (a_restore_C0M2_pos_k_Y_yk__ - 2*a_restore_C0M2_mid_k_Y_yk__ + a_restore_C0M2_neg_k_Y_yk__)/max(1e-12,dtau*dtau);
disp(sprintf(' %% dtau_dtau_a_restore_C0M2_dif_k_Y_yk__ vs dtau_dtau_a_restore_C0M2_mid_k_Y_yk__: %0.16f',fnorm(dtau_dtau_a_restore_C0M2_dif_k_Y_yk__ - dtau_dtau_a_restore_C0M2_mid_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_C0M2_dif_k_Y_yk__))));
%%%%%%%%;
figure(1+nf);nf=nf+1;clf;figmed;
markersize_use = 4;
...
tmp_r_C2M0_num = fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:) - dtau_a_restore_C1M1_mid_k_Y_yk__(1+tmp_index_,:));
tmp_r_C2M0_den = fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:));
tmp_r_C2M0 = tmp_r_C2M0_num/max(1e-12,tmp_r_C2M0_den);
tmp_r_C2M0_(1+l_val) = tmp_r_C2M0;
tmp_r_C1M1_num = fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:) - dtau_a_restore_C1M1_mid_k_Y_yk__(1+tmp_index_,:));
tmp_r_C1M1_den = fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:));
tmp_r_C1M1 = tmp_r_C1M1_num/max(1e-12,tmp_r_C1M1_den);
tmp_r_C1M1_(1+l_val) = tmp_r_C1M1;
tmp_r_C0M2_num = fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:) - dtau_a_restore_C1M1_mid_k_Y_yk__(1+tmp_index_,:));
tmp_r_C0M2_den = fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:));
...
for l_val=0:l_max;
tmp_index_ = efind(KAPPA.Y_l_val_use_==l_val);
tmp_r_C2M0_num = fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:) - dtau_dtau_a_restore_C1M1_mid_k_Y_yk__(1+tmp_index_,:));
tmp_r_C2M0_den = fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:));
tmp_r_C2M0 = tmp_r_C2M0_num/max(1e-12,tmp_r_C2M0_den);
tmp_r_C2M0_(1+l_val) = tmp_r_C2M0;
tmp_r_C1M1_num = fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:) - dtau_dtau_a_restore_C1M1_mid_k_Y_yk__(1+tmp_index_,:));
tmp_r_C1M1_den = fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:));
tmp_r_C1M1 = tmp_r_C1M1_num/max(1e-12,tmp_r_C1M1_den);
tmp_r_C1M1_(1+l_val) = tmp_r_C1M1;
tmp_r_C0M2_num = fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:) - dtau_dtau_a_restore_C1M1_mid_k_Y_yk__(1+tmp_index_,:));
tmp_r_C0M2_den = fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:));
tmp_r_C0M2 = tmp_r_C0M2_num/max(1e-12,tmp_r_C0M2_den);
tmp_r_C0M2_(1+l_val) = tmp_r_C0M2;
end;%for l_val=0:l_max;
hold on;
...
%%%%%%%%;
% Now test the accumulation of images via weight_imagecount_M_. ;
%%%%%%%%;
n_w_max = 98;
n_M = 13;
n_N = 4;
...
disp(sprintf(' %% index_nN_from_nM_: %s',num2str(transpose(index_nN_from_nM_),'%3.2d')));
for nN=0:n_N-1;
tmp_index_ = efind(index_nN_from_nM_==nN);
index_nM_from_nN__{1+nN} = tmp_index_;
weight_imagecount_N_(1+nN) = numel(tmp_index_);
end;%for nN=0:n_N-1;
disp(sprintf(' %% weight_imagecount_N_: %s',num2str(transpose(weight_imagecount_N_),'%3.2d')));
weight_imagecount_M_ = ones(n_M,1);
rng(0);
viewing_polar_a_N_ = 2*pi*rand(n_N,1);
viewing_azimu_b_N_ = 2*pi*rand(n_N,1);
viewing_gamma_z_N_ = 2*pi*rand(n_N,1);
dtau_viewing_polar_a_N_ = 2*pi*rand(n_N,1);
dtau_viewing_azimu_b_N_ = 2*pi*rand(n_N,1);
dtau_viewing_gamma_z_N_ = 2*pi*rand(n_N,1);
n_k_p_r = 2;
N_k_p_wkN__ = randn(n_w_max*n_k_p_r,n_N);
viewing_polar_a_M_ = viewing_polar_a_N_(1+index_nN_from_nM_);
viewing_azimu_b_M_ = viewing_azimu_b_N_(1+index_nN_from_nM_);
viewing_gamma_z_M_ = viewing_gamma_z_N_(1+index_nN_from_nM_);
dtau_viewing_polar_a_M_ = dtau_viewing_polar_a_N_(1+index_nN_from_nM_);
dtau_viewing_azimu_b_M_ = dtau_viewing_azimu_b_N_(1+index_nN_from_nM_);
dtau_viewing_gamma_z_M_ = dtau_viewing_gamma_z_N_(1+index_nN_from_nM_);
M_k_p_wkM__ = N_k_p_wkN__(:,1+index_nN_from_nM_);
%%%%;
if ~exist('KAPPA_M','var'); KAPPA_M=[]; end;
parameter.flag_recalc_knn=1;
parameter.flag_recalc_qref_from_data=0;
parameter.flag_recalc_dtau_qref_from_data=0;
parameter.flag_recalc_dtau_dtau_qref_from_data=0;
...
if ~exist('KAPPA_N','var'); KAPPA_N=[]; end;
parameter.flag_recalc_knn=1;
parameter.flag_recalc_qref_from_data=0;
parameter.flag_recalc_dtau_qref_from_data=0;
parameter.flag_recalc_dtau_dtau_qref_from_data=0;
...
[ ...
 parameter ...
,KAPPA_M ...
,a_restore_from_M_C2M0_k_Y_yk__ ...
,a_restore_from_M_C1M1_k_Y_yk__ ...
,a_restore_from_M_C0M2_k_Y_yk__ ...
,dtau_a_restore_from_M_C2M0_k_Y_yk__ ...
,dtau_a_restore_from_M_C1M1_k_Y_yk__ ...
,dtau_a_restore_from_M_C0M2_k_Y_yk__ ...
,dtau_dtau_a_restore_from_M_C2M0_k_Y_yk__ ...
,dtau_dtau_a_restore_from_M_C1M1_k_Y_yk__ ...
,dtau_dtau_a_restore_from_M_C0M2_k_Y_yk__ ...
] = ...
kappa_qpro_apply_3( ...
 parameter ...
,KAPPA_M ...
...
[ ...
 parameter ...
,KAPPA_N ...
,a_restore_from_N_C2M0_k_Y_yk__ ...
,a_restore_from_N_C1M1_k_Y_yk__ ...
,a_restore_from_N_C0M2_k_Y_yk__ ...
,dtau_a_restore_from_N_C2M0_k_Y_yk__ ...
,dtau_a_restore_from_N_C1M1_k_Y_yk__ ...
,dtau_a_restore_from_N_C0M2_k_Y_yk__ ...
,dtau_dtau_a_restore_from_N_C2M0_k_Y_yk__ ...
,dtau_dtau_a_restore_from_N_C1M1_k_Y_yk__ ...
,dtau_dtau_a_restore_from_N_C0M2_k_Y_yk__ ...
] = ...
kappa_qpro_apply_3( ...
 parameter ...
,KAPPA_N ...
...
,viewing_azimu_b_N_ ...
,viewing_gamma_z_N_ ...
,dtau_viewing_polar_a_N_ ...
,dtau_viewing_azimu_b_N_ ...
,dtau_viewing_gamma_z_N_ ...
,n_k_p_r ...
,N_k_p_wkN__ ...
);
%%%%;
...
[ ...
 parameter ...
,KAPPA_N ...
,a_restore_from_O_C2M0_k_Y_yk__ ...
,a_restore_from_O_C1M1_k_Y_yk__ ...
,a_restore_from_O_C0M2_k_Y_yk__ ...
,dtau_a_restore_from_O_C2M0_k_Y_yk__ ...
,dtau_a_restore_from_O_C1M1_k_Y_yk__ ...
,dtau_a_restore_from_O_C0M2_k_Y_yk__ ...
,dtau_dtau_a_restore_from_O_C2M0_k_Y_yk__ ...
,dtau_dtau_a_restore_from_O_C1M1_k_Y_yk__ ...
,dtau_dtau_a_restore_from_O_C0M2_k_Y_yk__ ...
] = ...
kappa_qpro_apply_3( ...
 parameter ...
,KAPPA_N ...
...
%%%%;
disp(sprintf(' %% a_restore_from_N_C2M0_k_Y_yk__ vs a_restore_from_M_C2M0_k_Y_yk__: %0.16f',fnorm(a_restore_from_N_C2M0_k_Y_yk__ - a_restore_from_M_C2M0_k_Y_yk__)/max(1e-12,fnorm(a_restore_from_N_C2M0_k_Y_yk__))));
disp(sprintf(' %% a_restore_from_N_C1M1_k_Y_yk__ vs a_restore_from_M_C1M1_k_Y_yk__: %0.16f',fnorm(a_restore_from_N_C1M1_k_Y_yk__ - a_restore_from_M_C1M1_k_Y_yk__)/max(1e-12,fnorm(a_restore_from_N_C1M1_k_Y_yk__))));
disp(sprintf(' %% a_restore_from_N_C0M2_k_Y_yk__ vs a_restore_from_M_C0M2_k_Y_yk__: %0.16f',fnorm(a_restore_from_N_C0M2_k_Y_yk__ - a_restore_from_M_C0M2_k_Y_yk__)/max(1e-12,fnorm(a_restore_from_N_C0M2_k_Y_yk__))));
disp(sprintf(' %% dtau_a_restore_from_N_C2M0_k_Y_yk__ vs dtau_a_restore_from_M_C2M0_k_Y_yk__: %0.16f',fnorm(dtau_a_restore_from_N_C2M0_k_Y_yk__ - dtau_a_restore_from_M_C2M0_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_from_N_C2M0_k_Y_yk__))));
disp(sprintf(' %% dtau_a_restore_from_N_C1M1_k_Y_yk__ vs dtau_a_restore_from_M_C1M1_k_Y_yk__: %0.16f',fnorm(dtau_a_restore_from_N_C1M1_k_Y_yk__ - dtau_a_restore_from_M_C1M1_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_from_N_C1M1_k_Y_yk__))));
disp(sprintf(' %% dtau_a_restore_from_N_C0M2_k_Y_yk__ vs dtau_a_restore_from_M_C0M2_k_Y_yk__: %0.16f',fnorm(dtau_a_restore_from_N_C0M2_k_Y_yk__ - dtau_a_restore_from_M_C0M2_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_from_N_C0M2_k_Y_yk__))));
disp(sprintf(' %% dtau_dtau_a_restore_from_N_C2M0_k_Y_yk__ vs dtau_dtau_a_restore_from_M_C2M0_k_Y_yk__: %0.16f',fnorm(dtau_dtau_a_restore_from_N_C2M0_k_Y_yk__ - dtau_dtau_a_restore_from_M_C2M0_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_from_N_C2M0_k_Y_yk__))));
disp(sprintf(' %% dtau_dtau_a_restore_from_N_C1M1_k_Y_yk__ vs dtau_dtau_a_restore_from_M_C1M1_k_Y_yk__: %0.16f',fnorm(dtau_dtau_a_restore_from_N_C1M1_k_Y_yk__ - dtau_dtau_a_restore_from_M_C1M1_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_from_N_C1M1_k_Y_yk__))));
disp(sprintf(' %% dtau_dtau_a_restore_from_N_C0M2_k_Y_yk__ vs dtau_dtau_a_restore_from_M_C0M2_k_Y_yk__: %0.16f',fnorm(dtau_dtau_a_restore_from_N_C0M2_k_Y_yk__ - dtau_dtau_a_restore_from_M_C0M2_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_from_N_C0M2_k_Y_yk__))));
%%%%;
disp(sprintf(' %% a_restore_from_N_C2M0_k_Y_yk__ vs a_restore_from_O_C2M0_k_Y_yk__: %0.16f %%<-- should not match',fnorm(a_restore_from_N_C2M0_k_Y_yk__ - a_restore_from_O_C2M0_k_Y_yk__)/max(1e-12,fnorm(a_restore_from_N_C2M0_k_Y_yk__))));
disp(sprintf(' %% a_restore_from_N_C1M1_k_Y_yk__ vs a_restore_from_O_C1M1_k_Y_yk__: %0.16f %%<-- should not match',fnorm(a_restore_from_N_C1M1_k_Y_yk__ - a_restore_from_O_C1M1_k_Y_yk__)/max(1e-12,fnorm(a_restore_from_N_C1M1_k_Y_yk__))));
disp(sprintf(' %% a_restore_from_N_C0M2_k_Y_yk__ vs a_restore_from_O_C0M2_k_Y_yk__: %0.16f %%<-- should not match',fnorm(a_restore_from_N_C0M2_k_Y_yk__ - a_restore_from_O_C0M2_k_Y_yk__)/max(1e-12,fnorm(a_restore_from_N_C0M2_k_Y_yk__))));
disp(sprintf(' %% dtau_a_restore_from_N_C2M0_k_Y_yk__ vs dtau_a_restore_from_O_C2M0_k_Y_yk__: %0.16f %%<-- should not match',fnorm(dtau_a_restore_from_N_C2M0_k_Y_yk__ - dtau_a_restore_from_O_C2M0_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_from_N_C2M0_k_Y_yk__))));
disp(sprintf(' %% dtau_a_restore_from_N_C1M1_k_Y_yk__ vs dtau_a_restore_from_O_C1M1_k_Y_yk__: %0.16f %%<-- should not match',fnorm(dtau_a_restore_from_N_C1M1_k_Y_yk__ - dtau_a_restore_from_O_C1M1_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_from_N_C1M1_k_Y_yk__))));
disp(sprintf(' %% dtau_a_restore_from_N_C0M2_k_Y_yk__ vs dtau_a_restore_from_O_C0M2_k_Y_yk__: %0.16f %%<-- should not match',fnorm(dtau_a_restore_from_N_C0M2_k_Y_yk__ - dtau_a_restore_from_O_C0M2_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_from_N_C0M2_k_Y_yk__))));
disp(sprintf(' %% dtau_dtau_a_restore_from_N_C2M0_k_Y_yk__ vs dtau_dtau_a_restore_from_O_C2M0_k_Y_yk__: %0.16f %%<-- should not match',fnorm(dtau_dtau_a_restore_from_N_C2M0_k_Y_yk__ - dtau_dtau_a_restore_from_O_C2M0_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_from_N_C2M0_k_Y_yk__))));
disp(sprintf(' %% dtau_dtau_a_restore_from_N_C1M1_k_Y_yk__ vs dtau_dtau_a_restore_from_O_C1M1_k_Y_yk__: %0.16f %%<-- should not match',fnorm(dtau_dtau_a_restore_from_N_C1M1_k_Y_yk__ - dtau_dtau_a_restore_from_O_C1M1_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_from_N_C1M1_k_Y_yk__))));
disp(sprintf(' %% dtau_dtau_a_restore_from_N_C0M2_k_Y_yk__ vs dtau_dtau_a_restore_from_O_C0M2_k_Y_yk__: %0.16f %%<-- should not match',fnorm(dtau_dtau_a_restore_from_N_C0M2_k_Y_yk__ - dtau_dtau_a_restore_from_O_C0M2_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_from_N_C0M2_k_Y_yk__))));
%%%%%%%%;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
