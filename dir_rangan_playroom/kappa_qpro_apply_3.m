...
parameter.kernel_l_max_use = 24;
parameter.kernel_l_max_ext = ceil(1.25*parameter.kernel_l_max_use);
...
%%%%%%%%;
% Now test the accumulation of images via weight_image_M_. ;
%%%%%%%%;
n_w_max = 98;
n_M = 13;
n_N = 4;
...
disp(sprintf(' %% weight_image_N_: %s',num2str(transpose(weight_image_N_),'%3.2d')));
...
weight_mollify_qref_from_data_wMn__ = reshape(bsxfun(@times,reshape(mollify_qref_from_data_wMn__,[n_w,n_M,n_nearest_total]),reshape(weight_image_M_,[1,n_M,1])),[n_w*n_M,n_nearest_total]);
...
weight_dtau_kappa_1wMn___ = reshape(bsxfun(@times,reshape(dtau_kappa_1wMn___,[n_w,n_M,n_nearest_total]),reshape(weight_image_M_,[1,n_M,1])),[n_w,n_M,n_nearest_total]);
...
;
weight_dtau_dtau_kappa_1wMn___ = reshape(bsxfun(@times,reshape(dtau_dtau_kappa_1wMn___,[n_w,n_M,n_nearest_total]),reshape(weight_image_M_,[1,n_M,1])),[n_w,n_M,n_nearest_total]);
