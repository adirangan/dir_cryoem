...
imagesc_p(pm_n_k_p_r,1:pm_n_k_p_r,pm_n_w_,sum(pm_n_w_),real(db_UXI_CTF_S_k_p__(:,1+nviewing_all)/sin(pm_viewing_polar_a_all_(1+nviewing_all))),[],colormap_beach());
axis image; axisnotick; title(sprintf('db_UXI_CTF_S_k_p__(:,1+nv)/sin(polar_a) %d',nviewing_all),'Interpreter','none');
