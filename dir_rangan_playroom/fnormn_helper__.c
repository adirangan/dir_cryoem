double fnormn_helper_z_vs_ff__(int n_0,int n_1,int flag_rup_A,double complex *z_A_,int flag_rup_B,float *f_B_real_,float *f_B_imag_)
{
  int n_0_rup=0,n_1_rup=0;
  int n_0_A_use=0,n_1_A_use=0;
  int n_0_B_use=0,n_1_B_use=0;
  int n0=0,n1=0;
  unsigned long long int tabA=0,tabB=0;
  double d_fnorm=0.0,d_denom=0.0,d_fnormn=0.0;
  double complex z_A;
  float f_B_real=0,f_B_imag=0;
  n_0_rup = rup(n_0,8); n_1_rup = rup(n_1,8);
  ...
  for (n1=0;n1<n_1;n1++){
    for (n0=0;n0<n_0;n0++){
      tabA = (unsigned long long int)n0 +(unsigned long long int)n1*(unsigned long long int)n_0_A_use;
      tabB = (unsigned long long int)n0 +(unsigned long long int)n1*(unsigned long long int)n_0_B_use;
      z_A = z_A_[tabA];
...
double fnormn_helper_z_vs_c__(int n_0,int n_1,int flag_rup_A,double complex *z_A_,int flag_rup_B,float complex *c_B_)
{
  int n_0_rup=0,n_1_rup=0;
  int n_0_A_use=0,n_1_A_use=0;
  int n_0_B_use=0,n_1_B_use=0;
...
double fnormn_helper_ff_vs_c__(int n_0,int n_1,int flag_rup_A,float *f_A_real_,float *f_A_imag_,int flag_rup_B,float complex *c_B_)
{
  int n_0_rup=0,n_1_rup=0;
  int n_0_A_use=0,n_1_A_use=0;
  int n_0_B_use=0,n_1_B_use=0;
