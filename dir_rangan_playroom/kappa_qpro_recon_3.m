...
str_thisfunction = 'kappa_qpro_recon_3';
...
parameter.kernel_qpro_polar_a_pole_south=4*pi/24;
...
disp(sprintf(' %% dtau_a_restore_dif_C1M1_k_Y_yk__ vs dtau_a_restore_mid_C1M1_k_Y_yk__: %0.16f',fnorm(dtau_a_restore_dif_C1M1_k_Y_yk__ - dtau_a_restore_mid_C1M1_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_dif_C1M1_k_Y_yk__))));
%%%%;
if flag_disp;
figure(1+nf);nf=nf+1;clf;figmed;
subplot(1,2,1);
...
disp(sprintf(' %% dtau_dtau_a_restore_dif_C1M1_k_Y_yk__ vs dtau_dtau_a_restore_mid_C1M1_k_Y_yk__: %0.16f',fnorm(dtau_dtau_a_restore_dif_C1M1_k_Y_yk__ - dtau_dtau_a_restore_mid_C1M1_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_dif_C1M1_k_Y_yk__))));
%%%%;
if flag_disp;
figure(1+nf);nf=nf+1;clf;figmed;
subplot(1,2,1);
