...
verbose=2;
if (verbose); disp(sprintf(' %% [entering test_ampleut_3]: alternating-minimization with principal-modes, local-exclusion and updating-translations')); end;
...
ampleut_template_tree = [];
if ( isempty(ampleut_template_tree));
...
if (~isfield(parameter,'ampleut_template_tree_n_level')); parameter.ampleut_template_tree_n_level = 3; end; %<-- parameter_bookmark. ;
ampleut_template_tree = get_template_tree_0(parameter.template_viewing_k_eq_d_min,parameter.ampleut_template_tree_n_level);
ampleut_n_level = parameter.ampleut_template_tree_n_level;
end;%if ( isempty(ampleut_template_tree));
flag_plot=1;
if flag_plot;
figure(1);clf;hold on; figsml;
tmp_nlevel = 1;
tmp_n_S = ampleut_template_tree.n_S_(1+tmp_nlevel);
c_beach__ = colormap_beach(); n_c_beach = size(c_beach__,1);
str_symbol_ = {'o','^','s','p','h'}; markersize_use = 25;
hold on;
plot3( ...
 ampleut_template_tree.viewing_pole_k_c_0_all__{ampleut_n_level}(:) ...
,ampleut_template_tree.viewing_pole_k_c_1_all__{ampleut_n_level}(:) ...
,ampleut_template_tree.viewing_pole_k_c_2_all__{ampleut_n_level}(:) ...
,'.' ...
,'Color' , 'k' ...
);
...
tmp_index_ = ampleut_template_tree.index_neighbor_fine_from_coarse___{1+tmp_nlevel}{1+tmp_nS};
plot3( ...
 ampleut_template_tree.viewing_pole_k_c_0_all__{ampleut_n_level}(1+tmp_index_) ...
,ampleut_template_tree.viewing_pole_k_c_1_all__{ampleut_n_level}(1+tmp_index_) ...
,ampleut_template_tree.viewing_pole_k_c_2_all__{ampleut_n_level}(1+tmp_index_) ...
,str_symbol ...
