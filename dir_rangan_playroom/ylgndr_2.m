...
%%%%;
% compare to ../dir_rangan_python/dir_ascii/tmp_y_ylgndr_jlm___.ascii. ;
%%%%;
...
fname_pymat = sprintf('%s/test_ylgndr_2.mat',dir_pymat);
...
fnorm_disp(flag_verbose,'d0y_mid_jlm___',d0y_mid_jlm___,'tmp_.d0y_mid_jlm___',tmp_.d0y_mid_jlm___,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'d1y_mid_jlm___',d1y_mid_jlm___,'tmp_.d1y_mid_jlm___',tmp_.d1y_mid_jlm___,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'d2y_mid_jlm___',d2y_mid_jlm___,'tmp_.d2y_mid_jlm___',tmp_.d2y_mid_jlm___,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'sqrt_2lp1_',sqrt_2lp1_,'tmp_.sqrt_2lp1_',tmp_.sqrt_2lp1_,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'sqrt_2mp1_',sqrt_2mp1_,'tmp_.sqrt_2mp1_',tmp_.sqrt_2mp1_,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'sqrt_rat0_m_',sqrt_rat0_m_,'tmp_.sqrt_rat0_m_',tmp_.sqrt_rat0_m_,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'sqrt_rat3_lm__',sqrt_rat3_lm__,'tmp_.sqrt_rat3_lm__',tmp_.sqrt_rat3_lm__,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'sqrt_rat4_lm__',sqrt_rat4_lm__,'tmp_.sqrt_rat4_lm__',tmp_.sqrt_rat4_lm__,' %%<-- should be <1e-6');
