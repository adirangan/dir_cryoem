...
weight_Y_row_ = zeros(n_y_sum,1);
weight_Y_col_ = zeros(n_y_sum,1);
weight_Y_val_ = zeros(n_y_sum,1);
e_k_Y_ = zeros(n_y_sum,1);
na=0;
for nk_p_r=1:n_k_p_r;
tmp_ij_ = na + (1:n_y_(nk_p_r));
...
%weight_Y_ = sparse(weight_Y_row_,weight_Y_col_,weight_Y_val_,n_y_sum,n_y_sum);
