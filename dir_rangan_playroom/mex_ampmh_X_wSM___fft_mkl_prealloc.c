...
/* The helper function */
/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
void mex_ampmh_X_wSM___fft_mkl_prealloc_n1po_helper
(
 int verbose
 ,int n_M
 ,int n_M_sub
 ...
 )
{
  ...
  /* %%%% */
  if (verbose){ printf(" %% [entering mex_ampmh_X_wSM___fft_mkl_prealloc_n1po_helper]\n");}
  /* %%%%%%%%%%%%%%%% */
  if (n_M_sub>0){
    /* %%%% */
    ...
    /* if (n_M_sub>0){ } */}
  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  if (verbose){ printf(" %% [finished mex_ampmh_X_wSM___fft_mkl_prealloc_n1po_helper]\n");}
}

void mex_ampmh_X_wSM___fft_mkl_prealloc_nxpo_helper
(
 int verbose
 ,int n_M
 ,int n_M_sub
 ...
 )
{
  MKL_LONG mkll_err=0;
  /* %%%% */
  if (verbose){ printf(" %% [entering mex_ampmh_X_wSM___fft_mkl_prealloc_nxpo_helper]\n");}
  /* %%%%%%%%%%%%%%%% */
  if (n_M_sub>0){
    /* %%%% */
    /* svd_SVUXM_wlSM____ = ifft(svd_SVUXM_wlSM____,[],1); */
    ...
    /* if (n_M_sub>0){ } */}
  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  if (verbose){ printf(" %% [finished mex_ampmh_X_wSM___fft_mkl_prealloc_nxpo_helper]\n");}
}

void mex_ampmh_X_wSM___fft_mkl_prealloc_nxpo_omp_helper
(
 int verbose
 ,int n_M_per_Mbatch
 ,int n_M
...
/* %%%% */
 ,int nMbatch
 ,int n_Mbatch
 ,DFTI_DESCRIPTOR ** mkl_dfti_fft1d_p__
 )
{
  MKL_LONG mkll_err=0;
  unsigned long long int tabC=0,tabD=0;
  /* %%%%; */
  int n_M_sub=0,nM_sub=0;
  /* %%%% */
  if (verbose){ printf(" %% [entering mex_ampmh_X_wSM___fft_mkl_prealloc_nxpo_omp_helper]\n");}
  ...
  if (n_M_sub>0){
    ...
    mkll_err = DftiComputeBackward(mkl_dfti_fft1d_p__[nMbatch],f0_svd_SVUXM_0in_wlSM____ + tabD,f0_svd_SVUXM_out_wlSM____ + tabD);
    /* %%%% */
    /* if (n_M_sub>0){ } */}
  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  if (verbose){ printf(" %% [finished mex_ampmh_X_wSM___fft_mkl_prealloc_nxpo_omp_helper]\n");}
}

void mex_ampmh_X_wSM___fft_mkl_prealloc_n1pi_helper
(
 int verbose
 ,int n_M
 ,int n_M_sub
 ...
 )
{
  ...
  unsigned long long int tab=0,tabA=0,tabB=0,tabC=0;
  /* %%%% */
  if (verbose){ printf(" %% [entering mex_ampmh_X_wSM___fft_mkl_prealloc_n1pi_helper]\n");}
  /* %%%%%%%%%%%%%%%% */
  if (n_M_sub>0){
    /* %%%% */
    /* svd_SVUXM_wlSM____ = ifft(svd_SVUXM_wlSM____,[],1); */
    ...
    /* if (n_M_sub>0){ } */}
  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  if (verbose){ printf(" %% [finished mex_ampmh_X_wSM___fft_mkl_prealloc_n1pi_helper]\n");}
}

void mex_ampmh_X_wSM___fft_mkl_prealloc_nxpi_helper
(
 int verbose
 ,int n_M
 ,int n_M_sub
 ...
 )
{
  MKL_LONG mkll_err=0;
  /* %%%%; */
  if (verbose){ printf(" %% [entering mex_ampmh_X_wSM___fft_mkl_prealloc_nxpi_helper]\n");}
  /* %%%%%%%%%%%%%%%% */
  if (n_M_sub>0){
    /* %%%% */
    /* svd_SVUXM_wlSM____ = ifft(svd_SVUXM_wlSM____,[],1); */
    ...
    /* if (n_M_sub>0){ } */}
  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  if (verbose){ printf(" %% [finished mex_ampmh_X_wSM___fft_mkl_prealloc_nxpi_helper]\n");}
}

void mex_ampmh_X_wSM___fft_mkl_prealloc_nxpi_omp_helper
(
 int verbose
 ,int n_M_per_Mbatch
 ,int n_M
 ...
 )
{
  MKL_LONG mkll_err=0;
  /* %%%%; */
  unsigned long long int tabD=0;
  int n_M_sub=0,nM_sub=0;
  /* %%%% */
  if (verbose){ printf(" %% [entering mex_ampmh_X_wSM___fft_mkl_prealloc_nxpi_omp_helper]\n");}
  n_M_sub = n_M_per_Mbatch; if (nMbatch==n_Mbatch-1){ n_M_sub = n_M - n_M_per_Mbatch*nMbatch;}
  /* %%%%%%%%%%%%%%%% */
  if (n_M_sub>0){
    /* %%%% */
    ...
    tabD =
      ...
      *(unsigned long long int)n_M_per_Mbatch
      *(unsigned long long int)nMbatch;
    mkll_err = DftiComputeBackward(mkl_dfti_fft1d_p__[nMbatch],f0_svd_SVUXM_0in_wlSM____ + tabD);
    /* %%%% */
    /* if (n_M_sub>0){ } */}
  /* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  if (verbose){ printf(" %% [finished mex_ampmh_X_wSM___fft_mkl_prealloc_nxpi_omp_helper]\n");}
}

/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
/* mkl fft */
/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
void mex_ampmh_X_wSM___fft_mkl_prealloc_test()
{
  ...
  unsigned long long int ulli_numel=0,ulli_total=0,tabA=0,tabB=0,tabC=0,tabD=0,ulli=0;
  float rerror=0;
  /* %%%% */
  ...
  if (verbose){ printf(" %% [entering mex_ampmh_X_wSM___fft_mkl_prealloc_test]\n");}
  /* %%%%%%%%%%%%%%%% */
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,ulli_total,verbose," initialization: ");
  local_tic(0,t_start_,d_start_);
  mkll_i_dfti = n_w_max; mkll_n_dfti = FTK_n_svd_l*n_S*n_M_use; //%<-- do all at once. ;
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,ulli_total,verbose," descriptor: ");
  local_tic(0,t_start_,d_start_);
  mex_ampmh_X_wSM___fft_mkl_prealloc_nxpi_helper
    (
     verbose
     ,n_M
     ,n_M_use
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,ulli_total,verbose," mex_ampmh_X_wSM___fft_mkl_prealloc_nxpi_helper: ");
  mkll_err = DftiFreeDescriptor(&mkl_dfti_fft1d_p_); mkl_dfti_fft1d_p_=NULL;
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,ulli_total,verbose," descriptor: ");
  local_tic(0,t_start_,d_start_);
  mex_ampmh_X_wSM___fft_mkl_prealloc_n1po_helper
    (
     verbose
     ,n_M
     ,n_M_use
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,ulli_total,verbose," mex_ampmh_X_wSM___fft_mkl_prealloc_n1po_helper: ");
  mkll_err = DftiFreeDescriptor(&mkl_dfti_fft1d_p_); mkl_dfti_fft1d_p_=NULL;
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,ulli_total,verbose," descriptor: ");
  local_tic(0,t_start_,d_start_);
  mex_ampmh_X_wSM___fft_mkl_prealloc_n1pi_helper
    (
     verbose
     ,n_M
     ,n_M_use
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,ulli_total,verbose," mex_ampmh_X_wSM___fft_mkl_prealloc_n1pi_helper: ");
  mkll_err = DftiFreeDescriptor(&mkl_dfti_fft1d_p_); mkl_dfti_fft1d_p_=NULL;
  rerror = cfnormn(ulli_numel,f0_svd_SVUXM_bkp_wlSM____,f0_svd_SVUXM_0in_wlSM____);
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,ulli_total,verbose," descriptor: ");
  local_tic(0,t_start_,d_start_);
  mex_ampmh_X_wSM___fft_mkl_prealloc_nxpo_helper
    (
     verbose
     ,n_M
     ,n_M_use
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,ulli_total,verbose," mex_ampmh_X_wSM___fft_mkl_prealloc_nxpo_helper: ");
  mkll_err = DftiFreeDescriptor(&mkl_dfti_fft1d_p_); mkl_dfti_fft1d_p_=NULL;
  rerror = cfnormn(ulli_numel,f0_svd_SVUXM_bkp_wlSM____,f0_svd_SVUXM_out_wlSM____);
  ...
  for (nMbatch=0;nMbatch<n_Mbatch;nMbatch++){
    ...
    tabD =
      ...
      *(unsigned long long int)n_M_per_Mbatch
      *(unsigned long long int)nMbatch;
    memset(f0_svd_SVUXM_out_wlSM____+tabD,0,tabC*sizeof(float complex));
    ...
    mkll_err = DftiSetValue((mkl_dfti_fft1d_p__[nMbatch]),DFTI_PLACEMENT,DFTI_NOT_INPLACE);
...
#pragma omp for schedule(dynamic)
    for (nMbatch=0;nMbatch<n_Mbatch;nMbatch++){
      mex_ampmh_X_wSM___fft_mkl_prealloc_nxpo_omp_helper
	(
	 0*verbose
	 ,n_M_per_Mbatch
	 ,n_M
	 ...
	 ,mkl_dfti_fft1d_p__
      ...
      /* for (nMbatch=0;nMbatch<n_Mbatch;nMbatch++){ } */}
    /* end omp parallel */}
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,ulli_total,verbose," mex_ampmh_X_wSM___fft_mkl_prealloc_nxpo_omp_helper: ");
  for (nMbatch=0;nMbatch<n_Mbatch;nMbatch++){
...
#pragma omp for schedule(dynamic)
    for (nMbatch=0;nMbatch<n_Mbatch;nMbatch++){
      mex_ampmh_X_wSM___fft_mkl_prealloc_nxpi_omp_helper
	(
	 0*verbose
	 ,n_M_per_Mbatch
	 ,n_M
	 ...
	 ,mkl_dfti_fft1d_p__
      ...
      /* for (nMbatch=0;nMbatch<n_Mbatch;nMbatch++){ } */}
    /* end omp parallel */}
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,ulli_total,verbose," mex_ampmh_X_wSM___fft_mkl_prealloc_nxpi_omp_helper: ");
  for (nMbatch=0;nMbatch<n_Mbatch;nMbatch++){
    mkll_err = DftiFreeDescriptor(&(mkl_dfti_fft1d_p__[nMbatch]));
    /* for (nMbatch=0;nMbatch<n_Mbatch;nMbatch++){ } */}
  free(mkl_dfti_fft1d_p__);  mkl_dfti_fft1d_p__=NULL;
  ...
  if (verbose){ printf(" %% [finished mex_ampmh_X_wSM___fft_mkl_prealloc_test]\n");}
}
