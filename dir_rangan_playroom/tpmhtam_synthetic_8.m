...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% test_principled_marching_helper_trpv1_alternating_minimization_synthetic_8. ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
%%%%%%%%;
% Note that a 2d isotropic gaussian with std sigma has the property ;
% that a fraction (1-exp(-R^2/(2*sigma^2))) is contained within radius R. ;
% For example, try out: ;
% tmp_sigma = 1.45; tmp_R = 3.3; tmp_A_ = randn(1024*64,2)*tmp_sigma; tmp_r_ = sqrt(sum(tmp_A_.^2,2)); tmp_0in = numel(find(tmp_r_<tmp_R))/numel(tmp_r_); tmp_1in = 1-exp(-tmp_R^2/(2*tmp_sigma^2)); disp(sprintf(' %% I_monte: %0.6f I_form: %0.6f',tmp_0in,tmp_1in));
% Thus, to ensure that 95-percent of the true-displacements lie within delta_r_max, ;
% we require that exp(-delta_r_max^2/(2*sigma^2)) = 0.05 ;
% or that sigma = sqrt(delta_r_max^2/log(20^2)). ;
% Roughly speaking, sigma should approximately equal delta_r_max/2.5. ;
%%%%%%%%;
delta_r_p = 0.05;
...
%%%%%%%%;
syn_a_k_Y_0lsq_ = cg_lsq_4(syn_n_order,n_k_p_r,k_p_r_,l_max_,n_w_,syn_n_M,syn_M_k_p__,1,CTF_avg_k_p_,true_viewing_polar_a_,true_viewing_azimu_b_,true_viewing_gamma_z_,true_viewing_delta_x_,true_viewing_delta_y_);
%%%%%%%%;
...
save(fname_mat ...
     ...
     ,'true_viewing_delta_x_','true_viewing_delta_y_','FTK'...
...
syn_M_loading_MS__ = get_loading_0(tmp_n_residual_loading,tmp_n_residual_iteration,syn_n_order,tmp_pm_n_k_p_r,tmp_pm_weight_k_p_r_,tmp_pm_l_max_,tmp_pm_n_w_,syn_n_M,reshape(UX_M_k_p_wnM___,[tmp_pm_n_w_sum,syn_n_M]),euler_polar_a_MS__(:,end),euler_azimu_b_MS__(:,end),euler_gamma_z_MS__(:,end));
save(MS_fname_mat ...
     ,'X_best_MS_' ...
     ,'a_UX_Y_0lsq_MS__' ...
...
syn_M_loading_SM__ = get_loading_0(tmp_n_residual_loading,tmp_n_residual_iteration,syn_n_order,tmp_pm_n_k_p_r,tmp_pm_weight_k_p_r_,tmp_pm_l_max_,tmp_pm_n_w_,syn_n_M,reshape(UX_M_k_p_wnM___,[tmp_pm_n_w_sum,syn_n_M]),euler_polar_a_SM__(:,end),euler_azimu_b_SM__(:,end),euler_gamma_z_SM__(:,end));
save(SM_fname_mat ...
     ,'X_best_SM_' ...
     ,'a_UX_Y_0lsq_SM__' ...
