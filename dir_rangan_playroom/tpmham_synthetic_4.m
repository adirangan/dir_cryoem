...
fname_mat = sprintf('%s_mat/tpmham_synthetic_4_UX_%s_M_k_p___n%.3ds%.4dr%.3d.mat',dir_trunk,syn_infix,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank);
...
%%%%%%%%;
fname_fig = sprintf('%s_mat/dir_jpg/tpmham_synthetic_4_UX_%s_M_k_p___n%.3ds%.4dr%.3d',dir_trunk,syn_infix,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank);
...
%%%%%%%%;
fname_fig = sprintf('%s_mat/dir_jpg/tpmham_synthetic_4_UX_%s_M_k_p___A_n%.3ds%.4dr%.3d',dir_trunk,syn_infix,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
for nUX_rank=0:syn_n_UX_rank-1;
fname_pre = sprintf('%s_mat/tpmham_synthetic_4_UX_%s_Y_n%.3ds%.4dr%.3d_singlepc_rng%.3dnUX%.3d',dir_trunk,syn_infix,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank,syn_rseed,nUX_rank);
...
[syn_X_best_singlepc_,~,euler_polar_a__,euler_azimu_b__,euler_gamma_z__] = am_2(tmp_rseed,tmp_n_iteration,tmp_n_iteration_register,tmp_viewing_k_eq_d,tmp_n_order,tmp_n_k_p_r,tmp_k_p_r,tmp_k_p_r_max,tmp_weight_k_p_r,tmp_weight_2d_k_p_r,tmp_n_w,syn_n_M,tmp_M_k_p__,tmp_M_k_q__,1,ones(tmp_n_w_sum,1),tmp_l_max,tmp_a_k_Y_quad_,[],[],[],1,[]);
save(fname_mat ...
...
%%%%%%%%;
for nUX_rank=0:syn_n_UX_rank-1;
fname_pre = sprintf('%s_mat/tpmham_synthetic_4_UX_%s_Y_n%.3ds%.4dr%.3d_allshell_rng%.3dnUX%.3d',dir_trunk,syn_infix,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank,syn_rseed,nUX_rank);
fname_mat = sprintf('%s.mat',fname_pre);
fname_tmp = sprintf('%s.tmp',fname_pre);
if (~exist(fname_mat,'file') & ~exist(fname_tmp,'file'));
disp(sprintf(' %% %s not found, creating',fname_pre));
...
%%%%%%%%;
tmp_rseed=syn_rseed;tmp_n_iteration=syn_n_iteration;tmp_n_iteration_register=1;tmp_viewing_k_eq_d = 1/(2*pi);tmp_n_order = syn_n_order;
[syn_X_best_allshell_,~,euler_polar_a__,euler_azimu_b__,euler_gamma_z__] = am_2(tmp_rseed,tmp_n_iteration,tmp_n_iteration_register,tmp_viewing_k_eq_d,tmp_n_order,tmp_n_k_p_r,tmp_k_p_r_,tmp_k_p_r_max,tmp_weight_k_p_r_,tmp_weight_2d_k_p_r_,tmp_n_w_,syn_n_M,tmp_M_k_p__,tmp_M_k_q__,1,ones(tmp_n_w_sum,1),tmp_l_max_,tmp_a_k_Y_quad_,[],[],[],1,[]);
save(fname_mat ...
