...
%%%%%%%%;
% Here we determine point_pole_gx, ;
% which is the angle within the point_pole_template_k_c__ ;
% (denoted gammax below) ;
% such that the point_pole_template_k_c__ evaluated at that gammax ;
% (denoted point_pole_template_gammax_k_c_) ;
