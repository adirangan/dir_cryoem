function [ FA_x_c_ , X_1_ , X_2_ , X_3_ ]  = spharm_to_fig_8(n_k,k_,n_l_,a_,res,n_iso,angle_,delta_,transf_type);
...
% n_iso = number of isosurfaces to plot (default 2). ;
...
if nargin<8; delta_ = 0*0.125*[1,2,3]; end;
if nargin<7; angle_ = 0*[1*pi/4,1*pi/4,1*pi/6]; end;
if nargin<6; n_iso = 2; end;
