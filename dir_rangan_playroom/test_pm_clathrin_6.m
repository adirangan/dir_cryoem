...
verbose=1;
if (verbose); disp(sprintf(' %% [entering test_pm_clathrin_6]')); end;
...
%%%%%%%%;
% Now calculate the hessian of X_RS_xxzS____. ;
%%%%%%%%;


verbose=1;
if (verbose); disp(sprintf(' %% [finished test_pm_clathrin_6]')); end;
