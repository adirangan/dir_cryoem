%%%%%%%%;
Htv_q3d = ...
  + 1.0 * sum( conj(dtau_a_restore_C2M0_k_p_qk_) .* conj(a_k_p_qk_) .* (dvol_a_k_p_qk_) .* weight_3d_riesz_qk_ ) ...
  - 1.0 * sum( conj(dtau_a_restore_C1M1_k_p_qk_) .* (dvol_a_k_p_qk_) .* weight_3d_riesz_qk_ ) ...
  ;
