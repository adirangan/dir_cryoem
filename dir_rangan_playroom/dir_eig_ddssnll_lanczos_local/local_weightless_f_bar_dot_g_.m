function [tmp_fg,tmp_fg_dvol,tmp_fg_a,tmp_fg_b,tmp_fg_c] = local_weightless_f_bar_dot_g_(n_k_p_r,l_max_,n_M,tmp_f_ykabc_,tmp_g_ykabc_);
...
tmp_fg_dvol = local_weightless_f_dvol_bar_dot_g_dvol_(n_k_p_r,l_max_,tmp_f_dvol_yk_,tmp_g_dvol_yk_);
