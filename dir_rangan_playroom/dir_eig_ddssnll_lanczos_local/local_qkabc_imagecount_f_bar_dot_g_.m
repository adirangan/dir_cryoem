function [tmp_fg,tmp_fg_dvol,tmp_fg_a,tmp_fg_b,tmp_fg_c] = local_qkabc_imagecount_f_bar_dot_g_(n_q,n_k_p_r,weight_3d_riesz_k_p_qk_,n_M,weight_imagecount_M_,tmp_f_qkabc_,tmp_g_qkabc_);
n_qk = n_q*n_k_p_r;
