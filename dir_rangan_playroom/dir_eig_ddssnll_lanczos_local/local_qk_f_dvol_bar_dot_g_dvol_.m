...
n_qk = n_q*n_k_p_r;
if ~isempty(weight_3d_riesz_k_p_qk_); scaling_volumetric = (4*pi)^2 * sqrt(pi/2); end;
if  isempty(weight_3d_riesz_k_p_qk_); weight_3d_riesz_k_p_qk_ = ones(n_qk,1); scaling_volumetric = 1.0; end;
