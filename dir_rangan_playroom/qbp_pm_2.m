...
,data_k_c_2__ ...
,data_k_c_wMd__ ...
,index_quad_from_data_ ...
,quad_from_data_qwM__ ...
,n_quad_from_data_q_ ...
,data_from_quad_wMq__ ...
,VSCTF_wMc__ ...
,VSCTF2_qc__ ...
,VSCTF2_qcc___ ...
,VSCTF2_pinv_ccq___ ...
...
tmp_t = toc(tmp_t); disp(sprintf(' %% pm_l_max %d, n_S: %d, quad_k_eq_d %0.3f, flag_qbp_pm_solve_in_CTF_sequence %d, qbp_pm_2: %0.3fs',pm_l_max,n_S,parameter.quad_k_eq_d,parameter.flag_qbp_pm_solve_in_CTF_sequence,tmp_t));
%%%%;
tmp_t = tic();
...
if (nargin<1+na); UX_M_k_p_wnM__ = []; end; na=na+1;
if (nargin<1+na); n_CTF_rank = []; end; na=na+1;
if (nargin<1+na); VSCTF_Mc__ = []; end; na=na+1;
...
if (nargin<1+na); quad_azimu_b_all_ = []; end; na=na+1;
if (nargin<1+na); quad_polar_a_all_ = []; end; na=na+1;
if (nargin<1+na); quad_weight_all_ = []; end; na=na+1;
if (nargin<1+na); quad_k_c_0_all_ = []; end; na=na+1;
if (nargin<1+na); quad_k_c_1_all_ = []; end; na=na+1;
if (nargin<1+na); quad_k_c_2_all_ = []; end; na=na+1;
if (nargin<1+na); quad_k_c_qd__ = []; end; na=na+1;
if (nargin<1+na); Ylm__ = []; end; na=na+1;
if (nargin<1+na); Ylm_yq__ = []; end; na=na+1;
if (nargin<1+na); Ylm_w_yq__ = []; end; na=na+1;
if (nargin<1+na); data_k_p_polar_a__ = []; end; na=na+1;
if (nargin<1+na); data_k_p_azimu_b__ = []; end; na=na+1;
if (nargin<1+na); data_k_c_0__ = []; end; na=na+1;
if (nargin<1+na); data_k_c_1__ = []; end; na=na+1;
if (nargin<1+na); data_k_c_2__ = []; end; na=na+1;
if (nargin<1+na); data_k_c_wMd__ = []; end; na=na+1;
if (nargin<1+na); index_quad_from_data_ = []; end; na=na+1;
if (nargin<1+na); quad_from_data_qwM__ = []; end; na=na+1;
if (nargin<1+na); n_quad_from_data_q_ = []; end; na=na+1;
if (nargin<1+na); data_from_quad_wMq__ = []; end; na=na+1;
if (nargin<1+na); VSCTF_wMc__ = []; end; na=na+1;
if (nargin<1+na); VSCTF2_qc__ = []; end; na=na+1;
if (nargin<1+na); VSCTF2_qcc___ = []; end; na=na+1;
if (nargin<1+na); VSCTF2_pinv_ccq___ = []; end; na=na+1;

verbose = 0;
if (verbose>0); disp(sprintf(' %% [entering qbp_pm_2]')); end;
...
%%%%%%%%;
end;%if isempty(Ylm_w_yq__);
%%%%%%%%;
if isempty(data_k_c_wMd__);
%%%%%%%%;
[ ...
 data_k_p_polar_a__ ...
,data_k_p_azimu_b__ ...
...
end;%if isempty(VSCTF2_qcc___);
%%%%;
if isempty(VSCTF2_pinv_ccq___);
...
end;%if isempty(VSCTF2_pinv_ccq___);
%%%%;
...
if (~flag_unique_pm_n);
error(sprintf(' %% Error, set all values of pm_l_max, pm_n_lm and pm_n_w to be the same in cg_lsq_pm_2.'));
...
if (verbose>0); disp(sprintf(' %% [finished qbp_pm_2]')); end;  
