 ...
 * mex CFLAGS='$CFLAGS -fPIC -w -O3 -D_AVX -mavx -D_CBLAS -D_FMA -mfma -fopenmp' LDFLAGS='$LDFLAGS -fopenmp' mex_ampmh_X_wSM___15.c -lm -lfftw3_omp -lfftw3 -lfftw3f_omp -lfftw3f -lgslcblas -output /data/rangan/dir_cryoem/dir_rangan_playroom/mex_ampmh_X_wSM___15 ; ampmh_X_wSM_mex5___8 ;
 * compile from shell with: ;
 * gcc -fPIC -w -O3 -DWITHOUT_MEX -D_AVX -mavx -D_CBLAS -D_FMA -mfma -fopenmp mex_ampmh_X_wSM___15.c -lm -lfftw3_omp -lfftw3 -lfftw3f_omp -lfftw3f -lgslcblas ; ./a.out;
...
void test_transpose_float()
{
  /* 
     ...
     tmp_t = toc(tmp_t); disp(sprintf(' %% permute(A_nrm__,[2,1]): %0.6fs <-- %0.2f Gops',tmp_t,(n_row_A*n_row_B)/tmp_t/1e9));
   */
  int verbose=1;
...
int main()
{
  ...
  if (flag_test){
    ...
    printf(" %% finished testing, exiting before calling mex_ampmh_X_wSM___15_omp \n"); exit(0);
    /* if (flag_test){ } */}
  /* %%%%; */
  local_tic(0,t_start_,d_start_);
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,1,verbose+1,"mex_ampmh_X_wSM___15_omp: ");
...
void mexFunction(int nlhs,mxArray *plhs[],int nrhs,const mxArray *prhs[])
{
  ...
  /* %%%%%%%%%%%%%%%% */
  if (verbose){ printf(" %% [finished gateway mex_ampmh_X_wSM___15_omp]\n");}
}
#endif
