...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% test_principled_marching_helper_trpv1_alternating_minimization_synthetic_10. ;
...
if (~exist(MS_fname_mat,'file') & ~exist(MS_fname_tmp,'file'));
...
save(MS_fname_mat ...
     ...
     ,'image_delta_x_MS__','image_delta_y_MS__','image_X_value_MS__','image_S_index_MS__'...
     ,'syn_M_loading_MS__','syn_M_molecule_type_','syn_M_loading_MS_time' ...
     );
%%%%%%%%;
delete(MS_fname_tmp);
end;%if (~exist(MS_fname_mat,'file') & ~exist(MS_fname_tmp,'file'));
if ( exist(MS_fname_mat,'file') | exist(MS_fname_tmp,'file'));
...
tmp_rseed=syn_rseed;tmp_n_iteration=syn_n_iteration;tmp_n_iteration_register=1;
tmp_viewing_k_eq_d = 1/(2*pi)/sqrt(1);tmp_n_order = syn_n_order;
tmp_n_UX_rank = 1+nUX_rank;
flag_MS_vs_SM = 0;
f_rand = 0;
a_UX_Y_true_ = reshape(a_UX_Y_quad_mavg__(:,1:tmp_n_UX_rank),[n_lm_max*tmp_n_UX_rank,1]); %<-- use as ground truth for this set of principled-image-rings. ;
CTF_index_ = 1;
CTF_k_p__ = ones(n_w_sum,1);
tmp_t = tic();
[X_best_SM_...
...
,CTF_index_...
,CTF_k_p__...
,svd_VUXM_lwnM____(:,:,1:tmp_n_UX_rank,:)...
,[]...
,l_max_...
,a_UX_Y_true_...
...
save(SM_fname_mat ...
     ...
     ,'image_delta_x_SM__','image_delta_y_SM__','image_X_value_SM__','image_S_index_SM__'...
