...
if (flag_verbose>0); disp(sprintf(' %% npole %d/%d, fnorm(point_pole_polar_a-tmp_point_pole_polar_a): %0.16f',npole,n_w_max,fnorm(point_pole_polar_a-tmp_point_pole_polar_a))); end;
