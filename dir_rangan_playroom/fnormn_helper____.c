double fnormn_helper_z_vs_ff____(int n_0,int n_1,int n_2,int n_3,int flag_rup_A,double complex *z_A_,int flag_rup_B,float *f_B_real_,float *f_B_imag_)
{
  int n_0_rup=0,n_1_rup=0,n_2_rup=0,n_3_rup=0;
  int n_0_A_use=0,n_1_A_use=0,n_2_A_use=0,n_3_A_use=0;
  int n_0_B_use=0,n_1_B_use=0,n_2_B_use=0,n_3_B_use=0;
  int n0=0,n1=0,n2=0,n3=0;
  unsigned long long int tabA=0,tabB=0;
  double d_fnorm=0.0,d_denom=0.0,d_fnormn=0.0;
  double complex z_A;
  float f_B_real=0,f_B_imag=0;
  n_0_rup = rup(n_0,8); n_1_rup = rup(n_1,8); n_2_rup = rup(n_2,8); n_3_rup = rup(n_3,8);
  ...
  n_3_A_use = n_3; if (flag_rup_A){ n_3_A_use = n_3_rup;}
  ...
  n_3_B_use = n_3; if (flag_rup_B){ n_3_B_use = n_3_rup;}
	...
	for (n0=0;n0<n_0;n0++){
	  tabA =
	    ...
	    ((unsigned long long int)n1 +
	      ...
	      *(unsigned long long int)n_2_A_use)
	  ...
	  tabB =
	    ...
	    ((unsigned long long int)n1 +
	     ((unsigned long long int)n2 +
	      (unsigned long long int)n3
	      *(unsigned long long int)n_2_B_use)
	     *(unsigned long long int)n_1_B_use)
	    *(unsigned long long int)n_0_B_use;
	  z_A = z_A_[tabA];
	  f_B_real = f_B_real_[tabB];
	  f_B_imag = 0.0; if (f_B_imag_!=NULL){ f_B_imag = f_B_imag_[tabB];} if (f_B_imag_==NULL){ z_A = creal(z_A);}
...
double fnormn_helper_z_vs_c____(int n_0,int n_1,int n_2,int n_3,int flag_rup_A,double complex *z_A_,int flag_rup_B,float complex *c_B_)
{
  int n_0_rup=0,n_1_rup=0,n_2_rup=0,n_3_rup=0;
  int n_0_A_use=0,n_1_A_use=0,n_2_A_use=0,n_3_A_use=0;
  int n_0_B_use=0,n_1_B_use=0,n_2_B_use=0,n_3_B_use=0;
...
double fnormn_helper_ff_vs_c____(int n_0,int n_1,int n_2,int n_3,int flag_rup_A,float *f_A_real_,float *f_A_imag_,int flag_rup_B,float complex *c_B_)
{
  int n_0_rup=0,n_1_rup=0,n_2_rup=0,n_3_rup=0;
  int n_0_A_use=0,n_1_A_use=0,n_2_A_use=0,n_3_A_use=0;
  int n_0_B_use=0,n_1_B_use=0,n_2_B_use=0,n_3_B_use=0;
  ...
  for (n3=0;n3<n_3;n3++){
	...
	for (n0=0;n0<n_0;n0++){
	  ...
	  f_A_imag = 0.0; if (f_A_imag_!=NULL){ f_A_imag = f_A_imag_[tabA];} if (f_A_imag_==NULL){ c_B = crealf(c_B);}
