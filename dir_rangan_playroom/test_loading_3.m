...
%%%%;
subplot(p_row,p_col,1+np);np=np+1;
scatter3(SV_0a_Ml__(:,1),SV_0_Ml__(:,2),SV_0_Ml__(:,3),8,mod(0:n_M-1,3),'filled');axis vis3d; title('0a');
%%%%;
subplot(p_row,p_col,1+np);np=np+1;
scatter3(SV_0b_Ml__(:,1),SV_0_Ml__(:,2),SV_0_Ml__(:,3),8,mod(0:n_M-1,3),'filled');axis vis3d; title('0b');
%%%%;
subplot(p_row,p_col,1+np);np=np+1;
scatter3(SV_0c_Ml__(:,1),SV_0_Ml__(:,2),SV_0_Ml__(:,3),8,mod(0:n_M-1,3),'filled');axis vis3d; title('0c');
%%%%;
subplot(p_row,p_col,1+np);np=np+1;
