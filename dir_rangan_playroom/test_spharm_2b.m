function test_spharm_2b(n_l,a_,res_);
...
%{
  test_spharm_2b();
  % or something like: ;
  n_l =  2; a_ = [+0,+0,+0,+0,+0,+0,+1,+0,+0]; res_ = [96,96]; test_spharm_2b(n_l,a_,res_);
  n_l =  1; a_ = [+0,+0,+0,+1]; res_ = [96,96]; test_spharm_2b(n_l,a_,res_);
  %}
...
alpha = +1*pi/4; beta = 0*pi/2; gamma = 0*pi/6;
