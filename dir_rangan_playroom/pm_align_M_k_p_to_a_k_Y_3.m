...
CTF_UX_S_l2_SMi___ = zeros(n_S,n_M,n_iteration);
UX_M_l2_SMi___ = zeros(n_S,n_M,n_iteration);
%%%%%%%%;
rng(rseed);
...
CTF_UX_S_l2_SMi___(:,:,1+niteration) = CTF_UX_S_l2_SM__; %<-- these actually refer to end of iteration. ;
UX_M_l2_SMi___(:,:,1+niteration) = UX_M_l2_SM__; %<-- these actually refer to end of iteration. ;
%%%%%%%%;
