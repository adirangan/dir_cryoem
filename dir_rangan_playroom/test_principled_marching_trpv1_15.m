...
% 2. the delta_sigma used to calculate the cost is set to 0. ;
clear; setup;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_a_k_p_quad_',dir_trunk);
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_15_b_x_u_reco__.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_b_x_u_reco__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_a_k_Y_quad_A',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_a_k_Y_quad_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_S_k_p__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_S_k_p__A',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
nk_p_r = 12;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_CTF_k_p__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_CTF_k_p_r_xxxx__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_X_%s_A',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_X_%s_B',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_UX_%s_S_CTF_k_p___',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_UX_%s_S_CTF_k_q___',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_UX_%s_S_CTF_k_q___spectrum',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
n_plot=6;
for nplot=0:n_plot-1;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_UX_%s_S_CTF_k_p___A',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_euler_angle_marina_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_delta_read_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_M_x_c___center_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
N_x_c___ = M_x_c___;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_M_x_c___sample',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_UX_%s_M_k_p___',dir_trunk,str_combine);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_UX_%s_M_k_q___',dir_trunk,str_combine);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_UX_%s_M_k_q___spectrum',dir_trunk,str_combine);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
tmp_image_delta_x_ = +0.0*delta_read_x_(1+(0:n_image_sub-1));
tmp_image_delta_y_ = +0.0*delta_read_y_(1+(0:n_image_sub-1));
%%%%%%%%;
tmp_t = tic;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_15_c_x_u_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
