%%%%%%%%;
% tests ssnll_from_a_k_p_14 using ongrid images. ;
%%%%%%%%;
...
n_w_max = 2*n_w_int*(l_max_max+1); n_w_0in_ = n_w_max*ones(n_k_p_r,1);
[ ...
 n_w_ ...
,weight_2d_k_p_r_ ...
,weight_2d_wk_ ...
...
plot3(viewing_k_c_0_S_,viewing_k_c_1_S_,viewing_k_c_2_S_,'.');
...
%%%%;
nS = max(0,min(floor(n_S/2)-1,128));
S_k_p_wk_ = S_k_p_wkS__(:,1+nS);
tmp_azimu_b = viewing_azimu_b_S_(1+nS);
tmp_polar_a = viewing_polar_a_S_(1+nS);
tmp_gamma_z = 0.0;
...
%%%%;
nT = max(0,min(floor(n_S/2)-1,128));
...
parameter_ssnll.tolerance_pinv = 1e-6;
...
%%%%%%%%;
% Set up test with full set of 'on-grid' images, ;
%%%%%%%%;
%index_nS_from_nM_ = efind(abs(periodize(viewing_polar_a_S_,-pi/2,+pi/2))>1e-6); %<-- avoid poles. ;
index_nS_from_nM_ = transpose([0:n_S-1]); %<-- include poles. ;
n_M = numel(index_nS_from_nM_);
index_nCTF_from_nM_ = mod(mod(index_nS_from_nM_,5),2);
index_neta_from_nM_ = mod(mod(index_nS_from_nM_,3),2);
...
if flag_use_gamma_z_M==1;
euler_gamma_z_M_ = 2*pi*rand(n_M,1); %<-- yes rotate images. ; 
end;%if flag_use_gamma_z_M==1;
if flag_use_gamma_z_M==0;
euler_gamma_z_M_ = zeros(n_M,1); %<-- not rotate images. ;
end;%if flag_use_gamma_z_M==0;
for nM=0:n_M-1;
...
if flag_use_gamma_z_M==0;
dtau_euler_gamma_z_M_ = zeros(n_M,1);
end;%if flag_use_gamma_z_M==0;
...
ssnll_tst_avg_M_ = (ssnll_tst_pos_M_ + ssnll_tst_neg_M_)/2.0;
fnorm_disp(flag_verbose,'ssnll_tst_avg_M_',ssnll_tst_avg_M_,'ssnll_tst_mid_M_',ssnll_tst_mid_M_);
fnorm_disp(flag_verbose,'ssnll_tst_avg_M_',ssnll_tst_avg_M_,'ssnll_pwv_mid_M_',ssnll_pwv_mid_M_);
dvol_ssnll_tst_avg_M_ = (dvol_ssnll_tst_pos_M_ + dvol_ssnll_tst_neg_M_)/2.0;
fnorm_disp(flag_verbose,'dvol_ssnll_tst_avg_M_',dvol_ssnll_tst_avg_M_,'dvol_ssnll_tst_mid_M_',dvol_ssnll_tst_mid_M_);
fnorm_disp(flag_verbose,'dvol_ssnll_tst_avg_M_',dvol_ssnll_tst_avg_M_,'dvol_ssnll_pwv_mid_M_',dvol_ssnll_pwv_mid_M_);
%%%%%%%%;
...
ssnll_errabs_M_ = abs(ssnll_tst_avg_M_ - ssnll_tst_mid_M_);
dvol_ssnll_errabs_M_ = abs(dvol_ssnll_tst_avg_M_ - dvol_ssnll_tst_mid_M_);
dtau_ssnll_errabs_M_ = abs(dtau_ssnll_tst_dif_M_-dtau_ssnll_tst_mid_M_);
dtau_dvol_ssnll_errabs_M_ = abs(dtau_dvol_ssnll_tst_dif_M_-dtau_dvol_ssnll_tst_mid_M_);
dtau_dtau_ssnll_errabs_M_ = abs(dtau_dtau_ssnll_tst_dif_M_-dtau_dtau_ssnll_tst_mid_M_);
ssnll_errrel_M_ = abs(ssnll_tst_avg_M_ - ssnll_tst_mid_M_)./max(1e-12,abs(ssnll_tst_mid_M_));
dvol_ssnll_errrel_M_ = abs(dvol_ssnll_tst_avg_M_ - dvol_ssnll_tst_mid_M_)./max(1e-12,abs(dvol_ssnll_tst_mid_M_));
dtau_ssnll_errrel_M_ = abs(dtau_ssnll_tst_dif_M_-dtau_ssnll_tst_mid_M_)./max(1e-12,abs(dtau_ssnll_tst_mid_M_));
dtau_dvol_ssnll_errrel_M_ = abs(dtau_dvol_ssnll_tst_dif_M_-dtau_dvol_ssnll_tst_mid_M_)./max(1e-12,abs(dtau_dvol_ssnll_tst_mid_M_));
dtau_dtau_ssnll_errrel_M_ = abs(dtau_dtau_ssnll_tst_dif_M_-dtau_dtau_ssnll_tst_mid_M_)./max(1e-12,abs(dtau_dtau_ssnll_tst_mid_M_));

flag_disp=1;
if flag_disp;
%%%%%%%%;
figure(1+nf);nf=nf+1;clf;figbig;
p_row = 3; p_col = 5; npr=0; npc=0;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(ssnll_errabs_M_),'o');
xlim([-0,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
title('log10(ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(ssnll_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
title('log10(ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(ssnll_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
title('log10(ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dvol_ssnll_errabs_M_),'o');
xlim([-0,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
title('log10(dvol_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dvol_ssnll_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
title('log10(dvol_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dvol_ssnll_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
title('log10(dvol_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_ssnll_errabs_M_),'o');
xlim([-0,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
title('log10(dtau_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_ssnll_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
title('log10(dtau_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_ssnll_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
title('log10(dtau_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_errabs_M_),'o');
xlim([-0,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
title('log10(dtau_dvol_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
title('log10(dtau_dvol_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
title('log10(dtau_dvol_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_errabs_M_),'o');
xlim([-0,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
title('log10(dtau_dtau_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
title('log10(dtau_dtau_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
title('log10(dtau_dtau_ssnll_errabs_M_)','Interpreter','none'); grid on;
%%%%%%%%;
end;%if flag_disp;
...
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(ssnll_errrel_M_),'o');
xlim([-0,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
title('log10(ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(ssnll_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
title('log10(ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(ssnll_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
title('log10(ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dvol_ssnll_errrel_M_),'o');
xlim([-0,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
title('log10(dvol_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dvol_ssnll_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
title('log10(dvol_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dvol_ssnll_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
title('log10(dvol_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_ssnll_errrel_M_),'o');
xlim([-0,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
title('log10(dtau_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_ssnll_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
title('log10(dtau_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_ssnll_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
title('log10(dtau_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_errrel_M_),'o');
xlim([-0,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
title('log10(dtau_dvol_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
title('log10(dtau_dvol_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
title('log10(dtau_dvol_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_errrel_M_),'o');
xlim([-0,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
title('log10(dtau_dtau_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
title('log10(dtau_dtau_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+npc+npr*p_col);npr=npr+1; if npr==p_row;npr=0;npc=npc+1; end;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
title('log10(dtau_dtau_ssnll_errrel_M_)','Interpreter','none'); grid on;
%%%%%%%%;
end;%if flag_disp;
