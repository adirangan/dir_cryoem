...
x_s_0 = (nsource/n_source).^(0.25)*0.75/sqrt(2)*sin(3.5*pi*nsource/n_source);
x_s_1 = (nsource/n_source).^(0.25)*0.75/sqrt(2)*cos(5.7*pi*nsource/n_source);
...
subplot(1,2,1);imagesc(a_rho_x_u_,alim_); axis image; axisnotick;
subplot(1,2,2);imagesc(b_rho_x_u_,alim_); axis image; axisnotick;
end;%if flag_plot;
%%%%%%%%;
a_x_u_base_ = a_x_u_;
