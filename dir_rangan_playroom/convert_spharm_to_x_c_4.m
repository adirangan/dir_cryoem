...
verbose=0;
if (verbose); disp(sprintf(' %% [entering convert_spharm_to_x_c_4]')); end;
...
if flag_continue==1;
if (verbose); disp(sprintf(' %% compatible grids generated in convert_spharm_to_x_c_4')); end;
...
if (verbose); disp(sprintf(' %% [finished convert_spharm_to_x_c_4]')); end;
