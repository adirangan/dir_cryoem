...
fname_mat = sprintf('%s_mat/tpmham_synthetic_3_UX_M_k_p___n%.3ds%.4dr%.3d.mat',dir_trunk,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank);
...
%%%%%%%%;
fname_fig = sprintf('%s_mat/dir_jpg/tpmham_synthetic_3_UX_M_k_p___n%.3ds%.4dr%.3d',dir_trunk,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank);
...
%%%%%%%%;
fname_fig = sprintf('%s_mat/dir_jpg/tpmham_synthetic_3_UX_M_k_p___A_n%.3ds%.4dr%.3d',dir_trunk,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
[syn_X_best_singlepc_,~,euler_polar_a__,euler_azimu_b__,euler_gamma_z__] = am_1(tmp_rseed,tmp_n_iteration,tmp_n_iteration_register,tmp_viewing_k_eq_d,tmp_n_order,tmp_n_k_p_r,tmp_k_p_r,tmp_k_p_r_max,tmp_weight_k_p_r,tmp_weight_2d_k_p_r,tmp_n_w,syn_n_M,tmp_M_k_p__,tmp_M_k_q__,1,ones(tmp_n_w_sum,1),tmp_l_max,tmp_a_k_Y_quad_,[],[],[]);
save(fname_mat ...
