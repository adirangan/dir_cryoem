c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
      subroutine test_innerproduct_batch(verbose,svd_unitadd
...
c$$$
c$$$      integer svd_unitadd   added to svd_unitnumber within 
c$$$                            gen_Jsvd_svdload. Necessary for maintaining
c$$$                            unique file-identifiers when loading is
c$$$                            preformed across multiple threads.
c$$$
...
c$$$      parameters for timing
     ...
     $        ,' too small in test_innerproduct_batch'
      ...
      include './dir_gen_Jsvd_1/gen_Jsvd_svdload_2.txt'
      if (verbose.gt.1) then
