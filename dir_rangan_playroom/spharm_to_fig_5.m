function [ FA_x_c , X_1_ , X_2_ , X_3_ ]  = spharm_to_fig_5(n_k,k_,n_l_,a_,res,alpha_,delta_);
...
if (verbose); disp(sprintf(' %% res %d: numel FA_k_c_p %d , numel MOL_A_K_P_ %d , FA_x_c/nu_3d1 %f , nu_3d3/FA_x_c %f , nu_3d3/nu_3d1 %f',res,numel(FA_k_c_p),numel(MOL_A_K_P_), mean(FA_x_c(:))./mean(FA_x_c_nu3d1(:)) , mean(FA_x_c_nu3d3(:))./mean(FA_x_c(:)) , mean(FA_x_c_nu3d3(:))./mean(FA_x_c_nu3d1(:)) )); end;
