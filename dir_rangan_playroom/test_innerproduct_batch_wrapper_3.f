      subroutine test_innerproduct_batch_wrapper_3(verbose,n_S,n_M
...
c$$$      parameters for timing
      ...
      if (verbose.gt.0) then
          write(6,'(A)')
     $        '[entering test_innerproduct_batch_wrapper_3]: '
       end if
     ...
     $        ,' to sort the results:'
      ...
      call test_innerproduct_batch_sort(n_S,n_M,delta_x_max_SM_
     $     ,delta_y_max_SM_,gamma_z_max_SM_,C_Z_max_SM_,delta_x_sort_SM_
     $     ,delta_y_sort_SM_,gamma_z_sort_SM_,C_Z_sort_SM_,I_permute_SM_
     $     ,I_inverse_SM_)
      if (verbose.gt.1) then
      ...
      call test_innerproduct_batch_sort(n_M,n_S,delta_x_max_MS_
     $     ,delta_y_max_MS_,gamma_z_max_MS_,C_Z_max_MS_,delta_x_sort_MS_
     $     ,delta_y_sort_MS_,gamma_z_sort_MS_,C_Z_sort_MS_,I_permute_MS_
     $     ,I_inverse_MS_)
      if (verbose.gt.1) then
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_batch_wrapper_3]'
      end if
