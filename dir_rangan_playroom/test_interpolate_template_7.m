...
parameter.flag_parsimonious = 1;%parameter.flag_parsimonious = 0;
if ~exist('wS_sub_from_single_shell_sba__','var'); wS_sub_from_single_shell_sba__=[]; end;
if ~exist('dwS_subda_from_single_shell_sba__','var'); dwS_subda_from_single_shell_sba__=[]; end;
if ~exist('dwS_subdb_from_single_shell_sba__','var'); dwS_subdb_from_single_shell_sba__=[]; end;
if ~exist('ddwS_subdaa_from_single_shell_sba__','var'); ddwS_subdaa_from_single_shell_sba__=[]; end;
...
%%%%%%%%;
% Now call interpolate_template_8 using full calculation. ;
%%%%%%%%;
parameter.flag_verbose = 1+0*flag_verbose;
parameter.flag_check = 0;
...
if ~exist('a_R_k_p_Rqk__','var'); a_R_k_p_Rqk__=[]; end;
if ~exist('ba_from_single_shell_Rbaba___','var'); ba_from_single_shell_Rbaba___=[]; end;
if ~exist('wT_sub_from_R_single_shell_Rsba___','var'); wT_sub_from_R_single_shell_Rsba___=[]; end;
if ~exist('dwT_subda_from_R_single_shell_Rsba___','var'); dwT_subda_from_R_single_shell_Rsba___=[]; end;
if ~exist('dwT_subdb_from_R_single_shell_Rsba___','var'); dwT_subdb_from_R_single_shell_Rsba___=[]; end;
if ~exist('ddwT_subdaa_from_R_single_shell_Rsba___','var'); ddwT_subdaa_from_R_single_shell_Rsba___=[]; end;
if ~exist('ddwT_subdab_from_R_single_shell_Rsba___','var'); ddwT_subdab_from_R_single_shell_Rsba___=[]; end;
if ~exist('ddwT_subdbb_from_R_single_shell_Rsba___','var'); ddwT_subdbb_from_R_single_shell_Rsba___=[]; end;
[ ...
 parameter ...
,template_mi8_x_wkS_sub__ ...
,n_w ...
,n_viewing_S_sub ...
,viewing_azimu_b_S_sub_ ...
,viewing_polar_a_S_sub_ ...
...
,a_R_k_p_Rqk__ ...
,ba_from_single_shell_Rbaba___ ...
,wT_sub_from_R_single_shell_Rsba___ ...
,dtemplateda_mi8_wkS_sub__ ...
,dtemplatedb_mi8_wkS_sub__ ...
,dtemplatedc_mi8_wkS_sub__ ...
,dwS_subda_from_single_shell_sba__ ...
,dwS_subdb_from_single_shell_sba__ ...
,dwT_subda_from_R_single_shell_Rsba___ ...
,dwT_subdb_from_R_single_shell_Rsba___ ...
,ddtemplatedaa_mi8_wkS_sub__ ...
,ddtemplatedab_mi8_wkS_sub__ ...
,ddtemplatedac_mi8_wkS_sub__ ...
,ddtemplatedbb_mi8_wkS_sub__ ...
,ddtemplatedbc_mi8_wkS_sub__ ...
,ddtemplatedcc_mi8_wkS_sub__ ...
,ddwS_subdaa_from_single_shell_sba__ ...
,ddwS_subdab_from_single_shell_sba__ ...
,ddwS_subdbb_from_single_shell_sba__ ...
,ddwT_subdaa_from_R_single_shell_Rsba___ ...
,ddwT_subdab_from_R_single_shell_Rsba___ ...
,ddwT_subdbb_from_R_single_shell_Rsba___ ...
] = ...
...
% Display errors. ;
%%%%%%%%;
fnorm_disp(flag_verbose,'template_mid_x_wkS_sub__',template_mid_x_wkS_sub__,'template_mi8_x_wkS_sub__',template_mi8_x_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'dtemplateda_mid_wkS_sub__',dtemplateda_mid_wkS_sub__,'dtemplateda_mi8_wkS_sub__',dtemplateda_mi8_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'dtemplatedb_mid_wkS_sub__',dtemplatedb_mid_wkS_sub__,'dtemplatedb_mi8_wkS_sub__',dtemplatedb_mi8_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'dtemplatedc_mid_wkS_sub__',dtemplatedc_mid_wkS_sub__,'dtemplatedc_mi8_wkS_sub__',dtemplatedc_mi8_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedaa_mid_wkS_sub__',ddtemplatedaa_mid_wkS_sub__,'ddtemplatedaa_mi8_wkS_sub__',ddtemplatedaa_mi8_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedab_mid_wkS_sub__',ddtemplatedab_mid_wkS_sub__,'ddtemplatedab_mi8_wkS_sub__',ddtemplatedab_mi8_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedac_mid_wkS_sub__',ddtemplatedac_mid_wkS_sub__,'ddtemplatedac_mi8_wkS_sub__',ddtemplatedac_mi8_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedbb_mid_wkS_sub__',ddtemplatedbb_mid_wkS_sub__,'ddtemplatedbb_mi8_wkS_sub__',ddtemplatedbb_mi8_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedbc_mid_wkS_sub__',ddtemplatedbc_mid_wkS_sub__,'ddtemplatedbc_mi8_wkS_sub__',ddtemplatedbc_mi8_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedcc_mid_wkS_sub__',ddtemplatedcc_mid_wkS_sub__,'ddtemplatedcc_mi8_wkS_sub__',ddtemplatedcc_mi8_wkS_sub__,' %%<-- should be zero');

%if (flag_verbose>0); disp(sprintf(' %% returning before testing difference quotient')); end; disp('returning'); return;
