...
if (verbose); disp(sprintf(' %% [entering ampmut_1_debug]')); end;
...
% If we had not included the displacements +image_delta_x_ and +image_delta_y_ above, ;
% we would include them below (also with a positive-sign). ;
%%%%%%%%;
tmp_t = tic();
...
if (verbose); disp(sprintf(' %% [finished ampmut_1_debug]')); end;
