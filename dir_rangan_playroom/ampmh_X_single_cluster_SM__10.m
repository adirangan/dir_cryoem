...
verbose = 0;
if (verbose>0); disp(sprintf(' %% [entering ampmh_X_single_cluster_SM__10]')); end;
...
parameter = parameter_timing_update(parameter,'ampmh_X_single_cluster_SM__10: svd_VUXM_nMwl____',tmp_t);
%%%%%%%%;
tmp_t = tic();
...
parameter = parameter_timing_update(parameter,'ampmh_X_single_cluster_SM__10: svd_SVUXM_SMwl____',tmp_t);
tmp_t = tic();
...
parameter = parameter_timing_update(parameter,'ampmh_X_single_cluster_SM__10: svd_SVUXM_lwSM____',tmp_t);
%%%%%%%%;
...
parameter = parameter_timing_update(parameter,'ampmh_X_single_cluster_SM__10: svd_USESVUXM_dwSM____',tmp_t);
...
parameter = parameter_timing_update(parameter,'ampmh_X_single_cluster_SM__10: X_sub_dwSM____',tmp_t);
%%%%%%%%;
flag_check=0;
if flag_check;
...
parameter = parameter_timing_update(parameter,'ampmh_X_single_cluster_SM__10: X_wSM___',tmp_t);
%%%%%%%%;
end;%if (n_S_sub>0);
...
if (verbose>1); disp(sprintf(' %% [finished ampmh_X_single_cluster_SM__10]')); end;
