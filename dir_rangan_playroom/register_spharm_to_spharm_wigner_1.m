...
%%%%%%%%;
N_wavelength = 1.0; %<-- make this small to speed up calculation. ;
%%%%%%%%;
if (N_wavelength==0);
...
[n_delta_all,n_delta_all_csum_,delta_p_r_all_,delta_p_azimu_b_all_,delta_p_polar_a_all_,weight_delta_all_,weight_shell_delta_,n_delta_p_r,delta_p_r_,weight_delta_p_r_,delta_c_0_all_,delta_c_1_all_,delta_c_2_all_] = sample_sphere_6(sub_verbose,delta_p_r_max,delta_eq_d,'L') ;
...
[X_base__] = register_spharm_to_spharm_single_beta_2(sub_verbose,n_k_p_r,k_p_r_,weight_3d_k_p_r_,l_max_,a_k_Y_norm_,b_k_Y_norm_,polar_a,0,[],0,[],[],[],[],[]);
...
[X_node__] = register_spharm_to_spharm_single_beta_2(sub_verbose,n_k_p_r,k_p_r_,weight_3d_k_p_r_,l_max_,a_k_Y_norm_,b_k_Y_node__(:,ndelta_node),polar_a,0,[],0,[],[],[],[],[]);
