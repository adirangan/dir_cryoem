...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_rib80s_0_X__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
n_M = n_image_sub;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_rib80s_0_X_TM_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
markersize_use = 32;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_rib80s_0_X_2d_xcor_d0_vs_2d_Memp_d1_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf; hold on;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_rib80s_0_X_%s__.mat',dir_trunk,str_cost);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_rib80s_0_UX_%s_M_k_p___.mat',dir_trunk,str_cost);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
O_k_p__ = zeros(n_w_sum,n_image_sub); %<-- holds not centered images (i.e., original). ;
M_k_p__ = zeros(n_w_sum,n_image_sub); %<-- holds yes centered images (except, actually not centered). ;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_rib80s_0_UX_%s_M_k_p___',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_rib80s_0_UX_%s_M_k_q___',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_rib80s_0_UX_%s_M_k_q___spectrum',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
flag_skip_to_plot = 1; %<-- skip over main computation and plot figures (as best as possible). ;
if flag_compute;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
%%%%%%%%;
