...
str_thisfunction = 'kappa_qpro_apply_2';
...
[parameter,KAPPA] = kappa_qpro_apply_2(parameter);
%%%%%%%%;
n_w_max = 98;
n_M = 13;
rng(0);
...
parameter.flag_recalc_dtau_qref_from_data=0;
parameter.flag_recalc_dtau_dtau_qref_from_data=0;
[parameter,KAPPA] = kappa_qpro_apply_2(parameter,KAPPA,n_w_max,n_M,viewing_polar_a_M_,viewing_azimu_b_M_,viewing_gamma_z_M_);
%%%%%%%%;
n_k_p_r = 2;
