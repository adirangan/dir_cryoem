...
%%;
if k_int==8;
sigma_angstrom = 48.0/2; %<-- low resolution. ;
k_eq_d_double = 0.50;
t_eq_d_double = 0.50;
n_w_int = 2;
...
%%;
if k_int==16;
sigma_angstrom = 32.0/2; %<-- low resolution. ;
k_eq_d_double = 0.50;
t_eq_d_double = 0.50;
n_w_int = 2;
KAPPA_flag_kernel_full = 1;
...
%%;
if k_int==32;
sigma_angstrom = 24.0/2; %<-- low resolution. ;
k_eq_d_double = 0.50;
t_eq_d_double = 0.50;
n_w_int = 2;
KAPPA_flag_kernel_full = 1;
...
%%;
if k_int==48;
sigma_angstrom = 16.0/2; %<-- low resolution. ;
k_eq_d_double = 1.00;
t_eq_d_double = 1.00;
n_w_int = 1;
KAPPA_flag_kernel_full = 1;
...
%sigma_angstrom = 4.0; %<-- low resolution. ;
