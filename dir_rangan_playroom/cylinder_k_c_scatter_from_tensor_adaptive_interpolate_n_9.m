...
if flag_d; dweight_0_xxs_sub_ = reshape(repmat(reshape(weight_dnumerator_0_from_nk_c_0_./weight_denominator_0_from_nk_c_0_,[1,n_xs_sub]),[n_nodex,1]),[n_nodex*n_xs_sub,1]) / dk_c_0 ; end;
if flag_dd; ddweight_0_xxs_sub_ = reshape(repmat(reshape(weight_ddnumerator_0_from_nk_c_0_./weight_denominator_0_from_nk_c_0_,[1,n_xs_sub]),[n_nodex,1]),[n_nodex*n_xs_sub,1]) / dk_c_0^2 ; end;
...
if flag_d; dweight_1_xxs_sub__ = bsxfun(@rdivide,weight_dnumerator_1_xxs_sub__,reshape(weight_denominator_1_x_,[n_nodex,1])) / dk_c_1 ; end;
if flag_dd; ddweight_1_xxs_sub__ = bsxfun(@rdivide,weight_ddnumerator_1_xxs_sub__,reshape(weight_denominator_1_x_,[n_nodex,1])) / dk_c_1^2 ; end;
