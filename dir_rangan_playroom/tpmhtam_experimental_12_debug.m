function tpmhtam_experimental_12_debug(...
 dat_infix...
,dat_rseed...
,dat_n_M...
,dat_M_k_p__...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% test_principled_marching_helper_trpv1_alternating_minimization_experimental_12_debug. ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
disp(sprintf(' %% SM_fname_mat: %s',SM_fname_mat));
disp(sprintf(' %% X_best_SM_:'));
disp(num2str(transpose(tmp_.X_best_SM_))); 
clear tmp_;
SM_fname_pre = sprintf('%s_SM_%s_debug',fname_0,fname_2);
SM_fname_mat = sprintf('%s.mat',SM_fname_pre);
%SM_fname_tmp = sprintf('%s.tmp',SM_fname_pre);
if (1 | ~exist(SM_fname_mat,'file'));
flag_skip=0;
SM_fname_tmp = sprintf('%s.tmp',SM_fname_pre);
