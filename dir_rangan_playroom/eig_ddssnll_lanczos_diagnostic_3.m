...
,ori_n_k_all_csum_ ...
,ori_k_p_r_all_ ...
,ori_k_p_azimu_b_all_ ...
,ori_k_p_polar_a_all_ ...
,ori_weight_3d_k_all_ ...
,ori_weight_shell_k_ ...
,ori_n_k_p_r ...
,ori_k_p_r_ ...
,ori_weight_3d_k_p_r_ ...
,ori_l_max_ ...
,ori_Ylm_uklma___ ...
,ori_k_p_azimu_b_sub_uka__ ...
,ori_k_p_polar_a_sub_uka__ ...
,ori_l_max_uk_ ...
,ori_index_nu_n_k_per_shell_from_nk_p_r_ ...
,ori_index_k_per_shell_uka__ ...
,ori_from_pm_UX_kn__ ...
,ori_X_weight_r_ ...
,n_x_u ...
...
str_thisfunction = 'eig_ddssnll_lanczos_diagnostic_3';
...
if (nargin<1+na); ori_n_k_all=[]; end; na=na+1;
if (nargin<1+na); ori_n_k_all_csum_=[]; end; na=na+1;
if (nargin<1+na); ori_k_p_r_all_=[]; end; na=na+1;
if (nargin<1+na); ori_k_p_azimu_b_all_=[]; end; na=na+1;
if (nargin<1+na); ori_k_p_polar_a_all_=[]; end; na=na+1;
if (nargin<1+na); ori_weight_3d_k_all_=[]; end; na=na+1;
if (nargin<1+na); ori_weight_shell_k_=[]; end; na=na+1;
if (nargin<1+na); ori_n_k_p_r=[]; end; na=na+1;
if (nargin<1+na); ori_k_p_r_=[]; end; na=na+1;
if (nargin<1+na); ori_weight_3d_k_p_r_=[]; end; na=na+1;
if (nargin<1+na); ori_l_max_=[]; end; na=na+1;
if (nargin<1+na); ori_Ylm_uklma___=[]; end; na=na+1;
if (nargin<1+na); ori_k_p_azimu_b_sub_uka__=[]; end; na=na+1;
if (nargin<1+na); ori_k_p_polar_a_sub_uka__=[]; end; na=na+1;
if (nargin<1+na); ori_l_max_uk_=[]; end; na=na+1;
if (nargin<1+na); ori_index_nu_n_k_per_shell_from_nk_p_r_=[]; end; na=na+1;
if (nargin<1+na); ori_index_k_per_shell_uka__=[]; end; na=na+1;
if (nargin<1+na); ori_from_pm_UX_kn__=[]; end; na=na+1;
if (nargin<1+na); ori_X_weight_r_=[]; end; na=na+1;
...
%%%%%%%%;
if isempty(ori_n_k_all); ori_n_k_all = n_k_all; end;
if isempty(ori_n_k_all_csum_); ori_n_k_all_csum_ = n_k_all_csum_; end;
if isempty(ori_k_p_r_all_); ori_k_p_r_all_ = k_p_r_all_; end;
if isempty(ori_k_p_azimu_b_all_); ori_k_p_azimu_b_all_ = k_p_azimu_b_all_; end;
if isempty(ori_k_p_polar_a_all_); ori_k_p_polar_a_all_ = k_p_polar_a_all_; end;
if isempty(ori_weight_3d_k_all_); ori_weight_3d_k_all_ = weight_3d_k_all_; end;
if isempty(ori_weight_shell_k_); ori_weight_shell_k_ = weight_shell_k_; end;
if isempty(ori_n_k_p_r); ori_n_k_p_r = n_k_p_r; end;
if isempty(ori_k_p_r_); ori_k_p_r_ = k_p_r_; end;
if isempty(ori_weight_3d_k_p_r_); ori_weight_3d_k_p_r_ = weight_3d_k_p_r_; end;
if isempty(ori_l_max_); ori_l_max_ = l_max_; end;
if isempty(ori_Ylm_uklma___); ori_Ylm_uklma___ = Ylm_uklma___; end;
if isempty(ori_k_p_azimu_b_sub_uka__); ori_k_p_azimu_b_sub_uka__ = k_p_azimu_b_sub_uka__; end;
if isempty(ori_k_p_polar_a_sub_uka__); ori_k_p_polar_a_sub_uka__ = k_p_polar_a_sub_uka__; end;
if isempty(ori_l_max_uk_); ori_l_max_uk_ = l_max_uk_; end;
if isempty(ori_index_nu_n_k_per_shell_from_nk_p_r_); ori_index_nu_n_k_per_shell_from_nk_p_r_ = index_nu_n_k_per_shell_from_nk_p_r_; end;
if isempty(ori_index_k_per_shell_uka__); ori_index_k_per_shell_uka__ = index_k_per_shell_uka__; end;
if isempty(ori_from_pm_UX_kn__); ori_from_pm_UX_kn__ = eye(ori_n_k_p_r,n_k_p_r); end;
if isempty(ori_X_weight_r_); ori_X_weight_r_ = ones(ori_n_k_p_r,1); end;
%%%%;
...
%%%%%%%%;
ori_n_lm_ = (ori_l_max_+1).^2;
ori_n_lm_max = max(ori_n_lm_);
ori_n_lm_sum = sum(ori_n_lm_);
ori_n_lm_csum_ = cumsum([0;ori_n_lm_]);
ori_l_max_max = max(ori_l_max_);
%%%%%%%%;
ori_k_c_0_all_ = cos(ori_k_p_azimu_b_all_).*sin(ori_k_p_polar_a_all_);
ori_k_c_1_all_ = sin(ori_k_p_azimu_b_all_).*sin(ori_k_p_polar_a_all_);
ori_k_c_2_all_ = cos(ori_k_p_polar_a_all_);
%%%%%%%%;
...
ori_a_k_Y_reco_yk_ = zeros(ori_n_lm_sum,1);
pm_n_UX_rank = n_k_p_r;
for nUX_rank=0:pm_n_UX_rank-1;
for ori_nk_p_r=0:ori_n_k_p_r-1;
ori_tmp_l_max = ori_l_max_(1+ori_nk_p_r);
ori_tmp_n_lm = (ori_tmp_l_max+1).^2;
ori_tmp_index_ = ori_n_lm_csum_(1+ori_nk_p_r) + (0:ori_tmp_n_lm-1);
ori_a_k_Y_reco_yk_(1+ori_tmp_index_) = ori_a_k_Y_reco_yk_(1+ori_tmp_index_) + ori_from_pm_UX_kn__(1+ori_nk_p_r,1+nUX_rank)/max(1e-12,ori_X_weight_r_(1+ori_nk_p_r))*a_k_Y_quad_yk__(1:ori_tmp_n_lm,1+nUX_rank);
end;%for ori_nk_p_r=0:ori_n_k_p_r-1;
end;%for nUX_rank=0:pm_n_UX_rank-1;
%%%%%%%%;
tmp_t = tic;
if ~exist('ori_Ylm_uklma___','var'); ori_Ylm_uklma___ = []; end;
if ~exist('ori_k_p_azimu_b_sub_uka__','var'); ori_k_p_azimu_b_sub_uka__ = []; end;
if ~exist('ori_k_p_polar_a_sub_uka__','var'); ori_k_p_polar_a_sub_uka__ = []; end;
if ~exist('ori_l_max_uk_','var'); ori_l_max_uk_ = []; end;
if ~exist('ori_index_nu_n_k_per_shell_from_nk_p_r_','var'); ori_index_nu_n_k_per_shell_from_nk_p_r_ = []; end;
if ~exist('ori_index_k_per_shell_uka__','var'); ori_index_k_per_shell_uka__ = []; end;
[ ...
 ori_a_k_p_reco_ ...
,ori_Ylm_uklma___ ...
,ori_k_p_azimu_b_sub_uka__ ...
...
tmp_t = toc(tmp_t); disp(sprintf(' %% ori_a_k_p_reco_ time %0.2fs',tmp_t));
%%%%;
eta = pi/k_p_r_max; tmp_t = tic;
ori_a_x_u_reco_ = xxnufft3d3(ori_n_k_all,2*pi*ori_k_c_0_all_*eta,2*pi*ori_k_c_1_all_*eta,2*pi*ori_k_c_2_all_*eta,ori_a_k_p_reco_.*(2*pi)^3.*ori_weight_3d_k_all_,+1,1e-12,n_xxx_u,x_u_0___(:)/eta,x_u_1___(:)/eta,x_u_2___(:)/eta)/sqrt(2*pi)/sqrt(2*pi)/sqrt(2*pi);
tmp_t = toc(tmp_t); disp(sprintf(' %% xxnufft3d3: ori_a_x_u_reco_ time %0.2fs',tmp_t));
%%%%;
...
isosurface_f_x_u_1(struct('percent_threshold_',[percent_threshold]),ori_a_x_u_reco_);
...
v_k_Y_use_yk__ = local_yk__from_yk_(n_k_p_r,l_max_,v_k_Y_use_yk_);
ori_v_k_Y_reco_yk_ = zeros(ori_n_lm_sum,1);
pm_n_UX_rank = n_k_p_r;
for nUX_rank=0:pm_n_UX_rank-1;
for ori_nk_p_r=0:ori_n_k_p_r-1;
ori_tmp_l_max = ori_l_max_(1+ori_nk_p_r);
ori_tmp_n_lm = (ori_tmp_l_max+1).^2;
ori_tmp_index_ = ori_n_lm_csum_(1+ori_nk_p_r) + (0:ori_tmp_n_lm-1);
ori_v_k_Y_reco_yk_(1+ori_tmp_index_) = ori_v_k_Y_reco_yk_(1+ori_tmp_index_) + ori_from_pm_UX_kn__(1+ori_nk_p_r,1+nUX_rank)/max(1e-12,ori_X_weight_r_(1+ori_nk_p_r))*v_k_Y_use_yk__(1:ori_tmp_n_lm,1+nUX_rank);
end;%for ori_nk_p_r=0:ori_n_k_p_r-1;
end;%for nUX_rank=0:pm_n_UX_rank-1;
%%%%;
tmp_t = tic;
...
tmp_t = toc(tmp_t); disp(sprintf(' %% ori_v_k_p_reco_ time %0.2fs',tmp_t));
%%%%;
eta = pi/k_p_r_max; tmp_t = tic;
ori_v_x_u_reco_ = xxnufft3d3(ori_n_k_all,2*pi*ori_k_c_0_all_*eta,2*pi*ori_k_c_1_all_*eta,2*pi*ori_k_c_2_all_*eta,ori_v_k_p_reco_.*(2*pi)^3.*ori_weight_3d_k_all_,+1,1e-12,n_xxx_u,x_u_0___(:)/eta,x_u_1___(:)/eta,x_u_2___(:)/eta)/sqrt(2*pi)/sqrt(2*pi)/sqrt(2*pi);
tmp_t = toc(tmp_t); disp(sprintf(' %% xxnufft3d3: ori_v_x_u_reco_ time %0.2fs',tmp_t));
%%%%;
if flag_disp;
...
for percent_threshold=[05:10:95];
subplot(p_row,p_col,1+np);np=np+1;cla;
isosurface_f_x_u_1(struct('percent_threshold_',[percent_threshold]),ori_v_x_u_reco_);
title(sprintf('p %.2f',percent_threshold));
end;%for percent_threshold=[05:10:95];
...
ori_v_x_u_reco___ = reshape(ori_v_x_u_reco_,[n_x_u,n_x_u,n_x_u]);
subplot(1,3,1);
imagesc(squeeze(real(ori_v_x_u_reco___(:,:,end/2))));
...
if flag_replot | ~exist(fname_fig_sub_jpg,'file');
figure(1+nf);nf=nf+1;clf;figbig;fig80s;
vmax = max(abs(ori_v_x_u_reco_),[],'all');
amax = max(abs(ori_a_x_u_reco_),[],'all');
...
prct = prct_(1+prow);
dvol = dvol_(1+pcol);
tmp_ori_a_x_u_reco_ = ori_a_x_u_reco_/max(1e-12,amax) + dvol*ori_v_x_u_reco_/max(1e-12,vmax);
isosurface_f_x_u_1(struct('percent_threshold_',[prct]),tmp_ori_a_x_u_reco_);
...
tmp_dtau_euler_nrm_polar_a_M_ = tmp_dtau_euler_polar_a_M_/max(1e-12,tmp_dtau_euler_fnorm);
tmp_dtau_euler_nrm_azimu_b_M_ = tmp_dtau_euler_azimu_b_M_/max(1e-12,tmp_dtau_euler_fnorm);
tmp_dtau_euler_nrm_gamma_z_M_ = tmp_dtau_euler_gamma_z_M_/max(1e-12,tmp_dtau_euler_fnorm);
factor_amplify = 2.0;
%{
subplot(1,2,1);
plot_sphere_grid_0;
