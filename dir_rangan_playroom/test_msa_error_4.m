...
disp(sprintf(' %% 1. typical distance between A00_wk__ and N00_new_wk__: %0.9f',sqrt(mean(sum(abs(A00_wk__ - N00_new_wk__).^2,2)))));
disp(sprintf(' %% 1. predicted L2_A00_vs_N00_new/sqrt(2*pi): %0.9f',L2_A00_vs_N00_new/sqrt(2*pi)));
...
A00_at_new_vs_N00_new_at_two_Mk__ = A00_at_new_Mk__ - N00_new_at_two_Mk__;
...
gamma_dif_M_ = periodize(gamma_two_M_-gamma_new_M_,-pi,+pi);
...
disp(sprintf(' %% typical N00_new_at_new_vs_N00_new_at_two_Mk__: %0.9f',mean(abs(N00_new_at_new_vs_N00_new_at_two_Mk__))));
disp(sprintf(' %% predicted distance between gamma_new_M_ and gamma_two_M_: %0.9f',mean(sin(theta_Ap0_vs_Np0_new_w_))))
disp(sprintf(' %% 1. typical sqrt(sum(abs(A00_at_new_vs_N00_new_at_new_Mk__).^2,2): %0.9f',sqrt(mean(sum(abs(A00_at_new_vs_N00_new_at_new_Mk__).^2,2)))));
disp(sprintf(' %% 2. typical sqrt(sum(abs(A00_at_new_vs_N00_new_at_two_Mk__).^2,2): %0.9f',sqrt(mean(sum(abs(A00_at_new_vs_N00_new_at_two_Mk__).^2,2)))));
disp(sprintf(' %% 3. typical sqrt(sum(abs(N00_new_at_new_vs_N00_new_at_two_Mk__).^2,2): %0.9f',sqrt(mean(sum(abs(N00_new_at_new_vs_N00_new_at_two_Mk__).^2,2)))));
disp(sprintf(' %% typical abs(gamma_dif_M_): %0.9f',sqrt(mean(abs(gamma_dif_M_).^2))));
disp(sprintf(' %% 3. typical abs(sqrt(sum(abs(Np0_new_at_new_Mk__).^2,2)).*gamma_dif_M_): %0.9f',sqrt(mean(sum(abs(bsxfun(@times,Np0_new_at_new_Mk__,gamma_dif_M_)).^2,2)))));
