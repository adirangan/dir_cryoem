...
dir_pm = sprintf('/%s/rangan/dir_cryoem/dir_p28hRPT3/dir_pm',string_root);
...
dir_relion = sprintf('/%s/rangan/dir_cryoem/dir_p28hRPT3/dir_relion',string_root);
...
fname_nopath_volume = 'emd_8676.map'; %<-- class T3. ;
%%%%%%%%;
