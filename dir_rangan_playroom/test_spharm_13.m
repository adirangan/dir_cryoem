function X_best = test_spharm_13(n_k,k_,n_l_,a_,b_);
...
% The optimal alignment should be the inverse of the preliminary transformation, ;
% yielding an innerproduct of exactly 1. ;
% However, the preliminary rotation and displacement are technically 'off grid', since ;
% their composition cannot be undone by a single pass of this greedy alternating algorithm. ;
% With this kind of initial preparation, the alternating algorithm should ;
% proceed over several iterations, and hopefully converge to 1. ;
% However, as can be seen, it is possible for this convergence to be rather slow. ;
% ;
% Inputs: ;
...
%%%%%%%%%%%%%%%% ;
alpha__in_ = [+alpha_(2),+beta_(3),+gamma_(4)];
...
%%%%%%%%%%%%%%%% ;
delta__in_ = [+delta_x_(1),+delta_y_(2),+delta_z_(3)];
