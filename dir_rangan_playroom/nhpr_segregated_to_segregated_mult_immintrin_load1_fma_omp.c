...
/* The helper function */
/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
void nhpr_segregated_to_segregated_mult_immintrin_load1_fma_omp_helper
(
 int n_row_A
 ,int n_col_X
 ,float *f_AR_trn__
 ...
 )
{
  ...
  char str_thisfunction[] = "nhpr_segregated_to_segregated_mult_immintrin_load1_fma_omp_helper";
  f_CR__=NULL;
  if (f_CR_p_!=NULL){
...
void nhpr_segregated_to_segregated_mult_immintrin_load1_fma_omp
(
 int n_row_A
 ,int n_col_X
 ,float *f_AR_trn__
 ...
 )
{
  ...
  if ((f_CR__!=NULL) && (f_CI__!=NULL)){
	...
	nhpr_segregated_to_segregated_mult_immintrin_load1_fma_omp_helper
	  (
	   n_row_A
	   ,n_col_X
	   ,f_AR_trn__
