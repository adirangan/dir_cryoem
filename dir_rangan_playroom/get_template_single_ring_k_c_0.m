...
%%%%%%%%;
% Given a list of n_viewing_all template-viewing-angles: ;
% [viewing_azimu_b_all_(1+nviewing_all),viewing_polar_a_all_(1+nviewing_all)], ;
% this function computes the location of the template-points: ;
% [ ...
%   template_k_c_0__(1+nw,1+nviewing_all) ...
%  ,template_k_c_1__(1+nw,1+nviewing_all) ...
%  ,template_k_c_2__(1+nw,1+nviewing_all) ...
% ];
% where nw indexes the polar-angle gamma_z within the template itself ;
% (i.e., gamma_z = (2*pi*nw)/n_w_max). ;
% Note that these locations are on the unit-sphere, ;
% and must be scaled before they correspond to a particular ring. ;
%%%%%%%%;
