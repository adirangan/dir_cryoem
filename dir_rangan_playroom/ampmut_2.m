...
if (verbose); disp(sprintf(' %% [testing ampmut_2.m]')); end;
%%%%%%%%;
...
tmp_t = toc(tmp_t); disp(sprintf(' %% ampmut_2: time %0.2fs',tmp_t));
%%%%;
%%%%%%%%;
...
verbose=2;
if (verbose); disp(sprintf(' %% [entering ampmut_2]')); end;
...
if (verbose); disp(sprintf(' %% [finished ampmut_2]')); end;
