      subroutine test_innerproduct_batch_sort_a(n_S,n_M,delta_x_max_
     $    ,delta_y_max_,gamma_z_max_,C_S_max_,C_Z_max_,delta_x_sort_
     $    ,delta_y_sort_,gamma_z_sort_,C_S_sort_,C_Z_sort_,I_permute_
     $    ,I_inverse_)
c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
c$$$                            holds the (complex) l2_norm associated with
c$$$                            the template S rotated by the appropriate
c$$$                            gamma_z and multiplied by the image-dependent
c$$$                            ctf-function.
c$$$                            (output of test_innerproduct_svdread_batch.f)
c$$$
...
c$$$                            Each segment of length n_S holds the values
c$$$                            of delta_y_max_ associated with the template
c$$$                            indices that match C_Z_sort_.
c$$$
c$$$      real *8 gamma_z_sort_ Array of size n_S*n_M.
c$$$                            Each segment of length n_S holds the values
c$$$                            of gamma_z_max_ associated with the template
c$$$                            indices that match C_Z_sort_.
c$$$
c$$$      complex *16 C_S_sort_ Array of size n_S*n_M.
c$$$                            Each segment of length n_S holds the values
c$$$                            of C_S_max_ associated with the template
c$$$                            indices that match C_Z_sort_.
c$$$
c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
      implicit none
      ...
      complex *16 C_S_sort_(0:n_S*n_M-1)
     ...
     $           *n_S)+nm*n_S)
            C_S_sort_(ns+nm*n_S) = C_S_max_(I_permute_(ns+nm
     $           *n_S)+nm*n_S)
         enddo
      enddo
      end
