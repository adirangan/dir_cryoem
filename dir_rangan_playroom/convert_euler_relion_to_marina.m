function euler_out_ = convert_euler_relion_to_marina(euler_0in_);
euler_out_ = rot_mat_to_euler(relion_euler_rot_mat(euler_0in_(1)*pi/180,euler_0in_(2)*pi/180,euler_0in_(3)*pi/180));
euler_out_(1) = acos(euler_out_(1));

function RMat = relion_euler_rot_mat(phi,theta,psi);
