...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_heterogeneity_10_a_k_p_form__.mat',dir_trunk);
...
if (nmolecule< 2); mu_r__(1+nsource,1+nmolecule) = t + (t>0.75)*((t-0.75)/0.5)^2*(nmolecule-1); end;
if (nmolecule==2); mu_r__(1+nsource,1+nmolecule) = t ; end;
if (nmolecule< 2); 
mu_dx__(1+nsource,1+nmolecule) = (t>0.75)*((t-0.75)/0.5)^2*2*(nmolecule-0.5); 
mu_dy__(1+nsource,1+nmolecule) = (t>0.75)*((t-0.75)/0.5)^2*2*(0.5-nmolecule); 
end;%if (nmolecule< 2); 
if (nmolecule==2); 
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_heterogeneity_10_mu_source___',dir_trunk);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_heterogeneity_10_a_x_u_reco__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
for nmolecule=0:n_molecule-1;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_heterogeneity_10_b_x_u_reco_0__.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
nmolecule=0;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_heterogeneity_10_b_x_u_reco_0__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_heterogeneity_10_a_k_Y_quad__.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
l_max_upb = 36;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_heterogeneity_10_a_k_Y_quad_0_A',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
nmolecule=0;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_heterogeneity_10_a_k_Y_quad_0_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
nmolecule=0;
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_heterogeneity_10_weight_2d_k_p_r_.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_heterogeneity_10_X_%s.mat',dir_trunk,str_cost);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_heterogeneity_10_X_%s_A',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_heterogeneity_10_X_%s_B',dir_trunk,str_cost);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
nmolecule=0;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/tpmhham_synthetic_6_UX_%s_Y_n%.3dsxxxrxxx_syn_X_best_allshell_MS___',dir_trunk,syn_infix,syn_n_M);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%%%%%;
clf;
...
for nUX_rank=0:syn_n_UX_rank-1;
syn_rseed = syn_rseed_(1+nsyn_rseed);
fname_fig = sprintf('%s_jpg/tpmhham_synthetic_6_UX_%s_Y_n%.3dsxxxdrxxx_syn_X_best_allshell_MS_rng%.3dnUX%.3d_',dir_trunk,syn_infix,syn_n_M,syn_rseed,nUX_rank);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%%%%%;
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/tpmhham_synthetic_6_UX_%s_Y_n%.3dsxxxrxxx_syn_X_best_allshell_SM___',dir_trunk,syn_infix,syn_n_M);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%%%%%;
clf;
...
for nUX_rank=0:syn_n_UX_rank-1;
syn_rseed = syn_rseed_(1+nsyn_rseed);
fname_fig = sprintf('%s_jpg/tpmhham_synthetic_6_UX_%s_Y_n%.3dsxxxdrxxx_syn_X_best_allshell_SM_rng%.3dnUX%.3d_',dir_trunk,syn_infix,syn_n_M,syn_rseed,nUX_rank);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%%%%%;
clf;
