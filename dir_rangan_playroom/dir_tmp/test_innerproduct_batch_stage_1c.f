...
c$$$     $        ,T_p_)
     ...
     $              *n_gamma_z + nctf*n_gamma_z*n_S),C_S_use_,+gamma_z
     $              ,Z_q_)
               timing_toc_3 = second()
     ...
     $              nctf*n_gamma_z*n_S),C_S_use_,+gamma_z,S_p,M_q_,Z_q_)
               timing_toc_3 = second()
               timing_tot_3 = timing_tot_3 + (timing_toc_3 -
     $              timing_tic_3)
     ...
     $           ,C_S_(0 +ns*n_gamma_z + nctf*n_gamma_z*n_S),C_S_use_,
     $           +gamma_z ,ngz_max,C_S_max)
