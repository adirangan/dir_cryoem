...
dir_trunk = sprintf('/%s/rangan/dir_cryoem/dir_rangan_playroom/dir_principled_marching_trpv1',string_root);
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_a_k_p_quad_.mat',dir_trunk);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_a_k_p_quad_',dir_trunk);
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_b_x_u_reco__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_b_x_u_reco__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_a_k_Y_quad_.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
l_max_upb = 36;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_a_k_Y_quad_A',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_a_k_Y_quad_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_S_k_p__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_S_k_p__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_S_k_p__A',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
nk_p_r = 12;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_CTF_k_p__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_CTF_k_p__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_CTF_k_p_r_xxxx__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_euler_angle_marina_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_M_x_c_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_M_x_c___.mat',dir_trunk);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_delta_read_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_M_x_c___center_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
N_x_c___ = M_x_c___;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_M_x_c___sample',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_M_k_p___.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_X__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
n_M = n_image_sub;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_X_TM_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
markersize_use = 32;
e_c2d__ = colormap_polar_a_azimu_b_2d(+euler_angle_marina_(1,1:n_M),+euler_angle_marina_(2,1:n_M),0.35);
d_c2d__ = colormap_gaussian_2d(delta_read_x_,delta_read_y_,delta_sigma,0.35);
...
scatter(delta_read_x_(1:n_M),delta_read_y_(1:n_M),markersize_use,d_c2d__(1:n_M,:),'filled');
hold off;
axisnotick;
...
hold on;
patch([-1;+1;+1;-1],[-1;-1;+1;+1],'k');
scatter(delta_read_x_(1:n_M),delta_read_y_(1:n_M),markersize_use,c_beach__(1+nc_beach_,:),'filled');
hold off;
axisnotick;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_X_2d_xcor_d0_vs_2d_Memp_d1_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf; hold on;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_X_%s__.mat',dir_trunk,str_cost);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_X_%s_A',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_X_%s_B',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
%%%%%%%%;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_CTF_UX_%s_S_k_p___.mat',dir_trunk,str_cost);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_CTF_UX_%s_S_k_p___',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_CTF_UX_%s_S_k_q___',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_CTF_UX_%s_S_k_q___spectrum',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
n_plot=6;
for nplot=0:n_plot-1;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_CTF_UX_%s_S_k_p___A',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_UX_%s_M_k_p___.mat',dir_trunk,str_cost);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
O_k_p__ = zeros(n_w_sum,n_image_sub); %<-- holds not centered images (i.e., original). ;
M_k_p__ = zeros(n_w_sum,n_image_sub); %<-- holds yes centered images (except, actually not centered). ;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_UX_%s_M_k_p___',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_UX_%s_M_k_q___',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_UX_%s_M_k_q___spectrum',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_c_k_Y_.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_c_x_u_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_d0_CTF_UXI_S_k_p__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_d0_CTF_UXI_S_k_p__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_d0_CTF_UXI_S_grad_FIGA',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%;
...
% Now calculate the typical directional-derivative (with respect to viewing-angle) of the template-operator applied to the true molecule. ;
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_0_d0_CTF_UX_S_k_p__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
pm_n_UX_rank = 9;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_d0_CTF_UX_S_k_p__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_d0_CTF_UX_S_grad_FIGA',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%;
l2_snr_ = [0 , 2.^[-2:-0.5:-4]]; n_l2_snr=numel(l2_snr_);
...
hold off;
axisnotick;
axis(2.5*delta_sigma*[-1,+1,-1,+1]); 
axis square; xlabel('dx'); ylabel('dy'); title('true delta');
%%%%%%%%;
...
axis(2.5*delta_sigma*[-1,+1,-1,+1]); 
axis square; xlabel('dx'); ylabel('dy'); title(sprintf('MS %d e %0.2f',niteration,mean(tmp_error_)));
...
axis(2.5*delta_sigma*[-1,+1,-1,+1]); 
axis square; xlabel('dx'); ylabel('dy'); title(sprintf('SM %d e %0.2f',niteration,mean(tmp_error_)));
end;%for niteration=0:dat_n_iteration-1;
clear tmp_SM_;
...
for ndat_rseed=0:n_dat_rseed-1;
dat_rseed = dat_rseed_(1+ndat_rseed);
tmp_pre_ = load(sprintf('%s_mat/tpmutameux_Memp_ut0120le5v064_n1024_SM_nUX002rng%.3d.mat',dir_trunk,dat_rseed));
...
if flag_plot;
%%%%%%%%;
% generate diagnostics for the various experimental runs. ;
%%%%%%%%;
delta_sigma_use = delta_sigma;
svd_eps = 1e-3;
dat_n_order = 5;
...
if ( exist(SM_fname_mat,'file'));
disp(sprintf(' %% %s found',SM_fname_mat));
tmp_dir_jpg = sprintf('%s_jpg/dir_tpmutameux_%s_n%.3d',dir_trunk,dat_infix,dat_n_M);
if (~exist(tmp_dir_jpg,'dir')); disp(sprintf(' %% %s not found, creating',tmp_dir_jpg)); mkdir(tmp_dir_jpg); end;
fname_1 = 'SM';
dat_f_rand = 0.05;
%%%%%%%%;
...
str_delta = sprintf('d%.4dle%dv%.3d',floor(1000*delta_r_max_use),round(-log(svd_eps)),n_delta_v_requested);
syn_infix = sprintf('%s_%s',str_cost,str_delta);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_X_compare_A',dir_trunk);
if (1 | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
figure(1);clf;
...
% X0_from_Y1__ = transpose(U0__(:,1:r0)) * Y1 * V0__(:,1:r0) ;
% Then measure the spectrum of this projection: ;
% svd_X0_from_Y1_ = svds(X0_vrom_X1__(1:r0,1:r0),r1), ;
% and then finally compare this spectrum to the original spectrum of Y1. ;
% To simplify matters, we calculate X0_from_X1__ instead, and conclude with: ;
% svd_X0_from_X1_ = svds(X0_vrom_X1__(1:r0,1:r0),r1max). ;
%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_X_compare_B',dir_trunk);
if (1 | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
figure(1);clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_0_X_compare_C',dir_trunk);
if (1 | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
figure(1);clf;
...
tmp_verbose=0;
tmp_viewing_k_eq_d = 1/(2*pi)/sqrt(1);
[tmp_S_k_p__,~,~,~,tmp_n_viewing_all,tmp_viewing_azimu_b_all_,tmp_viewing_polar_a_all_,~,~,~,~,~,~] = get_template_0(tmp_verbose,tmp_pm_n_k_p_r,tmp_pm_k_p_r_,tmp_pm_k_p_r_max,tmp_pm_weight_3d_k_p_r_,tmp_pm_l_max_,tmp_a_CTF_UX_Y_0lsq_,tmp_viewing_k_eq_d,-1,tmp_pm_n_w_);
