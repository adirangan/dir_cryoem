...
%%%%%%%%;
X2_quad_ = zeros(n_w_max,1);
P_S_k_q_ = interp_p_to_q(n_k_p_r,n_w_,n_w_sum,P_S_k_p_);
P_R_k_q_ = transf_svd_q_to_q_FTK_6(FTK,n_k_p_r,k_p_r_,n_w_,n_w_sum,P_S_k_q_,+delta_upd_(1),+delta_upd_(2));
P_N_k_p_ = conj(P_C_k_p_).*P_M_k_p_;
P_N_k_p_ = rotate_p_to_p_fftw(n_k_p_r,n_w_,n_w_sum,P_N_k_p_,-gamma_z_est);
P_N_k_p_ = transf_p_to_p(n_k_p_r,k_p_r_,n_w_,n_w_sum,P_N_k_p_,-delta_est_(1),-delta_est_(2));
P_N_k_q_ = interp_p_to_q(n_k_p_r,n_w_,n_w_sum,P_N_k_p_);
T_quad_q2_ = innerproduct_q_k_stretch_quad_0(n_k_p_r,2*pi*k_p_r_,weight_2d_k_p_r_,n_w_,n_w_sum,P_R_k_q_,P_N_k_q_)/(2*pi);
...
P_N_k_p_ = transf_p_to_p(n_k_p_r,k_p_r_,n_w_,n_w_sum,P_N_k_p_,-delta_est_(1),-delta_est_(2));
P_N_k_q_ = interp_p_to_q(n_k_p_r,n_w_,n_w_sum,P_N_k_p_);
Z_S_svdr_ = innerproduct_q_k_svdr_quad_FTK_5(1,FTK,n_k_p_r,2*pi*k_p_r_,weight_2d_k_p_r_,n_w_,n_w_sum,P_S_k_q_,P_N_k_q_)/(2*pi);
