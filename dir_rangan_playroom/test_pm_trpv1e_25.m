...
dir_pm = sprintf('/%s/rangan/dir_cryoem/dir_trpv1e/dir_pm',string_root);
...
dir_relion = sprintf('/%s/rangan/dir_cryoem/dir_trpv1e/dir_relion',string_root);
...
disp(sprintf(' %% %s not found, creating',fname_mat));
tmp_t = tic;
k_p_r_max = 64/(2*pi); k_eq_d = 1.0/(2*pi);
[ ...
 n_k_all ...
,n_k_all_csum_ ...
,k_p_r_all_ ...
