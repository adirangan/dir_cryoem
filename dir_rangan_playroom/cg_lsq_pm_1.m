...
scatter_from_tensor__ = cg_interpolate_n_2(n_order,n_polar_a,n_azimu_b,pm_n_w*n_M,k_p_polar_a__(:),k_p_azimu_b__(:));
...
[a_UX_Y_yc_,~] = pcg(AtAn__,At__(reshape(UX_M_k_p_wnM__(1+index_pm_nw_,:)*sparse(1:n_M,1:n_M,image_I_value_,n_M,n_M),[pm_n_w*n_M,1])));
...
function An_a_UX_Y_yc_ = An(n_CTF_rank,n_M,VSCTF_wMc__,pm_n_w,pm_l_max,a_UX_Y_yc_,scatter_from_tensor__,n_polar_a,n_azimu_b,legendre_evaluate_ljm___);
...
function At_UX_M_ = At(n_CTF_rank,n_M,VSCTF_wMc__,pm_n_w,pm_l_max,UX_M_,tensor_from_scatter__,n_polar_a,n_azimu_b,legendre_evaluate_mlj___,expil__,expi__);
pm_n_lm = (1+pm_l_max).^2;
