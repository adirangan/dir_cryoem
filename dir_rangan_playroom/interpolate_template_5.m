...
%%%%%%%%;
if (flag_verbose>0);
tmp_str = 'wS_sub_from_single_shell_sba__';
tmp_nnz = nnz(wS_sub_from_single_shell_sba__); tmp_num = numel(wS_sub_from_single_shell_sba__);
disp(sprintf(' %% %s: nnz: %0.12d*16/1e9 --> mem %0.2fGB vs num: %0.12d*8/1e9 --> mem %0.2fGB',tmp_str,tmp_nnz,tmp_nnz*16/1e9,tmp_num,tmp_num*8/1e9));
disp(sprintf(' %% %s: nnz: %.12d num: %.12d ratio: %0.6f',tmp_str,tmp_nnz,tmp_num,tmp_nnz/tmp_num));
tmp_str = 'dwS_subda_from_single_shell_sba__';
tmp_nnz = nnz(dwS_subda_from_single_shell_sba__); tmp_num = numel(dwS_subda_from_single_shell_sba__);
disp(sprintf(' %% %s: nnz: %.12d num: %.12d ratio: %0.6f',tmp_str,tmp_nnz,tmp_num,tmp_nnz/tmp_num));
tmp_str = 'dwS_subdb_from_single_shell_sba__';
tmp_nnz = nnz(dwS_subdb_from_single_shell_sba__); tmp_num = numel(dwS_subdb_from_single_shell_sba__);
disp(sprintf(' %% %s: nnz: %.12d num: %.12d ratio: %0.6f',tmp_str,tmp_nnz,tmp_num,tmp_nnz/tmp_num));
tmp_str = 'ddwS_subdaa_from_single_shell_sba__';
tmp_nnz = nnz(ddwS_subdaa_from_single_shell_sba__); tmp_num = numel(ddwS_subdaa_from_single_shell_sba__);
disp(sprintf(' %% %s: nnz: %.12d num: %.12d ratio: %0.6f',tmp_str,tmp_nnz,tmp_num,tmp_nnz/tmp_num));
tmp_str = 'ddwS_subdab_from_single_shell_sba__';
tmp_nnz = nnz(ddwS_subdab_from_single_shell_sba__); tmp_num = numel(ddwS_subdab_from_single_shell_sba__);
disp(sprintf(' %% %s: nnz: %.12d num: %.12d ratio: %0.6f',tmp_str,tmp_nnz,tmp_num,tmp_nnz/tmp_num));
tmp_str = 'ddwS_subdbb_from_single_shell_sba__';
tmp_nnz = nnz(ddwS_subdbb_from_single_shell_sba__); tmp_num = numel(ddwS_subdbb_from_single_shell_sba__);
disp(sprintf(' %% %s: nnz: %.12d num: %.12d ratio: %0.6f',tmp_str,tmp_nnz,tmp_num,tmp_nnz/tmp_num));
