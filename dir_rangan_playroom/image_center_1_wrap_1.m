...
%%%%;
M_x_c_rec0___ = zeros(n_x_M_u,n_x_M_u,n_M);
...
M_x_c_rec0___(:,:,1+nM) = reshape(M_x_c_rec0_,[n_x_M_u,n_x_M_u]);
...
R_x_c_rec0___(:,:,1+nM) = reshape(R_x_c_rec0_,[n_x_M_u,n_x_M_u]);
