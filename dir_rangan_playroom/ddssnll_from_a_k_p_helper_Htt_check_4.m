...
if (flag_verbose>0); disp(sprintf(' %% Htt_q2d: %0.16f',Htt_q2d)); end;
Htt_q3d = ...
  + 1.0 * sum( conj(a_k_p_qk_) .* (a_k_p_qk_ ) .* (0.5*dtau_dtau_a_restore_C2M0_k_p_qk_) .* weight_3d_riesz_qk_ ) ...
  - 1.0 * sum( conj(a_k_p_qk_) .* (0.5*dtau_dtau_a_restore_C1M1_k_p_qk_) .* weight_3d_riesz_qk_ ) ...
  - 1.0 * sum( conj(0.5*dtau_dtau_a_restore_C1M1_k_p_qk_) .* (a_k_p_qk_) .* weight_3d_riesz_qk_ ) ...
  + 1.0 * sum( (0.5*dtau_dtau_a_restore_C0M2_k_p_qk_) .* weight_3d_riesz_qk_ ) ...
  ;
