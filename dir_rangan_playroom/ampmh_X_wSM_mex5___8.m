...
tmp_t = toc(tmp_t); if (verbose>1); disp(sprintf(' %% ampmh_X_wSM_mex5___8: %0.3fs',tmp_t)); end;
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex5___8',tmp_t);
...
verbose = 1;
if (verbose>0); disp(sprintf(' %% [entering ampmh_X_wSM_mex5___8]')); end;
...
elrt_sum_mex_ampmh_X_wSM___15=0;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex5___8: svd_VUXM_nMwl____',tmp_t,1,nop);
%%%%%%%%;
if (flag_compress_S==0);
tmp_t = tic(); nop=0;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex5___8: svd_SVUXM_SMwl____',tmp_t,1,nop);
%%%%;
tmp_t = tic(); nop=0;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex5___8: svd_SVUXM_lwSM____',tmp_t,1,nop);
end;%if (flag_compress_S==0);
%%%%%%%%;
flag_disp=0;
if flag_disp;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex5___8: svd_USVUXM_SMwl____',tmp_t,1,nop);
tmp_t = tic(); nop=0;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex5___8: svd_USVUXM_SMwl____ (permute)',tmp_t,1,nop);
end;%if (flag_compress_S==1);
%%%%%%%%;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex5___8: svd_USESVUXM_dwSM____',tmp_t,1,nop);
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex5___8: X_sub_dwSM____',tmp_t,1,nop);
%%%%%%%%;
flag_check=0;
if flag_check;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex5___8: X_wSM___',tmp_t,1,nop);
end;%if (flag_optimize_over_gamma_z == 0);
%%%%%%%%;
if (flag_optimize_over_gamma_z == 1);
tmp_t = tic(); nop=0;
...
if (verbose>0); disp(sprintf(' %% [finished ampmh_X_wSM_mex5___8]')); end;
