...
%%%%;
R_k_hi_p_quad_wk_ = S_k_hi_p_quad_wk_ - S_k_hi_p_form_wk_;
...
%%%%;
R_k_lo_p_quad_wk_ = S_k_lo_p_quad_wk_ - S_k_lo_p_form_wk_;
...
subplot(p_row,p_col,1+np);np=np+1;imagesc_c(n_x_c,x_c_0_,n_x_c,x_c_1_,real(S_x_lo_c_form_xx_),S_x_lim_); axis image; axisnotick; title('real(S_x_lo_c_form_xx_)','Interpreter','none');
...
%%%%%%%%;
R_k_hi_p_quad_l2 = sum(conj(R_k_hi_p_quad_wk_).*R_k_hi_p_quad_wk_.*weight_2d_hi_wk_*(2*pi)^2,'all');
S_k_hi_p_quad_l2 = sum(conj(S_k_hi_p_quad_wk_).*S_k_hi_p_quad_wk_.*weight_2d_hi_wk_*(2*pi)^2,'all');
S_k_hi_p_form_l2 = sum(conj(S_k_hi_p_form_wk_).*S_k_hi_p_form_wk_.*weight_2d_hi_wk_*(2*pi)^2,'all');
if (flag_verbose>0); disp(sprintf(' %% S_k_hi_p_form_l2: %0.6f S_k_hi_p_quad_l2: %0.6f R_k_hi_p_quad_l2: %0.6f ratio: %0.16f',S_k_hi_p_form_l2,S_k_hi_p_quad_l2,R_k_hi_p_quad_l2,R_k_hi_p_quad_l2/max(1e-12,S_k_hi_p_form_l2))); end;
%%%%;
R_k_lo_p_quad_l2 = sum(conj(R_k_lo_p_quad_wk_).*R_k_lo_p_quad_wk_.*weight_2d_lo_wk_*(2*pi)^2,'all');
S_k_lo_p_quad_l2 = sum(conj(S_k_lo_p_quad_wk_).*S_k_lo_p_quad_wk_.*weight_2d_lo_wk_*(2*pi)^2,'all');
S_k_lo_p_form_l2 = sum(conj(S_k_lo_p_form_wk_).*S_k_lo_p_form_wk_.*weight_2d_lo_wk_*(2*pi)^2,'all');
if (flag_verbose>0); disp(sprintf(' %% S_k_lo_p_form_l2: %0.6f S_k_lo_p_quad_l2: %0.6f R_k_lo_p_quad_l2: %0.6f ratio: %0.16f',S_k_lo_p_form_l2,S_k_lo_p_quad_l2,R_k_lo_p_quad_l2,R_k_lo_p_quad_l2/max(1e-12,S_k_lo_p_form_l2))); end;
%%%%;
if flag_plot>1;
S_k_lim_ = max(abs(S_k_lo_p_quad_wk_),[],'all')*0.75*[-1,+1];
p_row = 2; p_col = 3; np=0;
subplot(p_row,p_col,1+np);np=np+1;imagesc_p(n_k_hi_p_r,k_hi_p_r_,n_w_hi_,n_w_hi_sum,real(S_k_hi_p_form_wk_),S_k_lim_); axis image; axisnotick; title('real(S_k_hi_p_form_wk_)','Interpreter','none');
subplot(p_row,p_col,1+np);np=np+1;imagesc_p(n_k_hi_p_r,k_hi_p_r_,n_w_hi_,n_w_hi_sum,real(S_k_hi_p_quad_wk_),S_k_lim_); axis image; axisnotick; title('real(S_k_hi_p_quad_wk_)','Interpreter','none');
subplot(p_row,p_col,1+np);np=np+1;imagesc_p(n_k_hi_p_r,k_hi_p_r_,n_w_hi_,n_w_hi_sum,real(R_k_hi_p_quad_wk_),S_k_lim_); axis image; axisnotick; title('real(R_k_hi_p_quad_wk_)','Interpreter','none');
subplot(p_row,p_col,1+np);np=np+1;imagesc_p(n_k_lo_p_r,k_lo_p_r_,n_w_lo_,n_w_lo_sum,real(S_k_lo_p_form_wk_),S_k_lim_); axis image; axisnotick; title('real(S_k_lo_p_form_wk_)','Interpreter','none');
subplot(p_row,p_col,1+np);np=np+1;imagesc_p(n_k_lo_p_r,k_lo_p_r_,n_w_lo_,n_w_lo_sum,real(S_k_lo_p_quad_wk_),S_k_lim_); axis image; axisnotick; title('real(S_k_lo_p_quad_wk_)','Interpreter','none');
subplot(p_row,p_col,1+np);np=np+1;imagesc_p(n_k_lo_p_r,k_lo_p_r_,n_w_lo_,n_w_lo_sum,real(R_k_lo_p_quad_wk_),S_k_lim_); axis image; axisnotick; title('real(R_k_lo_p_quad_wk_)','Interpreter','none');
end;%if flag_plot;
%%%%%%%%;
