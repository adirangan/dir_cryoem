...
%%%%%%%%;
ssnll_q3d = ...
 + 0.5 * sum( (conj(a_k_Y_form_yk__) .* a_times_a_restore_C2M0_k_Y_lmk__) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1]) ) ...
 - 0.5 * 2*real(sum( (conj(a_k_Y_form_yk__).^1 .* a_restore_C1M1_k_Y_lmk__) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1]) )) ...
 + 0.5 * sum( a_restore_C0M2_k_Y_lmk__(1+0,:) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1])*sqrt(4*pi) ) ...
;
ssnll_q3d = ssnll_q3d / scaling_volumetric ;
...
%%%%%%%%;
Hvv_q3d = ...
 + 1.0 * sum( (conj(dvol_a_dvol_a_k_Y_quad_yk__) .* a_restore_C2M0_k_Y_lmk__) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1]) ) ...
;
if (flag_verbose>0); disp(sprintf(' %% Hvv_q3d: %0.16f',Hvv_q3d)); end;
Hvv_q3d = ...
 + 1.0 * sum( (conj(dvol_a_k_Y_form_yk__) .* dvol_a_times_a_restore_C2M0_k_Y_lmk__) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1]) ) ...
;
if (flag_verbose>0); disp(sprintf(' %% Hvv_q3d: %0.16f',Hvv_q3d)); end;
Hvv_q3d = ...
 + 1.0 * sum( conj(dvol_a_k_Y_form_yk__) .* bsxfun(@times,dvol_a_times_a_restore_C2M0_k_Y_lmk__,reshape(weight_3d_riesz_k_p_r_,[1,n_k_p_r])) , 'all' ) ...
;
if (flag_verbose>0); disp(sprintf(' %% Hvv_q3d: %0.16f',Hvv_q3d)); end;
Hvv_q3d = ...
...
%%%%%%%%;
dtau_ssnll_q3d = ...
 + 0.5 * sum( (conj(a_k_Y_form_yk__).^1 .* a_times_dtau_a_restore_C2M0_k_Y_lmk__) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1]) ) ...
 - 0.5 * 2*real(sum( (conj(a_k_Y_form_yk__).^1 .* dtau_a_restore_C1M1_k_Y_lmk__) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1]) )) ...
 + 0.5 * sum( dtau_a_restore_C0M2_k_Y_lmk__(1+0,:) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1])*sqrt(4*pi) ) ...
;
dtau_ssnll_q3d = dtau_ssnll_q3d / scaling_volumetric ;
...
%%%%;
Hvt_q3d = ...
  + 1.0 * sum( (conj(dvol_a_k_Y_form_yk__) .* a_times_dtau_a_restore_C2M0_k_Y_lmk__) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1]) ) ...
  - 1.0 * sum( (conj(dvol_a_k_Y_form_yk__) .* dtau_a_restore_C1M1_k_Y_lmk__) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1]) ) ...
  ;
Hvt_q3d = Hvt_q3d / scaling_volumetric ;
Hvt_q2d = Htv_q2d ; %<-- due to symmetry. ;
if (flag_verbose>0); disp(sprintf(' %% Hvt_q2d vs Hvt_q3d: %0.16f',fnorm(Hvt_q2d - Hvt_q3d)/max(1e-12,fnorm(Hvt_q2d)))); end;
...
%%%%%%%%;
% Now calculate the different-quotient and compare. ;
%%%%%%%%;
...
%%%%%%%%;
% Now try to find eigenvectors of hessian. ;
%%%%%%%%;
...
[tmp_vv,tmp_vv_dvol,tmp_vv_a,tmp_vv_b,tmp_vv_c] = local_f_bar_dot_g_(n_k_p_r,weight_3d_riesz_k_p_r_,l_max_,n_image_0,tmp_v_ykabc_,tmp_v_ykabc_);
...
[tmp_ee_0,tmp_ee_0_dvol,tmp_ee_0_a,tmp_ee_0_b,tmp_ee_0_c] = local_f_bar_dot_g_(n_k_p_r,weight_3d_riesz_k_p_r_,l_max_,n_image_0,v_eig_ykabc_,v_eig_ykabc_);
...
[tmp_vv,tmp_vv_dvol,tmp_vv_a,tmp_vv_b,tmp_vv_c] = local_f_bar_dot_g_(n_k_p_r,weight_3d_riesz_k_p_r_,l_max_,n_image_1,tmp_v_ykabc_,tmp_v_ykabc_);
...
[tmp_ee_1,tmp_ee_1_dvol,tmp_ee_1_a,tmp_ee_1_b,tmp_ee_1_c] = local_f_bar_dot_g_(n_k_p_r,weight_3d_riesz_k_p_r_,l_max_,n_image_1,v_eig_ykabc_,v_eig_ykabc_);
...
[tmp_vv,tmp_vv_dvol,tmp_vv_a,tmp_vv_b,tmp_vv_c] = local_f_bar_dot_g_(n_k_p_r,weight_3d_riesz_k_p_r_,l_max_,n_image_2,tmp_v_ykabc_,tmp_v_ykabc_);
...
[tmp_ee_2,tmp_ee_2_dvol,tmp_ee_2_a,tmp_ee_2_b,tmp_ee_2_c] = local_f_bar_dot_g_(n_k_p_r,weight_3d_riesz_k_p_r_,l_max_,n_image_2,v_eig_ykabc_,v_eig_ykabc_);
