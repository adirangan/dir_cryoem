...
%%%%%%%%;
% Now repeat the same calculations within ddssnll_2. ;
%%%%%%%%;
parameter_ddssnll = struct('type','parameter');
parameter_ddssnll.flag_verbose = flag_verbose;
parameter_ddssnll.flag_disp = 1;
...
[ ...
 ~ ...
,Hvt_expand_ykabc_ ...
,Hv_expand_q3d_k_Y_quad_yk_ ...
,Hv_expand_q3d_k_Y_quad_yk__ ...
,Hv_expand_q3d_k_p_quad_ ...
,Ht_expand_q2d_M3__ ...
] = ...
ddssnll_2( ...
 parameter_ddssnll ...
...
dvt_expand_ykabc_l2 = local_imagecount_f_bar_dot_g_(n_k_p_r,weight_3d_riesz_k_p_r_,l_max_,n_M_expand,weight_imagecount_M_expand_,dvt_expand_ykabc_,dvt_expand_ykabc_);
ddssnll_expand_mid_q2d = local_imagecount_f_bar_dot_g_(n_k_p_r,weight_3d_riesz_k_p_r_,l_max_,n_M_expand,weight_imagecount_M_expand_,Hvt_expand_ykabc_,dvt_expand_ykabc_);
...
if (flag_verbose>0); disp(sprintf(' %% Hv_q3d_k_Y_quad_yk_ vs Hv_expand_q3d_k_Y_quad_yk_: %0.16f',fnorm(Hv_q3d_k_Y_quad_yk_-Hv_expand_q3d_k_Y_quad_yk_)/max(1e-12,fnorm(Hv_q3d_k_Y_quad_yk_)))); end;
if (flag_verbose>0); disp(sprintf(' %% Hv_q3d_k_Y_quad_yk__ vs Hv_expand_q3d_k_Y_quad_yk__: %0.16f',fnorm(Hv_q3d_k_Y_quad_yk__-Hv_expand_q3d_k_Y_quad_yk__)/max(1e-12,fnorm(Hv_q3d_k_Y_quad_yk__)))); end;
if (flag_verbose>0); disp(sprintf(' %% Hv_q3d_k_p_quad_ vs Hv_expand_q3d_k_p_quad_: %0.16f',fnorm(Hv_q3d_k_p_quad_-Hv_expand_q3d_k_p_quad_)/max(1e-12,fnorm(Hv_q3d_k_p_quad_)))); end;
