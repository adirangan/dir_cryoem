...
if (flag_verbose>0); disp(sprintf(' %%%%%%%%%%%%%%%% : ')); end;
if (flag_verbose>0); disp(sprintf(' %% ssnll_frm vs ssnll_pwv: %0.16f',fnorm(ssnll_frm - ssnll_pwv)/max(1e-12,fnorm(ssnll_frm)))); end;
if (flag_verbose>0); disp(sprintf(' %% ssnll_pwv_M_ vs ssnll_q2d_M_: %0.16f',fnorm(ssnll_pwv_M_ - ssnll_q2d_M_)/max(1e-12,fnorm(ssnll_pwv_M_)))); end;
if (flag_verbose>0); disp(sprintf(' %% ssnll_pwv vs ssnll_q2d: %0.16f',fnorm(ssnll_pwv - ssnll_q2d)/max(1e-12,fnorm(ssnll_pwv)))); end;
if (flag_verbose>0); disp(sprintf(' %% S_k_p_pwv_wkS__ vs S_k_p_q2d_wkS__: %0.16f',fnorm(S_k_p_pwv_wkS__ - S_k_p_q2d_wkS__)/max(1e-12,fnorm(S_k_p_pwv_wkS__)))); end;
if (flag_verbose>0); disp(sprintf(' %% dvol_ssnll_pwv_M_ vs dvol_ssnll_q2d_M_: %0.16f',fnorm(dvol_ssnll_pwv_M_ - dvol_ssnll_q2d_M_)/max(1e-12,fnorm(dvol_ssnll_pwv_M_)))); end;
if (flag_verbose>0); disp(sprintf(' %% dvol_ssnll_pwv vs dvol_ssnll_q2d: %0.16f',fnorm(dvol_ssnll_pwv - dvol_ssnll_q2d)/max(1e-12,fnorm(dvol_ssnll_pwv)))); end;
if (flag_verbose>0); disp(sprintf(' %% dvol_S_k_p_pwv_wkS__ vs dvol_S_k_p_q2d_wkS__: %0.16f',fnorm(dvol_S_k_p_pwv_wkS__ - dvol_S_k_p_q2d_wkS__)/max(1e-12,fnorm(dvol_S_k_p_pwv_wkS__)))); end;
if (flag_verbose>0); disp(sprintf(' %% dvol_dvol_ssnll_pwv vs dvol_dvol_ssnll_q2d: %0.16f',fnorm(dvol_dvol_ssnll_pwv - dvol_dvol_ssnll_q2d)/max(1e-12,fnorm(dvol_dvol_ssnll_pwv)))); end;
if (flag_verbose>0); disp(sprintf(' %% dtau_ssnll_pwv_M3__ vs dtau_ssnll_q2d_M3__: %0.16f',fnorm(dtau_ssnll_pwv_M3__ - dtau_ssnll_q2d_M3__)/max(1e-12,fnorm(dtau_ssnll_pwv_M3__)))); end;
if (flag_verbose>0); disp(sprintf(' %% dtau_ssnll_pwv vs dtau_ssnll_q2d: %0.16f',fnorm(dtau_ssnll_pwv - dtau_ssnll_q2d)/max(1e-12,fnorm(dtau_ssnll_pwv)))); end;
if (flag_verbose>0); disp(sprintf(' %% dtau_S_k_p_pwv_wkS3___ vs dtau_S_k_p_q2d_wkS3___: %0.16f',fnorm(dtau_S_k_p_pwv_wkS3___ - dtau_S_k_p_q2d_wkS3___)/max(1e-12,fnorm(dtau_S_k_p_pwv_wkS3___)))); end;
if (flag_verbose>0); disp(sprintf(' %% dtau_dvol_ssnll_pwv_M3__ vs dtau_dvol_ssnll_q2d_M3__: %0.16f',fnorm(dtau_dvol_ssnll_pwv_M3__ - dtau_dvol_ssnll_q2d_M3__)/max(1e-12,fnorm(dtau_dvol_ssnll_pwv_M3__)))); end;
if (flag_verbose>0); disp(sprintf(' %% dtau_dvol_ssnll_pwv vs dtau_dvol_ssnll_q2d: %0.16f',fnorm(dtau_dvol_ssnll_pwv - dtau_dvol_ssnll_q2d)/max(1e-12,fnorm(dtau_dvol_ssnll_pwv)))); end;
if (flag_verbose>0); disp(sprintf(' %% dtau_dvol_S_k_p_pwv_wkS3___ vs dtau_dvol_S_k_p_q2d_wkS3___: %0.16f',fnorm(dtau_dvol_S_k_p_pwv_wkS3___ - dtau_dvol_S_k_p_q2d_wkS3___)/max(1e-12,fnorm(dtau_dvol_S_k_p_pwv_wkS3___)))); end;
if (flag_verbose>0); disp(sprintf(' %% dtau_dtau_ssnll_pwv_M33___ vs dtau_dtau_ssnll_q2d_M33___: %0.16f',fnorm(dtau_dtau_ssnll_pwv_M33___ - dtau_dtau_ssnll_q2d_M33___)/max(1e-12,fnorm(dtau_dtau_ssnll_pwv_M33___)))); end;
if (flag_verbose>0); disp(sprintf(' %% dtau_dtau_ssnll_pwv vs dtau_dtau_ssnll_q2d: %0.16f',fnorm(dtau_dtau_ssnll_pwv - dtau_dtau_ssnll_q2d)/max(1e-12,fnorm(dtau_dtau_ssnll_pwv)))); end;
if (flag_verbose>0); disp(sprintf(' %% dtau_dtau_S_k_p_pwv_wkS33____ vs dtau_dtau_S_k_p_q2d_wkS33____: %0.16f',fnorm(dtau_dtau_S_k_p_pwv_wkS33____ - dtau_dtau_S_k_p_q2d_wkS33____)/max(1e-12,fnorm(dtau_dtau_S_k_p_pwv_wkS33____)))); end;
...
%%%%%%%%;
for n_type = 0:3-1;
if n_type==0; tmp_yk__ = a_restore_C2M0_k_Y_lmk__; end;
if n_type==1; tmp_yk__ = a_restore_C1M1_k_Y_lmk__; end;
if n_type==2; tmp_yk__ = a_restore_C0M2_k_Y_lmk__; end;
%%%%;
...
if (flag_verbose>0); disp(sprintf(' %% ssnll_pwv vs ssnll_q3d: %0.16f',fnorm(ssnll_pwv-ssnll_q3d)/fnorm(ssnll_pwv))); end;
...
for n_type = 0:3*3-1;
ntype = 0;
if n_type==ntype; tmp_yk__ = a_restore_C2M0_k_Y_lmk__; end; ntype = ntype + 1;
if n_type==ntype; tmp_yk__ = a_restore_C1M1_k_Y_lmk__; end; ntype = ntype + 1;
if n_type==ntype; tmp_yk__ = a_restore_C0M2_k_Y_lmk__; end; ntype = ntype + 1;
if n_type==ntype; tmp_yk__ = dtau_a_restore_C2M0_k_Y_lmk__; end; ntype = ntype + 1;
if n_type==ntype; tmp_yk__ = dtau_a_restore_C1M1_k_Y_lmk__; end; ntype = ntype + 1;
if n_type==ntype; tmp_yk__ = dtau_a_restore_C0M2_k_Y_lmk__; end; ntype = ntype + 1;
if n_type==ntype; tmp_yk__ = dtau_dtau_a_restore_C2M0_k_Y_lmk__; end; ntype = ntype + 1;
if n_type==ntype; tmp_yk__ = dtau_dtau_a_restore_C1M1_k_Y_lmk__; end; ntype = ntype + 1;
if n_type==ntype; tmp_yk__ = dtau_dtau_a_restore_C0M2_k_Y_lmk__; end; ntype = ntype + 1;
%%%%;
tmp_yk_ = zeros(n_lm_sum,1);
tmp_t = tic();
for nk_p_r=0:n_k_p_r-1;
...
dtau_ssnll_q3d = ...
 ...
 - 0.5 * 2*real(sum( (conj(a_k_Y_form_yk__).^1 .* dtau_a_restore_C1M1_k_Y_lmk__) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1]) )) ...
...
if (flag_verbose>0); disp(sprintf(' %% dtau_ssnll_pwv vs dtau_ssnll_q3d: %0.16f',fnorm(dtau_ssnll_pwv - dtau_ssnll_q3d)/max(1e-12,fnorm(dtau_ssnll_pwv)))); end;
%%%%%%%%;
dtau_ssnll_q3d = ...
...
dtau_dtau_ssnll_q3d = ...
 ...
 - 0.5 * 2*real(sum( (conj(a_k_Y_form_yk__).^1 .* dtau_dtau_a_restore_C1M1_k_Y_lmk__) * reshape(weight_3d_riesz_k_p_r_,[n_k_p_r,1]) )) ...
...
if (flag_verbose>0); disp(sprintf(' %% dtau_dtau_ssnll_pwv vs dtau_dtau_ssnll_q3d: %0.16f',fnorm(dtau_dtau_ssnll_pwv - dtau_dtau_ssnll_q3d)/max(1e-12,fnorm(dtau_dtau_ssnll_pwv)))); end;
%%%%%%%%;
dtau_dtau_ssnll_q3d = ...
