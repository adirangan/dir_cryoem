...
%%%%%%%%;
% Now repeat the same calculations within ddssnll_0. ;
%%%%%%%%;
...
tmp_S_k_p_q2d_wkS__ = [];
tmp_dvol_S_k_p_q2d_wkS__ = [];
tmp_dtau_S_k_p_q2d_wkS3___ = [];
tmp_dtau_dvol_S_k_p_q2d_wkS3___ = [];
tmp_dtau_dtau_S_k_p_q2d_wkS33____ = [];
ddssnll_0( ...
 parameter_ddssnll ...
,n_k_p_r ...
,k_p_r_ ...
