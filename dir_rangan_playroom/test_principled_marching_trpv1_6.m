...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_6_a_k_p_quad_.mat',dir_trunk);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_a_k_p_quad_',dir_trunk);
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_6_b_x_u_reco__.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_b_x_u_reco__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_6_a_k_Y_quad_.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_a_k_Y_quad_A',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_a_k_Y_quad_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_6_S_k_p__.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_S_k_p__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_S_k_p__A',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
nk_p_r = 12;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_6_CTF_k_p__.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_CTF_k_p__',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_6_X_.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
...
X_polar_a = 0;
X_ori_(1+nk_p_r_0,1+nk_p_r_1) = register_spharm_to_spharm_2(verbose,1,1,1,tmp_l_max,a_k_Y_quad_(1+tmp_ij_0_)*CTF_avg_k_p_r_(1+nk_p_r_0),a_k_Y_quad_(1+tmp_ij_1_)*CTF_avg_k_p_r_(1+nk_p_r_1));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_X_A',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_X_B',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
%%%%%%%%;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_6_UX_S_CTF_k_p___.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
for nk_p_r=0:n_k_p_r-1;
tmp_UX_S_CTF_k_p_ = tmp_UX_S_CTF_k_p_ + UX_(1+nk_p_r,1+nUX_rank)*tmp_S_CTF_k_p__(:,1+nk_p_r);
end;%for nk_p_r=0:n_k_p_r-1;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_UX_S_CTF_k_p___',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_UX_S_CTF_k_q___',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_UX_S_CTF_k_q___spectrum',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
n_plot=6;
for nplot=0:n_plot-1;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_UX_S_CTF_k_p___A',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_6_M_x_c___.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_delta_read_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_M_x_c___center_',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
N_x_c___ = M_x_c___;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_M_x_c___sample',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1_6_UX_M_k_p___.mat',dir_trunk);
if (~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_UX_M_k_p___',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_UX_M_k_q___',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1_6_UX_M_k_q___spectrum',dir_trunk);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/tpmham_synthetic_UX_Y_n%.3dsxxxrxxx_syn_X_best_singlepc____',dir_trunk,syn_n_M);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
tpmham_experimental_2(dat_rseed,dat_n_M,UX_M_k_p___,UX_M_k_q___,dat_n_UX_rank,dat_n_iteration,dat_n_order,dir_trunk,n_k_p_r,n_w_,l_max_,a_UX_Y_quad__);
end;%for ndat_rseed=0:n_dat_rseed-1;
%%%%%%%%;
% Collect output. ;
%%%%%%%%;
dat_X_best_singlepc____ = zeros(dat_n_iteration,n_dat_rseed);
flag_dat_X_best_singlepc____ = zeros(dat_n_iteration,n_dat_rseed);
for ndat_rseed=0:n_dat_rseed-1;
dat_rseed = dat_rseed_(1+ndat_rseed);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/tpmham_experimental_UX_Y_n%.3d_dat_X_best_singlepc____',dir_trunk,dat_n_M);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
c_ = colormap_beach(); n_c = size(c_,1); %c_ = diag(0.85 + 0.15*transpose(linspace(-1,+1,n_c)).^2) * c_;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/tpmham_experimental_UX_Y_n%.3d_dat_X_best_allshell____',dir_trunk,dat_n_M);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
c_ = colormap_beach(); n_c = size(c_,1); %c_ = diag(0.85 + 0.15*transpose(linspace(-1,+1,n_c)).^2) * c_;
