...
g_dilation = @(point_pole_predilated_polar_a) polar_cap_dilated_amplitude*sin(2*point_pole_predilated_polar_a);
...
plot(point_output_polar_a_p_+pi/2,0.5*g_dilation(point_output_polar_a_p_+pi/2),'gx-');
hold off;
...
plot(point_output_polar_a_p_+pi/2,-point_pole_predilated_template_gammax_polar_a_std_p_,'ro-');
plot(point_output_polar_a_p_+pi/2,(0.5/sqrt(2))*g_dilation(point_output_polar_a_p_+pi/2),'gx-');
hold off;
...
plot(point_output_polar_a_p_+pi/2,-point_pole_predilated_template_gammax_k_c_r_avg_p_,'mo-');
plot(point_output_polar_a_p_+pi/2,0.5*g_dilation(point_output_polar_a_p_+pi/2),'cx-');
hold off;
