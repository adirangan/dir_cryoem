...
verbose=1;
if (verbose); disp(sprintf(' %% [entering ampmut_compare_image_rank_0b]')); end;
%%%%%%%%;
% This is identical to ampmut_compare_image_rank_0, except that the loaded mat-files are scanned for variables ending in _Mi__. ;
%%%%%%%%;
...
if (verbose); disp(sprintf(' %% [finished ampmut_compare_image_rank_0b]')); end;
