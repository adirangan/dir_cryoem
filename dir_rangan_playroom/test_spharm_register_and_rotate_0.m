...
subplot(1,2,2); isosurface_f_x_c_0(reshape(real(a_x_u_reco_),[x_u_res,x_u_res,x_u_res]),98.5); title('a_reco','Interpreter','none');
end;%if flag_plot;

%%%%%%%%;
% now load one of the reconstructions. ;
%%%%%%%%;
fname_pre = 'X_2d_xcor_d0_a1t0056n16r0';
...
if flag_plot;
figure(1);clf;figmed;
subplot(1,2,1); isosurface_f_x_c_0(reshape(real(a_x_u_reco_),[x_u_res,x_u_res,x_u_res]),98.5); title('a_reco','Interpreter','none');
subplot(1,2,2); isosurface_f_x_c_0(reshape(real(b_x_u_reco_),[x_u_res,x_u_res,x_u_res]),98.5); title('b_reco','Interpreter','none');
end;%if flag_plot;
...
if flag_plot;
figure(1);clf;figmed;
subplot(1,2,1); isosurface_f_x_c_0(reshape(real(b_x_u_reco_),[x_u_res,x_u_res,x_u_res]),98.5); title('b_reco','Interpreter','none');
subplot(1,2,2); isosurface_f_x_c_0(reshape(real(c_x_u_reco_),[x_u_res,x_u_res,x_u_res]),98.5); title('c_reco','Interpreter','none');
end;%if flag_plot;
...
figure(1);clf;figmed;
subplot(1,2,1); isosurface_f_x_c_0(reshape(real(a_x_u_reco_),[x_u_res,x_u_res,x_u_res]),98.5); title('a_reco','Interpreter','none');
subplot(1,2,2); isosurface_f_x_c_0(reshape(real(d_x_u_reco_),[x_u_res,x_u_res,x_u_res]),98.5); title('d_reco','Interpreter','none');
end;%if flag_plot;
%%%%%%%%;
[ ...
 ~ ...
