...
str_thisfunction = 'polish_dssnll_fminunc_1';
...
if (~isfield(parameter,'polish_dssnll_fminunc_tolerance')); parameter.polish_dssnll_fminunc_tolerance = tolerance_master; end; %<-- parameter_bookmark. ;
polish_dssnll_fminunc_tolerance = parameter.polish_dssnll_fminunc_tolerance;
if (~isfield(parameter,'polish_dssnll_fminunc_n_iteration')); parameter.polish_dssnll_fminunc_n_iteration = 8; end; %<-- parameter_bookmark. ;
polish_dssnll_fminunc_n_iteration = parameter.polish_dssnll_fminunc_n_iteration;
...
%%%%%%%%;
inline_local_ssnll_from_a_k_Y_12 = ...
@(euler_abc_M3_) ...
local_ssnll_from_a_k_Y_12( ...
 euler_abc_M3_ ...
,parameter ...
,n_k_p_r ...
,k_p_r_ ...
...
euler_abc_init_M3_ = [euler_polar_a_M_;euler_azimu_b_M_;euler_gamma_z_M_];
tmp_options = optimoptions( ...
 'fminunc' ...
,'Display','iter' ...
,'SpecifyObjectiveGradient',true ...
,'MaxFunctionEvaluations',polish_dssnll_fminunc_n_iteration ...
,'OptimalityTolerance',polish_dssnll_fminunc_tolerance ...
);
[euler_abc_crit_M3_,ssnll_q2d_crit] = fminunc(inline_local_ssnll_from_a_k_Y_12,euler_abc_init_M3_,tmp_options);
tmp_t = toc(tmp_t); if (flag_verbose>0); disp(sprintf(' %% fminunc using ssnll_from_a_k_Y_12: time %0.2fs',tmp_t)); end;
a_k_Y_crit_yk_ = a_k_Y_quad_yk_;
euler_polar_a_crit_M_ = euler_abc_crit_M3_(1 + 0*n_M + [0:n_M-1]);
euler_azimu_b_crit_M_ = euler_abc_crit_M3_(1 + 1*n_M + [0:n_M-1]);
euler_gamma_z_crit_M_ = euler_abc_crit_M3_(1 + 2*n_M + [0:n_M-1]);
%%%%%%%%;
...
%%%%;
tmp_t = tic();
a_init_ykabc_ = local_ykabc_from_yk_a_b_c_(n_k_p_r,l_max_,n_M,a_k_Y_quad_yk_,euler_polar_a_M_,euler_azimu_b_M_,euler_gamma_z_M_);
a_ri_init_ykabcykabc_ = cat(1,real(a_init_ykabc_),imag(a_init_ykabc_));
tmp_options = optimoptions( ...
 'fminunc' ...
,'Display','iter' ...
,'SpecifyObjectiveGradient',true ...
...
[a_ri_crit_ykabcykabc_,ssnll_q2d_crit] = fminunc(inline_local_dssnll_1,a_ri_init_ykabcykabc_,tmp_options);
tmp_t = toc(tmp_t); if (flag_verbose>0); disp(sprintf(' %% fminunc using dssnll_1: time %0.2fs',tmp_t)); end;
n_ykabc = n_lm_sum + n_M*3;
a_r_crit_ykabc_ = a_ri_crit_ykabcykabc_(1+0*n_ykabc+[0:n_ykabc-1]);
a_i_crit_ykabc_ = a_ri_crit_ykabcykabc_(1+1*n_ykabc+[0:n_ykabc-1]);
a_crit_ykabc_ = a_r_crit_ykabc_ + i*a_i_crit_ykabc_;
[a_k_Y_crit_yk_,euler_polar_a_crit_M_,euler_azimu_b_crit_M_,euler_gamma_z_crit_M_] = local_yk_a_b_c_from_ykabc_(n_k_p_r,l_max_,n_M,a_crit_ykabc_);
%%%%%%%%;
...
%%%%%%%%;
function [ssnll_q2d,dtau_ssnll_q2d_M3_] = ...
local_ssnll_from_a_k_Y_12( ...
 euler_abc_M3_ ...
,parameter ...
,n_k_p_r ...
...
%%%%;
euler_polar_a_M_ = euler_abc_M3_(1 + 0*n_M + [0:n_M-1]);
euler_azimu_b_M_ = euler_abc_M3_(1 + 1*n_M + [0:n_M-1]);
euler_gamma_z_M_ = euler_abc_M3_(1 + 2*n_M + [0:n_M-1]);
%%%%;
parameter_ssnll = struct('type','parameter');
parameter_ssnll.flag_verbose = 0*parameter.flag_verbose;
parameter_ssnll.viewing_k_eq_d = parameter.viewing_k_eq_d;
parameter_ssnll.template_k_eq_d = parameter.template_k_eq_d;
[ ...
 parameter_ssnll ...
,ssnll_q2d_M_ ...
,ssnll_q2d ...
...
dtau_ssnll_q2d_M3_ = dtau_ssnll_q2d_M3__(:);
%%%%%%%%;

%%%%%%%%;
function [ssnll_q2d,G_ri_ykabcykabc_] = ...
local_dssnll_1( ...
 a_ri_ykabcykabc_ ...
,parameter ...
,n_k_p_r ...
...
%%%%%%%%;
n_ykabc = n_lm_sum + n_M*3;
a_r_ykabc_ = a_ri_ykabcykabc_(1+0*n_ykabc+[0:n_ykabc-1]);
a_i_ykabc_ = a_ri_ykabcykabc_(1+1*n_ykabc+[0:n_ykabc-1]);
a_ykabc_ = a_r_ykabc_ + i*a_i_ykabc_;
[a_k_Y_yk_,euler_polar_a_M_,euler_azimu_b_M_,euler_gamma_z_M_] = local_yk_a_b_c_from_ykabc_(n_k_p_r,l_max_,n_M,a_ykabc_);
%%%%%%%%;
...
ssnll_q2d = real(ssnll_q2d);
%G_ykabc_ = conj(G_bar_ykabc_); %<-- yes conjugate. ;
G_ykabc_ =     (G_bar_ykabc_); %<-- not conjugate. ;
G_ri_ykabcykabc_ = cat(1,real(G_ykabc_),imag(G_ykabc_));
%%%%%%%%;
