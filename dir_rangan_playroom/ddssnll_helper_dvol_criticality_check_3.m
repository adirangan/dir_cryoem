...
tmp_H_q3d_k_p_quad = @(dvol_a_k_p_quad_) ...
  ( ...
    + 0.5 * sum( abs(a_k_p_quad_ + dvol_a_k_p_quad_).^2 .* combine_a_restore_C2M0_k_p_quad_ .* weight_3d_riesz_k_all_ ) ...
    - 0.5 * 2*real(sum( conj(a_k_p_quad_ + dvol_a_k_p_quad_).^1 .* combine_a_restore_C1M1_k_p_quad_ .* weight_3d_riesz_k_all_ )) ...
    + 0.5 * sum( combine_a_restore_C0M2_k_p_quad_ .* weight_3d_riesz_k_all_ ) ...
    ) ...
  / scaling_volumetric  ...
  ;
%%%%%%%%;
