...
fp=fopen(fname_m,'w');
fprintf(fp,'if  isempty(%s_k_Y_yk__) & ~isempty(%s_k_Y_yk_);\n',tmp_str_infix,tmp_str_infix);
fprintf(fp,'%s_k_Y_yk__ = local_yk__from_yk_(n_k_p_r,l_max_,%s_k_Y_yk_);\n',tmp_str_infix,tmp_str_infix);
fprintf(fp,'end;%%if  isempty(%s_k_Y_yk__) & ~isempty(%s_k_Y_yk_);\n',tmp_str_infix,tmp_str_infix);
fprintf(fp,'%%%%%%%%;\n');
fprintf(fp,'if  isempty(%s_k_Y_yk_) & ~isempty(%s_k_Y_yk__);\n',tmp_str_infix,tmp_str_infix);
fprintf(fp,'%s_k_Y_yk_ = local_yk_from_yk__(n_k_p_r,l_max_,%s_k_Y_yk__);\n',tmp_str_infix,tmp_str_infix);
fprintf(fp,'end;%%if  isempty(%s_k_Y_yk_) & ~isempty(%s_k_Y_yk__);\n',tmp_str_infix,tmp_str_infix);
fprintf(fp,'%%%%%%%%;\n');
fprintf(fp,'if  isempty(%s_k_p_quad_) & ~isempty(%s_k_Y_yk_);\n',tmp_str_infix,tmp_str_infix);
fprintf(fp,'tmp_yk_ = %s_k_Y_yk_; tmp_str = ''%s_k_Y_yk_'';\n',tmp_str_infix,tmp_str_infix);
fprintf(fp,'%%%%%%%%;\n');
...
fprintf(fp,'end;%%if  isempty(%s_k_p_quad_) & ~isempty(%s_k_Y_yk_);\n',tmp_str_infix,tmp_str_infix);
fprintf(fp,'%%%%%%%%;\n');
fclose(fp);
end;%for;
