      subroutine test_resid_multah(thetas,phis,nout,residua,nterms,
     1           nquad,k,ctfw,output)
      ...
      complex *16 residua((nterms+1)*(nterms+1))
      ...
      if (verbose.gt.0) then
         write(6,'(A,I0)') '[entering test_resid_multah], nout: ' , nout
      end if
     ...
     1    xnodes,wts,values,phivals,ugrid,ctfw)
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_resid_multah]'
      end if
