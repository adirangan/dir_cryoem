...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% test_principled_marching_heterogeneous_helper_alternating_minimization_synthetic_6. ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_mat/dir_jpg/tpmhham_synthetic_6_UX_%s_M_k_p___n%.3ds%.4dr%.3d',dir_trunk,syn_infix,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
nUX_rank=1-1; clim_ = 1.5*std(real(syn_UX_M_k_p___(:,:,1+nUX_rank)),1,'all')*[-1,+1];
nUX_rank= 1-1; subplot(2,2,1); imagesc(real(squeeze(syn_UX_M_k_p___(:,:,1+nUX_rank))),clim_); xlabel('nimage'); ylabel('gamma'); title(sprintf('real(rank==%d) [%0.2f,%0.2f]',1+nUX_rank,clim_));
nUX_rank= 2-1; subplot(2,2,2); imagesc(real(squeeze(syn_UX_M_k_p___(:,:,1+nUX_rank))),clim_); xlabel('nimage'); ylabel('gamma'); title(sprintf('real(rank==%d) [%0.2f,%0.2f]',1+nUX_rank,clim_));
nUX_rank= 3-1; subplot(2,2,3); imagesc(real(squeeze(syn_UX_M_k_p___(:,:,1+nUX_rank))),clim_); xlabel('nimage'); ylabel('gamma'); title(sprintf('real(rank==%d) [%0.2f,%0.2f]',1+nUX_rank,clim_));
nUX_rank= 4-1; subplot(2,2,4); imagesc(real(squeeze(syn_UX_M_k_p___(:,:,1+nUX_rank))),clim_); xlabel('nimage'); ylabel('gamma'); title(sprintf('real(rank==%d) [%0.2f,%0.2f]',1+nUX_rank,clim_));
figbig;
...
%%%%%%%%;
fname_fig = sprintf('%s_mat/dir_jpg/tpmhham_synthetic_6_UX_%s_M_k_p___A_n%.3ds%.4dr%.3d',dir_trunk,syn_infix,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
for nUX_rank=0:syn_n_UX_rank-1;
fname_pre = sprintf('%s_mat/tpmhham_synthetic_6_UX_%s_Y_n%.3ds%.4dr%.3d_allshell_MS_rng%.3dnUX%.3d',dir_trunk,syn_infix,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank,syn_rseed,nUX_rank);
...
flag_MS_vs_SM = 1;
%%%%%%%%;
tmp_rseed=syn_rseed;tmp_n_iteration=syn_n_iteration;tmp_n_iteration_register=1;tmp_viewing_k_eq_d = 1/(2*pi)/sqrt(1);tmp_n_order = syn_n_order;
[syn_X_best_allshell_MS_,syn_a_k_Y_0lsq_MS__,euler_polar_a_MS__,euler_azimu_b_MS__,euler_gamma_z_MS__] = am_2(tmp_rseed,tmp_n_iteration,tmp_n_iteration_register,tmp_viewing_k_eq_d,tmp_n_order,tmp_n_k_p_r,tmp_k_p_r_,tmp_k_p_r_max,tmp_weight_k_p_r_,tmp_weight_2d_k_p_r_,tmp_n_w_,syn_n_M,tmp_M_k_p__,tmp_M_k_q__,1,ones(tmp_n_w_sum,1),tmp_l_max_,tmp_a_k_Y_quad_mavg_,[],[],[],flag_MS_vs_SM,[]);
tmp_n_residual_loading = 3; tmp_n_residual_iteration = 32;
syn_M_loading_MS__ = get_loading_0(tmp_n_residual_loading,tmp_n_residual_iteration,syn_n_order,tmp_n_k_p_r,tmp_weight_k_p_r_,tmp_l_max_,tmp_n_w_,syn_n_M,tmp_M_k_p__,euler_polar_a_MS__(:,end),euler_azimu_b_MS__(:,end),euler_gamma_z_MS__(:,end));
save(fname_mat ...
     ,'syn_X_best_allshell_MS_' ...
     ,'syn_a_k_Y_0lsq_MS__' ...
     ,'euler_polar_a_MS__','euler_azimu_b_MS__','euler_gamma_z_MS__'...
     ,'syn_M_loading_MS__','syn_M_molecule_type_' ...
     );
%%%%%%%%;
delete(fname_tmp);
...
%%%%%%%%;
for nUX_rank=0:syn_n_UX_rank-1;
MS_fname_pre = sprintf('%s_mat/tpmhham_synthetic_6_UX_%s_Y_n%.3ds%.4dr%.3d_allshell_MS_rng%.3dnUX%.3d',dir_trunk,syn_infix,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank,syn_rseed,nUX_rank);
...
%%%%%%%%;
SM_fname_pre = sprintf('%s_mat/tpmhham_synthetic_6_UX_%s_Y_n%.3ds%.4dr%.3d_allshell_SM_rng%.3dnUX%.3d',dir_trunk,syn_infix,syn_n_M,floor(1000*syn_snr),syn_n_UX_rank,syn_rseed,nUX_rank);
...
%%%%%%%%;
tmp_rseed=syn_rseed;tmp_n_iteration=syn_n_iteration;tmp_n_iteration_register=1;tmp_viewing_k_eq_d = 1/(2*pi)/sqrt(2);tmp_n_order = syn_n_order;
[syn_X_best_allshell_SM_,syn_a_k_Y_0lsq_SM__,euler_polar_a_SM__,euler_azimu_b_SM__,euler_gamma_z_SM__] = am_2(tmp_rseed,tmp_n_iteration,tmp_n_iteration_register,tmp_viewing_k_eq_d,tmp_n_order,tmp_n_k_p_r,tmp_k_p_r_,tmp_k_p_r_max,tmp_weight_k_p_r_,tmp_weight_2d_k_p_r_,tmp_n_w_,syn_n_M,tmp_M_k_p__,tmp_M_k_q__,1,ones(tmp_n_w_sum,1),tmp_l_max_,tmp_a_k_Y_quad_mavg_,tmp_euler_polar_a_MS_,tmp_euler_azimu_b_MS_,tmp_euler_gamma_z_MS_,flag_MS_vs_SM,f_rand);
tmp_n_residual_loading = 3; tmp_n_residual_iteration = 32;
syn_M_loading_SM__ = get_loading_0(tmp_n_residual_loading,tmp_n_residual_iteration,syn_n_order,tmp_n_k_p_r,tmp_weight_k_p_r_,tmp_l_max_,tmp_n_w_,syn_n_M,tmp_M_k_p__,euler_polar_a_SM__(:,end),euler_azimu_b_SM__(:,end),euler_gamma_z_SM__(:,end));
save(SM_fname_mat ...
     ,'syn_X_best_allshell_SM_' ...
     ,'syn_a_k_Y_0lsq_SM__' ...
     ,'euler_polar_a_SM__','euler_azimu_b_SM__','euler_gamma_z_SM__' ...
     ,'syn_M_loading_SM__','syn_M_molecule_type_' ...
     );
%%%%%%%%;
delete(SM_fname_tmp);
