...
shell_longitudinal_avg_ = flag_sign*equa_band_dilated_amplitude*g_dilation(shell_k_p_azimu_b,shell_k_p_polar_a_);
...
a_k_p_sub_ = shell_scatter_from_tensor_sba__*a_k_p_sub_ + 0.25 * shell_longitudinal_rsq .* (shell_scatter_from_tensor_db2da0_sba__*a_k_p_sub_);
