...
point_pole_predilated_template_gammax_k_c_0_pp__ = cos(point_pole_predilated_template_gammax_azimu_b_pp__).*sin(point_pole_predilated_template_gammax_polar_a_pp__);
point_pole_predilated_template_gammax_k_c_1_pp__ = sin(point_pole_predilated_template_gammax_azimu_b_pp__).*sin(point_pole_predilated_template_gammax_polar_a_pp__);
point_pole_predilated_template_gammax_k_c_2_pp__ = cos(point_pole_predilated_template_gammax_polar_a_pp__);
