...
[ ...
 parameter ...
,KAPPA ...
,a_restore_C0M0_k_Y_yk__ ...
,a_restore_C1M0_k_Y_yk__ ...
,a_restore_C2M0_k_Y_yk__ ...
,a_restore_C1M1_k_Y_yk__ ...
,a_restore_C0M2_k_Y_yk__ ...
,dtau_a_restore_C0M0_k_Y_yk__ ...
,dtau_a_restore_C1M0_k_Y_yk__ ...
,dtau_a_restore_C2M0_k_Y_yk__ ...
,dtau_a_restore_C1M1_k_Y_yk__ ...
,dtau_a_restore_C0M2_k_Y_yk__ ...
,dtau_dtau_a_restore_C0M0_k_Y_yk__ ...
,dtau_dtau_a_restore_C1M0_k_Y_yk__ ...
...
[ ...
 parameter ...
,KAPPA ...
,a_restore_C0M0_mid_k_Y_yk__ ...
,a_restore_C1M0_mid_k_Y_yk__ ...
,a_restore_C2M0_mid_k_Y_yk__ ...
,a_restore_C1M1_mid_k_Y_yk__ ...
,a_restore_C0M2_mid_k_Y_yk__ ...
,dtau_a_restore_C0M0_mid_k_Y_yk__ ...
,dtau_a_restore_C1M0_mid_k_Y_yk__ ...
,dtau_a_restore_C2M0_mid_k_Y_yk__ ...
,dtau_a_restore_C1M1_mid_k_Y_yk__ ...
,dtau_a_restore_C0M2_mid_k_Y_yk__ ...
,dtau_dtau_a_restore_C0M0_mid_k_Y_yk__ ...
,dtau_dtau_a_restore_C1M0_mid_k_Y_yk__ ...
...
[ ...
 parameter ...
,KAPPA ...
,a_restore_C0M0_pos_k_Y_yk__ ...
,a_restore_C1M0_pos_k_Y_yk__ ...
...
[ ...
 parameter ...
,KAPPA ...
,a_restore_C0M0_neg_k_Y_yk__ ...
,a_restore_C1M0_neg_k_Y_yk__ ...
...
%%%%%%%%;
dtau_a_restore_C0M0_dif_k_Y_yk__ = (a_restore_C0M0_pos_k_Y_yk__ - a_restore_C0M0_neg_k_Y_yk__)/max(1e-12,2*dtau);
disp(sprintf(' %% dtau_a_restore_C0M0_dif_k_Y_yk__ vs dtau_a_restore_C0M0_mid_k_Y_yk__: %0.16f',fnorm(dtau_a_restore_C0M0_dif_k_Y_yk__ - dtau_a_restore_C0M0_mid_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_C0M0_dif_k_Y_yk__))));
dtau_a_restore_C1M0_dif_k_Y_yk__ = (a_restore_C1M0_pos_k_Y_yk__ - a_restore_C1M0_neg_k_Y_yk__)/max(1e-12,2*dtau);
disp(sprintf(' %% dtau_a_restore_C1M0_dif_k_Y_yk__ vs dtau_a_restore_C1M0_mid_k_Y_yk__: %0.16f',fnorm(dtau_a_restore_C1M0_dif_k_Y_yk__ - dtau_a_restore_C1M0_mid_k_Y_yk__)/max(1e-12,fnorm(dtau_a_restore_C1M0_dif_k_Y_yk__))));
...
%%%%%%%%;
dtau_dtau_a_restore_C0M0_dif_k_Y_yk__ = (a_restore_C0M0_pos_k_Y_yk__ - 2*a_restore_C0M0_mid_k_Y_yk__ + a_restore_C0M0_neg_k_Y_yk__)/max(1e-12,dtau*dtau);
disp(sprintf(' %% dtau_dtau_a_restore_C0M0_dif_k_Y_yk__ vs dtau_dtau_a_restore_C0M0_mid_k_Y_yk__: %0.16f',fnorm(dtau_dtau_a_restore_C0M0_dif_k_Y_yk__ - dtau_dtau_a_restore_C0M0_mid_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_C0M0_dif_k_Y_yk__))));
dtau_dtau_a_restore_C1M0_dif_k_Y_yk__ = (a_restore_C1M0_pos_k_Y_yk__ - 2*a_restore_C1M0_mid_k_Y_yk__ + a_restore_C1M0_neg_k_Y_yk__)/max(1e-12,dtau*dtau);
disp(sprintf(' %% dtau_dtau_a_restore_C1M0_dif_k_Y_yk__ vs dtau_dtau_a_restore_C1M0_mid_k_Y_yk__: %0.16f',fnorm(dtau_dtau_a_restore_C1M0_dif_k_Y_yk__ - dtau_dtau_a_restore_C1M0_mid_k_Y_yk__)/max(1e-12,fnorm(dtau_dtau_a_restore_C1M0_dif_k_Y_yk__))));
...
tmp_r_C0M0_num = fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:) - dtau_a_restore_C1M1_mid_k_Y_yk__(1+tmp_index_,:));
tmp_r_C0M0_den = fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:));
tmp_r_C0M0 = tmp_r_C0M0_num/max(1e-12,tmp_r_C0M0_den);
tmp_r_C0M0_(1+l_val) = tmp_r_C0M0;
tmp_r_C1M0_num = fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:) - dtau_a_restore_C1M1_mid_k_Y_yk__(1+tmp_index_,:));
tmp_r_C1M0_den = fnorm(dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:));
...
for l_val=0:l_max;
tmp_index_ = efind(KAPPA.Y_l_val_use_==l_val);
tmp_r_C0M0_num = fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:) - dtau_dtau_a_restore_C1M1_mid_k_Y_yk__(1+tmp_index_,:));
tmp_r_C0M0_den = fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:));
tmp_r_C0M0 = tmp_r_C0M0_num/max(1e-12,tmp_r_C0M0_den);
tmp_r_C0M0_(1+l_val) = tmp_r_C0M0;
tmp_r_C1M0_num = fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:) - dtau_dtau_a_restore_C1M1_mid_k_Y_yk__(1+tmp_index_,:));
tmp_r_C1M0_den = fnorm(dtau_dtau_a_restore_C1M1_dif_k_Y_yk__(1+tmp_index_,:));
tmp_r_C1M0 = tmp_r_C1M0_num/max(1e-12,tmp_r_C1M0_den);
tmp_r_C1M0_(1+l_val) = tmp_r_C1M0;
...
%%%%%%%%%%%%%%%%;
if index_calc==0;
if flag_d0; a_restore_C0M0_k_Y_yk__ = a_restore_k_Y_yk__; end;
if flag_d1; dtau_a_restore_C0M0_k_Y_yk__ = dtau_a_restore_k_Y_yk__; end;
if flag_d2; dtau_dtau_a_restore_C0M0_k_Y_yk__ = dtau_dtau_a_restore_k_Y_yk__; end; 
end;%if index_calc==0;
%%%%;
if index_calc==1;
if flag_d0; a_restore_C1M0_k_Y_yk__ = a_restore_k_Y_yk__; end;
if flag_d1; dtau_a_restore_C1M0_k_Y_yk__ = dtau_a_restore_k_Y_yk__; end;
if flag_d2; dtau_dtau_a_restore_C1M0_k_Y_yk__ = dtau_dtau_a_restore_k_Y_yk__; end; 
end;%if index_calc==1;
%%%%;
if index_calc==2;
