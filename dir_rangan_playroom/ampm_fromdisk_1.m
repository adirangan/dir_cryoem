...
str_thisfunction = 'ampm_fromdisk_1';
...
ampm_.X_best_ampm_ia__(:,1+na) = tmp_.X_best_;
ampm_.X_best_flag_flip_ampm_ia__(:,1+na) = tmp_.X_best_flag_flip_;
ampm_.polar_a_best_ampm_ia__(:,1+na) = tmp_.polar_a_best_;
ampm_.azimu_b_best_ampm_ia__(:,1+na) = tmp_.azimu_b_best_;
ampm_.gamma_z_best_ampm_ia__(:,1+na) = tmp_.gamma_z_best_;
ampm_.delta_best_ampm_dia__(:,:,1+na) = tmp_.delta_best__;
clear tmp_;
...
ampm_.corr_crop_ampm_xa__(:,1+na) = tmp_.corr_crop_;
clear tmp_;
...
ampm_.fsc_crop_ampm_kxa___(:,:,1+na) = tmp_.fsc_crop_ampm_kx__;
ampm_.fsc_ampm_ka__(:,1+na) = tmp_.fsc_ampm_k_;
clear tmp_;
