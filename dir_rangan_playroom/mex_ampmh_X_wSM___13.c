/*==========================================================
 * mex_ampmh_X_wSM___13.c ;
 * compile from Matlab with: ;
 * mex CFLAGS='$CFLAGS -fPIC -w -O2 -D_AVX -mavx -D_CBLAS -D_FMA -mfma' mex_ampmh_X_wSM___13.c -lm -lfftw3 -lfftw3f -lgslcblas -output /data/rangan/dir_cryoem/dir_rangan_playroom/mex_ampmh_X_wSM___13 ;
 * compile from shell with: ;
 * gcc -fPIC -w -O2 -DWITHOUT_MEX -D_AVX -mavx -D_CBLAS -D_FMA -mfma mex_ampmh_X_wSM___13.c -lm -lfftw3 -lfftw3f -lgslcblas ; ./a.out;
...
void mexFunction(int nlhs,mxArray *plhs[],int nrhs,const mxArray *prhs[])
{
  ...
  int na=0,n_a;
  mwSize n_out=0;
  if (verbose){ printf(" %% [entering gateway mex_ampmh_X_wSM___13]\n");}
  /* %%%%%%%%%%%%%%%% */
  if(nrhs!=18) { mexErrMsgIdAndTxt("MyToolbox:mex_ampmh_X_wSM___13:nrhs","18 0in required.");}
  if(nlhs<  4) { mexErrMsgIdAndTxt("MyToolbox:mex_ampmh_X_wSM___13:nlhs"," 4 out required.");}
  /* %%%%%%%%%%%%%%%% */
  na=0;
  /* %%%% */
  ...
  /* %%%%%%%%%%%%%%%% */
  if (verbose){ printf(" %% [finished gateway mex_ampmh_X_wSM___13]\n");}
}
#endif
