...
% The goal is to clarify the scale of fourier-space. ;
%%%%%%%%;
clear;
...
%%%%;
fname_fig_pre = sprintf('/%s/rangan/dir_cryoem/dir_CryoBIFE_MD/dir_CryoLike_fig/pm_fig_image_basis_nl%d_FIGB',string_root,nl);
