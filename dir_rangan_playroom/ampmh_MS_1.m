...
image_delta_x_(1+nM_best) = delta_x_wSM___(1+nw_best,1+index_nS,1+nM_best);
image_delta_y_(1+nM_best) = delta_y_wSM___(1+nw_best,1+index_nS,1+nM_best);
image_I_value_(1+nM_best) = I_value_wSM___(1+nw_best,1+index_nS,1+nM_best);
