...
%%%%%%%%;
n_point = 1+64;
point_output_azimu_b_p_ = zeros(n_point,1);
point_output_polar_a_p_ = zeros(n_point,1);
point_pole_predilated_template_gammax_k_c_0_pp__ = zeros(n_point,n_w_max);
point_pole_predilated_template_gammax_k_c_1_pp__ = zeros(n_point,n_w_max);
point_pole_predilated_template_gammax_k_c_2_pp__ = zeros(n_point,n_w_max);
point_pole_predilated_template_gammax_azimu_b_pp__ = zeros(n_point,n_w_max);
point_pole_predilated_template_gammax_polar_a_pp__ = zeros(n_point,n_w_max);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
point_output_azimu_b_p_(1+npoint) = point_output_azimu_b;
point_output_polar_a_p_(1+npoint) = point_output_polar_a;
%%%%%%%%;
if flag_disp;
...
%%%%%%%%;
tmp_f = @(point_pole_predilated_polar_a) abs(point_pole_predilated_polar_a + polar_cap_dilated_amplitude*sin(2*point_pole_predilated_polar_a) - point_pole_polar_a).^2;
point_pole_predilated_polar_a = fminsearch(tmp_f,point_pole_polar_a);
...
point_pole_predilated_template_gammax_k_c_0_pp__(1+npoint,1+npole) = point_pole_predilated_template_gammax_k_c_(1+0);
point_pole_predilated_template_gammax_k_c_1_pp__(1+npoint,1+npole) = point_pole_predilated_template_gammax_k_c_(1+1);
point_pole_predilated_template_gammax_k_c_2_pp__(1+npoint,1+npole) = point_pole_predilated_template_gammax_k_c_(1+2);
...
point_pole_predilated_template_gammax_azimu_b_pp__(1+npoint,1+npole) = point_pole_predilated_template_gammax_azimu_b;
point_pole_predilated_template_gammax_polar_a_pp__(1+npoint,1+npole) = point_pole_predilated_template_gammax_polar_a;
%%%%%%%%;
if flag_disp;
...
disp(sprintf(' %% tmp_error: %0.16f',fnorm(point_pole_predilated_template_gammax_k_c_0_pp__ - cos(point_pole_predilated_template_gammax_azimu_b_pp__).*sin(point_pole_predilated_template_gammax_polar_a_pp__))));
disp(sprintf(' %% tmp_error: %0.16f',fnorm(point_pole_predilated_template_gammax_k_c_1_pp__ - sin(point_pole_predilated_template_gammax_azimu_b_pp__).*sin(point_pole_predilated_template_gammax_polar_a_pp__))));
disp(sprintf(' %% tmp_error: %0.16f',fnorm(point_pole_predilated_template_gammax_k_c_2_pp__ - cos(point_pole_predilated_template_gammax_polar_a_pp__))));
point_pole_predilated_template_gammax_k_c_0_avg_p_ = mean(point_pole_predilated_template_gammax_k_c_0_pp__,2);
point_pole_predilated_template_gammax_k_c_1_avg_p_ = mean(point_pole_predilated_template_gammax_k_c_1_pp__,2);
point_pole_predilated_template_gammax_k_c_2_avg_p_ = mean(point_pole_predilated_template_gammax_k_c_2_pp__,2);
point_pole_predilated_template_gammax_polar_a_avg_p_ = mean(point_pole_predilated_template_gammax_polar_a_pp__,2);
point_pole_predilated_template_gammax_polar_a_std_p_ = std(point_pole_predilated_template_gammax_polar_a_pp__,1,2);
point_pole_predilated_template_gammax_k_c_r_pp__ = ...
sqrt( ...
 bsxfun(@minus,point_pole_predilated_template_gammax_k_c_0_pp__,mean(point_pole_predilated_template_gammax_k_c_0_pp__,2)).^2 ...
+bsxfun(@minus,point_pole_predilated_template_gammax_k_c_1_pp__,mean(point_pole_predilated_template_gammax_k_c_1_pp__,2)).^2 ...
+bsxfun(@minus,point_pole_predilated_template_gammax_k_c_2_pp__,mean(point_pole_predilated_template_gammax_k_c_2_pp__,2)).^2 ...
);
%point_pole_predilated_template_gammax_k_c_r_avg_p_ = sqrt(mean(point_pole_predilated_template_gammax_k_c_r_pp__.^2,2)); %<-- take 2-norm, rather than mean norm. ;
point_pole_predilated_template_gammax_k_c_r_avg_p_ = mean(point_pole_predilated_template_gammax_k_c_r_pp__,2); %<-- take mean-norm, rather than 2-norm. ;
...
subplot(1,3,1);
hold on;
plot(point_output_polar_a_p_+pi/2,point_pole_predilated_template_gammax_polar_a_avg_p_-point_output_polar_a_p_-pi/2,'ro-');
plot(point_output_polar_a_p_+pi/2,0.5*polar_cap_dilated_amplitude*sin(2*(point_output_polar_a_p_+pi/2)),'gx-');
hold off;
xlim([0,pi]); xlabel('point_output_polar_a_p_+pi/2','Interpreter','none'); ylabel('amplitude'); title('avg polar_a displacement amplitude','Interpreter','none');
%%%%;
subplot(1,3,2);
hold on;
plot(point_output_polar_a_p_+pi/2,+point_pole_predilated_template_gammax_polar_a_std_p_,'ro-');
plot(point_output_polar_a_p_+pi/2,-point_pole_predilated_template_gammax_polar_a_std_p_,'ro-');
plot(point_output_polar_a_p_+pi/2,(0.5/sqrt(2))*polar_cap_dilated_amplitude*sin(2*(point_output_polar_a_p_+pi/2)),'gx-');
hold off;
xlim([0,pi]); xlabel('point_output_polar_a_p_+pi/2','Interpreter','none'); ylabel('amplitude'); title('std polar_a displacement amplitude','Interpreter','none');
%%%%;
subplot(1,3,3);
hold on;
plot(point_output_polar_a_p_+pi/2,+point_pole_predilated_template_gammax_k_c_r_avg_p_,'mo-');
plot(point_output_polar_a_p_+pi/2,-point_pole_predilated_template_gammax_k_c_r_avg_p_,'mo-');
plot(point_output_polar_a_p_+pi/2,0.5*polar_cap_dilated_amplitude*sin(2*(point_output_polar_a_p_+pi/2)),'cx-');
hold off;
xlim([0,pi]); xlabel('point_output_polar_a_p_+pi/2','Interpreter','none'); ylabel('amplitude'); title('avg polar_a displacement radius','Interpreter','none');
%%%%;
end;%if flag_disp;
