...
% Now moving on to MlaFEDB. ;
% Now moving on to rib80s. ;
% Now moving on to p28hRPT1. ;
%%%%%%%%;
...
dat_n_UX_rank_ = [14,16,18,20,22];  n_dat_n_UX_rank = numel(dat_n_UX_rank_);
%delta_r_max_factor_ = [0.125,0.25,0.50,0.75]; n_delta_r_max_factor = numel(delta_r_max_factor_);
delta_r_max_factor_ = [0.25,0.50]; n_delta_r_max_factor = numel(delta_r_max_factor_);
%%%%%%%%;
