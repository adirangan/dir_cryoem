function test_mra_error_2(q_max,n_M,flag_recalc,flag_replot);
...
test_mra_error_2(q_max,n_M,1,1);
...
fname_mat_pre = sprintf('%s/test_mra_error_2_Q%dN%d_',dir_pm_mat,q_max,n_M);
...
%%%%%%%%%%%%%%%%;
fname_fig_pre = sprintf('%s/test_mra_error_2_Q%dN%d_FIGA',dir_pm_jpg,q_max,n_M);
