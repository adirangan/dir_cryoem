function tpmham_experimental_2(dat_rseed,dat_n_M,UX_M_k_p___,UX_M_k_q___,dat_n_UX_rank,dat_n_iteration,dat_n_order,dir_trunk,n_k_p_r,n_w_,l_max_,a_UX_Y_quad__);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% test_principled_marching_helper_alternating_minimization_experimental_0. ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_mat/dir_jpg/tpmham_experimental_UX_M_k_p___n%.3d',dir_trunk,dat_n_M);
...
%%%%%%%%;
fname_fig = sprintf('%s_mat/dir_jpg/tpmham_experimental_UX_M_k_p___A_n%.3d',dir_trunk,dat_n_M);
if (~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
fname_pre = sprintf('%s_mat/tpmham_experimental_UX_Y_n%.3d_singlepc_rng%.3dnUX%.3d',dir_trunk,dat_n_M,dat_rseed,nUX_rank);
...
%%%%%%%%;
for nUX_rank=0:dat_n_UX_rank-1;
fname_pre = sprintf('%s_mat/tpmham_experimental_UX_Y_n%.3d_allshell_rng%.3dnUX%.3d',dir_trunk,dat_n_M,dat_rseed,nUX_rank);
fname_mat = sprintf('%s.mat',fname_pre);
fname_tmp = sprintf('%s.tmp',fname_pre);
if (~exist(fname_mat,'file') & ~exist(fname_tmp,'file'));
disp(sprintf(' %% %s not found, creating',fname_pre));
