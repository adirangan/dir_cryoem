...
weight_3d_riesz_k_qk_ = weight_3d_k_p_qk_;
for nk_p_r=0:n_k_p_r-1;
...
weight_3d_riesz_k_qk_(1+tmp_index_) = weight_3d_k_p_qk_(1+tmp_index_) * weight_2d_k_p_r / max(1e-16,weight_3d_k_p_r);
if (flag_verbose> 1); disp(sprintf(' %% k_p_r %0.6f: sum(weight_3d_riesz_k_qk_(1+tmp_index_))/(weight_2d_k_p_r * 4*pi): %0.16f',k_p_r,sum(weight_3d_riesz_k_qk_(1+tmp_index_))/(4*pi*weight_2d_k_p_r))); end;
end;%for nk_p_r=0:n_k_p_r-1;
%%%%%%%%;
...
if (flag_verbose>0); disp(sprintf(' %% sum(weight_3d_riesz__qk_) vs 4*pi^2*k_p_r_max^2: %0.16f',fnorm(sum(weight_3d_riesz_k_qk_) - term_3r))); end;
...
%%%%%%%%;
ssnll_q3d = ...
 + 0.5 * sum( abs(a_k_p_quad_).^2 .* a_restore_C2M0_k_p_quad_ .* weight_3d_riesz_k_qk_ ) ...
 - 0.5 * 2*real(sum( conj(a_k_p_quad_).^1 .* a_restore_C1M1_k_p_quad_ .* weight_3d_riesz_k_qk_ )) ...
 + 0.5 * sum( a_restore_C0M2_k_p_quad_ .* weight_3d_riesz_k_qk_ ) ...
;
ssnll_q3d = ssnll_q3d / scaling_volumetric ;
if (flag_verbose>0); disp(sprintf(' %% ssnll_pw1 vs ssnll_q3d: %0.16f',fnorm(ssnll_pw1-ssnll_q3d)/fnorm(ssnll_pw1))); end;
if (flag_verbose>0); disp(sprintf(' %% ssnll_q2d vs ssnll_q3d: %0.16f',fnorm(ssnll_q2d-ssnll_q3d)/fnorm(ssnll_q2d))); end;
%%%%%%%%;
ssnll_q3d = ...
 + 0.5 * sum( conj(a_k_p_quad_) .* (a_k_p_quad_) .* a_restore_C2M0_k_p_quad_ .* weight_3d_riesz_k_qk_ ) ...
 - 0.5 * sum( conj(a_k_p_quad_) .* a_restore_C1M1_k_p_quad_ .* weight_3d_riesz_k_qk_ ) ...
 - 0.5 * sum( conj(a_restore_C1M1_k_p_quad_) .* (a_k_p_quad_) .* weight_3d_riesz_k_qk_ ) ...
 + 0.5 * sum( a_restore_C0M2_k_p_quad_ .* weight_3d_riesz_k_qk_ ) ...
;
ssnll_q3d = ssnll_q3d / scaling_volumetric ;
if (flag_verbose>0); disp(sprintf(' %% ssnll_pw1 vs ssnll_q3d: %0.16f',fnorm(ssnll_pw1-ssnll_q3d)/fnorm(ssnll_pw1))); end;
...
if (flag_verbose>0); disp(sprintf(' %% Hvv_q3d: %0.16f',Hvv_q3d)); end;
Hvv_q3d = ...
 + 1.0 * sum( (conj(dvol_a_k_p_quad_) .* dvol_a_k_p_quad_ .* a_restore_C2M0_k_p_quad_) .* weight_3d_riesz_k_qk_ ) ...
;
if (flag_verbose>0); disp(sprintf(' %% Hvv_q3d: %0.16f',Hvv_q3d)); end;
...
%%%%%%%%;
dvol_ssnll_q3d = + 1.0 * sum( ( conj(a_k_p_quad_) .* (a_restore_C2M0_k_p_quad_) - conj(a_restore_C1M1_k_p_quad_) ) .* dvol_a_k_p_quad_ .* weight_3d_riesz_k_qk_ );
...
%%%%%%%%;
dtau_ssnll_q3d = ...
 + 0.5 * sum( abs(a_k_p_quad_).^2 .* dtau_a_restore_C2M0_k_p_quad_ .* weight_3d_riesz_k_qk_ ) ...
 - 0.5 * 2*real(sum( conj(a_k_p_quad_).^1 .* dtau_a_restore_C1M1_k_p_quad_ .* weight_3d_riesz_k_qk_ )) ...
 + 0.5 * sum( dtau_a_restore_C0M2_k_p_quad_ .* weight_3d_riesz_k_qk_ ) ...
  ;
dtau_ssnll_q3d = dtau_ssnll_q3d / scaling_volumetric ;
if (flag_verbose>0); disp(sprintf(' %% dtau_ssnll_pw1 vs dtau_ssnll_q3d: %0.16f',fnorm(dtau_ssnll_pw1 - dtau_ssnll_q3d)/max(1e-12,fnorm(dtau_ssnll_pw1)))); end;
%%%%%%%%;
...
%%%%%%%%;
dtau_dtau_ssnll_q3d = ...
 + 0.5 * sum( abs(a_k_p_quad_).^2 .* dtau_dtau_a_restore_C2M0_k_p_quad_ .* weight_3d_riesz_k_qk_ ) ...
 - 0.5 * 2*real(sum( conj(a_k_p_quad_).^1 .* dtau_dtau_a_restore_C1M1_k_p_quad_ .* weight_3d_riesz_k_qk_ )) ...
 + 0.5 * sum( dtau_dtau_a_restore_C0M2_k_p_quad_ .* weight_3d_riesz_k_qk_ ) ...
  ;
dtau_dtau_ssnll_q3d = dtau_dtau_ssnll_q3d / scaling_volumetric ;
if (flag_verbose>0); disp(sprintf(' %% dtau_dtau_ssnll_pw1 vs dtau_dtau_ssnll_q3d: %0.16f',fnorm(dtau_dtau_ssnll_pw1 - dtau_dtau_ssnll_q3d)/max(1e-12,fnorm(dtau_dtau_ssnll_pw1)))); end;
%%%%%%%%;
...
Htt_q3d = ...
  + 1.0 * sum( conj(a_k_p_quad_) .* (a_k_p_quad_ ) .* (0.5*dtau_dtau_a_restore_C2M0_k_p_quad_) .* weight_3d_riesz_k_qk_ ) ...
  - 1.0 * sum( conj(a_k_p_quad_) .* (0.5*dtau_dtau_a_restore_C1M1_k_p_quad_) .* weight_3d_riesz_k_qk_ ) ...
  - 1.0 * sum( conj(0.5*dtau_dtau_a_restore_C1M1_k_p_quad_) .* (a_k_p_quad_) .* weight_3d_riesz_k_qk_ ) ...
  + 1.0 * sum( (0.5*dtau_dtau_a_restore_C0M2_k_p_quad_) .* weight_3d_riesz_k_qk_ ) ...
  ;
...
%%%%%%%%;
Htv_q3d = ...
  + 1.0 * sum( conj(dtau_a_restore_C2M0_k_p_quad_) .* conj(a_k_p_quad_) .* (dvol_a_k_p_quad_) .* weight_3d_riesz_k_qk_ ) ...
  - 1.0 * sum( conj(dtau_a_restore_C1M1_k_p_quad_) .* (dvol_a_k_p_quad_) .* weight_3d_riesz_k_qk_ ) ...
  ;
...
%%%%%%%%;
Hvt_q3d = ...
  + 1.0 * sum( conj(dvol_a_k_p_quad_) .* (a_k_p_quad_) .* (dtau_a_restore_C2M0_k_p_quad_) .* weight_3d_riesz_k_qk_ ) ...
  - 1.0 * sum( conj(dvol_a_k_p_quad_) .* (dtau_a_restore_C1M1_k_p_quad_) .* weight_3d_riesz_k_qk_ ) ...
  ;
