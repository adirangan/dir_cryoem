      subroutine tesselation_neighborhood_wrapper_0(n_point,L_
     $     ,nl_max,nm_sum,ll_sum,T_nl_,T_vm_,T_dd_
     $     ,T_ll_,T_lf_,T_c0_,T_c1_,T_c2_,T_c3_,T_ls_,T_LT_,n_root_base
     $     ,root_base_,vp_input_,distance_req,n_LT_unique,LT_unique_)
      implicit none
      integer verbose
      data verbose / 0 /
...
c$$$      real *8 diamater_min
      ...
      real *8 vp_input_(0:2),distance_req
