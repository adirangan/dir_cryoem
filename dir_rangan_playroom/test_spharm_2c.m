function test_spharm_2c(n_l,a_,res_);
...
%{
  test_spharm_2c();
  % or something like: ;
  n_l =  2; a_ = [+0,+0,+0,+0,+0,+0,+1,+0,+0]; res_ = [96,96]; test_spharm_2c(n_l,a_,res_);
  n_l =  1; a_ = [+0,+0,+0,+1]; res_ = [96,96]; test_spharm_2c(n_l,a_,res_);
  %}
