...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% test_principled_marching_helper_trpv1_alternating_minimization_synthetic_9. ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
%%%%%%%%;
tmp_t = tic();
[~,n_w_,weight_2d_k_p_r_,weight_2d_k_all_,n_viewing_all,viewing_azimu_b_all_,viewing_polar_a_all_,n_viewing_polar_a,viewing_polar_a_,n_viewing_azimu_b_,template_k_c_0__,template_k_c_1__,template_k_c_2__] = get_template_0(verbose,n_k_p_r,k_p_r_,k_p_r_max,weight_3d_k_p_r_,l_max_,[],viewing_k_eq_d,template_k_eq_d);
n_w_max = max(n_w_);
n_w_sum = sum(n_w_);
n_w_csum = cumsum([0;n_w_]);
S_k_p___ = cell(n_molecule,1);
for nmolecule=0:n_molecule-1;
[S_k_p___{1+nmolecule}] = get_template_0(verbose,n_k_p_r,k_p_r_,k_p_r_max,weight_3d_k_p_r_,l_max_,a_k_Y_quad__(:,1+nmolecule),viewing_k_eq_d,template_k_eq_d);
