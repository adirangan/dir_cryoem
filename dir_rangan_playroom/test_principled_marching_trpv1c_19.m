...
% 20210103: switching back to trpv1. ;
clear;
...
dir_trunk = sprintf('/%s/rangan/dir_cryoem/dir_rangan_playroom/dir_principled_marching_trpv1c',string_root);
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_a_k_p_quad_.mat',dir_trunk);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_a_k_p_quad_',dir_trunk);
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_b_x_u_reco__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_b_x_u_reco__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_a_k_Y_quad_.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
l_max_upb = 36;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_a_k_Y_quad_A',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_a_k_Y_quad_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_S_k_p__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_S_k_p__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_S_k_p__A',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
nk_p_r = 12;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_CTF_k_p__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_CTF_k_p__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_CTF_k_p_r_xxxx__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_euler_angle_marina_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
% Now look at some of the experimental images associated with trpv1c. ;
...
%%%%%%%%;
fname_M_x_c_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_M_x_c___.mat',dir_trunk);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_delta_read_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_M_x_c___center_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
N_x_c___ = M_x_c___;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_M_x_c___sample',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_M_k_p___.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
fname_image_mda = sprintf('%s/images_mda',dir_data);
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_X__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
n_M = n_image_sub;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_X_TM_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
markersize_use = 32;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_X_2d_xcor_d0_vs_2d_Memp_d1_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf; hold on;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_vis_UX_.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
vis_n_UX_rank = 8;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_vis_UX_2d_xcor_d0_FIGA',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_vis_UX_2d_xcor_d1_FIGA',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_vis_UX_2d_Memp_d1_FIGA',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_X_%s__.mat',dir_trunk,str_cost);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_X_%s_A',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_X_%s_B',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
%%%%%%%%;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_CTF_UX_%s_S_k_p___.mat',dir_trunk,str_cost);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_CTF_UX_%s_S_k_p___',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_CTF_UX_%s_S_k_q___',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_CTF_UX_%s_S_k_q___spectrum',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
n_plot=6;
for nplot=0:n_plot-1;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_CTF_UX_%s_S_k_p___A',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_UX_%s_M_k_p___.mat',dir_trunk,str_cost);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
O_k_p__ = zeros(n_w_sum,n_image_sub); %<-- holds not centered images (i.e., original). ;
M_k_p__ = zeros(n_w_sum,n_image_sub); %<-- holds yes centered images (except, actually not centered). ;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_UX_%s_M_k_p___',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_UX_%s_M_k_q___',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_UX_%s_M_k_q___spectrum',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_c_k_Y_.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_c_x_u_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_d0_CTF_UXI_S_k_p__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_d0_CTF_UXI_S_k_p__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_d0_CTF_UXI_S_grad_FIGA',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%;
c__ = colormap_beach();
...
% Now calculate the typical directional-derivative (with respect to viewing-angle) of the template-operator applied to the true molecule. ;
%%%%%%%%;
fname_mat = sprintf('%s_mat/test_principled_marching_trpv1c_0_d0_CTF_UX_S_k_p__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
pm_n_UX_rank = 9;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_d0_CTF_UX_S_k_p__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
clf;
n_plot=6;
...
eta_equi_lob__ = reshape(reshape(eta_equi_lob___,[n_l2_snr*pm_n_k_p_r,pm_n_viewing_all])*reshape(pm_viewing_weight_all_,[pm_n_viewing_all,1])/(4*pi),[n_l2_snr,pm_n_k_p_r]);
%%%%%%%%;
fname_fig = sprintf('%s_jpg/test_principled_marching_trpv1c_0_d0_CTF_UX_S_grad_FIGA',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%;
c__ = colormap_beach();
