...
title('v_min_dtau_','Interpreter','none');
%%%%;
sgtitle(sprintf('%s niteration %d lambda %0.2f = exp(%+0.2f) index_lambda %d/%d: %s ',str_T,niteration,lambda_use,log(lambda_use),index_lambda,niteration-1,str_vv),'Interpreter','none');
%%%%%%%%%%%%%%%%;
end;%if ( exist(fname_mat,'file'));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
