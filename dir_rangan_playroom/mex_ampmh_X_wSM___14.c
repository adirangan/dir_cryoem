 ...
 * gcc -fPIC -w -O2 -DWITHOUT_MEX -D_AVX -mavx -D_CBLAS -D_FMA -mfma mex_ampmh_X_wSM___14.c -lm -lfftw3 -lfftw3f -lgslcblas ; ./a.out;
...
double l2_double_complex__vs_float_m256__(int n_a,int n_b,double complex *z__,float *f_R__,float *f_I__)
{
  ...
  ulli = (unsigned long long int)n_a_rup*(unsigned long long int)n_b_rup;
  for (nb=0;nb<n_b;nb++){
    for (na=0;na<n_a;na++){
      tabA =
...
double l2_double_complex___vs_float_m256___(int n_a,int n_b,int n_c,double complex *z___,float *f_R___,float *f_I___)
{
  ...
  unsigned long long int tabA=0,tabB=0;
  double l2_R=0,l2_I=0,l2=0;
  ulli = (unsigned long long int)n_a_rup*(unsigned long long int)n_b_rup*(unsigned long long int)n_c_rup;
  for (nc=0;nc<n_c;nc++){
    for (nb=0;nb<n_b;nb++){
      for (na=0;na<n_a;na++){
	tabA =
...
double l2_double_complex____vs_float_m256____(int n_a,int n_b,int n_c,int n_d,double complex *z____,float *f_R____,float *f_I____)
{
  ...
  unsigned long long int tabA=0,tabB=0;
  double l2_R=0,l2_I=0,l2=0;
  ulli = (unsigned long long int)n_a_rup*(unsigned long long int)n_b_rup*(unsigned long long int)n_c_rup*(unsigned long long int)n_d_rup;
  for (nd=0;nd<n_d;nd++){
    for (nc=0;nc<n_c;nc++){
      for (nb=0;nb<n_b;nb++){
	for (na=0;na<n_a;na++){
...
/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
/* The computational routine (brute force) */
/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
void mex_ampmh_X_wSM___11
(
  int n_M_per_Mbatch
 ,int n_S_per_Sbatch
 ...
 )
{
  ...
  /* %%%% */
  if (verbose){ printf(" %% [entering mex_ampmh_X_wSM___11]\n");}
  /* %%%%%%%%%%%%%%%% */
  ...
  fftw_plan_many_flags = FFTW_MEASURE;
  ...
  /* %%%%%%%%%%%%%%%% */
  if (verbose){ printf(" %% [finished mex_ampmh_X_wSM___11]\n");}
}
/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
/* The computational routine (compare fast and slow) */
/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
 ...
 )
{
  ...
  fftwf_plan_many_flags = FFTW_MEASURE;
...
/* can test dump with: ;
tmp_f_z_ = c_MDA_read_c16('mex_svd_SVUXM_lwsM____.mat');
tmp_f_r_ = c_MDA_read_r4('mex_f_svd_SVUXM_lwsM_real____.mat');
tmp_f_i_ = c_MDA_read_r4('mex_f_svd_SVUXM_lwsM_imag____.mat');
[tmp_n_l,tmp_n_w,tmp_n_s,tmp_n_M] = size(tmp_f_z_);
tmp_f_r_sub_ = tmp_f_r_(1:tmp_n_l,1:tmp_n_w,1:tmp_n_s,1:tmp_n_M);
tmp_f_i_sub_ = tmp_f_i_(1:tmp_n_l,1:tmp_n_w,1:tmp_n_s,1:tmp_n_M);
disp(sprintf(' %% real error: %0.16f',fnorm(real(tmp_f_z_) - tmp_f_r_sub_)));
disp(sprintf(' %% imag error: %0.16f',fnorm(imag(tmp_f_z_) - tmp_f_i_sub_)));
*/
/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
 ...
 )
{
  ...
  if (flag_fast){
    ...
    n_op_sum_f_CTF_UX_S_k_q_nSw___ += tab;
    /* if (flag_fast){ } */}
  if (verbose>2 && flag_slow && flag_fast){
    d_l2 = l2_double_complex___vs_float_m256___(pm_n_UX_rank,n_S,n_w_max,CTF_UX_S_k_q_nSw___,f_CTF_UX_S_k_q_nSw_real___,f_CTF_UX_S_k_q_nSw_imag___);
    printf(" %% CTF_UX_S_k_q_nSw___ l2 error %0.16f\n",d_l2);
    array_sub_printf(  CTF_UX_S_k_q_nSw___ ,"double complex",pm_n_UX_rank    *n_S    ,4,n_w_max    ,3," %%   CTF_UX_S_k_q_nSw___ : ");
    array_sub_printf(f_CTF_UX_S_k_q_nSw_real___,"float" ,pm_n_UX_rank_rup*n_S_rup,4,n_w_max_rup,3," %% f_CTF_UX_S_k_q_nSw_real___: ");
    array_sub_printf(f_CTF_UX_S_k_q_nSw_imag___,"float" ,pm_n_UX_rank_rup*n_S_rup,4,n_w_max_rup,3," %% f_CTF_UX_S_k_q_nSw_imag___: ");
    //exit(0);
  ...
  if (flag_fast){
    ...
    f_svd_SVUXM_wSMl_real____ = float____m256_malloc_from_double____(n_w_max,n_S,n_M_per_Mbatch,FTK_n_svd_l,NULL);
    f_svd_SVUXM_wSMl_imag____ = float____m256_malloc_from_double____(n_w_max,n_S,n_M_per_Mbatch,FTK_n_svd_l,NULL);
    /* if (flag_fast){ } */}
  /* %%%% */
  if (flag_slow){
    tab = 
  ...
  for (nMbatch=0;nMbatch<n_Mbatch;nMbatch++){
	...
	printf(" %% svd_SVUXM_SMlw____ l2 error %0.16f\n",d_l2);
	array_sub_printf(  svd_SVUXM_SMlw____ ,"double complex",n_S    *n_M_sub    ,4,FTK_n_svd_l    *n_w_max    ,3," %%   svd_SVUXM_SMlw____ : ");
	array_sub_printf(f_svd_SVUXM_SMlw_real____,"float" ,n_S_rup*n_M_sub_rup,4,FTK_n_svd_l_rup*n_w_max_rup,3," %% f_svd_SVUXM_SMlw_real____: ");
	array_sub_printf(f_svd_SVUXM_SMlw_imag____,"float" ,n_S_rup*n_M_sub_rup,4,FTK_n_svd_l_rup*n_w_max_rup,3," %% f_svd_SVUXM_SMlw_imag____: ");
	//exit(0);
	...
	tabA = 
	  ...
	  *(unsigned long long int)n_M_per_Mbatch_rup
	  *(unsigned long long int)FTK_n_svd_l_rup;
	memset(f_svd_SVUXM_out_wSMl____,0,tabA*sizeof(fftwf_complex));
	fftwf_execute(fftwf_plan_many_plan);
	local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,tab,verbose-1,"f_svd_SVUXM_out_wSMl____: ");
	elrt_sum_f_svd_SVUXM_out_wSMl____ += elrt_[0];
	n_op_sum_f_svd_SVUXM_out_wSMl____ += tab;
	...
	printf(" %% svd_SVUXM_lwSM____ l2 error %0.16f\n",d_l2);
	array_sub_printf(  svd_SVUXM_lwSM____ ,"double complex",FTK_n_svd_l    *n_w_max    ,3,n_S    *n_M_sub    ,4," %%   svd_SVUXM_lwSM____ : ");
	array_sub_printf(f_svd_SVUXM_lwSM_real____,"float" ,FTK_n_svd_l_rup*n_w_max_rup,3,n_S_rup*n_M_sub_rup,4," %% f_svd_SVUXM_lwSM_real____: ");
	array_sub_printf(f_svd_SVUXM_lwSM_imag____,"float" ,FTK_n_svd_l_rup*n_w_max_rup,3,n_S_rup*n_M_sub_rup,4," %% f_svd_SVUXM_lwSM_imag____: ");
	//exit(0);
	...
	if (n_S_sub>0){
	  ...
	  if (verbose>2 && flag_slow && flag_fast){
	    ...
	    printf(" %% svd_SVUXM_lwsM____ l2 error %0.16f\n",d_l2);
	    /* note: if n_S_sub is too small, array_sub_printf will not stride correctly */
	    array_sub_printf(  svd_SVUXM_lwsM____ ,"double complex",FTK_n_svd_l    *n_w_max    ,3,n_S_sub    *n_M_sub    ,4," %%   svd_SVUXM_lwsM____ : ");
	    array_sub_printf(f_svd_SVUXM_lwsM_real____,"float" ,FTK_n_svd_l_rup*n_w_max_rup,3,n_S_sub_rup*n_M_sub_rup,4," %% f_svd_SVUXM_lwsM_real____: ");
	    array_sub_printf(f_svd_SVUXM_lwsM_imag____,"float" ,FTK_n_svd_l_rup*n_w_max_rup,3,n_S_sub_rup*n_M_sub_rup,4," %% f_svd_SVUXM_lwsM_imag____: ");
	    //exit(0);
	  ...
	  if (flag_dump){
	    ...
	    if (flag_fast){
	      MDA_ndim=0;
	      MDA_dim_[MDA_ndim++] = FTK_n_svd_l_rup;
	      MDA_dim_[MDA_ndim++] = n_w_max_rup;
	      MDA_dim_[MDA_ndim++] = n_S_sub_rup;
	      MDA_dim_[MDA_ndim++] = n_M_sub_rup;
	      MDA_n_dim = MDA_ndim;
	      sprintf(MDA_fname,"mex_f_svd_SVUXM_lwsM_real____.mat");
	      MDA_write_r8(MDA_n_dim,MDA_dim_,f_svd_SVUXM_lwsM_real____,MDA_fname);
	      sprintf(MDA_fname,"mex_f_svd_SVUXM_lwsM_imag____.mat");
	      MDA_write_r8(MDA_n_dim,MDA_dim_,f_svd_SVUXM_lwsM_imag____,MDA_fname);
	      /* if (flag_fast){ } */}
	    /* if (flag_dump){ } */}
	  /* %%%% */
	  /* svd_USESVUXM_dwSM____ = real(reshape(FTK.svd_U_d_expiw_s__*reshape(svd_SVUXM_lwsM____,[FTK.n_svd_l,n_w_max*n_S_sub*n_M_sub]),[FTK.n_delta_v,n_w_max,n_S_sub,n_M_sub])); */
	  ...
	  if (verbose>2 && flag_slow && flag_fast){
	    ...
	    printf(" %% svd_USESVUXM_dwSM____ l2 error %0.16f\n",d_l2);
	    array_sub_printf(  svd_USESVUXM_dwSM____ ,"double complex",FTK_n_delta_v    *n_w_max    ,3,n_S_sub    *n_M_sub    ,4," %%   svd_USESVUXM_dwSM____ : ");
	    array_sub_printf(f_svd_USESVUXM_dwSM_real____,"float" ,FTK_n_delta_v_rup*n_w_max_rup,3,n_S_sub_rup*n_M_sub_rup,4," %% f_svd_USESVUXM_dwSM_real____: ");
	    array_sub_printf(f_svd_USESVUXM_dwSM_imag____,"float" ,FTK_n_delta_v_rup*n_w_max_rup,3,n_S_sub_rup*n_M_sub_rup,4," %% f_svd_USESVUXM_dwSM_imag____: ");
	    //exit(0);
	  ...
	  if (flag_dump && flag_fast){
	    ...
	    MDA_dim_[MDA_ndim++] = n_M_sub;
	    MDA_n_dim = MDA_ndim;
	    sprintf(MDA_fname,"mex_f_svd_USESVUXM_dwSM_real____.mat");
	    MDA_write_r8(MDA_n_dim,MDA_dim_,f_svd_USESVUXM_dwSM_real____,MDA_fname);
	    sprintf(MDA_fname,"mex_f_svd_USESVUXM_dwSM_imag____.mat");
	    MDA_write_r8(MDA_n_dim,MDA_dim_,f_svd_USESVUXM_dwSM_imag____,MDA_fname);
	    /* if (flag_dump){ } */}
	  /* %%%% */
	  /* 
	     l2_dSM___ = permute(reshape(reshape(sqrt(CTF_UX_S_l2_use_(1+index_S_in_Sbatch_)),[n_S_sub,1])*reshape(sqrt(UX_M_l2_dM_use__(:,1+index_M_in_Mbatch_)),[1,FTK.n_delta_v*n_M_sub]),[n_S_sub,FTK.n_delta_v,n_M_sub]),[2,1,3]);
	  ...
	  */
	  ...
	  if (verbose>2 && flag_slow && flag_fast){
	    tabA = 
	      ...
	      *(unsigned long long int)n_S_sub
	      *(unsigned long long int)n_M_sub;
	    d_l2 = dfnormn(tabA,X_sub_dwSM____,d_X_sub_dwSM____);
	    printf(" %% X_sub_dwSM____ l2 error %0.16f\n",d_l2);
	    array_sub_printf(  X_sub_dwSM____ ,"double",FTK_n_delta_v*n_w_max,3,n_S_sub*n_M_sub,4," %%   X_sub_dwSM____ : ");
	    array_sub_printf(d_X_sub_dwSM____ ,"double",FTK_n_delta_v*n_w_max,3,n_S_sub*n_M_sub,4," %% d_X_sub_dwSM____ : ");
	    //exit(0);
	    /* if (verbose>2){ } */}
	  /* %%%% */
	  tab = (unsigned long long int)FTK_n_delta_v*(unsigned long long int)n_w_max*(unsigned long long int)n_S_sub*(unsigned long long int)n_M_sub;
	  ...
	  if (flag_dump){
	    ...
	    if (flag_fast){
	      ...
	      MDA_dim_[MDA_ndim++] = n_M_sub;
	      MDA_n_dim = MDA_ndim;
	      sprintf(MDA_fname,"mex_d_X_sub_dwSM____.mat");
	      MDA_write_r8(MDA_n_dim,MDA_dim_,d_X_sub_dwSM____,MDA_fname);
	      /* if (flag_fast){ } */}
	    /* if (flag_dump){ } */}
	  /* %%%% */
	  /* 
  ...
  /* %%%%%%%%%%%%%%%% */
  if (verbose){
    if (flag_slow){ printf(" %% elrt_sum_CTF_UX_S_k_q_nSw___     : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_CTF_UX_S_k_q_nSw___,n_op_sum_CTF_UX_S_k_q_nSw___/elrt_sum_CTF_UX_S_k_q_nSw___/1e6,n_op_sum_CTF_UX_S_k_q_nSw___/elrt_sum_CTF_UX_S_k_q_nSw___/1e9);}
    if (flag_fast){ printf(" %% elrt_sum_f_CTF_UX_S_k_q_nSw___   : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_f_CTF_UX_S_k_q_nSw___,n_op_sum_f_CTF_UX_S_k_q_nSw___/elrt_sum_f_CTF_UX_S_k_q_nSw___/1e6,n_op_sum_f_CTF_UX_S_k_q_nSw___/elrt_sum_f_CTF_UX_S_k_q_nSw___/1e9);}
    if (flag_slow){ printf(" %% elrt_sum_svd_VUXM_nMwl____       : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_svd_VUXM_nMwl____,n_op_sum_svd_VUXM_nMwl____/elrt_sum_svd_VUXM_nMwl____/1e6,n_op_sum_svd_VUXM_nMwl____/elrt_sum_svd_VUXM_nMwl____/1e9);}
    if (flag_fast){ printf(" %% elrt_sum_f_svd_VUXM_nMlw____     : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_f_svd_VUXM_nMlw____,n_op_sum_f_svd_VUXM_nMlw____/elrt_sum_f_svd_VUXM_nMlw____/1e6,n_op_sum_f_svd_VUXM_nMlw____/elrt_sum_f_svd_VUXM_nMlw____/1e9);}
    if (flag_slow){ printf(" %% elrt_sum_svd_SVUXM_SMwl____      : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_svd_SVUXM_SMwl____,n_op_sum_svd_SVUXM_SMwl____/elrt_sum_svd_SVUXM_SMwl____/1e6,n_op_sum_svd_SVUXM_SMwl____/elrt_sum_svd_SVUXM_SMwl____/1e9);}
    if (flag_slow){ printf(" %% elrt_sum_svd_SVUXM_SMlw____      : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_svd_SVUXM_SMlw____,n_op_sum_svd_SVUXM_SMlw____/elrt_sum_svd_SVUXM_SMlw____/1e6,n_op_sum_svd_SVUXM_SMlw____/elrt_sum_svd_SVUXM_SMlw____/1e9);}
    if (flag_fast){ printf(" %% elrt_sum_f_svd_SVUXM_SMlw____    : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_f_svd_SVUXM_SMlw____,n_op_sum_f_svd_SVUXM_SMlw____/elrt_sum_f_svd_SVUXM_SMlw____/1e6,n_op_sum_f_svd_SVUXM_SMlw____/elrt_sum_f_svd_SVUXM_SMlw____/1e9);}
    if (flag_slow){ printf(" %% elrt_sum_svd_SVUXM_0in_wlSM____  : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_svd_SVUXM_0in_wlSM____,n_op_sum_svd_SVUXM_0in_wlSM____/elrt_sum_svd_SVUXM_0in_wlSM____/1e6,n_op_sum_svd_SVUXM_0in_wlSM____/elrt_sum_svd_SVUXM_0in_wlSM____/1e9);}
    if (flag_fast){ printf(" %% elrt_sum_f_svd_SVUXM_0in_wSMl____: %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_f_svd_SVUXM_0in_wSMl____,n_op_sum_f_svd_SVUXM_0in_wSMl____/elrt_sum_f_svd_SVUXM_0in_wSMl____/1e6,n_op_sum_f_svd_SVUXM_0in_wSMl____/elrt_sum_f_svd_SVUXM_0in_wSMl____/1e9);}
    if (flag_slow){ printf(" %% elrt_sum_svd_SVUXM_out_wlSM____  : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_svd_SVUXM_out_wlSM____,n_op_sum_svd_SVUXM_out_wlSM____/elrt_sum_svd_SVUXM_out_wlSM____/1e6,n_op_sum_svd_SVUXM_out_wlSM____/elrt_sum_svd_SVUXM_out_wlSM____/1e9);}
    if (flag_fast){ printf(" %% elrt_sum_f_svd_SVUXM_out_wSMl____: %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_f_svd_SVUXM_out_wSMl____,n_op_sum_f_svd_SVUXM_out_wSMl____/elrt_sum_f_svd_SVUXM_out_wSMl____/1e6,n_op_sum_f_svd_SVUXM_out_wSMl____/elrt_sum_f_svd_SVUXM_out_wSMl____/1e9);}
    if (flag_slow){ printf(" %% elrt_sum_svd_SVUXM_lwSM____      : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_svd_SVUXM_lwSM____,n_op_sum_svd_SVUXM_lwSM____/elrt_sum_svd_SVUXM_lwSM____/1e6,n_op_sum_svd_SVUXM_lwSM____/elrt_sum_svd_SVUXM_lwSM____/1e9);}
    if (flag_fast){ printf(" %% elrt_sum_f_svd_SVUXM_lwSM____    : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_f_svd_SVUXM_lwSM____,n_op_sum_f_svd_SVUXM_lwSM____/elrt_sum_f_svd_SVUXM_lwSM____/1e6,n_op_sum_f_svd_SVUXM_lwSM____/elrt_sum_f_svd_SVUXM_lwSM____/1e9);}
    if (flag_slow){ printf(" %% elrt_sum_svd_SVUXM_lwsM____      : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_svd_SVUXM_lwsM____,n_op_sum_svd_SVUXM_lwsM____/elrt_sum_svd_SVUXM_lwsM____/1e6,n_op_sum_svd_SVUXM_lwsM____/elrt_sum_svd_SVUXM_lwsM____/1e9);}
    if (flag_fast){ printf(" %% elrt_sum_f_svd_SVUXM_lwsM____    : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_f_svd_SVUXM_lwsM____,n_op_sum_f_svd_SVUXM_lwsM____/elrt_sum_f_svd_SVUXM_lwsM____/1e6,n_op_sum_f_svd_SVUXM_lwsM____/elrt_sum_f_svd_SVUXM_lwsM____/1e9);}
    if (flag_slow){ printf(" %% elrt_sum_svd_USESVUXM_dwSM____   : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_svd_USESVUXM_dwSM____,n_op_sum_svd_USESVUXM_dwSM____/elrt_sum_svd_USESVUXM_dwSM____/1e6,n_op_sum_svd_USESVUXM_dwSM____/elrt_sum_svd_USESVUXM_dwSM____/1e9);}
    if (flag_fast){ printf(" %% elrt_sum_f_svd_USESVUXM_dwSM____ : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_f_svd_USESVUXM_dwSM____,n_op_sum_f_svd_USESVUXM_dwSM____/elrt_sum_f_svd_USESVUXM_dwSM____/1e6,n_op_sum_f_svd_USESVUXM_dwSM____/elrt_sum_f_svd_USESVUXM_dwSM____/1e9);}
    if ( 1       ){ printf(" %% elrt_sum_l2_dSM___               : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_l2_dSM___,n_op_sum_l2_dSM___/elrt_sum_l2_dSM___/1e6,n_op_sum_l2_dSM___/elrt_sum_l2_dSM___/1e9);}
    if (flag_slow){ printf(" %% elrt_sum_X_sub_dwSM____          : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_X_sub_dwSM____,n_op_sum_X_sub_dwSM____/elrt_sum_X_sub_dwSM____/1e6,n_op_sum_X_sub_dwSM____/elrt_sum_X_sub_dwSM____/1e9);}
    if (flag_fast){ printf(" %% elrt_sum_d_X_sub_dwSM____        : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_d_X_sub_dwSM____,n_op_sum_d_X_sub_dwSM____/elrt_sum_d_X_sub_dwSM____/1e6,n_op_sum_d_X_sub_dwSM____/elrt_sum_d_X_sub_dwSM____/1e9);}
    if (flag_slow){ printf(" %% elrt_sum_I_value_use_dwSM____    : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_I_value_use_dwSM____,n_op_sum_I_value_use_dwSM____/elrt_sum_I_value_use_dwSM____/1e6,n_op_sum_I_value_use_dwSM____/elrt_sum_I_value_use_dwSM____/1e9);}
    if ( 1       ){ printf(" %% elrt_sum_X_wSM___                : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_X_wSM___,n_op_sum_X_wSM___/elrt_sum_X_wSM___/1e6,n_op_sum_X_wSM___/elrt_sum_X_wSM___/1e9);}
    /* if (verbose){ } */}
  /* %%%%%%%%%%%%%%%% */
  free(gamma_z_); gamma_z_=NULL;
  if (flag_compute_I_value){ free(I_value_use_dwSM____); I_value_use_dwSM____=NULL;}
...
/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
/* The computational routine (slow vs fast) */
/* attempting split fftwf */
/* verdict: split fftwf is not actually faster? */
/* However, it will likely be easier to parallelize */
/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
void mex_ampmh_X_wSM___14
(
  int n_M_per_Mbatch
 ,int n_S_per_Sbatch
 ,int flag_optimize_over_gamma_z
 ...
 )
{
  ...
  double n_op_sum_X_wSM___=0;
  /* %%%% */
  if (verbose){ printf(" %% [entering mex_ampmh_X_wSM___14]\n");}
  /* %%%%%%%%%%%%%%%% */
  if (flag_slow){
    n_a = FTK_n_delta_v*FTK_n_svd_l;
    FTK_svd_U_d_expiw_s__ = double_complex_malloc_and_interleave(n_a,FTK_svd_U_d_expiw_s_real__,FTK_svd_U_d_expiw_s_imag__);
  ...
  if (flag_fast){
    ...
    /* if (flag_fast){ } */}
  if (verbose>2 && flag_fast){
    array_sub_printf(f_FTK_svd_U_d_expiw_s_dl_real__     ,"float" ,FTK_n_delta_v_rup,3,FTK_n_svd_l_rup,4," %% f_FTK_svd_U_d_expiw_s_dl_real__     : ");
    array_sub_printf(f_FTK_svd_U_d_expiw_s_ld_real__,"float" ,FTK_n_svd_l_rup,4,FTK_n_delta_v_rup,3," %% f_FTK_svd_U_d_expiw_s_ld_real__: ");
    array_sub_printf(f_FTK_svd_U_d_expiw_s_dl_imag__     ,"float" ,FTK_n_delta_v_rup,3,FTK_n_svd_l_rup,4," %% f_FTK_svd_U_d_expiw_s_dl_imag__     : ");
    array_sub_printf(f_FTK_svd_U_d_expiw_s_ld_imag__,"float" ,FTK_n_svd_l_rup,4,FTK_n_delta_v_rup,3," %% f_FTK_svd_U_d_expiw_s_ld_imag__: ");
    //exit(0);
    /* if (verbose>2){ } */}
  if (flag_fast){
    f_CTF_UX_S_k_q_wnS_real___ = float___m256_malloc_from_double___(n_w_max,pm_n_UX_rank,n_S,CTF_UX_S_k_q_wnS_real__);
  ...
  /* %%%% */
  if (flag_fast){
    f_svd_SVUXM_0in_wSMl_real____ = float____m256_malloc_from_double____(n_w_max,n_S,n_M_per_Mbatch,FTK_n_svd_l,NULL);
    f_svd_SVUXM_0in_wSMl_imag____ = float____m256_malloc_from_double____(n_w_max,n_S,n_M_per_Mbatch,FTK_n_svd_l,NULL);
    f_svd_SVUXM_out_wSMl_real____ = float____m256_malloc_from_double____(n_w_max,n_S,n_M_per_Mbatch,FTK_n_svd_l,NULL);
    f_svd_SVUXM_out_wSMl_imag____ = float____m256_malloc_from_double____(n_w_max,n_S,n_M_per_Mbatch,FTK_n_svd_l,NULL);
	...
	for (nM=0;nM<n_M_sub;nM++){
	  for (nS=0;nS<n_S;nS++){
		...
		tabB = 
		   ...
		   *(unsigned long long int)n_S_rup)
		  *(unsigned long long int)n_w_max_rup;
		d_l2_R = creal(svd_SVUXM_0in_wlSM____[tabA]) - f_svd_SVUXM_0in_wSMl_real____[tabB];
		d_l2_I = cimag(svd_SVUXM_0in_wlSM____[tabA]) - f_svd_SVUXM_0in_wSMl_imag____[tabB];
		d_l2 += d_l2_R*d_l2_R + d_l2_I*d_l2_I;
		d_l2_R = creal(svd_SVUXM_0in_wlSM____[tabA]);
		d_l2_I = cimag(svd_SVUXM_0in_wlSM____[tabA]);
		d_l2_iso += d_l2_R*d_l2_R + d_l2_I*d_l2_I;
		/* for (nw=0;nw<n_w_max;nw++){ } */}
	      /* for (nl=0;nl<FTK_n_svd_l;nl++){ } */}
	    /* for (nS=0;nS<n_S;nS++){ } */}
	  /* for (nM=0;nM<n_M_sub;nM++){ } */}
	printf(" %% svd_SVUXM_0in_wSMl____ l2 error %0.16f (l2 rerror %0.16f)\n",d_l2,d_l2/maximum(1e-12,d_l2_iso));
	//exit(0);
	/* if (verbose>2){ } */}
      if (verbose>2 && flag_slow && flag_fast){
	d_l2 = 0;
	...
	for (nM=0;nM<n_M_sub;nM++){
	  for (nS=0;nS<n_S;nS++){
		...
		tabB = 
		   ...
		   *(unsigned long long int)n_S_rup)
		  *(unsigned long long int)n_w_max_rup;
		d_l2_R = creal(svd_SVUXM_out_wlSM____[tabA]) - f_svd_SVUXM_out_wSMl_real____[tabB];
		d_l2_I = cimag(svd_SVUXM_out_wlSM____[tabA]) - f_svd_SVUXM_out_wSMl_imag____[tabB];
		d_l2 += d_l2_R*d_l2_R + d_l2_I*d_l2_I;
		d_l2_R = creal(svd_SVUXM_out_wlSM____[tabA]);
		d_l2_I = cimag(svd_SVUXM_out_wlSM____[tabA]);
		d_l2_iso += d_l2_R*d_l2_R + d_l2_I*d_l2_I;
		/* for (nw=0;nw<n_w_max;nw++){ } */}
	      /* for (nl=0;nl<FTK_n_svd_l;nl++){ } */}
	    /* for (nS=0;nS<n_S;nS++){ } */}
	  /* for (nM=0;nM<n_M_sub;nM++){ } */}
	printf(" %% svd_SVUXM_out_wSMl____ l2 error %0.16f (l2 rerror %0.16f)\n",d_l2,d_l2/maximum(1e-12,d_l2_iso));
	//exit(0);
	/* if (verbose>2){ } */}
      if (verbose>2 && flag_slow && flag_fast){
	d_l2 = l2_double_complex____vs_float_m256____(
  ...
  if (verbose){
    ...
    if (flag_slow){ printf(" %% elrt_sum_X_sub_dwSM____          : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_X_sub_dwSM____,n_op_sum_X_sub_dwSM____/elrt_sum_X_sub_dwSM____/1e6,n_op_sum_X_sub_dwSM____/elrt_sum_X_sub_dwSM____/1e9);}
    if (flag_fast){ printf(" %% elrt_sum_d_X_sub_dwSM____        : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_d_X_sub_dwSM____,n_op_sum_d_X_sub_dwSM____/elrt_sum_d_X_sub_dwSM____/1e6,n_op_sum_d_X_sub_dwSM____/elrt_sum_d_X_sub_dwSM____/1e9);}
    if ( 1       ){ printf(" %% elrt_sum_I_value_use_dwSM____    : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_I_value_use_dwSM____,n_op_sum_I_value_use_dwSM____/elrt_sum_I_value_use_dwSM____/1e6,n_op_sum_I_value_use_dwSM____/elrt_sum_I_value_use_dwSM____/1e9);}
    if ( 1       ){ printf(" %% elrt_sum_X_wSM___                : %0.6f <-- %0.2fMhz %0.2fGhz \n",elrt_sum_X_wSM___,n_op_sum_X_wSM___/elrt_sum_X_wSM___/1e6,n_op_sum_X_wSM___/elrt_sum_X_wSM___/1e9);}
    /* if (verbose){ } */}
  /* %%%%%%%%%%%%%%%% */
  free(gamma_z_); gamma_z_=NULL;
  ...
  if (flag_slow){
    ...
    /* if (flag_slow){ } */}
  if (flag_fast){
    _mm_free(f_svd_SVUXM_0in_wSMl_real____); f_svd_SVUXM_0in_wSMl_real____=NULL;
    _mm_free(f_svd_SVUXM_0in_wSMl_imag____); f_svd_SVUXM_0in_wSMl_imag____=NULL;
    _mm_free(f_svd_SVUXM_out_wSMl_real____); f_svd_SVUXM_out_wSMl_real____=NULL;
    _mm_free(f_svd_SVUXM_out_wSMl_imag____); f_svd_SVUXM_out_wSMl_imag____=NULL;
  ...
  if (flag_fast){
    ...
    /* if (flag_fast){ } */}
  /* %%%%%%%%%%%%%%%% */
  if (verbose){ printf(" %% [finished mex_ampmh_X_wSM___14]\n");}
}
...
int main()
{
  ...
  int flag_test=0;
  /* 0in */
  int n_M_per_Mbatch=48;
  int n_S_per_Sbatch=48;
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,1,verbose+1,"mex_ampmh_X_wSM___14: ");
  /* %%%%; */
  local_tic(0,t_start_,d_start_);
  mex_ampmh_X_wSM___13
    (
      n_M_per_Mbatch
     ,n_S_per_Sbatch
     ,flag_optimize_over_gamma_z
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,1,verbose+1,"mex_ampmh_X_wSM___13: ");
  /* %%%%; */
  local_tic(0,t_start_,d_start_);
  mex_ampmh_X_wSM___11
    (
      n_M_per_Mbatch
     ,n_S_per_Sbatch
     ,flag_optimize_over_gamma_z
  ...
  local_toc(0,t_start_,t_final_,d_start_,d_final_,l_msec_,l_ssec_,l_usec_,elct_,elrt_,1,verbose+1,"mex_ampmh_X_wSM___11: ");
  /* %%%%; */
...
void mexFunction(int nlhs,mxArray *plhs[],int nrhs,const mxArray *prhs[])
{
  ...
  int na=0,n_a;
  mwSize n_out=0;
  if (verbose){ printf(" %% [entering gateway mex_ampmh_X_wSM___14]\n");}
  /* %%%%%%%%%%%%%%%% */
  if(nrhs!=18) { mexErrMsgIdAndTxt("MyToolbox:mex_ampmh_X_wSM___14:nrhs","18 0in required.");}
  if(nlhs<  4) { mexErrMsgIdAndTxt("MyToolbox:mex_ampmh_X_wSM___14:nlhs"," 4 out required.");}
  /* %%%%%%%%%%%%%%%% */
  na=0;
  /* %%%% */
  ...
  /* %%%%%%%%%%%%%%%% */
  if (verbose){ printf(" %% [finished gateway mex_ampmh_X_wSM___14]\n");}
}
#endif
