...
dir_trunk = sprintf('/%s/rangan/dir_cryoem/dir_trpv1/dir_pm',string_root);
if (~exist(sprintf('%s_mat',dir_trunk),'dir')); disp(sprintf(' %% mkdir %s_mat',dir_trunk)); mkdir(sprintf('%s_mat',dir_trunk)); end;
if (~exist(sprintf('%s_jpg',dir_trunk),'dir')); disp(sprintf(' %% mkdir %s_jpg',dir_trunk)); mkdir(sprintf('%s_jpg',dir_trunk)); end;
...
%%%%%%%%;
fname_emd = sprintf('%s/../emd_5778.mrc',dir_data);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/a_x_u_load_',dir_trunk);
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/a_k_p_quad_.mat',dir_trunk);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/a_k_p_quad_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;
clf;
...
%%%%%%%%;
verbose=0;
fname_mat = sprintf('%s_mat/a_k_Y_quad_.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/a_k_Y_quad_A',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;
clf;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/a_k_Y_quad_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;
clf;
...
fname_fig = sprintf('%s_jpg/S_k_p__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;figbig;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/S_k_q__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;figbig;
Slim_ = std(abs(S_k_p__(:)))*2.5*[-1,+1];
...
%%%%%%%%;
fname_mrc = sprintf('%s/../tv1.mrcs',dir_data);
M_x_c___ = cast(ReadMRC(fname_mrc,4081,1024),'double');
%%%%%%%%;
% They seem to match reasonably well ;
%%%%%%%%;
fname_fig = sprintf('%s_jpg/M_x_u__vs_N_x_u__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/M_abs_x_c_avg_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/M_k_q__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;figbig;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/M_k_q_norm_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;figbig;
subplot(2,2,1);
...
%%%%%%%%;
fname_star = sprintf('%s/../tv1_relion_data.star',dir_data);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/euler_angle_original_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;figbig;
subplot(2,3,1);
...
%%%%%%%%;
fname_star = sprintf('%s/../tv1_run002_data.star',dir_data);
[blockNames,blockData,ok]=ReadStarFile(fname_star);
tmp_ij_ = 1 + [0:n_M-1];
euler_angle_star__ = [ ...
 blockData{1}.rlnAngleRot(tmp_ij_) ...
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/euler_angle_marina_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;figbig;
subplot(2,3,1);
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/euler_angle_star_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
dscale = 2.5;
...
%%%%%%%%;
disp(sprintf(' %% CTF_Voltage_kV_ vs blockData{1}.rlnVoltage: %0.16f',fnorm(CTF_Voltage_kV_(1+CTF_idx_) - blockData{1}.rlnVoltage)));
disp(sprintf(' %% CTF_Spherical_Aberration_ vs blockData{1}.rlnSphericalAberration: %0.16f',fnorm(CTF_Spherical_Aberration_(1+CTF_idx_) - blockData{1}.rlnSphericalAberration)));
disp(sprintf(' %% CTF_Amplitude_Contrast_ vs blockData{1}.rlnAmplitudeContrast: %0.16f',fnorm(CTF_Amplitude_Contrast_(1+CTF_idx_) - blockData{1}.rlnAmplitudeContrast)));
disp(sprintf(' %% CTF_Defocus_U_ vs blockData{1}.rlnDefocusU: %0.16f',fnorm(CTF_Defocus_U_(1+CTF_idx_) - blockData{1}.rlnDefocusU)));
disp(sprintf(' %% CTF_Defocus_V_ vs blockData{1}.rlnDefocusV: %0.16f',fnorm(CTF_Defocus_V_(1+CTF_idx_) - blockData{1}.rlnDefocusV)));
disp(sprintf(' %% CTF_Defocus_Angle_*180/pi vs blockData{1}.rlnDefocusAngle: %0.16f',fnorm(CTF_Defocus_Angle_(1+CTF_idx_)*180/pi - blockData{1}.rlnDefocusAngle)/fnorm(CTF_Defocus_Angle_(1+CTF_idx_)*180/pi)));
%%%%%%%%;
% Note the one-to-one correspondence between CTF_idx_ and MicrographName. ;
%%%%%%%%;
u_MicrographName_ = unique(blockData{1}.rlnMicrographName); n_u_MicrographName = numel(u_MicrographName_);
for nu_MicrographName=0:n_u_MicrographName-1;
tmp_index_ = efind(blockData{1}.rlnMicrographName==u_MicrographName_(1+nu_MicrographName));
...
%%%%%%%%;
n_ctf = numel(unique(blockData{1}.rlnMicrographName));
CTF_Detector_Pixel_Size_ = mscope_params(3)*ones(n_ctf,1);
...
tmp_index_ = efind(blockData{1}.rlnMicrographName==MicrographName);
CTF_index_(1+tmp_index_) = nctf;
tmp_index = min(tmp_index_);
CTF_Voltage_kV_(1+nctf) = blockData{1}.rlnVoltage(1+tmp_index);
CTF_Spherical_Aberration_(1+nctf) = blockData{1}.rlnSphericalAberration(1+tmp_index);
CTF_Amplitude_Contrast_(1+nctf) = blockData{1}.rlnAmplitudeContrast(1+tmp_index);
CTF_Defocus_U_(1+nctf) = blockData{1}.rlnDefocusU(1+tmp_index);
CTF_Defocus_V_(1+nctf) = blockData{1}.rlnDefocusV(1+tmp_index);
CTF_Defocus_Angle_(1+nctf) = blockData{1}.rlnDefocusAngle(1+tmp_index);
end;%for nctf=0:n_ctf-1;
%%%%%%%%;

%%%%%%%%;
fname_mat = sprintf('%s_mat/CTF_k_p__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/CTF_k_p_sample__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;figbig;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/CTF_k_p_xcor__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;figmed;
figbeach();
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/CTF_k_p_r_xxxx__',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;
clf;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/X__.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/X_TM_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
markersize_use = 32;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/X_2d_xcor_d0_vs_2d_Memp_d1_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/X_2d_xcor_d0_vs_2d_Msup_d1_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf; hold on;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/X_2d_Memp_d1_vs_2d_Msup_d1_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf; hold on;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/vis_UX_.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
vis_n_UX_rank = 8;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/vis_UX_2d_xcor_d0_FIGA',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/vis_UX_2d_xcor_d1_FIGA',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/vis_UX_2d_Memp_d1_FIGA',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
%%%%;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/X_%s__.mat',dir_trunk,str_cost);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
%%%%%%%%;
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/X_%s_A',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;
colormap(colormap_beach());
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/X_%s_B',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;
%%%%%%%%;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/UX_%s_M_k_p_wnM___.mat',dir_trunk,str_cost);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/UX_%s_M_k_p_wnM___',dir_trunk,str_cost);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;figbig;
...
%%%%%%%%;
fname_mat = sprintf('%s_mat/c_k_Y_.mat',dir_trunk);
if (flag_recalc | ~exist(fname_mat,'file'));
disp(sprintf(' %% %s not found, creating',fname_mat));
...
%%%%%%%%;
fname_fig = sprintf('%s_jpg/c_x_u_',dir_trunk);
if (flag_replot | ~exist(sprintf('%s.jpg',fname_fig),'file'));
disp(sprintf(' %% %s not found, creating',fname_fig));
figure(1+nf);nf=nf+1;clf;figbig;
...
%%%%;
fname_pre = sprintf('%s_mat/ut%.4dn%.2dr%d',dir_trunk,floor(1000*delta_r_max_use),dat_n_UX_rank,dat_rseed);
