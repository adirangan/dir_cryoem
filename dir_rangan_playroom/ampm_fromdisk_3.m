...
%%%%;
ampm_.euler_polar_a_prev_Ma__ = zeros(ampm_.n_M,n_str_filter);
ampm_.euler_azimu_b_prev_Ma__ = zeros(ampm_.n_M,n_str_filter);
ampm_.euler_gamma_z_prev_Ma__ = zeros(ampm_.n_M,n_str_filter);
ampm_.image_delta_x_prev_Ma__ = zeros(ampm_.n_M,n_str_filter);
ampm_.image_delta_y_prev_Ma__ = zeros(ampm_.n_M,n_str_filter);
ampm_.image_I_value_prev_Ma__ = zeros(ampm_.n_M,n_str_filter);
ampm_.image_X_value_prev_Ma__ = zeros(ampm_.n_M,n_str_filter);
ampm_.image_S_index_prev_Ma__ = zeros(ampm_.n_M,n_str_filter);
%%%%;
...
%%%%;
if ( isfield(tmp_,'euler_polar_a_Mi__')); ampm_.euler_polar_a_prev_Ma__(:,1+na) = tmp_.euler_polar_a_Mi__(:,end-1); end;
if ( isfield(tmp_,'euler_azimu_b_Mi__')); ampm_.euler_azimu_b_prev_Ma__(:,1+na) = tmp_.euler_azimu_b_Mi__(:,end-1); end;
if ( isfield(tmp_,'euler_gamma_z_Mi__')); ampm_.euler_gamma_z_prev_Ma__(:,1+na) = tmp_.euler_gamma_z_Mi__(:,end-1); end;
if ( isfield(tmp_,'image_delta_x_acc_Mi__')); ampm_.image_delta_x_prev_Ma__(:,1+na) = tmp_.image_delta_x_acc_Mi__(:,end-1) + tmp_.image_delta_x_upd_Mi__(:,end-1); end;
if ( isfield(tmp_,'image_delta_y_acc_Mi__')); ampm_.image_delta_y_prev_Ma__(:,1+na) = tmp_.image_delta_y_acc_Mi__(:,end-1) + tmp_.image_delta_y_upd_Mi__(:,end-1); end;
if ( isfield(tmp_,'image_I_value_Mi__')); ampm_.image_I_value_prev_Ma__(:,1+na) = tmp_.image_I_value_Mi__(:,end-1); end;
if ( isfield(tmp_,'image_X_value_Mi__')); ampm_.image_X_value_prev_Ma__(:,1+na) = tmp_.image_X_value_Mi__(:,end-1-1); end;
if ( isfield(tmp_,'image_S_index_Mi__')); ampm_.image_S_index_prev_Ma__(:,1+na) = tmp_.image_S_index_Mi__(:,end-1); end;
%%%%;
clear tmp_;
end;%if ( exist(tmp_fname_mat,'file'));
%%%%%%%%;
