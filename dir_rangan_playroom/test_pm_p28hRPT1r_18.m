...
dir_pm = sprintf('/%s/rangan/dir_cryoem/dir_p28hRPT1r/dir_pm',string_root);
...
dir_relion = sprintf('/%s/rangan/dir_cryoem/dir_p28hRPT1r/dir_relion',string_root);
...
if flag_center==1; 
end;%if flag_center==1; 
if flag_center==0;
N_k_p__ = M_k_p__;
N_k_q__ = M_k_q__;
end;%if flag_center==0;
...
delta_r_max_factor_ = [0.00,0.125];
...
fprintf(fp,'\n');
fprintf(fp,'loop_\n');
fprintf(fp,'_rlnImageName #1\n');
fprintf(fp,'_rlnOpticsGroup #2\n');
fprintf(fp,'_rlnDefocusU #3\n');
fprintf(fp,'_rlnDefocusV #4\n');
fprintf(fp,'_rlnDefocusAngle #5\n');
for nM=0:n_M_relion-1;
