...
pm1m2m3gf = @(a,b,x1p,x1q,p1,m1,x2p,x2q,p2,m2,x3p,x3q,p3,m3,s) ...
  pmgf(a,b,x1p,x1q,p1,m1,s).*pmgf(a,b,x2p,x2q,p2,m2,s).*pmgf(a,b,x3p,x3q,p3,m3,s);
n_a = 128;
n_b = 128;
vlim = 10;
...
rseed_ = 0 + (0:48-1); n_rseed = numel(rseed_);
...
pm1m2m3gf__ = pm1m2m3gf(a__,b__,x1p,x1q,p1,m1,x2p,x2q,p1,m3,x3p,x3q,p1,m3,s);
nlpm1m2m3gf__ = -log(pm1m2m3gf__);
nlplim_ = prctile(nlpm1m2m3gf__,linspace(0,75,n_contour),'all');
subplot(p_row,p_col,1+nrseed);
contour(nlpm1m2m3gf__,nlplim_);
