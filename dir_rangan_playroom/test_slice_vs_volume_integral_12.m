...
test_slice_vs_volume_integral_12( ...
 global_parameter ...
,fname_prefix ...
...
%%%%%%%%;
% Applying eig_ddssnll_lanczos_2 to various molecules. ;
% Limiting to principal modes. ;
%%%%%%%%;

if (nargin<1);
table_data__ = { ...
'ISWINCP_x0' , 'ISWINCP' , 1.07 , 'emd_9718.map' , 'ADPBeF.star', 1024 ; ...
%'p28hRPT1_x0' , 'p28hRP' , 0.98 , 'emd_8674.map' , 'T1.star', 1024 ; ...
'trpv1_x0' , 'trpv1' , 1.2156 , 'emd_5778.mrc' , 'tv1_relion_data.star', 1024*8 ; ...
'rib80s_x0' , 'rib80s' , 1.34 , 'emd_2660.mrc' , 'shiny_2sets.star', 1024 ; ...
'MlaFEDB_x0' , 'MlaFEDB' , 0.832 , 'emd_22116.map' , 'Empiar_10536_00_to_23.star', 1024 ; ...
'LetB1_x0' , 'LetB1' , 1.31 , 'emd_20993.map' , 'job_569_model_1.star', 1024 ; ...
'TMEM16F_x0' , 'TMEM16F' , 1.059 , 'emd_20244.map' , 'All_8192.star', 1024 ; ...
'LSUbl17dep_x0' , 'LSUbl17dep' , 1.31 , 'emd_8434.map' , 'Parameters_negated.star', 1024 ; ...
'ps1_x0' , 'precatalytic_spliceosome' , 1.699 , 'consensus_half1_class001.mrc' , 'consensus_data.star', 1024 ; ...
%'LetB1_x0' , 'LetB1' , 1.31 , 'emd_20993.map' , 'job_569_model_1_350MB.star', 1024 ; ...
'LSUbl17depE_x0' , 'LSUbl17dep' , 1.31 , 'emd_8450.map' , 'Parameters_negated.star', 1024 ; ...
};
...
n_M_star = table_data__{1+nexperiment,1+na}; na=na+1;
disp(sprintf(' %% nexperiment %d/%d: %16s | %16s | %0.3f | %16s | %32s | %d |' ...
	     ,nexperiment,n_experiment ...
	     ,fname_prefix,dir_nopath_data_star,Pixel_Spacing,fname_nopath_volume,fname_nopath_star,n_M_star ...
	     ));
...
str_thisfunction = 'test_slice_vs_volume_integral_12';
...
%%%%%%%%;
fname_fig_pre = sprintf('%s_jpg/a_k_Y_quad_A',dir_ssnll);
fname_fig_jpg = sprintf('%s.jpg',fname_fig_pre);
fname_fig_eps = sprintf('%s.eps',fname_fig_pre);
if (flag_replot | ~exist(fname_fig_jpg,'file'));
disp(sprintf(' %% %s not found, creating',fname_fig_pre));
...
%%%%%%%%;
fname_fig_pre = sprintf('%s_jpg/a_k_Y_quad_yk_',dir_ssnll);
fname_fig_jpg = sprintf('%s.jpg',fname_fig_pre);
fname_fig_eps = sprintf('%s.eps',fname_fig_pre);
if (flag_replot | ~exist(fname_fig_jpg,'file'));
disp(sprintf(' %% %s not found, creating',fname_fig_pre));
...
% In our 'image-driven' units, sigma^2 is about RR_bar/n_x_u_pack^2 = 0.000013 = 1.3e-5. ;
%%%%%%%%;
