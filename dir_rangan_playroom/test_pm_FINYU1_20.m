...
delta_sigma_true_0in = 0.15; %<-- increase to increase translation-spread of images. ;
snr_per_AA_0in = 0.05; %<-- decrease to increase noise. ;
n_M_0in = 1024; %<-- number of images. ;
n_CTF_0in = 20; %<-- number of distinct CTFs. ;
Pixel_A_0in = 4.0; %<-- Pixel_Spacing in Angstroms, if n_x_u increases, this should decrease. ;
Voltage_0in = 300; %<-- no need to change. ;
Defocus_0in = 2e4; %<-- increase to increase number of CTF zero-crossings. ;
Defocus_relative_spread_0in = 0.25; %<-- increase to increase n_CTF_rank. ;
...
%fname_emd = sprintf('%s/%s',dir_data_star,fname_nopath_volume_{1+nvolume}); a_het_x_u_load_ = cast(ReadMRC(fname_emd),'double');
tmp_ = load(sprintf('%s/%s',dir_data_star,fname_nopath_volume_{1+nvolume}),'a_x_u_load_');
a_het_x_u_load_ = tmp_.a_x_u_load_;
clear tmp_;
%%%%%%%%;
...
a_het_rho_x_c_0_avg = sum(x_u_0___.^1.*a_het_rho_x_u_pack_/sum(a_het_rho_x_u_pack_,'all'),'all');
a_het_rho_x_c_1_avg = sum(x_u_1___.^1.*a_het_rho_x_u_pack_/sum(a_het_rho_x_u_pack_,'all'),'all');
a_het_rho_x_c_2_avg = sum(x_u_2___.^1.*a_het_rho_x_u_pack_/sum(a_het_rho_x_u_pack_,'all'),'all');
a_het_rho_x_c_0_std = sum((x_u_0___ - a_het_rho_x_c_0_avg).^2.*a_het_rho_x_u_pack_/sum(a_het_rho_x_u_pack_,'all'),'all');
a_het_rho_x_c_1_std = sum((x_u_1___ - a_het_rho_x_c_1_avg).^2.*a_het_rho_x_u_pack_/sum(a_het_rho_x_u_pack_,'all'),'all');
a_het_rho_x_c_2_std = sum((x_u_2___ - a_het_rho_x_c_2_avg).^2.*a_het_rho_x_u_pack_/sum(a_het_rho_x_u_pack_,'all'),'all');
...
b_het_rho_x_c_0_avg = sum(x_u_0___.^1.*b_het_rho_x_u_pack_/sum(b_het_rho_x_u_pack_,'all'),'all');
b_het_rho_x_c_1_avg = sum(x_u_1___.^1.*b_het_rho_x_u_pack_/sum(b_het_rho_x_u_pack_,'all'),'all');
b_het_rho_x_c_2_avg = sum(x_u_2___.^1.*b_het_rho_x_u_pack_/sum(b_het_rho_x_u_pack_,'all'),'all');
b_het_rho_x_c_0_std = sum((x_u_0___ - b_het_rho_x_c_0_avg).^2.*b_het_rho_x_u_pack_/sum(b_het_rho_x_u_pack_,'all'),'all');
b_het_rho_x_c_1_std = sum((x_u_1___ - b_het_rho_x_c_1_avg).^2.*b_het_rho_x_u_pack_/sum(b_het_rho_x_u_pack_,'all'),'all');
b_het_rho_x_c_2_std = sum((x_u_2___ - b_het_rho_x_c_2_avg).^2.*b_het_rho_x_u_pack_/sum(b_het_rho_x_u_pack_,'all'),'all');
...
%%%%%%%%;
eta = pi/x_p_r_max; tmp_t = tic;
a_het_k_p_quad_ = xxnufft3d3(n_xxx_u,x_u_0___(:)*eta,x_u_1___(:)*eta,x_u_2___(:)*eta,a_het_x_u_pack_(:).*xxx_u_weight_(:),-1,1e-12,n_k_all,2*pi*k_c_0_all_/eta,2*pi*k_c_1_all_/eta,2*pi*k_c_2_all_/eta)/sqrt(2*pi)/sqrt(2*pi)/sqrt(2*pi);
...
%%%%%%%%;
vis_UX_2d_xcor_d0_a_x_u_reco__ = zeros(n_xxx_u,vis_n_UX_rank);
vis_UX_2d_xcor_d1_a_x_u_reco__ = zeros(n_xxx_u,vis_n_UX_rank);
vis_UX_2d_Memp_d1_a_x_u_reco__ = zeros(n_xxx_u,vis_n_UX_rank);
for nUX_rank=0:vis_n_UX_rank-1;
eta = pi/k_p_r_max; tmp_t = tic;
vis_UX_2d_xcor_d0_a_x_u_reco__(:,1+nUX_rank) = xxnufft3d3(n_k_all,2*pi*k_c_0_all_*eta,2*pi*k_c_1_all_*eta,2*pi*k_c_2_all_*eta,vis_UX_2d_xcor_d0_a_k_p_reco__(:,1+nUX_rank).*(2*pi)^3.*weight_3d_k_all_,+1,1e-12,n_xxx_u,x_u_0___(:)/eta,x_u_1___(:)/eta,x_u_2___(:)/eta)/sqrt(2*pi)/sqrt(2*pi)/sqrt(2*pi);
tmp_t = toc(tmp_t); disp(sprintf(' %% xxnufft3d3: vis_UX_2d_xcor_d0_a_x_u_reco_ time %0.2fs',tmp_t));
eta = pi/k_p_r_max; tmp_t = tic;
vis_UX_2d_xcor_d1_a_x_u_reco__(:,1+nUX_rank) = xxnufft3d3(n_k_all,2*pi*k_c_0_all_*eta,2*pi*k_c_1_all_*eta,2*pi*k_c_2_all_*eta,vis_UX_2d_xcor_d1_a_k_p_reco__(:,1+nUX_rank).*(2*pi)^3.*weight_3d_k_all_,+1,1e-12,n_xxx_u,x_u_0___(:)/eta,x_u_1___(:)/eta,x_u_2___(:)/eta)/sqrt(2*pi)/sqrt(2*pi)/sqrt(2*pi);
tmp_t = toc(tmp_t); disp(sprintf(' %% xxnufft3d3: vis_UX_2d_xcor_d1_a_x_u_reco_ time %0.2fs',tmp_t));
eta = pi/k_p_r_max; tmp_t = tic;
vis_UX_2d_Memp_d1_a_x_u_reco__(:,1+nUX_rank) = xxnufft3d3(n_k_all,2*pi*k_c_0_all_*eta,2*pi*k_c_1_all_*eta,2*pi*k_c_2_all_*eta,vis_UX_2d_Memp_d1_a_k_p_reco__(:,1+nUX_rank).*(2*pi)^3.*weight_3d_k_all_,+1,1e-12,n_xxx_u,x_u_0___(:)/eta,x_u_1___(:)/eta,x_u_2___(:)/eta)/sqrt(2*pi)/sqrt(2*pi)/sqrt(2*pi);
...
tmp_t = tic;
eta = pi/k_p_r_max; 
c_x_u_reco_ = xxnufft3d3(n_k_all,2*pi*k_c_0_all_*eta,2*pi*k_c_1_all_*eta,2*pi*k_c_2_all_*eta,c_k_p_reco_.*(2*pi)^3.*weight_3d_k_all_,+1,1e-12,n_xxx_u,x_u_0___(:)/eta,x_u_1___(:)/eta,x_u_2___(:)/eta)/sqrt(2*pi)/sqrt(2*pi)/sqrt(2*pi);
...
dat_n_UX_rank_ = [8,10,12,14,16,18,20,22];
%dat_n_UX_rank_ = [18,20];
...
%%%%%%%%;
flag_compute = 1 & ( strcmp(platform,'access1') | 0*strcmp(platform,'rusty') | strcmp(platform,'eval1') );
if flag_compute;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
