...
/* The helper function */
/* %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
void hp_segregated_to_segregated_mult_immintrin_load1_fma_omp_helper
(
 int n_row_A
 ,int n_col_X
 ,float *f_AR_trn__
...
void hp_segregated_to_segregated_mult_immintrin_load1_fma_omp
(
 int n_row_A
 ,int n_col_X
 ,float *f_AR_trn__
 ...
 )
{
  ...
  if ((f_CR__!=NULL) && (f_CI__!=NULL)){
	...
	hp_segregated_to_segregated_mult_immintrin_load1_fma_omp_helper
	  (
	   n_row_A
	   ,n_col_X
	   ,f_AR_trn__
