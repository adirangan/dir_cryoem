...
flag_check=0;
if flag_check;
disp(sprintf(' %% testing accuracy of scatter_from_tensor_sba__:'));
...
if flag_polar_a_ascend_vs_descend==1; polar_a_ = transpose(linspace(0,1*pi,n_polar_a)); end; %<-- traditional order. ;
if flag_polar_a_ascend_vs_descend==0; polar_a_ = transpose(linspace(1*pi,0,n_polar_a)); end; %<-- reverse order. ;
...
for n_order=[3,5,7];
scatter_from_tensor_sba__ = cg_interpolate_n_3(n_order,n_azimu_b,n_polar_a,n_scat,azimu_b_scat_,polar_a_scat_,flag_polar_a_ascend_vs_descend);
...
scatter_from_tensor_sba__ = cg_interpolate_n_3(n_order,n_azimu_b,n_polar_a,n_scat,azimu_b_scat_,polar_a_scat_);
