...
if (verbose); disp(sprintf(' %% [testing ampmh_X_wSM___4.m]')); end;
%%%%%%%%;
tmp_t = tic();
[ ...
 n_k_all ...
...
%%%%%%%%;
% Finally check ampmh_X_wSM___4 to see how the rotations and translations are implemented. ;
%%%%%%%%;
...
verbose=0;
if (verbose>0); disp(sprintf(' %% [entering ampmh_X_wSM___4]')); end;
%n_w_max = max(n_w_);
...
if (verbose>1); disp(sprintf(' %% [finished ampmh_X_wSM___4]')); end;
