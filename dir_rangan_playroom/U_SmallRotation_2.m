...
str_thisfunction = 'U_SmallRotation_2';
...
weight_3d_riesz_weight_imagecount_ykabc_ = cat(1,weight_3d_riesz_yk_/scaling_volumetric,repmat(weight_imagecount_M_,[3,1]));
...
[U_SmallRotation_Delta_ykabcs__,S_SmallRotation_Delta_ss__,V_SmallRotation_Delta_ss__] = svds(bsxfun(@times,numerator_root_weight_3d_riesz_weight_imagecount_ykabc_,SmallRotation_Delta_ykabcs__),n_SmallRotation);
...
U_SmallRotation_Delta_ykabcs__ = bsxfun(@times,denomator_root_weight_3d_riesz_weight_imagecount_ykabc_,U_SmallRotation_Delta_ykabcs__);
if (flag_verbose>0); disp(sprintf(' %% S_SmallRotation_Delta_s_: %s',num2str(transpose(S_SmallRotation_Delta_s_),' %+0.6f'))); end;
U_tilde_SmallRotation_Delta_ykabcs__ = bsxfun(@times,numerator_root_weight_3d_riesz_weight_imagecount_ykabc_,U_SmallRotation_Delta_ykabcs__);
