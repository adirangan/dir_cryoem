function [X_,X_weight_r_,X_ori_,X_tau_,weight_so3,n_m_max,polar_a_,azimu_b_,gamma_z_] = principled_marching_cost_matrix_4(n_k_p_r,weight_k_p_r_,l_max_,n_molecule,molecule_density_,a_k_Y__,CTF_k_p_r__);
...
X_ori_(1+nk_p_r_0,1+nk_p_r_1) = X_ori_(1+nk_p_r_0,1+nk_p_r_1) + molecule_density*register_spharm_to_spharm_2(verbose,1,1,1,l_max_max,a_k_Y___(:,1+nk_p_r_0,1+nmolecule_0),a_k_Y___(:,1+nk_p_r_1,1+nmolecule_1)) * X_weight_r_01 * CTF_k_p_r__(1+nk_p_r_0,1+nk_p_r_1);
X_tau_(1+nk_p_r_0,1+nk_p_r_1) = X_tau_(1+nk_p_r_0,1+nk_p_r_1) + molecule_density*(4*pi)^2 * conj(a_k_Y___(1+0,1+nk_p_r_0,1+nmolecule_0))*a_k_Y___(1+0,1+nk_p_r_1,1+nmolecule_1) * X_weight_r_01 * CTF_k_p_r__(1+nk_p_r_0,1+nk_p_r_1);
