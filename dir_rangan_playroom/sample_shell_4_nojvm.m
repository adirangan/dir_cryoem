function [n_all,azimu_b_all_,polar_a_all_,weight_all_] = sample_shell_4_nojvm(r,d,TorL) ;
...
setup;
 ...
 [n_all,azimu_b_all_,polar_a_all_,weight_all_] = sample_shell_4_nojvm(1,sample_d,'L') ;
 for nk=1:b_K;
 k = k_(nk);
...
[n_all,azimu_b_all_,polar_a_all_,weight_all_] = sample_shell_4_nojvm(r,d,'T') ;
f_all_ = feval(@f_test,polar_a_all_); g_all_ = feval(@g_test,azimu_b_all_); h_all_ = f_all_.*g_all_;
It = dot(weight_all_,h_all_);
[n_all,azimu_b_all_,polar_a_all_,weight_all_] = sample_shell_4_nojvm(r,d,'C') ;
f_all_ = feval(@f_test,polar_a_all_); g_all_ = feval(@g_test,azimu_b_all_); h_all_ = f_all_.*g_all_;
Ic = dot(weight_all_,h_all_);
[n_all,azimu_b_all_,polar_a_all_,weight_all_] = sample_shell_4_nojvm(r,d,'L') ;
f_all_ = feval(@f_test,polar_a_all_); g_all_ = feval(@g_test,azimu_b_all_); h_all_ = f_all_.*g_all_;
