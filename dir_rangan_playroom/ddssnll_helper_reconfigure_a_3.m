%%%%%%%%;
if isempty(a_k_Y_quad_yk_) & ~isempty(a_k_p_quad_);
tmp_t = tic;
[ ...
 a_k_Y_quad_yk_ ...
,Ylm_uklma___ ...
...
end;%if isempty(a_k_Y_quad_yk_) & ~isempty(a_k_p_quad_);
%%%%%%%%;
...
%%%%%%%%;
if isempty(a_k_p_quad_) & ~isempty(a_k_Y_quad_yk_);
tmp_t = tic;
[ ...
 a_k_p_quad_ ...
,Ylm_uklma___ ...
...
end;%if isempty(a_k_p_quad_) & ~isempty(a_k_Y_quad_yk_);
%%%%%%%%;
