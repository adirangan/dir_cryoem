      subroutine test_innerproduct_batch_wrapper_2(verbose
     $     ,ncur,nlats_,grid_k_p_,max_x_c,n_S,ld_S,S_k_p_,n_M,ld_M
     $     ,M_k_p_,alpha_est_,eps_target,N_pixels_in,displacement_max
...
c$$$      calculating all innerproducts
     ...
     $     ,gamma_z_est_,eps_target,N_pixels_in,displacement_max
