function tpmutam_experimental_0_debug( ...
 dat_infix ...
,dat_rseed ...
,dat_n_M ...
,dat_M_k_p__ ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
% test_principled_marching_update_translation_alternating_minimization_experimental_0_debug. ;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
if (verbose); disp(sprintf(' %% [entering tpmutam_experimental_0_debug]')); end;

fname_mat = sprintf('%s_mat/tpmutameuxd_%s_M_k_p___n%.3dr%.3d.mat',dir_trunk,dat_infix,dat_n_M,dat_n_UX_rank);
...
%%%%%%%%;
tmp_svd_eps_ = 10.^[-3:0.5:0];
for nl=0:numel(tmp_svd_eps_)-1;
tmp_svd_eps = tmp_svd_eps_(1+nl);
disp(sprintf(' %% tmp_svd_eps %0.3f <-- n_svd_l %0.2d',tmp_svd_eps,numel(efind(FTK.svd_s_>=tmp_svd_eps))));
end;%for nl=0:numel(tmp_svd_eps_)-1;
%%%%%%%%;
%{
%%%%%%%%;
...
fname_0 = sprintf('%s_mat/tpmutameuxd_%s_n%.3d',dir_trunk,dat_infix,dat_n_M);
...
%%%%%%%%;
for nUX_rank=dat_n_UX_rank-1;%for nUX_rank=0:dat_n_UX_rank-1;
...
if (verbose); disp(sprintf(' %% [finished tpmutam_experimental_0_debug]')); end;
