...
if (verbose); disp(sprintf(' %% [testing ampmh_X_wSM___7.m]')); end;
%%%%%%%%;
tmp_t = tic();
[ ...
 n_k_all ...
...
%%%%%%%%;
% Finally, check ampmh_X_wSM___7 to see how the rotations and translations are implemented. ;
%%%%%%%%;
...
verbose = 0;
if (verbose>0); disp(sprintf(' %% [entering ampmh_X_wSM___7]')); end;
if (nargin<12); parameter = []; end;
[ ...
 FTK ...
,n_w_max ...
,pm_n_UX_rank ...
...
if (nargout>3); gamma_z_wSM___ = zeros(n_w_max,n_S,n_M); end;
if (nargout>4); I_value_wSM___ = zeros(n_w_max,n_S,n_M); end;
...
if (verbose>1); disp(sprintf(' %% [finished ampmh_X_wSM___7]')); end;
