...
flag_disp=1;
if flag_disp;
figure(1+nf);nf=nf+1;set(gcf,'Position',1+[0,0,1024*2,1024*0.5]);figpm;
p_row = 1; p_col = 5;
fontsize_use = 18;
%%%%;
...
%%%%;
fname_fig = sprintf('/%s/rangan/dir_cryoem/dir_pm_manuscript/dir_pm_fig/pm_fig_image_basis_nl%d_FIGA',string_root,nl);
