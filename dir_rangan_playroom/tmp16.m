%%%%%%%%;
% Arranging inputs for hessian. ;
% First run test_slice_vs_volume_integral_5, then: ;
% who_ = who(); for nl=0:numel(who_)-1; disp(sprintf(',%s ...',who_{1+nl})); end;
%%%%%%%%;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
if (flag_verbose>0); disp(sprintf(' %% [entering %s]',str_thisfunctin)); end;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;

%%%%%%%%;
if isempty(a_k_Y_quad__);
...
end;%if isempty(a_k_Y_quad__);
%%%%%%%%;
if isempty(dvol_a_k_Y_quad__);
...
end;%if isempty(dvol_a_k_Y_quad__);
%%%%%%%%;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
if (flag_verbose>0); disp(sprintf(' %% [finished %s]',str_thisfunctin)); end;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
