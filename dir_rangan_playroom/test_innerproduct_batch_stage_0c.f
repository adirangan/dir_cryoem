c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
      subroutine test_innerproduct_batch_stage_0c(verbose
...
c$$$      parameters for timing
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_batch_stage_0c]'
      end if      
      if (verbose.gt.0) then
     ...
     $        ,' too large in test_innerproduct_batch_stage_0c'
      end if
     ...
     $        ,' too small in test_innerproduct_batch_stage_0c'
      end if
      if (.false.) then
...
c$OMP DO 
     ...
     $           ,' with thread: ',omp_get_thread_num()
         ...
         call test_innerproduct_batch_stage_1c(verbose
...
c$OMP END PARALLEL
     ...
     $        timing_toc-timing_tic
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_batch_stage_0c]'
      end if
