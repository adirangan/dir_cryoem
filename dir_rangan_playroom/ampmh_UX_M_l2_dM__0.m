function UX_M_l2_dM__ = ampmh_UX_M_l2_dM__0(FTK,n_k_p_r,n_w_,n_M,M_k_q__,pm_n_UX_rank,UX__,X_weight_r_,svd_VUXM_lwnM____);
UX_M_l2_dM__ = zeros(FTK.n_delta_v,n_M);
n_w_max = max(n_w_);
if isempty(svd_VUXM_lwnM____);
svd_VUXM_lwnM____ = tpmh_VUXM_lwnM____0(FTK,n_k_p_r,n_w_,n_M,M_k_q__(:,1:n_M),pm_n_UX_rank,UX__,X_weight_r_);
