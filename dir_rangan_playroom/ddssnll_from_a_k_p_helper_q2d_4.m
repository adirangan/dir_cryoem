...
if flag_disp;
%%%%%%%%;
dtau_ssnll_q2d_errabs_M_ = abs(dtau_ssnll_q2d_dif_M_-dtau_ssnll_q2d_mid_M_);
dtau_ssnll_q2d_errrel_M_ = abs(dtau_ssnll_q2d_dif_M_-dtau_ssnll_q2d_mid_M_)./max(1e-12,abs(dtau_ssnll_q2d_dif_M_));
dtau_dvol_ssnll_q2d_errabs_M_ = abs(dtau_dvol_ssnll_q2d_dif_M_-dtau_dvol_ssnll_q2d_mid_M_);
dtau_dvol_ssnll_q2d_errrel_M_ = abs(dtau_dvol_ssnll_q2d_dif_M_-dtau_dvol_ssnll_q2d_mid_M_)./max(1e-12,abs(dtau_dvol_ssnll_q2d_dif_M_));
dtau_dtau_ssnll_q2d_errabs_M_ = abs(dtau_dtau_ssnll_q2d_dif_M_-dtau_dtau_ssnll_q2d_mid_M_);
dtau_dtau_ssnll_q2d_errrel_M_ = abs(dtau_dtau_ssnll_q2d_dif_M_-dtau_dtau_ssnll_q2d_mid_M_)./max(1e-12,abs(dtau_dtau_ssnll_q2d_dif_M_));
%%%%%%%%;
figure(1+nf);nf=nf+1;clf;figmed;
p_row = 3; p_col = 3; np=0;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_ssnll_q2d_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
ylabel('dtau_ssnll_q2d_errabs_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_ssnll_q2d_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
ylabel('dtau_ssnll_q2d_errabs_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_ssnll_q2d_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
ylabel('dtau_ssnll_q2d_errabs_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_q2d_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
ylabel('dtau_dvol_ssnll_q2d_errabs_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_q2d_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
ylabel('dtau_dvol_ssnll_q2d_errabs_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_q2d_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
ylabel('dtau_dvol_ssnll_q2d_errabs_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_q2d_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
ylabel('dtau_dtau_ssnll_q2d_errabs_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_q2d_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
ylabel('dtau_dtau_ssnll_q2d_errabs_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_q2d_errabs_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
ylabel('dtau_dtau_ssnll_q2d_errabs_M_','Interpreter','none'); grid on;
%%%%%%%%;
figure(1+nf);nf=nf+1;clf;figmed;
...
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_ssnll_q2d_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
ylabel('dtau_ssnll_q2d_errrel_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_ssnll_q2d_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
ylabel('dtau_ssnll_q2d_errrel_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_ssnll_q2d_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
ylabel('dtau_ssnll_q2d_errrel_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_q2d_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
ylabel('dtau_dvol_ssnll_q2d_errrel_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_q2d_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
ylabel('dtau_dvol_ssnll_q2d_errrel_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_dvol_ssnll_q2d_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
ylabel('dtau_dvol_ssnll_q2d_errrel_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_polar_a_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_q2d_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_polar_a_M_/pi','Interpreter','none');
ylabel('dtau_dtau_ssnll_q2d_errrel_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_azimu_b_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_q2d_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_azimu_b_M_/pi','Interpreter','none');
ylabel('dtau_dtau_ssnll_q2d_errrel_M_','Interpreter','none'); grid on;
%%%%;
subplot(p_row,p_col,1+np);np=np+1;cla;
plot(periodize(euler_gamma_z_M_,-pi,+pi)/pi,log10(dtau_dtau_ssnll_q2d_errrel_M_),'o');
xlim([-1,+1]); xlabel('euler_gamma_z_M_/pi','Interpreter','none');
ylabel('dtau_dtau_ssnll_q2d_errrel_M_','Interpreter','none'); grid on;
%%%%%%%%;
end;%if flag_disp;
