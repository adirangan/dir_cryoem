...
Elim_ = 1.0 + 1.0*[-1,+1];
%Elim_ = 2.0 + 2.0*[-1,+1];
figure(1+nf);nf=nf+1;clf;set(gcf,'Position',1+[0,0,4.25*768,512+128]);figbeach;
...
ylabel('$\beta$','Interpreter','latex','FontSize',fontsize_sym);%ylabel('$\lambda$','Interpreter','latex','FontSize',fontsize_sym);
...
xlim([-pi,+pi]); xlabel('$\psi$','Interpreter','latex','FontSize',fontsize_sym);
ylim([-0.25,5.00]);
title('Distribution');
%%%%;
...
sgtitle(''); %fontsize_use = 32;
subplot(1,4,1+0);title('Error (BI)','Interpreter','none'); %set(gca,'FontSize',fontsize_use);
subplot(1,4,1+1);title('Error (ME)','Interpreter','none'); %set(gca,'FontSize',fontsize_use);
subplot(1,4,1+2);title('Error (AMPM)','Interpreter','none'); %set(gca,'FontSize',fontsize_use);
subplot(1,4,1+3);%set(gca,'FontSize',fontsize_use);
