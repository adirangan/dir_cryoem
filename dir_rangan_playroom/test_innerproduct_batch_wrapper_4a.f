      subroutine test_innerproduct_batch_wrapper_4a(verbose,n_S,n_M,C_M_
...
c$$$      parameters for timing
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[entering test_innerproduct_batch_wrapper_4a]'
      end if
      if (verbose.gt.0) then
     ...
     $        ,ns_tmp,'; ns ',ns,'; finished'
      ...
      if (verbose.gt.0) then
         write(6,'(A)') '[finished test_innerproduct_batch_wrapper_4a]'
      end if
      end
