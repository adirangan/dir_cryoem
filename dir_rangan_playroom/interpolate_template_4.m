...
str_thisfunction = 'interpolate_template_4';
...
%%%%;
fnorm_disp(flag_verbose,'template_2_wkS_sub__',template_2_wkS_sub__,'template_mid_x_wkS_sub__',template_mid_x_wkS_sub__);
fnorm_disp(flag_verbose,'template_2_wkS_sub__',template_2_wkS_sub__,'template_3_mid_x_wkS_sub__',template_3_mid_x_wkS_sub__);
fnorm_disp(flag_verbose,'template_3_wkS_sub__',template_3_wkS_sub__,'template_mid_x_wkS_sub__',template_mid_x_wkS_sub__);
fnorm_disp(flag_verbose,'template_3_wkS_sub__',template_3_wkS_sub__,'template_3_mid_x_wkS_sub__',template_3_mid_x_wkS_sub__);
%%%%;
...
if (flag_verbose>0); disp(sprintf(' %% flag_d0 %d flag_d1 %d flag_d2 %d',flag_d0,flag_d1,flag_d2)); end;
...
if (flag_verbose>0); disp(sprintf(' %% sum(weight_3d_k_single_shell_) %0.16f 4*pi*weight_3d_k_p_r_(1) %0.16f',sum(weight_3d_k_single_shell_),4*pi*weight_3d_k_p_r_(1))); end;
weight_shell_qk_single_shell_ = weight_shell_qk_(1:n_q_single_shell); %<-- sum(weight_shell_qk_single_shell_) = 4*pi*k_p_r_(1)^2. ;
if (flag_verbose>0); disp(sprintf(' %% sum(weight_shell_qk_single_shell_) %0.16f 4*pi*k_p_r_(1)^2 %0.16f',sum(weight_shell_qk_single_shell_),4*pi*k_p_r_(1)^2)); end;
weight_shell_qk_unit_shell_ = weight_shell_qk_single_shell_/max(1e-12,k_p_r_(1))^2; %<-- sum(weight_shell_qk_unit_shell_) = 4*pi. ;
%%%%%%%%;
...
+ bsxfun(@times,dSda_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_a),[n_wS,1])) ...
+ bsxfun(@times,dSdb_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_a),[n_wS,1])) ...
;
dSdb_k_p_wSk__(:,1+nk_p_r) = ...
+ bsxfun(@times,dSda_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_b),[n_wS,1])) ...
+ bsxfun(@times,dSdb_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_b),[n_wS,1])) ...
;
dSdc_k_p_wSk__(:,1+nk_p_r) = ...
+ bsxfun(@times,dSda_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_c),[n_wS,1])) ...
+ bsxfun(@times,dSdb_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_c),[n_wS,1])) ...
;
end;%if flag_d1;
if flag_d2;
ddSdaa_k_p_wSk__(:,1+nk_p_r) = ...
+ 1.0*bsxfun(@times,dSda_k_p_wS_,reshape(dtau_dtau_k_p_polar_a_wS33____(:,:,1+tab_a,1+tab_a),[n_wS,1])) ...
+ 1.0*bsxfun(@times,dSdb_k_p_wS_,reshape(dtau_dtau_k_p_azimu_b_wS33____(:,:,1+tab_a,1+tab_a),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdaa_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_a),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_a),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_a),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdbb_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_a),[n_wS,1])) ...
;
ddSdab_k_p_wSk__(:,1+nk_p_r) = ...
+ 1.0*bsxfun(@times,dSda_k_p_wS_,reshape(dtau_dtau_k_p_polar_a_wS33____(:,:,1+tab_a,1+tab_b),[n_wS,1])) ...
+ 1.0*bsxfun(@times,dSdb_k_p_wS_,reshape(dtau_dtau_k_p_azimu_b_wS33____(:,:,1+tab_a,1+tab_b),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdaa_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_b),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_b),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_b),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdbb_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_b),[n_wS,1])) ...
;
ddSdac_k_p_wSk__(:,1+nk_p_r) = ...
+ 1.0*bsxfun(@times,dSda_k_p_wS_,reshape(dtau_dtau_k_p_polar_a_wS33____(:,:,1+tab_a,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,dSdb_k_p_wS_,reshape(dtau_dtau_k_p_azimu_b_wS33____(:,:,1+tab_a,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdaa_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdbb_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_a),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_c),[n_wS,1])) ...
;
ddSdbb_k_p_wSk__(:,1+nk_p_r) = ...
+ 1.0*bsxfun(@times,dSda_k_p_wS_,reshape(dtau_dtau_k_p_polar_a_wS33____(:,:,1+tab_b,1+tab_b),[n_wS,1])) ...
+ 1.0*bsxfun(@times,dSdb_k_p_wS_,reshape(dtau_dtau_k_p_azimu_b_wS33____(:,:,1+tab_b,1+tab_b),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdaa_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_b),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_b),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_b),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_b),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_b),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_b),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdbb_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_b),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_b),[n_wS,1])) ...
;
ddSdbc_k_p_wSk__(:,1+nk_p_r) = ...
+ 1.0*bsxfun(@times,dSda_k_p_wS_,reshape(dtau_dtau_k_p_polar_a_wS33____(:,:,1+tab_b,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,dSdb_k_p_wS_,reshape(dtau_dtau_k_p_azimu_b_wS33____(:,:,1+tab_b,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdaa_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_b),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_b),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_b),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdbb_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_b),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_c),[n_wS,1])) ...
;
ddSdcc_k_p_wSk__(:,1+nk_p_r) = ...
+ 1.0*bsxfun(@times,dSda_k_p_wS_,reshape(dtau_dtau_k_p_polar_a_wS33____(:,:,1+tab_c,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,dSdb_k_p_wS_,reshape(dtau_dtau_k_p_azimu_b_wS33____(:,:,1+tab_c,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdaa_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_c),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_c),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdab_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_c),[n_wS,1]).*reshape(dtau_k_p_polar_a_wS3___(:,:,1+tab_c),[n_wS,1])) ...
+ 1.0*bsxfun(@times,ddSdbb_k_p_wS_,reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_c),[n_wS,1]).*reshape(dtau_k_p_azimu_b_wS3___(:,:,1+tab_c),[n_wS,1])) ...
;
end;%if flag_d2;
end;%for nk_p_r=0:n_k_p_r-1;
tmp_t = toc(tmp_t); if (flag_verbose>0); disp(sprintf(' %% applying interpolation operator: %0.6fs',tmp_t)); end;
...
% Copying to output. ;
%%%%%%%%;
if flag_d0; template_wkS__ = S_k_p_wkS__; end;
if flag_d1;
