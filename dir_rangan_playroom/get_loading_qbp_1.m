...
% These will not be used in calculating the loadings. ;
%%%%;
...
if (flag_unique_n==0);
error(sprintf(' %% Error, consider setting l_max_ and n_w_ to be uniform in get_loading_qbp_1'));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
if flag_loading_svd_vs_iterate==0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
V_Ml__(:,1+nloading) = V_Ml__(:,1+nloading)/S_l_(1+nloading);
end;%for nloading=0:n_loading-1;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
end;%flag_loading_svd_vs_iterate==0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
if flag_loading_svd_vs_iterate==1;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%;
...
if (verbose>1); disp(sprintf(' %% [finished get_loading_qbp_1]')); end;
