...
tmp_X_ampm_use_srt_ = sort(tmp_X_ampm_a_(tmp_index_ampm_),'ascend');
tmp_X_sher_use_srt_ = sort(tmp_X_sher_a_(tmp_index_sher_),'ascend');
...
patch(tmp_horiz + tmp_width*[0;0;1;1;0],tmp_verti*[0;1;1;0;0],0,'LineWidth',linewidth_use,'EdgeColor','k','FaceColor',facecolor_corr_);
str_xtick_{1+nx} = 'OAM';
xtick_min_(1+nx) = xtick_pre;
xtick_max_(1+nx) = xtick_pre + tmp_width;
xtick_pre = xtick_max_(1+nx) + tmp_horiz_gap;
