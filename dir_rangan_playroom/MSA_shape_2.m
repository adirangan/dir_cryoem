...
MSA_shape_2(parameter,q_max,n_gamma);
...
fname_fig_pre = sprintf('%s/MSA_shape_%s_complexplane_pre_FIGA',dir_jpg,tmp_str);
...
dir_jpg = sprintf('%s/dir_jpg',pwd); if ~exist(dir_jpg,'dir'); mkdir(dir_jpg); end;
fname_fig_pre = sprintf('%s/MSA_shape_%s_complexplane_FIGA',dir_jpg,tmp_str);
fname_fig_jpg = sprintf('%s.jpg',fname_fig_pre);
...
dir_jpg = sprintf('%s/dir_jpg',pwd); if ~exist(dir_jpg,'dir'); mkdir(dir_jpg); end;
fname_fig_pre = sprintf('%s/MSA_shape_%s_display_FIGA',dir_jpg,tmp_str);
fname_fig_jpg = sprintf('%s.jpg',fname_fig_pre);
...
fname_fig_pre = sprintf('%s/MSA_shape_%s_isosurface_FIGA',dir_jpg,tmp_str);
fname_fig_jpg = sprintf('%s.jpg',fname_fig_pre);
figure(1+nf);nf=nf+1;clf;figbig;
fontsize_use = 12;
