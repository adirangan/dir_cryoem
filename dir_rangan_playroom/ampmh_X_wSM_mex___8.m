%%%%%%%%;
% test function for mex_ampmh_X_wSM___10.c ;
%%%%%%%%;
function ...
[ ...
 parameter ...
...
if (verbose); disp(sprintf(' %% [testing ampmh_X_wSM_mex___8.m]')); end;
%%%%%%%%;
tmp_t = tic();
[ ...
 n_k_all ...
...
%%%%%%%%;
mex_X_wSS___ = reshape(mex_X_wSS___,size(X_wSS___));
mex_delta_x_wSS___ = reshape(mex_delta_x_wSS___,size(delta_x_wSS___));
mex_delta_y_wSS___ = reshape(mex_delta_y_wSS___,size(delta_y_wSS___));
mex_gamma_z_wSS___ = reshape(mex_gamma_z_wSS___,size(gamma_z_wSS___));
mex_I_value_wSS___ = reshape(mex_I_value_wSS___,size(I_value_wSS___));
%%%%%%%%;
flag_plot=1;
if flag_plot;
figure(1+nf);nf=nf+1;figbig; np=0;
n_l = n_w_max*n_S*n_S;
subplot(2,3,1+np);np=np+1; plot(1:n_l,X_wSS___(:) - mex_X_wSS___(:),'.'); title('X_wSS___','Interpreter','none');
subplot(2,3,1+np);np=np+1; plot(1:n_l,delta_x_wSS___(:) - mex_delta_x_wSS___(:),'.'); title('delta_x_wSS___','Interpreter','none');
subplot(2,3,1+np);np=np+1; plot(1:n_l,delta_y_wSS___(:) - mex_delta_y_wSS___(:),'.'); title('delta_y_wSS___','Interpreter','none');
subplot(2,3,1+np);np=np+1; plot(1:n_l,gamma_z_wSS___(:) - mex_gamma_z_wSS___(:),'.'); title('gamma_z_wSS___','Interpreter','none');
subplot(2,3,1+np);np=np+1; plot(1:n_l,I_value_wSS___(:) - mex_I_value_wSS___(:),'.'); title('I_value_wSS___','Interpreter','none');
sgtitle('flag_optimize_over_gamma_z==0','Interpreter','none');
end;%if flag_plot;
%%%%%%%%;
flag_dump=0;
if flag_dump;
%%%%;
mex_svd_SVUXM_SMwl____ = c_MDA_read_c16('mex_svd_SVUXM_SMwl____.mat');
ori_svd_SVUXM_SMwl____ = load('ori_svd_SVUXM_SMwl____.mat'); ori_svd_SVUXM_SMwl____ = ori_svd_SVUXM_SMwl____.svd_SVUXM_SMwl____;
disp(sprintf(' %% ori_svd_SVUXM_SMwl____ vs mex_svd_SVUXM_SMwl____: %0.16f',fnorm(ori_svd_SVUXM_SMwl____ - mex_svd_SVUXM_SMwl____)/fnorm(ori_svd_SVUXM_SMwl____)));
mex_svd_SVUXM_lwSM____ = c_MDA_read_c16('mex_svd_SVUXM_lwSM____.mat');
ori_svd_SVUXM_lwSM____ = load('ori_svd_SVUXM_lwSM____.mat'); ori_svd_SVUXM_lwSM____ = ori_svd_SVUXM_lwSM____.svd_SVUXM_lwSM____;
disp(sprintf(' %% ori_svd_SVUXM_lwSM____ vs mex_svd_SVUXM_lwSM____: %0.16f',fnorm(ori_svd_SVUXM_lwSM____ - mex_svd_SVUXM_lwSM____)/fnorm(ori_svd_SVUXM_lwSM____)));
%%%%;
mex_svd_SVUXM_lwsM____ = c_MDA_read_c16('mex_svd_SVUXM_lwsM____.mat');
ori_svd_SVUXM_lwsM____ = load('ori_svd_SVUXM_lwsM____.mat'); ori_svd_SVUXM_lwsM____ = ori_svd_SVUXM_lwsM____.svd_SVUXM_lwsM____;
disp(sprintf(' %% ori_svd_SVUXM_lwsM____ vs mex_svd_SVUXM_lwsM____: %0.16f',fnorm(ori_svd_SVUXM_lwsM____ - mex_svd_SVUXM_lwsM____)/fnorm(ori_svd_SVUXM_lwsM____)));
mex_svd_USESVUXM_dwSM____ = c_MDA_read_c16('mex_svd_USESVUXM_dwSM____.mat');
ori_svd_USESVUXM_dwSM____ = load('ori_svd_USESVUXM_dwSM____.mat'); ori_svd_USESVUXM_dwSM____ = ori_svd_USESVUXM_dwSM____.svd_USESVUXM_dwSM____;
disp(sprintf(' %% ori_svd_USESVUXM_dwSM____ vs mex_svd_USESVUXM_dwSM____: %0.16f',fnorm(ori_svd_USESVUXM_dwSM____ - mex_svd_USESVUXM_dwSM____)/fnorm(ori_svd_USESVUXM_dwSM____)));
%%%%;
mex_l2_dSM___ = c_MDA_read_r8('mex_l2_dSM___.mat');
ori_l2_dSM___ = load('ori_l2_dSM___.mat'); ori_l2_dSM___ = ori_l2_dSM___.l2_dSM___;
disp(sprintf(' %% ori_l2_dSM___ vs mex_l2_dSM___: %0.16f',fnorm(ori_l2_dSM___ - mex_l2_dSM___)/fnorm(ori_l2_dSM___)));
mex_n2_dSM___ = c_MDA_read_r8('mex_n2_dSM___.mat');
ori_n2_dSM___ = load('ori_n2_dSM___.mat'); ori_n2_dSM___ = ori_n2_dSM___.n2_dSM___;
disp(sprintf(' %% ori_n2_dSM___ vs mex_n2_dSM___: %0.16f',fnorm(ori_n2_dSM___ - mex_n2_dSM___)/fnorm(ori_n2_dSM___)));
mex_f2_dSM___ = c_MDA_read_r8('mex_f2_dSM___.mat');
ori_f2_dSM___ = load('ori_f2_dSM___.mat'); ori_f2_dSM___ = ori_f2_dSM___.f2_dSM___;
disp(sprintf(' %% ori_f2_dSM___ vs mex_f2_dSM___: %0.16f',fnorm(ori_f2_dSM___ - mex_f2_dSM___)/fnorm(ori_f2_dSM___)));
mex_X_sub_dwSM____ = c_MDA_read_r8('mex_X_sub_dwSM____.mat');
ori_X_sub_dwSM____ = load('ori_X_sub_dwSM____.mat'); ori_X_sub_dwSM____ = ori_X_sub_dwSM____.X_sub_dwSM____;
disp(sprintf(' %% ori_X_sub_dwSM____ vs mex_X_sub_dwSM____: %0.16f',fnorm(ori_X_sub_dwSM____ - mex_X_sub_dwSM____)/fnorm(ori_X_sub_dwSM____)));
%%%%;
mex_X_wSM___ = c_MDA_read_r8('mex_X_wSM___.mat');
ori_X_wSM___ = load('ori_X_wSM___.mat'); ori_X_wSM___ = ori_X_wSM___.X_wSM___;
disp(sprintf(' %% ori_X_wSM___ vs mex_X_wSM___: %0.16f',fnorm(ori_X_wSM___ - mex_X_wSM___)/fnorm(ori_X_wSM___)));
mex_delta_x_wSM___ = c_MDA_read_r8('mex_delta_x_wSM___.mat');
ori_delta_x_wSM___ = load('ori_delta_x_wSM___.mat'); ori_delta_x_wSM___ = ori_delta_x_wSM___.delta_x_wSM___;
disp(sprintf(' %% ori_delta_x_wSM___ vs mex_delta_x_wSM___: %0.16f',fnorm(ori_delta_x_wSM___ - mex_delta_x_wSM___)/fnorm(ori_delta_x_wSM___)));
mex_delta_y_wSM___ = c_MDA_read_r8('mex_delta_y_wSM___.mat');
ori_delta_y_wSM___ = load('ori_delta_y_wSM___.mat'); ori_delta_y_wSM___ = ori_delta_y_wSM___.delta_y_wSM___;
disp(sprintf(' %% ori_delta_y_wSM___ vs mex_delta_y_wSM___: %0.16f',fnorm(ori_delta_y_wSM___ - mex_delta_y_wSM___)/fnorm(ori_delta_y_wSM___)));
mex_gamma_z_wSM___ = c_MDA_read_r8('mex_gamma_z_wSM___.mat');
ori_gamma_z_wSM___ = load('ori_gamma_z_wSM___.mat'); ori_gamma_z_wSM___ = ori_gamma_z_wSM___.gamma_z_wSM___;
disp(sprintf(' %% ori_gamma_z_wSM___ vs mex_gamma_z_wSM___: %0.16f',fnorm(ori_gamma_z_wSM___ - mex_gamma_z_wSM___)/fnorm(ori_gamma_z_wSM___)));
mex_I_value_wSM___ = c_MDA_read_r8('mex_I_value_wSM___.mat');
ori_I_value_wSM___ = load('ori_I_value_wSM___.mat'); ori_I_value_wSM___ = ori_I_value_wSM___.I_value_wSM___;
disp(sprintf(' %% ori_I_value_wSM___ vs mex_I_value_wSM___: %0.16f',fnorm(ori_I_value_wSM___ - mex_I_value_wSM___)/fnorm(ori_I_value_wSM___)));
%%%%%%%%;
end;%if flag_dump;
%%%%;
...
%%%%%%%%;
if flag_plot;
figure(1+nf);nf=nf+1;clf;figmed;figbeach(); X_max = max(abs(X_wSS_form___(:)));
...
title('X form - X calc','Interpreter','none'); xlabel('S0');ylabel('S1');
subplot(2,2,1+np);np=np+1;
imagesc((squeeze(X_wSS_form___(:,:,1+nS) - X_wSS___(:,:,1+nS)*(pi*k_p_r_max^2))),X_max*[-1,+1]);
title('X form - X calc','Interpreter','none'); ylabel('nw');xlabel('S0');
subplot(2,2,1+np);np=np+1;
imagesc((squeeze(X_wSS_form___(1+nw,:,:) - mex_X_wSS___(1+nw,:,:)*(pi*k_p_r_max^2))),X_max*[-1,+1]);
title('X form - mex_X calc','Interpreter','none'); xlabel('S0');ylabel('S1');
subplot(2,2,1+np);np=np+1;
imagesc((squeeze(X_wSS_form___(:,:,1+nS) - mex_X_wSS___(:,:,1+nS)*(pi*k_p_r_max^2))),X_max*[-1,+1]);
title('X form - mex_X calc','Interpreter','none'); ylabel('nw');xlabel('S0');
end;%if flag_plot;
if (verbose); disp(sprintf(' %% X_wSS_form___ vs X_wSS*(pi*k_p_r_max^2): %0.16f',fnorm(X_wSS_form___ - X_wSS___*(pi*k_p_r_max^2))/fnorm(X_wSS_form___))); end;
if (verbose); disp(sprintf(' %% X_wSS_form___ vs mex_X_wSS*(pi*k_p_r_max^2): %0.16f',fnorm(X_wSS_form___ - mex_X_wSS___*(pi*k_p_r_max^2))/fnorm(X_wSS_form___))); end;
...
%%%%%%%%;
mex_X_SS__ = reshape(mex_X_SS__,size(X_SS__));
mex_delta_x_SS__ = reshape(mex_delta_x_SS__,size(delta_x_SS__));
mex_delta_y_SS__ = reshape(mex_delta_y_SS__,size(delta_y_SS__));
mex_gamma_z_SS__ = reshape(mex_gamma_z_SS__,size(gamma_z_SS__));
mex_I_value_SS__ = reshape(mex_I_value_SS__,size(I_value_SS__));
%%%%%%%%;
flag_plot=1;
if flag_plot;
figure(1+nf);nf=nf+1;figbig; np=0;
n_l = n_S*n_S;
subplot(2,3,1+np);np=np+1; plot(1:n_l,X_SS__(:) - mex_X_SS__(:),'.'); title('X_SS__','Interpreter','none');
subplot(2,3,1+np);np=np+1; plot(1:n_l,delta_x_SS__(:) - mex_delta_x_SS__(:),'.'); title('delta_x_SS__','Interpreter','none');
subplot(2,3,1+np);np=np+1; plot(1:n_l,delta_y_SS__(:) - mex_delta_y_SS__(:),'.'); title('delta_y_SS__','Interpreter','none');
subplot(2,3,1+np);np=np+1; plot(1:n_l,gamma_z_SS__(:) - mex_gamma_z_SS__(:),'.'); title('gamma_z_SS__','Interpreter','none');
subplot(2,3,1+np);np=np+1; plot(1:n_l,I_value_SS__(:) - mex_I_value_SS__(:),'.'); title('I_value_SS__','Interpreter','none');
sgtitle('flag_optimize_over_gamma_z==1','Interpreter','none');
end;%if flag_plot;
%%%%%%%%;
...
verbose = 2;
if (verbose>0); disp(sprintf(' %% [entering ampmh_X_wSM_mex___8]')); end;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex___8: svd_VUXM_nMwl____',tmp_t,1,nop);
%%%%%%%%;
if (flag_compress_S==0);
tmp_t = tic(); nop=0;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex___8: svd_SVUXM_SMwl____',tmp_t,1,nop);
%%%%;
tmp_t = tic(); nop=0;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex___8: svd_SVUXM_lwSM____',tmp_t,1,nop);
end;%if (flag_compress_S==0);
%%%%%%%%;
flag_disp=0;
if flag_disp;
if (verbose); disp(sprintf(' %% nMbatch %d/%d',nMbatch,n_Mbatch)); end;
tab = min(8,n_S*n_M_sub*n_w_max*FTK.n_svd_l);
if (verbose); array_printf(svd_SVUXM_SMwl____,1,tab,' %% svd_SVUXM_SMwl____'); end;
if (verbose); array_printf(svd_SVUXM_lwSM____,1,tab,' %% svd_SVUXM_lwSM____'); end;
end;%if flag_disp;
flag_dump=0;
if flag_dump;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex___8: svd_USVUXM_SMwl____',tmp_t,1,nop);
tmp_t = tic(); nop=0;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex___8: svd_USVUXM_SMwl____ (permute)',tmp_t,1,nop);
end;%if (flag_compress_S==1);
%%%%%%%%;
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex___8: svd_USESVUXM_dwSM____',tmp_t,1,nop);
...
parameter = parameter_timing_update(parameter,'ampmh_X_wSM_mex___8: X_sub_dwSM____',tmp_t,1,nop);
%%%%%%%%;
flag_check=0;
if flag_check;
...
%%%%%%%%;
if flag_disp;
if (verbose); disp(sprintf(' %% nMbatch %d/%d nSbatch %d/%d',nMbatch,n_Mbatch,nSbatch,n_Sbatch)); end;
if (flag_optimize_over_gamma_z==0);
tab = min(8,n_S_sub*n_M_sub*n_w_max);
if (verbose); array_printf(X_wSM___,1,tab,' %% X_wSM___'); end;
if (verbose); array_printf(delta_x_wSM___,1,tab,' %% delta_x_wSM___'); end;
if (verbose); array_printf(delta_y_wSM___,1,tab,' %% delta_y_wSM___'); end;
if (verbose); array_printf(gamma_z_wSM___,1,tab,' %% gamma_z_wSM___'); end;
if (flag_compute_I_value); if (verbose); array_printf(I_value_wSM___,1,tab,' %% I_value_wSM___'); end; end;
end;%if (flag_optimize_over_gamma_z==0);
if (flag_optimize_over_gamma_z==1);
tab = min(8,n_S_sub*n_M_sub); 
if (verbose); array_printf(X_SM__,1,tab,' %% X_SM__'); end;
if (verbose); array_printf(delta_x_SM__,1,tab,' %% delta_x_SM__'); end;
if (verbose); array_printf(delta_y_SM__,1,tab,' %% delta_y_SM__'); end;
if (verbose); array_printf(gamma_z_SM__,1,tab,' %% gamma_z_SM__'); end;
if (flag_compute_I_value); if (verbose); array_printf(I_value_SM__,1,tab,' %% I_value_SM__'); end; end;
end;%if (flag_optimize_over_gamma_z==1);
end;%if flag_disp;
%%%%%%%%;
end;%if (n_S_sub>0);
...
if (verbose>1); disp(sprintf(' %% [finished ampmh_X_wSM_mex___8]')); end;
