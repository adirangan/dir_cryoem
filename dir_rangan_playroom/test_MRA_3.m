...
%%%%%%%%;
figure(1);clf;figbig;
p_row = min(n_sigma,3); p_col = ceil(2*n_sigma/p_row); np=0;
c_beach__ = colormap_beach(); n_c_beach = size(c_beach__,1);
str_symbol_ = {'o','p'}; n_str_symbol=numel(str_symbol_);
markersize_use = 8;
linewidth_use = 3;
...
%set(gca,'YTick',1:n_gamma,'YTickLabel',gamma_scan_); ylabel('gamma');
set(gca,'YTick',[1,n_gamma],'YTickLabel',{'0','$2\pi$'},'TickLabelInterpreter','latex');
ylabel('$\gamma$','Interpreter','latex');
%set(gca,'XTick',1:n_r_factor,'XTickLabel',log2(r_factor_)); xlabel('log2(r_factor)','Interpreter','none');
set(gca,'XTick',[1,1+(n_r_factor-1)/2,n_r_factor],'XTickLabel',{'$\frac{1}{2}$','$1$','$2$'},'TickLabelInterpreter','latex');
xlabel('$r_{-}/r_{+}$','Interpreter','latex');
set(gca,'FontSize',18);
drawnow();
%%%%;
end;%for nsigma=0:n_sigma-1;
...
subplot(1,2,1);imagesc(loss_nrm_gf__);colorbar;
subplot(1,2,2);imagesc(adloss_nrm_gf__);colorbar;
