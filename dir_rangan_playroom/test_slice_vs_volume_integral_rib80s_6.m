%%%%%%%%;
% applying eig_ddssnll_lanczos_0 to rib80s. ;
%%%%%%%%;
...
str_thisfunction = 'test_slice_vs_volume_integral_rib80s_6';
...
tmp_k_c_0_ = cos(euler_azimu_b_true_).*sin(euler_polar_a_true_);
tmp_k_c_1_ = sin(euler_azimu_b_true_).*sin(euler_polar_a_true_);
tmp_k_c_2_ = cos(euler_polar_a_true_);
markersize_use = 16;
plot3(tmp_k_c_0_,tmp_k_c_1_,tmp_k_c_2_,'.','MarkerSize',markersize_use);
