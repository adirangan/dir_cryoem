...
n_w_max = max(n_w_);
UX_M_k_q_gpu_dwnM____ = reshape(svd_U_d_expiw_s_gpu__*reshape(svd_VUXM_gpu_lwnM____,[FTK.n_svd_l,n_w_max*pm_n_UX_rank*n_M]),[FTK.n_delta_v,n_w_max,pm_n_UX_rank,n_M]);
