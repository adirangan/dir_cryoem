str_thisfunction = 'test_interpolate_template_gpu_8';
...
parameter.flag_verbose = 1*flag_verbose;
...
if ~exist('wT_sub_from_R_single_shell_gpu_Rsba___','var'); wT_sub_from_R_single_shell_gpu_Rsba___=[]; end;
if ~exist('dwT_subda_from_R_single_shell_gpu_Rsba___','var'); dwT_subda_from_R_single_shell_gpu_Rsba___=[]; end;
if ~exist('dwT_subdb_from_R_single_shell_gpu_Rsba___','var'); dwT_subdb_from_R_single_shell_gpu_Rsba___=[]; end;
if ~exist('ddwT_subdaa_from_R_single_shell_gpu_Rsba___','var'); ddwT_subdaa_from_R_single_shell_gpu_Rsba___=[]; end;
if ~exist('ddwT_subdab_from_R_single_shell_gpu_Rsba___','var'); ddwT_subdab_from_R_single_shell_gpu_Rsba___=[]; end;
if ~exist('ddwT_subdbb_from_R_single_shell_gpu_Rsba___','var'); ddwT_subdbb_from_R_single_shell_gpu_Rsba___=[]; end;
tmp_t = tic();
[ ...
 parameter ...
,template_gpu_x_wkS_sub__ ...
,n_w ...
,n_viewing_S_sub ...
,viewing_azimu_b_S_sub_ ...
,viewing_polar_a_S_sub_ ...
...
,wT_sub_from_R_single_shell_gpu_Rsba___ ...
...
,dwT_subda_from_R_single_shell_gpu_Rsba___ ...
,dwT_subdb_from_R_single_shell_gpu_Rsba___ ...
...
,ddwT_subdaa_from_R_single_shell_gpu_Rsba___ ...
,ddwT_subdab_from_R_single_shell_gpu_Rsba___ ...
,ddwT_subdbb_from_R_single_shell_gpu_Rsba___ ...
] = ...
...
fnorm_disp(flag_verbose,'template_cpu_x_wkS_sub__',template_cpu_x_wkS_sub__,'template_gpu_x_wkS_sub__',template_gpu_x_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'dtemplateda_cpu_wkS_sub__',dtemplateda_cpu_wkS_sub__,'dtemplateda_gpu_wkS_sub__',dtemplateda_gpu_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'dtemplatedb_gpu_wkS_sub__',dtemplatedb_cpu_wkS_sub__,'dtemplatedb_gpu_wkS_sub__',dtemplatedb_gpu_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'dtemplatedc_cpu_wkS_sub__',dtemplatedc_cpu_wkS_sub__,'dtemplatedc_gpu_wkS_sub__',dtemplatedc_gpu_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedaa_cpu_wkS_sub__',ddtemplatedaa_cpu_wkS_sub__,'ddtemplatedaa_gpu_wkS_sub__',ddtemplatedaa_gpu_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedab_cpu_wkS_sub__',ddtemplatedab_cpu_wkS_sub__,'ddtemplatedab_gpu_wkS_sub__',ddtemplatedab_gpu_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedac_cpu_wkS_sub__',ddtemplatedac_cpu_wkS_sub__,'ddtemplatedac_gpu_wkS_sub__',ddtemplatedac_gpu_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedbb_cpu_wkS_sub__',ddtemplatedbb_cpu_wkS_sub__,'ddtemplatedbb_gpu_wkS_sub__',ddtemplatedbb_gpu_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedbc_cpu_wkS_sub__',ddtemplatedbc_cpu_wkS_sub__,'ddtemplatedbc_gpu_wkS_sub__',ddtemplatedbc_gpu_wkS_sub__,' %%<-- should be zero');
fnorm_disp(flag_verbose,'ddtemplatedcc_cpu_wkS_sub__',ddtemplatedcc_cpu_wkS_sub__,'ddtemplatedcc_gpu_wkS_sub__',ddtemplatedcc_gpu_wkS_sub__,' %%<-- should be zero');
