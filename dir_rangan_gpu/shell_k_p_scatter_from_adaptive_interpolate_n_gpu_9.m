function ...
[ ...
 scatter_from_tensor_gpu_sba__ ...
,dscatterda_from_tensor_gpu_sba__ ...
,dscatterdb_from_tensor_gpu_sba__ ...
,ddscatterdaa_from_tensor_gpu_sba__ ...
,ddscatterdab_from_tensor_gpu_sba__ ...
,ddscatterdbb_from_tensor_gpu_sba__ ...
] = ...
...
% k_s_b_, ;
% ;
% The (n_scatter)-by-(n_unrolled) scatter_from_tensor_gpu_sba__ matrix stores the ;
% interpolation weights linking a_k_p_ba_ to the unrolled a_k_s_. ;
%%%%;

str_thisfunction = 'shell_k_p_scatter_from_adaptive_interpolate_n_gpu_9';
...
tensor_extend_from_tensor_gpu_baba__ = gpuArray( sparse(1+index_row_tensor_extend_from_tensor_ba_,1+index_col_tensor_extend_from_tensor_ba_,1,n_k_p_b_extend_sum,n_k_p_b_sum) );

%%%%%%%%;
if  flag_1 & ~flag_d  &~flag_dd ;
[ ...
 scatter_from_tensor_extend_gpu_sba__ ...
] = ...
...
[ ...
 scatter_from_tensor_extend_gpu_sba__ ...
 dscatterda_from_tensor_extend_gpu_sba__ ...
 dscatterdb_from_tensor_extend_gpu_sba__ ...
] = ...
cylinder_k_c_scatter_from_tensor_adaptive_interpolate_n_gpu_9( ...
 n_order ...
,n_k_p_a_extend ...
...
[ ...
 ...
 dscatterda_from_tensor_extend_gpu_sba__ ...
 dscatterdb_from_tensor_extend_gpu_sba__ ...
 ddscatterdaa_from_tensor_extend_gpu_sba__ ...
 ddscatterdab_from_tensor_extend_gpu_sba__ ...
 ddscatterdbb_from_tensor_extend_gpu_sba__ ...
] = ...
cylinder_k_c_scatter_from_tensor_adaptive_interpolate_n_gpu_9( ...
 n_order ...
,n_k_p_a_extend ...
...
scatter_from_tensor_gpu_sba__ = scatter_from_tensor_extend_gpu_sba__ * tensor_extend_from_tensor_gpu_baba__ ;
if flag_d;
dscatterda_from_tensor_gpu_sba__ = dscatterda_from_tensor_extend_gpu_sba__ * tensor_extend_from_tensor_gpu_baba__ ;
dscatterdb_from_tensor_gpu_sba__ = dscatterdb_from_tensor_extend_gpu_sba__ * tensor_extend_from_tensor_gpu_baba__ ;
end;%if flag_d;
if flag_dd;
ddscatterdaa_from_tensor_gpu_sba__ = ddscatterdaa_from_tensor_extend_gpu_sba__ * tensor_extend_from_tensor_gpu_baba__ ;
ddscatterdab_from_tensor_gpu_sba__ = ddscatterdab_from_tensor_extend_gpu_sba__ * tensor_extend_from_tensor_gpu_baba__ ;
ddscatterdbb_from_tensor_gpu_sba__ = ddscatterdbb_from_tensor_extend_gpu_sba__ * tensor_extend_from_tensor_gpu_baba__ ;
end;%if flag_dd;
