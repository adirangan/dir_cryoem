...
index_nM_ = transpose([0:n_M-1]);
index_nS_ = transpose([0:n_S-1]);
[ ...
 parameter ...
,M_k_q_wkM__ ...
,UX_T_M_l2_dM__ ...
...
tmp_t = toc(tmp_t); if (flag_verbose>0); disp(sprintf(' %% tfpmhp_Z_wSM___14: %0.6f',tmp_t)); end;
%%%%;
tmp_t = tic();
...
parameter.flag_precompute_M_k_q_wkM__ = 0*1;
parameter.flag_precompute_UX_T_M_l2_dM__ = 0*1;
parameter.flag_precompute_UX_M_l2_M_ = 0*1;
parameter.flag_precompute_svd_V_UX_M_lwnM____ = 0*1;
parameter.flag_precompute_UX_CTF_S_k_q_wnS__ = 0*1;
parameter.flag_precompute_UX_CTF_S_l2_S_ = 0*1;
[ ...
 parameter ...
,tfpmh_Z_gpu_wSM___ ...
...
tmp_t = toc(tmp_t); if (flag_verbose>0); disp(sprintf(' %% tfpmh_Z_gpu_wSM___14: %0.6f',tmp_t)); end;
...
%%%%%%%%;
% compare to ../dir_rangan_python/dir_pymat/test_tfpmh_Z_gpu_wSM___14.mat. ;
%%%%;
dir_pymat = '../dir_rangan_python/dir_pymat';
if parameter.flag_optimize_over_gamma_z==0; fname_pymat = sprintf('%s/test_tfpmh_Z_gpu_wSM___14.mat',dir_pymat); end;
if parameter.flag_optimize_over_gamma_z==1; fname_pymat = sprintf('%s/test_tfpmh_Z_gpu_SM__14.mat',dir_pymat); end;
...
fnorm_disp(flag_verbose,'tfpmh_Z_gpu_wSM___',tfpmh_Z_gpu_wSM___,'tmp_.tfpmh_Z_gpu_wSM___',tmp_.tfpmh_Z_gpu_wSM___,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'tfpmh_UX_T_M_l2_gpu_dM__',tfpmh_UX_T_M_l2_gpu_dM__,'tmp_.tfpmh_UX_T_M_l2_gpu_dM__',tmp_.tfpmh_UX_T_M_l2_gpu_dM__,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'tfpmh_UX_M_l2_gpu_M_',tfpmh_UX_M_l2_gpu_M_,'tmp_.tfpmh_UX_M_l2_gpu_M_',tmp_.tfpmh_UX_M_l2_gpu_M_,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'tfpmh_UX_CTF_S_l2_gpu_S_',tfpmh_UX_CTF_S_l2_gpu_S_,'tmp_.tfpmh_UX_CTF_S_l2_gpu_S_',tmp_.tfpmh_UX_CTF_S_l2_gpu_S_,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'tfpmh_X_gpu_wSM___',tfpmh_X_gpu_wSM___,'tmp_.tfpmh_X_gpu_wSM___',tmp_.tfpmh_X_gpu_wSM___,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'tfpmh_delta_x_gpu_wSM___',tfpmh_delta_x_gpu_wSM___,'tmp_.tfpmh_delta_x_gpu_wSM___',tmp_.tfpmh_delta_x_gpu_wSM___,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'tfpmh_delta_y_gpu_wSM___',tfpmh_delta_y_gpu_wSM___,'tmp_.tfpmh_delta_y_gpu_wSM___',tmp_.tfpmh_delta_y_gpu_wSM___,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'tfpmh_gamma_z_gpu_wSM___',tfpmh_gamma_z_gpu_wSM___,'tmp_.tfpmh_gamma_z_gpu_wSM___',tmp_.tfpmh_gamma_z_gpu_wSM___,' %%<-- should be <1e-6');
fnorm_disp(flag_verbose,'tfpmh_index_sub_gpu_wSM___',tfpmh_index_sub_gpu_wSM___,'double(tmp_.tfpmh_index_sub_gpu_wSM___)',double(tmp_.tfpmh_index_sub_gpu_wSM___),' %%<-- should be <1e-6');
...
nw = max(0,min(n_w_max,floor(n_w_max*rand()))); gamma_z = (2*pi*nw)/max(1,n_w_max);
delta_x = tfpmh_delta_x_gpu_wSM___(1+nw,1+nS,1+nM); delta_y = tfpmh_delta_y_gpu_wSM___(1+nw,1+nS,1+nM);
Z_tfpm = tfpmh_Z_gpu_wSM___(1+nw,1+nS,1+nM);
X_tfpm = tfpmh_X_gpu_wSM___(1+nw,1+nS,1+nM);
end;%if parameter.flag_optimize_over_gamma_z==0;
%%%%;
if parameter.flag_optimize_over_gamma_z==1;
gamma_z = tfpmh_gamma_z_gpu_wSM___(1+nS,1+nM);
delta_x = tfpmh_delta_x_gpu_wSM___(1+nS,1+nM); delta_y = tfpmh_delta_y_gpu_wSM___(1+nS,1+nM);
Z_tfpm = tfpmh_Z_gpu_wSM___(1+nS,1+nM);
X_tfpm = tfpmh_X_gpu_wSM___(1+nS,1+nM);
