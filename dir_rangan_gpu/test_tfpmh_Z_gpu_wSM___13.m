...
disp(sprintf(' %% testing tfpmh_Z_gpu_wSM___13: flag_speed_vs_error %d',flag_speed_vs_error));
n_1 = 1; n_2 = 2;
...
[ ...
 parameter ...
,tfpmh_Z_gpu_wSM___ ...
,tfpmh_UX_CTF_R_S_l2_gpu_wSM___ ...
...
tmp_t = toc(tmp_t); if (flag_verbose>0); disp(sprintf(' %% tfpmh_Z_gpu_wSM___13: %0.6f',tmp_t)); end;
...
if (flag_verbose>0); disp(sprintf(' %% tmp_Z_errrel: %0.16f',tmp_Z_errrel)); end;
if (flag_verbose>0); disp(sprintf(' %% tmp_X_errrel: %0.16f',tmp_X_errrel)); end;
%%%%%%%%%%%%%%%%;
